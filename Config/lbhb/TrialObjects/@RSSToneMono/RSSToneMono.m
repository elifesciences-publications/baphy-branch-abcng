function RefTarO = RSSToneMono(varargin)
% RSSToneMono -- hacked from MultiRefTar
%
...
case 0
    ...
    RefTarO.descriptor = 'RSSToneMono';
    ...
    RefTarO.ReferenceCountFreq=[0 0.3 0.3 0.3 0 0];
    ...
    RefTarO.UserDefinableFields = ...
        {'OveralldB','edit',60,...
         ...
         'ReferenceCountFreq','edit',[0 0.3 0.3 0.3 0 0],...
    ...
    RefTarO = class(RefTarO,'RSSToneMono');
