...
fcorrs = [1 13.3 30 100 1000];
tcorrs = [1 15.3 30 100 1000];
...
for f=1:5
    ...
    [target_sounds, target_grids] = generate_gauss_sounds(10,320,fcorr,tcorr,.5,sr,1);

    temp = [];
    for t=1:10
        k=k+1;
        subplot(5,10,k);
        imagesc(flipud(20*log10(sound_energy_grid_full(target_sounds(t,:),sr,38,20,4300,20,1))));
