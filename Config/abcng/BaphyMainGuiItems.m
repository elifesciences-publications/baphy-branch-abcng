...
switch field
  % Tester:
  case 'Tester'
    varargout{1} = {'Jennifer','Celian','Thibaut','Yves','Rupesh','Anna','Jeff','Xinhe','Austin Powers'};
    % Ferret Names:
  case 'Ferret'
    if dbopen,
  ...
  case 'HWSetup'
    % Sound Proof rooms:
    varargout{1} = {'0: Test', '1: SB1', '2: SB2','3: LB1','4: TwoP','11:HP1','5:SB2Earphones'};
  ...
  case 'outpath',
    ...
    switch globalparams.HWSetup,
      ...
      case {1,2,3,4,5} % PHYSIOLOGY SETUPS
        varargout{1}='D:\Data\';
