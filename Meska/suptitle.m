function hout=suptitle(str,size)
...
%    h=[h,ch(i)];
%  end
%end	Commented out by bard to avoid complaints
...
ht=text(.5,titleypos-1,str);set(ht,'horizontalalignment','center','fontsize',fs,'fontweight','bold');
set(gcf,'nextplot',np);
axes(haold);
if nargout,
	hout=ht;
