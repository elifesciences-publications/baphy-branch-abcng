...
switch nargin
  case 0  % if no input arguments, create a default object
    ...
    Fields = {...
      ...
      'D1shape','popupmenu','none|contig_increm|non_contig_increm',...  % be careful to put all spaces for LastValues.mat
      'DifficultyLvl_D1','edit','150',...
      'D1param','edit','[]',...                % in case we need extra params
      'D2shape','popupmenu','none|contig_increm|non_contig_increm',...
      ...
      'FrozenPatternsAdress','popupmenu','none|C:\Code\baphy\UtilitiesYves\FrozenPatterns|/home/yves/baphy/UtilitiesYves/FrozenPatterns|C:\Users\Booth1\Dropbox\FrozenPatterns',...
