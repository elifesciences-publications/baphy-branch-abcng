...
case 0
    ...
    s = SoundObject ('SpeechLong', 40000, 0, 0, 0, {}, 1, {'Subsets','edit',1,'SNR','edit',1000,...
        'NoiseType','popupmenu','None|White|Pink|Jet2|F16|MachineGun|City','ReverbTime','edit',0,...
        'Duration','edit',3});
    o.Subsets = 1;
    o.SNR = 1000;
    o.NoiseType = 'White';
