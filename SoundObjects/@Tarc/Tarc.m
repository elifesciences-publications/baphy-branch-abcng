function o = Tarc(varargin)
% Tarc is the constructor for the object Tarc which is a child of  
%       SoundObject class
...
%       "Params"
% usage:
%   t = Tarc;     creates an instance of class torc with default values.
%   t = Tarc (Loudness, PreStimSilence, PostStimSilence,
...
switch nargin
    case 0
        ...
        s = SoundObject ('Tarc', 80000, 0, 0.4, 0.8, {}, 1, {'Rates','popupmenu','4|8|16|24',...
            'FrequencyRange','popupmenu','T:125-32000 Hz','Duration','edit',3});
        o.Duration = 3;
        o.FrequencyRange = 'T:125-32000 Hz';
        o.Rates = '4';
        o.Params.LowestFrequency = 125;
        o.Params.HighestFrequency = 32000;
        o.Params.NumberOfComponents = 800;
