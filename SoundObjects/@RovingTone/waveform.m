...
% this function is the waveform generator for object RovingTone

% compatibility issue: make new RovingTone object (with index) compatible witht
% the rest:
...
event = [];
% the parameters of RovingTone object
