function o = ToneInTorc (varargin)
...
switch nargin
    case 0
        ...
        o.BasedB= 70;
        o.BaseV=5;
        o = class(o,'ToneInTorc',s);
        o = ObjUpdate (o);
    case 1
        % if single argument of class SoundObject, return it
        if isa(varargin{1},'ToneInTOrc')
            o = varargin{1};
        else
    ...
    case 9
        % if no input arguments, create a default object
        s = SoundObject ('ToneInTorc', varargin{1}, varargin{2}, varargin{3}, varargin{4}, {}, 1, ...
            {'TorcRates','popupmenu','4:4:24|4:4:48|8:8:48|8:8:96',...
            'TorcFreqRange','popupmenu','L:125-4000 Hz|H:250-8000 Hz|V:500-16000 Hz',...
