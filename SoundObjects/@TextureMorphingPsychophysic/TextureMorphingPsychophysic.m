function o = TextureMorphingPsychophysic(varargin)
...
%   'Inverse_D0Dbis','popupmenu','no|yes',...
    ...
    s = SoundObject ('TextureMorphingPsychophysic',100000, 0,0.4, 0, {''}, 1, Fields);
    ...
    o.D2shape = 'none'; o.DifficultyLvl_D2 = 110; o.D2param = [2 3 5 7];
    o.FrozenPatternsAdress='none'; o.FrozenPatternsNb=0;
