...
global NET_DATA_ROOT DB_DATA_ROOT DB_FILESEP MYSQL_BIN_PATH
...
if isempty(NET_DATA_ROOT) & exist(DB_DATA_ROOT,'dir'),
   NET_DATA_ROOT=DB_DATA_ROOT;
   
elseif isempty(NET_DATA_ROOT),
   NET_DATA_ROOT='/Volumes/data/';
end
