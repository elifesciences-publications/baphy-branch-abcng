function varargout = DAQmxGetAIRawSampSize(varargin)
%DAQMXGETAIRAWSAMPSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIRawSampSize(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRawSampSize',varargin{:});
