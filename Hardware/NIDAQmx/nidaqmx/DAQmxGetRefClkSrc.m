function varargout = DAQmxGetRefClkSrc(varargin)
%DAQMXGETREFCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetRefClkSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRefClkSrc',varargin{:});
