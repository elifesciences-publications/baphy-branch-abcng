function varargout = DAQmxGetSelfCalLastDateAndTime(varargin)
%DAQMXGETSELFCALLASTDATEANDTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr] DAQmxGetSelfCalLastDateAndTime(cstring, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSelfCalLastDateAndTime',varargin{:});
