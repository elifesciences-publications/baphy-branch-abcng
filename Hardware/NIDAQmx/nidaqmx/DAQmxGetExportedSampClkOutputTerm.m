function varargout = DAQmxGetExportedSampClkOutputTerm(varargin)
%DAQMXGETEXPORTEDSAMPCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedSampClkOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedSampClkOutputTerm',varargin{:});
