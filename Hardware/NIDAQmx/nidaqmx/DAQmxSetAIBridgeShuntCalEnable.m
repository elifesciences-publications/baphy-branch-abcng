function varargout = DAQmxSetAIBridgeShuntCalEnable(varargin)
%DAQMXSETAIBRIDGESHUNTCALENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIBridgeShuntCalEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIBridgeShuntCalEnable',varargin{:});
