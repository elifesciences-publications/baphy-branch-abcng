function varargout = DAQmxResetAnlgWinPauseTrigBtm(varargin)
%DAQMXRESETANLGWINPAUSETRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinPauseTrigBtm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinPauseTrigBtm',varargin{:});
