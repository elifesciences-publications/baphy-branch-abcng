function varargout = DAQmxSetInterlockedHshkTrigAssertedLvl(varargin)
%DAQMXSETINTERLOCKEDHSHKTRIGASSERTEDLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetInterlockedHshkTrigAssertedLvl(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetInterlockedHshkTrigAssertedLvl',varargin{:});
