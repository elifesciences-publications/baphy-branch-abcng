function varargout = DAQmxGetCICountEdgesInitialCnt(varargin)
%DAQMXGETCICOUNTEDGESINITIALCNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCICountEdgesInitialCnt(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesInitialCnt',varargin{:});
