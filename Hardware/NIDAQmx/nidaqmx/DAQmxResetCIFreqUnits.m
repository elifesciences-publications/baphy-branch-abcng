function varargout = DAQmxResetCIFreqUnits(varargin)
%DAQMXRESETCIFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqUnits',varargin{:});
