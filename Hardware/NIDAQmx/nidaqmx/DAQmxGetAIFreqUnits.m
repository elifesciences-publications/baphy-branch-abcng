function varargout = DAQmxGetAIFreqUnits(varargin)
%DAQMXGETAIFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIFreqUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIFreqUnits',varargin{:});
