function varargout = DAQmxWriteCtrTicks(varargin)
%DAQMXWRITECTRTICKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr, uint32Ptr, int32Ptr, uint32Ptr] DAQmxWriteCtrTicks(uint32, int32, uint32, double, uint32, uint32Ptr, uint32Ptr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteCtrTicks',varargin{:});
