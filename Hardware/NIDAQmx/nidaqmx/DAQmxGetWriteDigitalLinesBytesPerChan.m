function varargout = DAQmxGetWriteDigitalLinesBytesPerChan(varargin)
%DAQMXGETWRITEDIGITALLINESBYTESPERCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWriteDigitalLinesBytesPerChan(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteDigitalLinesBytesPerChan',varargin{:});
