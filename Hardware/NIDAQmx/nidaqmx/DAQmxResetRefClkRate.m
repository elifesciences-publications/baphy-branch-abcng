function varargout = DAQmxResetRefClkRate(varargin)
%DAQMXRESETREFCLKRATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRefClkRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRefClkRate',varargin{:});
