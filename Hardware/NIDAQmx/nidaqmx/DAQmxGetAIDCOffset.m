function varargout = DAQmxGetAIDCOffset(varargin)
%DAQMXGETAIDCOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIDCOffset(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIDCOffset',varargin{:});
