function varargout = DAQmxGetScaleAttribute(varargin)
%DAQMXGETSCALEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetScaleAttribute(cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleAttribute',varargin{:});
