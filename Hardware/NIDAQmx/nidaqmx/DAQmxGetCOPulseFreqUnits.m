function varargout = DAQmxGetCOPulseFreqUnits(varargin)
%DAQMXGETCOPULSEFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCOPulseFreqUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseFreqUnits',varargin{:});
