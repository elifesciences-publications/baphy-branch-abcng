function varargout = DAQmxSetExportedAIConvClkOutputTerm(varargin)
%DAQMXSETEXPORTEDAICONVCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedAIConvClkOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAIConvClkOutputTerm',varargin{:});
