function varargout = DAQmxResetCIUsbXferReqSize(varargin)
%DAQMXRESETCIUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIUsbXferReqSize(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIUsbXferReqSize',varargin{:});
