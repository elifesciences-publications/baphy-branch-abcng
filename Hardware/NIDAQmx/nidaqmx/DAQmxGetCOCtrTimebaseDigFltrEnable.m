function varargout = DAQmxGetCOCtrTimebaseDigFltrEnable(varargin)
%DAQMXGETCOCTRTIMEBASEDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOCtrTimebaseDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseDigFltrEnable',varargin{:});
