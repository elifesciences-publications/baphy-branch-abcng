function varargout = DAQmxResetCIPeriodMeasMeth(varargin)
%DAQMXRESETCIPERIODMEASMETH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodMeasMeth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodMeasMeth',varargin{:});
