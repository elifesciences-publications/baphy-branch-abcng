function varargout = DAQmxSetDigLvlPauseTrigDigFltrTimebaseRate(varargin)
%DAQMXSETDIGLVLPAUSETRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigLvlPauseTrigDigFltrTimebaseRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigLvlPauseTrigDigFltrTimebaseRate',varargin{:});
