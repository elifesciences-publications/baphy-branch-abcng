function varargout = DAQmxSetDigLvlPauseTrigSrc(varargin)
%DAQMXSETDIGLVLPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigLvlPauseTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigLvlPauseTrigSrc',varargin{:});
