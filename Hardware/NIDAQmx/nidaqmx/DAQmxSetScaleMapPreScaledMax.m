function varargout = DAQmxSetScaleMapPreScaledMax(varargin)
%DAQMXSETSCALEMAPPRESCALEDMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetScaleMapPreScaledMax(cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleMapPreScaledMax',varargin{:});
