function varargout = DAQmxResetCISemiPeriodDigSyncEnable(varargin)
%DAQMXRESETCISEMIPERIODDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCISemiPeriodDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCISemiPeriodDigSyncEnable',varargin{:});
