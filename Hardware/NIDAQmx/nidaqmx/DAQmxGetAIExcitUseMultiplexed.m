function varargout = DAQmxGetAIExcitUseMultiplexed(varargin)
%DAQMXGETAIEXCITUSEMULTIPLEXED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIExcitUseMultiplexed(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIExcitUseMultiplexed',varargin{:});
