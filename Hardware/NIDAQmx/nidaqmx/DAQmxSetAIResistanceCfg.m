function varargout = DAQmxSetAIResistanceCfg(varargin)
%DAQMXSETAIRESISTANCECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIResistanceCfg(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIResistanceCfg',varargin{:});
