function varargout = DAQmxPerformBridgeOffsetNullingCal(varargin)
%DAQMXPERFORMBRIDGEOFFSETNULLINGCAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxPerformBridgeOffsetNullingCal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxPerformBridgeOffsetNullingCal',varargin{:});
