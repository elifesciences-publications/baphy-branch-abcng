function varargout = DAQmxResetHshkTrigType(varargin)
%DAQMXRESETHSHKTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetHshkTrigType(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetHshkTrigType',varargin{:});
