function varargout = DAQmxSetDOUsbXferReqSize(varargin)
%DAQMXSETDOUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOUsbXferReqSize(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOUsbXferReqSize',varargin{:});
