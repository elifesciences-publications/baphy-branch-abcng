function varargout = DAQmxGetAIChanCalEnableCal(varargin)
%DAQMXGETAICHANCALENABLECAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIChanCalEnableCal(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIChanCalEnableCal',varargin{:});
