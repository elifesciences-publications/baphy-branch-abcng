function varargout = DAQmxSetDigitalPowerUpStates(varargin)
%DAQMXSETDIGITALPOWERUPSTATES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, voidPtr] DAQmxSetDigitalPowerUpStates(cstring, cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigitalPowerUpStates',varargin{:});
