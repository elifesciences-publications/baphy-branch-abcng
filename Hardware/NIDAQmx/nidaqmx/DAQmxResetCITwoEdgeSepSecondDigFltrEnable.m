function varargout = DAQmxResetCITwoEdgeSepSecondDigFltrEnable(varargin)
%DAQMXRESETCITWOEDGESEPSECONDDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepSecondDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepSecondDigFltrEnable',varargin{:});
