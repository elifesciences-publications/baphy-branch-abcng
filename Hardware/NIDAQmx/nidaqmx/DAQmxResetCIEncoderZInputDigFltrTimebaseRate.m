function varargout = DAQmxResetCIEncoderZInputDigFltrTimebaseRate(varargin)
%DAQMXRESETCIENCODERZINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZInputDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZInputDigFltrTimebaseRate',varargin{:});
