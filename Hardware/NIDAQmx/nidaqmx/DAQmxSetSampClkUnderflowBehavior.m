function varargout = DAQmxSetSampClkUnderflowBehavior(varargin)
%DAQMXSETSAMPCLKUNDERFLOWBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkUnderflowBehavior(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkUnderflowBehavior',varargin{:});
