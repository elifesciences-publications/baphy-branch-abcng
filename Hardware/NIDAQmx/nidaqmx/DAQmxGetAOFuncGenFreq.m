function varargout = DAQmxGetAOFuncGenFreq(varargin)
%DAQMXGETAOFUNCGENFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOFuncGenFreq(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOFuncGenFreq',varargin{:});
