function varargout = DAQmxSetReadOverWrite(varargin)
%DAQMXSETREADOVERWRITE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetReadOverWrite(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadOverWrite',varargin{:});
