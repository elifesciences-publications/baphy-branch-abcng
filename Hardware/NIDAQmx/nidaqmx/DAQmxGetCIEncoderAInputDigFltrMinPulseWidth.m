function varargout = DAQmxGetCIEncoderAInputDigFltrMinPulseWidth(varargin)
%DAQMXGETCIENCODERAINPUTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIEncoderAInputDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderAInputDigFltrMinPulseWidth',varargin{:});
