function varargout = DAQmxGetAIStrainGagePoissonRatio(varargin)
%DAQMXGETAISTRAINGAGEPOISSONRATIO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIStrainGagePoissonRatio(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIStrainGagePoissonRatio',varargin{:});
