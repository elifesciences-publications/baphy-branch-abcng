function varargout = DAQmxResetCOCtrTimebaseDigFltrEnable(varargin)
%DAQMXRESETCOCTRTIMEBASEDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOCtrTimebaseDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOCtrTimebaseDigFltrEnable',varargin{:});
