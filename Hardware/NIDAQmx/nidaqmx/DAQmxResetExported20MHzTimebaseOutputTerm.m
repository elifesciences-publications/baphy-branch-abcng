function varargout = DAQmxResetExported20MHzTimebaseOutputTerm(varargin)
%DAQMXRESETEXPORTED20MHZTIMEBASEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExported20MHzTimebaseOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExported20MHzTimebaseOutputTerm',varargin{:});
