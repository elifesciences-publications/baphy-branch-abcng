function varargout = DAQmxPerformBridgeOffsetNullingCalEx(varargin)
%DAQMXPERFORMBRIDGEOFFSETNULLINGCALEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxPerformBridgeOffsetNullingCalEx(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxPerformBridgeOffsetNullingCalEx',varargin{:});
