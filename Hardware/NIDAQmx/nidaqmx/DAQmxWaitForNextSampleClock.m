function varargout = DAQmxWaitForNextSampleClock(varargin)
%DAQMXWAITFORNEXTSAMPLECLOCK calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxWaitForNextSampleClock(uint32, double, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWaitForNextSampleClock',varargin{:});
