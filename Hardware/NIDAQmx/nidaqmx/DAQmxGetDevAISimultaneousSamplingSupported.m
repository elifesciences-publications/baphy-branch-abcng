function varargout = DAQmxGetDevAISimultaneousSamplingSupported(varargin)
%DAQMXGETDEVAISIMULTANEOUSSAMPLINGSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevAISimultaneousSamplingSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAISimultaneousSamplingSupported',varargin{:});
