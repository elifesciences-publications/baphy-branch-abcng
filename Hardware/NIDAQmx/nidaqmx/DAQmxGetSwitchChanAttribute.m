function varargout = DAQmxGetSwitchChanAttribute(varargin)
%DAQMXGETSWITCHCHANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr] DAQmxGetSwitchChanAttribute(cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanAttribute',varargin{:});
