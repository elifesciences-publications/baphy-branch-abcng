function varargout = DAQmxResetCICtrTimebaseMasterTimebaseDiv(varargin)
%DAQMXRESETCICTRTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseMasterTimebaseDiv(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseMasterTimebaseDiv',varargin{:});
