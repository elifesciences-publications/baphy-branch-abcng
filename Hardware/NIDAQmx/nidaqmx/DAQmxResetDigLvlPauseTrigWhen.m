function varargout = DAQmxResetDigLvlPauseTrigWhen(varargin)
%DAQMXRESETDIGLVLPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigLvlPauseTrigWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigLvlPauseTrigWhen',varargin{:});
