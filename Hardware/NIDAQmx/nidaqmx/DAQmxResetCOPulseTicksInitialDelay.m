function varargout = DAQmxResetCOPulseTicksInitialDelay(varargin)
%DAQMXRESETCOPULSETICKSINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseTicksInitialDelay(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseTicksInitialDelay',varargin{:});
