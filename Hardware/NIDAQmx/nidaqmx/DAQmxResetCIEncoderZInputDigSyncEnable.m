function varargout = DAQmxResetCIEncoderZInputDigSyncEnable(varargin)
%DAQMXRESETCIENCODERZINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZInputDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZInputDigSyncEnable',varargin{:});
