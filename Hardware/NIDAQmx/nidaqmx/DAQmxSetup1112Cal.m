function varargout = DAQmxSetup1112Cal(varargin)
%DAQMXSETUP1112CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1112Cal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1112Cal',varargin{:});
