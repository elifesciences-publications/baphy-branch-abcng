function varargout = DAQmxResetBufOutputOnbrdBufSize(varargin)
%DAQMXRESETBUFOUTPUTONBRDBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetBufOutputOnbrdBufSize(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetBufOutputOnbrdBufSize',varargin{:});
