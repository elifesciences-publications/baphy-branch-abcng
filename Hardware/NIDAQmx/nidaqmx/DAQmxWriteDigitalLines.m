function varargout = DAQmxWriteDigitalLines(varargin)
%DAQMXWRITEDIGITALLINES calls nidaqmx library with the appropriate arguments.
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteDigitalLines',varargin{:});
