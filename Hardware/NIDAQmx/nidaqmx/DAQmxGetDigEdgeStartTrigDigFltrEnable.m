function varargout = DAQmxGetDigEdgeStartTrigDigFltrEnable(varargin)
%DAQMXGETDIGEDGESTARTTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetDigEdgeStartTrigDigFltrEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeStartTrigDigFltrEnable',varargin{:});
