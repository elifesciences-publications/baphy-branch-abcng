function varargout = DAQmxResetAODACOffsetVal(varargin)
%DAQMXRESETAODACOFFSETVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACOffsetVal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACOffsetVal',varargin{:});
