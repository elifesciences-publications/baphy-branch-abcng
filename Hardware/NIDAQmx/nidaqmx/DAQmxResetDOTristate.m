function varargout = DAQmxResetDOTristate(varargin)
%DAQMXRESETDOTRISTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOTristate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOTristate',varargin{:});
