function varargout = DAQmxSetExportedDataActiveEventLvlActiveLvl(varargin)
%DAQMXSETEXPORTEDDATAACTIVEEVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedDataActiveEventLvlActiveLvl(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedDataActiveEventLvlActiveLvl',varargin{:});
