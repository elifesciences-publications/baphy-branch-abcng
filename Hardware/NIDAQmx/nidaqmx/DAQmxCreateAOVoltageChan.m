function varargout = DAQmxCreateAOVoltageChan(varargin)
%DAQMXCREATEAOVOLTAGECHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAOVoltageChan(uint32, cstring, cstring, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAOVoltageChan',varargin{:});
