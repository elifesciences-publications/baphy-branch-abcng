function varargout = DAQmxGetCIFreqDigFltrEnable(varargin)
%DAQMXGETCIFREQDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIFreqDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqDigFltrEnable',varargin{:});
