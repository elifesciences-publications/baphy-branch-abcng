function varargout = DAQmxDeviceSupportsCal(varargin)
%DAQMXDEVICESUPPORTSCAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxDeviceSupportsCal(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxDeviceSupportsCal',varargin{:});
