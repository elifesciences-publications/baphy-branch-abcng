function varargout = DAQmxWriteDigitalScalarU32(varargin)
%DAQMXWRITEDIGITALSCALARU32 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxWriteDigitalScalarU32(uint32, uint32, double, uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteDigitalScalarU32',varargin{:});
