function varargout = DAQmxGetAnlgEdgeRefTrigHyst(varargin)
%DAQMXGETANLGEDGEREFTRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgEdgeRefTrigHyst(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeRefTrigHyst',varargin{:});
