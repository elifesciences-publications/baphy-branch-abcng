function varargout = DAQmxSetCIPulseWidthTerm(varargin)
%DAQMXSETCIPULSEWIDTHTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIPulseWidthTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPulseWidthTerm',varargin{:});
