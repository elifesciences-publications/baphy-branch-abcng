function varargout = DAQmxResetDOLogicFamily(varargin)
%DAQMXRESETDOLOGICFAMILY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOLogicFamily(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOLogicFamily',varargin{:});
