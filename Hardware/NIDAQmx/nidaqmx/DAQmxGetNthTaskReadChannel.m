function varargout = DAQmxGetNthTaskReadChannel(varargin)
%DAQMXGETNTHTASKREADCHANNEL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetNthTaskReadChannel(uint32, uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetNthTaskReadChannel',varargin{:});
