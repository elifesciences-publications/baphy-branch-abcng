function varargout = DAQmxGetCOPulseLowTime(varargin)
%DAQMXGETCOPULSELOWTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOPulseLowTime(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseLowTime',varargin{:});
