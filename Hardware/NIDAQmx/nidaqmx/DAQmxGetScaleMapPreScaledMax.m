function varargout = DAQmxGetScaleMapPreScaledMax(varargin)
%DAQMXGETSCALEMAPPRESCALEDMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetScaleMapPreScaledMax(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleMapPreScaledMax',varargin{:});
