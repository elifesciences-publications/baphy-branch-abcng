function varargout = DAQmxResetWatchdogAttribute(varargin)
%DAQMXRESETWATCHDOGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetWatchdogAttribute(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWatchdogAttribute',varargin{:});
