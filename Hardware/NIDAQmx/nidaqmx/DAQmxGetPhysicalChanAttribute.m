function varargout = DAQmxGetPhysicalChanAttribute(varargin)
%DAQMXGETPHYSICALCHANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetPhysicalChanAttribute(cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanAttribute',varargin{:});
