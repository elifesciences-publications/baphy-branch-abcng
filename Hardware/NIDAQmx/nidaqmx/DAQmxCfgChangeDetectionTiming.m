function varargout = DAQmxCfgChangeDetectionTiming(varargin)
%DAQMXCFGCHANGEDETECTIONTIMING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCfgChangeDetectionTiming(uint32, cstring, cstring, int32, uint64)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgChangeDetectionTiming',varargin{:});
