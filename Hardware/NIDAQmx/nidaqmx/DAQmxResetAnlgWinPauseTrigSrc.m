function varargout = DAQmxResetAnlgWinPauseTrigSrc(varargin)
%DAQMXRESETANLGWINPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinPauseTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinPauseTrigSrc',varargin{:});
