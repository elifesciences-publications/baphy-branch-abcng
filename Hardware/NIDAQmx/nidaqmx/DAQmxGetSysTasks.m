function varargout = DAQmxGetSysTasks(varargin)
%DAQMXGETSYSTASKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetSysTasks(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSysTasks',varargin{:});
