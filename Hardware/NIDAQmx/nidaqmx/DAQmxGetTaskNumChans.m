function varargout = DAQmxGetTaskNumChans(varargin)
%DAQMXGETTASKNUMCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetTaskNumChans(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTaskNumChans',varargin{:});
