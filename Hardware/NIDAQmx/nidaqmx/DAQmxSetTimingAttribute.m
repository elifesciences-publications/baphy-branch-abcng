function varargout = DAQmxSetTimingAttribute(varargin)
%DAQMXSETTIMINGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxSetTimingAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetTimingAttribute',varargin{:});
