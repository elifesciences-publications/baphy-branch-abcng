function varargout = DAQmxResetAIConvActiveEdge(varargin)
%DAQMXRESETAICONVACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAIConvActiveEdge(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvActiveEdge',varargin{:});
