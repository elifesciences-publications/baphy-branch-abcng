function varargout = DAQmxGetSwitchChanWireMode(varargin)
%DAQMXGETSWITCHCHANWIREMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSwitchChanWireMode(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanWireMode',varargin{:});
