function varargout = DAQmxResetAIEnhancedAliasRejectionEnable(varargin)
%DAQMXRESETAIENHANCEDALIASREJECTIONENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIEnhancedAliasRejectionEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIEnhancedAliasRejectionEnable',varargin{:});
