function varargout = DAQmxSetDigEdgeAdvTrigDigFltrEnable(varargin)
%DAQMXSETDIGEDGEADVTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeAdvTrigDigFltrEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeAdvTrigDigFltrEnable',varargin{:});
