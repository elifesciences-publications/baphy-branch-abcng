function varargout = DAQmxGetDevSerialNum(varargin)
%DAQMXGETDEVSERIALNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevSerialNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevSerialNum',varargin{:});
