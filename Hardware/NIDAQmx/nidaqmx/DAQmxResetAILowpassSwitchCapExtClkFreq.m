function varargout = DAQmxResetAILowpassSwitchCapExtClkFreq(varargin)
%DAQMXRESETAILOWPASSSWITCHCAPEXTCLKFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILowpassSwitchCapExtClkFreq(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILowpassSwitchCapExtClkFreq',varargin{:});
