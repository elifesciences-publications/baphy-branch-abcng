function varargout = DAQmxResetReadRelativeTo(varargin)
%DAQMXRESETREADRELATIVETO calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadRelativeTo(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadRelativeTo',varargin{:});
