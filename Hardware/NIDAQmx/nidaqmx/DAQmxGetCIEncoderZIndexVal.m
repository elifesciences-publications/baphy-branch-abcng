function varargout = DAQmxGetCIEncoderZIndexVal(varargin)
%DAQMXGETCIENCODERZINDEXVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIEncoderZIndexVal(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderZIndexVal',varargin{:});
