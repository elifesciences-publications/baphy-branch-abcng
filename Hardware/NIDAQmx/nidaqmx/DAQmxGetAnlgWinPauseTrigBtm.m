function varargout = DAQmxGetAnlgWinPauseTrigBtm(varargin)
%DAQMXGETANLGWINPAUSETRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgWinPauseTrigBtm(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinPauseTrigBtm',varargin{:});
