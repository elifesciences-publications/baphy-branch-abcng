function varargout = DAQmxSetAIRngHigh(varargin)
%DAQMXSETAIRNGHIGH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRngHigh(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRngHigh',varargin{:});
