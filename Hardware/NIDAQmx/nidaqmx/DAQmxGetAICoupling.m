function varargout = DAQmxGetAICoupling(varargin)
%DAQMXGETAICOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAICoupling(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAICoupling',varargin{:});
