function varargout = DAQmxGetSampClkRate(varargin)
%DAQMXGETSAMPCLKRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetSampClkRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkRate',varargin{:});
