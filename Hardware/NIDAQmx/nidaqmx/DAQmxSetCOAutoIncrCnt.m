function varargout = DAQmxSetCOAutoIncrCnt(varargin)
%DAQMXSETCOAUTOINCRCNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOAutoIncrCnt(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOAutoIncrCnt',varargin{:});
