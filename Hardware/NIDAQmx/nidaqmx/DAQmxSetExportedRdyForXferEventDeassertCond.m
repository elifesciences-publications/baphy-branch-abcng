function varargout = DAQmxSetExportedRdyForXferEventDeassertCond(varargin)
%DAQMXSETEXPORTEDRDYFORXFEREVENTDEASSERTCOND calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedRdyForXferEventDeassertCond(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedRdyForXferEventDeassertCond',varargin{:});
