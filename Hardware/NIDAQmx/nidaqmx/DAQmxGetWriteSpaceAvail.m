function varargout = DAQmxGetWriteSpaceAvail(varargin)
%DAQMXGETWRITESPACEAVAIL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWriteSpaceAvail(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteSpaceAvail',varargin{:});
