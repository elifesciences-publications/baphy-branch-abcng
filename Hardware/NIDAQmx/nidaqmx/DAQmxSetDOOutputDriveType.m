function varargout = DAQmxSetDOOutputDriveType(varargin)
%DAQMXSETDOOUTPUTDRIVETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOOutputDriveType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOOutputDriveType',varargin{:});
