function varargout = DAQmxGetWriteRawDataWidth(varargin)
%DAQMXGETWRITERAWDATAWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWriteRawDataWidth(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteRawDataWidth',varargin{:});
