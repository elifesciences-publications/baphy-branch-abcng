function varargout = DAQmxGetCICtrTimebaseDigFltrMinPulseWidth(varargin)
%DAQMXGETCICTRTIMEBASEDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCICtrTimebaseDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseDigFltrMinPulseWidth',varargin{:});
