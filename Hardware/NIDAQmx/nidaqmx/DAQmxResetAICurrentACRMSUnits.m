function varargout = DAQmxResetAICurrentACRMSUnits(varargin)
%DAQMXRESETAICURRENTACRMSUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAICurrentACRMSUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAICurrentACRMSUnits',varargin{:});
