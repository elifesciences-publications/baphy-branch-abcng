function varargout = DAQmxResetAIDataXferReqCond(varargin)
%DAQMXRESETAIDATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIDataXferReqCond(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIDataXferReqCond',varargin{:});
