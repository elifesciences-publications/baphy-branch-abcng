function varargout = DAQmxSetAIVoltageACRMSUnits(varargin)
%DAQMXSETAIVOLTAGEACRMSUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIVoltageACRMSUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIVoltageACRMSUnits',varargin{:});
