function varargout = DAQmxGetCOPulseFreq(varargin)
%DAQMXGETCOPULSEFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOPulseFreq(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseFreq',varargin{:});
