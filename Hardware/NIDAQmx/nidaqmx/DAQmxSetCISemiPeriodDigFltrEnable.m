function varargout = DAQmxSetCISemiPeriodDigFltrEnable(varargin)
%DAQMXSETCISEMIPERIODDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCISemiPeriodDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCISemiPeriodDigFltrEnable',varargin{:});
