function varargout = DAQmxGetCIFreqUnits(varargin)
%DAQMXGETCIFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIFreqUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqUnits',varargin{:});
