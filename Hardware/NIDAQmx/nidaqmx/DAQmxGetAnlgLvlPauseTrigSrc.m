function varargout = DAQmxGetAnlgLvlPauseTrigSrc(varargin)
%DAQMXGETANLGLVLPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetAnlgLvlPauseTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgLvlPauseTrigSrc',varargin{:});
