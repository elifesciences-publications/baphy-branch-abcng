function varargout = DAQmxSetAOUseOnlyOnBrdMem(varargin)
%DAQMXSETAOUSEONLYONBRDMEM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOUseOnlyOnBrdMem(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOUseOnlyOnBrdMem',varargin{:});
