function varargout = DAQmxGetAIProbeAtten(varargin)
%DAQMXGETAIPROBEATTEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIProbeAtten(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIProbeAtten',varargin{:});
