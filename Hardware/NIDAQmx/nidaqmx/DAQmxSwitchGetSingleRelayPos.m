function varargout = DAQmxSwitchGetSingleRelayPos(varargin)
%DAQMXSWITCHGETSINGLERELAYPOS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxSwitchGetSingleRelayPos(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchGetSingleRelayPos',varargin{:});
