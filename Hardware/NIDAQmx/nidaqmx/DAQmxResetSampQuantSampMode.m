function varargout = DAQmxResetSampQuantSampMode(varargin)
%DAQMXRESETSAMPQUANTSAMPMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampQuantSampMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampQuantSampMode',varargin{:});
