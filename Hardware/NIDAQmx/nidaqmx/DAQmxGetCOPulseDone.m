function varargout = DAQmxGetCOPulseDone(varargin)
%DAQMXGETCOPULSEDONE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOPulseDone(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseDone',varargin{:});
