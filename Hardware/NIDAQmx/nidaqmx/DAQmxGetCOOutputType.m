function varargout = DAQmxGetCOOutputType(varargin)
%DAQMXGETCOOUTPUTTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCOOutputType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOOutputType',varargin{:});
