function varargout = DAQmxSetAILossyLSBRemovalCompressedSampSize(varargin)
%DAQMXSETAILOSSYLSBREMOVALCOMPRESSEDSAMPSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILossyLSBRemovalCompressedSampSize(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILossyLSBRemovalCompressedSampSize',varargin{:});
