function varargout = DAQmxSetCICountEdgesTerm(varargin)
%DAQMXSETCICOUNTEDGESTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCICountEdgesTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesTerm',varargin{:});
