function varargout = DAQmxSetCOPulseLowTicks(varargin)
%DAQMXSETCOPULSELOWTICKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseLowTicks(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseLowTicks',varargin{:});
