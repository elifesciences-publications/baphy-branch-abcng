function varargout = DAQmxGetExtCalRecommendedInterval(varargin)
%DAQMXGETEXTCALRECOMMENDEDINTERVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetExtCalRecommendedInterval(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExtCalRecommendedInterval',varargin{:});
