function varargout = DAQmxResetCOPulseHighTicks(varargin)
%DAQMXRESETCOPULSEHIGHTICKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseHighTicks(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseHighTicks',varargin{:});
