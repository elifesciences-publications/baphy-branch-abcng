function varargout = DAQmxSetAIConvTimebaseDivEx(varargin)
%DAQMXSETAICONVTIMEBASEDIVEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIConvTimebaseDivEx(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvTimebaseDivEx',varargin{:});
