function varargout = DAQmxGetCOOutputState(varargin)
%DAQMXGETCOOUTPUTSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCOOutputState(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOOutputState',varargin{:});
