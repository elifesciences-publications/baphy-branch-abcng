function varargout = DAQmxResetAIRawDataCompressionType(varargin)
%DAQMXRESETAIRAWDATACOMPRESSIONTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRawDataCompressionType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRawDataCompressionType',varargin{:});
