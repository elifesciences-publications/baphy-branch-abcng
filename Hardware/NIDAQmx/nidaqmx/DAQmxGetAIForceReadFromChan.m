function varargout = DAQmxGetAIForceReadFromChan(varargin)
%DAQMXGETAIFORCEREADFROMCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIForceReadFromChan(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIForceReadFromChan',varargin{:});
