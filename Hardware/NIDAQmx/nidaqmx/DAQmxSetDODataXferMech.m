function varargout = DAQmxSetDODataXferMech(varargin)
%DAQMXSETDODATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDODataXferMech(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDODataXferMech',varargin{:});
