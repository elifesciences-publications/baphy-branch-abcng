function varargout = DAQmxSetup1142Cal(varargin)
%DAQMXSETUP1142CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1142Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1142Cal',varargin{:});
