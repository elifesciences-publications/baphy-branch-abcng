function varargout = DAQmxGetAIAccelSensitivityUnits(varargin)
%DAQMXGETAIACCELSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIAccelSensitivityUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIAccelSensitivityUnits',varargin{:});
