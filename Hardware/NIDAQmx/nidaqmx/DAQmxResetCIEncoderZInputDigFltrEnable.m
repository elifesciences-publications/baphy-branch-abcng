function varargout = DAQmxResetCIEncoderZInputDigFltrEnable(varargin)
%DAQMXRESETCIENCODERZINPUTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZInputDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZInputDigFltrEnable',varargin{:});
