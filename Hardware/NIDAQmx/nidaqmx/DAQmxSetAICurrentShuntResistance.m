function varargout = DAQmxSetAICurrentShuntResistance(varargin)
%DAQMXSETAICURRENTSHUNTRESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAICurrentShuntResistance(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAICurrentShuntResistance',varargin{:});
