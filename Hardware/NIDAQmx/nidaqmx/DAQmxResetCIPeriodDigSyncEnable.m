function varargout = DAQmxResetCIPeriodDigSyncEnable(varargin)
%DAQMXRESETCIPERIODDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodDigSyncEnable',varargin{:});
