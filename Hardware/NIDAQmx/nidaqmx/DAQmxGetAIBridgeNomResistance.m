function varargout = DAQmxGetAIBridgeNomResistance(varargin)
%DAQMXGETAIBRIDGENOMRESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIBridgeNomResistance(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIBridgeNomResistance',varargin{:});
