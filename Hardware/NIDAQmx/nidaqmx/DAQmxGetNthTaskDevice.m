function varargout = DAQmxGetNthTaskDevice(varargin)
%DAQMXGETNTHTASKDEVICE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetNthTaskDevice(uint32, uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetNthTaskDevice',varargin{:});
