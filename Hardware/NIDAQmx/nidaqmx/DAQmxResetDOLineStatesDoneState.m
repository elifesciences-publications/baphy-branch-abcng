function varargout = DAQmxResetDOLineStatesDoneState(varargin)
%DAQMXRESETDOLINESTATESDONESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOLineStatesDoneState(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOLineStatesDoneState',varargin{:});
