function varargout = DAQmxResetAnlgLvlPauseTrigSrc(varargin)
%DAQMXRESETANLGLVLPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgLvlPauseTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgLvlPauseTrigSrc',varargin{:});
