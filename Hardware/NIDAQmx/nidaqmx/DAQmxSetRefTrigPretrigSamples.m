function varargout = DAQmxSetRefTrigPretrigSamples(varargin)
%DAQMXSETREFTRIGPRETRIGSAMPLES calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetRefTrigPretrigSamples(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRefTrigPretrigSamples',varargin{:});
