function varargout = DAQmxGetDigEdgeArmStartTrigDigFltrTimebaseSrc(varargin)
%DAQMXGETDIGEDGEARMSTARTTRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigEdgeArmStartTrigDigFltrTimebaseSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeArmStartTrigDigFltrTimebaseSrc',varargin{:});
