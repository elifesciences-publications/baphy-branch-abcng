function varargout = DAQmxSetWriteSleepTime(varargin)
%DAQMXSETWRITESLEEPTIME calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetWriteSleepTime(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWriteSleepTime',varargin{:});
