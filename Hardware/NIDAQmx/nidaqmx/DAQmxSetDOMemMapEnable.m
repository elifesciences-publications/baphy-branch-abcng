function varargout = DAQmxSetDOMemMapEnable(varargin)
%DAQMXSETDOMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOMemMapEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOMemMapEnable',varargin{:});
