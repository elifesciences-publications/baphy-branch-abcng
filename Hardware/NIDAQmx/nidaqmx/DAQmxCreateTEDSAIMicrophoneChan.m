function varargout = DAQmxCreateTEDSAIMicrophoneChan(varargin)
%DAQMXCREATETEDSAIMICROPHONECHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateTEDSAIMicrophoneChan(uint32, cstring, cstring, int32, int32, double, int32, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateTEDSAIMicrophoneChan',varargin{:});
