function varargout = DAQmxSetAIFreqThreshVoltage(varargin)
%DAQMXSETAIFREQTHRESHVOLTAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIFreqThreshVoltage(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIFreqThreshVoltage',varargin{:});
