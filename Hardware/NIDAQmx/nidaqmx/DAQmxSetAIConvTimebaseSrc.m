function varargout = DAQmxSetAIConvTimebaseSrc(varargin)
%DAQMXSETAICONVTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAIConvTimebaseSrc(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvTimebaseSrc',varargin{:});
