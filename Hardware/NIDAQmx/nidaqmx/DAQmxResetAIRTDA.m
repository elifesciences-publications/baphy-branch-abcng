function varargout = DAQmxResetAIRTDA(varargin)
%DAQMXRESETAIRTDA calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRTDA(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRTDA',varargin{:});
