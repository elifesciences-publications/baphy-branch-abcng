function varargout = DAQmxResetAnlgWinStartTrigTop(varargin)
%DAQMXRESETANLGWINSTARTTRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinStartTrigTop(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinStartTrigTop',varargin{:});
