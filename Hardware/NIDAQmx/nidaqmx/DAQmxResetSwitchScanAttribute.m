function varargout = DAQmxResetSwitchScanAttribute(varargin)
%DAQMXRESETSWITCHSCANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSwitchScanAttribute(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSwitchScanAttribute',varargin{:});
