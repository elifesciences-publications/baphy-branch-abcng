function varargout = DAQmxSetExportedAdvCmpltEventPulsePolarity(varargin)
%DAQMXSETEXPORTEDADVCMPLTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedAdvCmpltEventPulsePolarity(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAdvCmpltEventPulsePolarity',varargin{:});
