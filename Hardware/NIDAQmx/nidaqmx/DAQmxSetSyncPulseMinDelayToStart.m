function varargout = DAQmxSetSyncPulseMinDelayToStart(varargin)
%DAQMXSETSYNCPULSEMINDELAYTOSTART calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSyncPulseMinDelayToStart(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSyncPulseMinDelayToStart',varargin{:});
