function varargout = DAQmxSetAIUsbXferReqSize(varargin)
%DAQMXSETAIUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIUsbXferReqSize(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIUsbXferReqSize',varargin{:});
