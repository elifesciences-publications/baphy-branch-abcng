function varargout = DAQmxSetAIStrainGageGageFactor(varargin)
%DAQMXSETAISTRAINGAGEGAGEFACTOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIStrainGageGageFactor(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIStrainGageGageFactor',varargin{:});
