function varargout = DAQmxGetAILVDTUnits(varargin)
%DAQMXGETAILVDTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAILVDTUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILVDTUnits',varargin{:});
