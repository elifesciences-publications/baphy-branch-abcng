function varargout = DAQmxGetAIBridgeBalanceCoarsePot(varargin)
%DAQMXGETAIBRIDGEBALANCECOARSEPOT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIBridgeBalanceCoarsePot(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIBridgeBalanceCoarsePot',varargin{:});
