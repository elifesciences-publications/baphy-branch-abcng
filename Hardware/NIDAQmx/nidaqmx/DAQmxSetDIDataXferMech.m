function varargout = DAQmxSetDIDataXferMech(varargin)
%DAQMXSETDIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDIDataXferMech(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDIDataXferMech',varargin{:});
