function varargout = DAQmxResetCIPeriodDigFltrMinPulseWidth(varargin)
%DAQMXRESETCIPERIODDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodDigFltrMinPulseWidth',varargin{:});
