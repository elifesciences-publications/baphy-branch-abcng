function varargout = DAQmxSetCIPeriodStartingEdge(varargin)
%DAQMXSETCIPERIODSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodStartingEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodStartingEdge',varargin{:});
