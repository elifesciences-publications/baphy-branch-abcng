function varargout = DAQmxWriteBinaryU16(varargin)
%DAQMXWRITEBINARYU16 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint16Ptr, int32Ptr, uint32Ptr] DAQmxWriteBinaryU16(uint32, int32, uint32, double, uint32, uint16Ptr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteBinaryU16',varargin{:});
