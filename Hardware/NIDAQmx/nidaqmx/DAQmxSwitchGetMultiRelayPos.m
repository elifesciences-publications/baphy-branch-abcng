function varargout = DAQmxSwitchGetMultiRelayPos(varargin)
%DAQMXSWITCHGETMULTIRELAYPOS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr, uint32Ptr] DAQmxSwitchGetMultiRelayPos(cstring, uint32Ptr, uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchGetMultiRelayPos',varargin{:});
