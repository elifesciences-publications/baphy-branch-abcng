function varargout = DAQmxGetAIMicrophoneSensitivity(varargin)
%DAQMXGETAIMICROPHONESENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIMicrophoneSensitivity(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIMicrophoneSensitivity',varargin{:});
