function varargout = DAQmxSetSwitchScanBreakMode(varargin)
%DAQMXSETSWITCHSCANBREAKMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSwitchScanBreakMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSwitchScanBreakMode',varargin{:});
