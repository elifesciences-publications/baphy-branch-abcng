function varargout = DAQmxResetCOPulseTimeUnits(varargin)
%DAQMXRESETCOPULSETIMEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseTimeUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseTimeUnits',varargin{:});
