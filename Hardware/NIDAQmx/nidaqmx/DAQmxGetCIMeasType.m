function varargout = DAQmxGetCIMeasType(varargin)
%DAQMXGETCIMEASTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIMeasType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIMeasType',varargin{:});
