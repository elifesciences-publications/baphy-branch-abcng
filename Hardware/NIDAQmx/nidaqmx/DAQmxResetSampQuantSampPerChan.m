function varargout = DAQmxResetSampQuantSampPerChan(varargin)
%DAQMXRESETSAMPQUANTSAMPPERCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampQuantSampPerChan(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampQuantSampPerChan',varargin{:});
