function varargout = DAQmxGetAdvTrigType(varargin)
%DAQMXGETADVTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAdvTrigType(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAdvTrigType',varargin{:});
