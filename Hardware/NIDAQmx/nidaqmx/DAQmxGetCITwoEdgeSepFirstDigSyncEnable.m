function varargout = DAQmxGetCITwoEdgeSepFirstDigSyncEnable(varargin)
%DAQMXGETCITWOEDGESEPFIRSTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCITwoEdgeSepFirstDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepFirstDigSyncEnable',varargin{:});
