function varargout = DAQmxWriteCtrFreq(varargin)
%DAQMXWRITECTRFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr, doublePtr, int32Ptr, uint32Ptr] DAQmxWriteCtrFreq(uint32, int32, uint32, double, uint32, doublePtr, doublePtr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteCtrFreq',varargin{:});
