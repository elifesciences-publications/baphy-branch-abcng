function varargout = DAQmxSetAIStrainUnits(varargin)
%DAQMXSETAISTRAINUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIStrainUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIStrainUnits',varargin{:});
