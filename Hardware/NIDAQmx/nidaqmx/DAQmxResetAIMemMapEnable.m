function varargout = DAQmxResetAIMemMapEnable(varargin)
%DAQMXRESETAIMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIMemMapEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIMemMapEnable',varargin{:});
