function varargout = DAQmxResetCIEncoderZIndexEnable(varargin)
%DAQMXRESETCIENCODERZINDEXENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZIndexEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZIndexEnable',varargin{:});
