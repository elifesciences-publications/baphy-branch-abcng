function varargout = DAQmxGetDevCOPhysicalChans(varargin)
%DAQMXGETDEVCOPHYSICALCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevCOPhysicalChans(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCOPhysicalChans',varargin{:});
