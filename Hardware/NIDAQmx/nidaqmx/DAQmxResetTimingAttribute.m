function varargout = DAQmxResetTimingAttribute(varargin)
%DAQMXRESETTIMINGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetTimingAttribute(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetTimingAttribute',varargin{:});
