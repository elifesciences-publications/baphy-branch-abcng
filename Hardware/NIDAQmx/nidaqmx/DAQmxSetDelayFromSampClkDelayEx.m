function varargout = DAQmxSetDelayFromSampClkDelayEx(varargin)
%DAQMXSETDELAYFROMSAMPCLKDELAYEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDelayFromSampClkDelayEx(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDelayFromSampClkDelayEx',varargin{:});
