function varargout = DAQmxResetSampTimingEngine(varargin)
%DAQMXRESETSAMPTIMINGENGINE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampTimingEngine(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampTimingEngine',varargin{:});
