function varargout = DAQmxGetReadAutoStart(varargin)
%DAQMXGETREADAUTOSTART calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadAutoStart(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadAutoStart',varargin{:});
