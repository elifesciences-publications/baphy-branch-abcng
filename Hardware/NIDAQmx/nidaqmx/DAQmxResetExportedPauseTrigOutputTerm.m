function varargout = DAQmxResetExportedPauseTrigOutputTerm(varargin)
%DAQMXRESETEXPORTEDPAUSETRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedPauseTrigOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedPauseTrigOutputTerm',varargin{:});
