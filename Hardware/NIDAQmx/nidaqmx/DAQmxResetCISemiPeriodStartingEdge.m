function varargout = DAQmxResetCISemiPeriodStartingEdge(varargin)
%DAQMXRESETCISEMIPERIODSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCISemiPeriodStartingEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCISemiPeriodStartingEdge',varargin{:});
