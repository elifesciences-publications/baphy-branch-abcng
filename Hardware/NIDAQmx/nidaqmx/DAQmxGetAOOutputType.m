function varargout = DAQmxGetAOOutputType(varargin)
%DAQMXGETAOOUTPUTTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAOOutputType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOOutputType',varargin{:});
