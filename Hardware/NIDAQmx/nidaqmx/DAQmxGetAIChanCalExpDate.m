function varargout = DAQmxGetAIChanCalExpDate(varargin)
%DAQMXGETAICHANCALEXPDATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr] DAQmxGetAIChanCalExpDate(uint32, cstring, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIChanCalExpDate',varargin{:});
