function varargout = DAQmxSetCIEncoderAInputDigFltrMinPulseWidth(varargin)
%DAQMXSETCIENCODERAINPUTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderAInputDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderAInputDigFltrMinPulseWidth',varargin{:});
