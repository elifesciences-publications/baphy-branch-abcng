function varargout = DAQmxSetAIBridgeCfg(varargin)
%DAQMXSETAIBRIDGECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIBridgeCfg(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIBridgeCfg',varargin{:});
