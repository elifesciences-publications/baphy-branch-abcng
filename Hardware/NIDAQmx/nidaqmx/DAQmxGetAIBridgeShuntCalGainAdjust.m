function varargout = DAQmxGetAIBridgeShuntCalGainAdjust(varargin)
%DAQMXGETAIBRIDGESHUNTCALGAINADJUST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIBridgeShuntCalGainAdjust(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIBridgeShuntCalGainAdjust',varargin{:});
