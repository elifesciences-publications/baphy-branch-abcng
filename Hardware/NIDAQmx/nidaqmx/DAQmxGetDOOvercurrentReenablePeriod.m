function varargout = DAQmxGetDOOvercurrentReenablePeriod(varargin)
%DAQMXGETDOOVERCURRENTREENABLEPERIOD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDOOvercurrentReenablePeriod(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOOvercurrentReenablePeriod',varargin{:});
