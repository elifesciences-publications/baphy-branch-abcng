function varargout = DAQmxSetWriteNextWriteIsLast(varargin)
%DAQMXSETWRITENEXTWRITEISLAST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetWriteNextWriteIsLast(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWriteNextWriteIsLast',varargin{:});
