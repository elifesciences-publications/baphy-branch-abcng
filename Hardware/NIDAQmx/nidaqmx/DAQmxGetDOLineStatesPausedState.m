function varargout = DAQmxGetDOLineStatesPausedState(varargin)
%DAQMXGETDOLINESTATESPAUSEDSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDOLineStatesPausedState(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOLineStatesPausedState',varargin{:});
