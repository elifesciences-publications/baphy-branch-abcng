function varargout = DAQmxSetCISemiPeriodTerm(varargin)
%DAQMXSETCISEMIPERIODTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCISemiPeriodTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCISemiPeriodTerm',varargin{:});
