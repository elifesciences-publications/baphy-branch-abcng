function varargout = DAQmxSwitchGetSingleRelayCount(varargin)
%DAQMXSWITCHGETSINGLERELAYCOUNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxSwitchGetSingleRelayCount(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchGetSingleRelayCount',varargin{:});
