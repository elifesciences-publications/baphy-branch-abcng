function varargout = DAQmxSetExportedPauseTrigLvlActiveLvl(varargin)
%DAQMXSETEXPORTEDPAUSETRIGLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedPauseTrigLvlActiveLvl(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedPauseTrigLvlActiveLvl',varargin{:});
