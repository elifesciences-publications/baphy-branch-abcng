function varargout = DAQmxSetTrigAttribute(varargin)
%DAQMXSETTRIGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxSetTrigAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetTrigAttribute',varargin{:});
