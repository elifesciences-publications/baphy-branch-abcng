function varargout = DAQmxSetCOConstrainedGenMode(varargin)
%DAQMXSETCOCONSTRAINEDGENMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOConstrainedGenMode(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOConstrainedGenMode',varargin{:});
