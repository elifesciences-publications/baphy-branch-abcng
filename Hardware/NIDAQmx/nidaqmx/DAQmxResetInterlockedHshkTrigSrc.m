function varargout = DAQmxResetInterlockedHshkTrigSrc(varargin)
%DAQMXRESETINTERLOCKEDHSHKTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetInterlockedHshkTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetInterlockedHshkTrigSrc',varargin{:});
