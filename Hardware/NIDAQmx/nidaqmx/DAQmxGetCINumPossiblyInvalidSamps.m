function varargout = DAQmxGetCINumPossiblyInvalidSamps(varargin)
%DAQMXGETCINUMPOSSIBLYINVALIDSAMPS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCINumPossiblyInvalidSamps(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCINumPossiblyInvalidSamps',varargin{:});
