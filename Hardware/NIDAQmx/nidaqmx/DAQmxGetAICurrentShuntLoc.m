function varargout = DAQmxGetAICurrentShuntLoc(varargin)
%DAQMXGETAICURRENTSHUNTLOC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAICurrentShuntLoc(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAICurrentShuntLoc',varargin{:});
