function varargout = DAQmxResetDigEdgeStartTrigDigFltrTimebaseRate(varargin)
%DAQMXRESETDIGEDGESTARTTRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeStartTrigDigFltrTimebaseRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeStartTrigDigFltrTimebaseRate',varargin{:});
