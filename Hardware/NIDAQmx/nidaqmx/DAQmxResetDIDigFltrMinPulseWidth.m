function varargout = DAQmxResetDIDigFltrMinPulseWidth(varargin)
%DAQMXRESETDIDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDIDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDIDigFltrMinPulseWidth',varargin{:});
