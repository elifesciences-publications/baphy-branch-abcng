function varargout = DAQmxGetExportedRdyForXferEventLvlActiveLvl(varargin)
%DAQMXGETEXPORTEDRDYFORXFEREVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedRdyForXferEventLvlActiveLvl(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedRdyForXferEventLvlActiveLvl',varargin{:});
