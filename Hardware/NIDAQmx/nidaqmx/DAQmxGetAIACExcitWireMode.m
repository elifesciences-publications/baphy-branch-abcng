function varargout = DAQmxGetAIACExcitWireMode(varargin)
%DAQMXGETAIACEXCITWIREMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIACExcitWireMode(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIACExcitWireMode',varargin{:});
