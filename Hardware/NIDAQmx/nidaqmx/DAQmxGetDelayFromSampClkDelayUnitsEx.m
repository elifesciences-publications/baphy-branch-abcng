function varargout = DAQmxGetDelayFromSampClkDelayUnitsEx(varargin)
%DAQMXGETDELAYFROMSAMPCLKDELAYUNITSEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDelayFromSampClkDelayUnitsEx(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDelayFromSampClkDelayUnitsEx',varargin{:});
