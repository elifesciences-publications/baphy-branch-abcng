function varargout = DAQmxGetSwitchChanMaxACSwitchPwr(varargin)
%DAQMXGETSWITCHCHANMAXACSWITCHPWR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxACSwitchPwr(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxACSwitchPwr',varargin{:});
