function varargout = DAQmxSetAIMin(varargin)
%DAQMXSETAIMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIMin(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIMin',varargin{:});
