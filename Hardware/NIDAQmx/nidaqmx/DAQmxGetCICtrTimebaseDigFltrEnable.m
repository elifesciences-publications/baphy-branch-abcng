function varargout = DAQmxGetCICtrTimebaseDigFltrEnable(varargin)
%DAQMXGETCICTRTIMEBASEDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCICtrTimebaseDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseDigFltrEnable',varargin{:});
