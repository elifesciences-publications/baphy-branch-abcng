function varargout = DAQmxSetAIChanCalOperatorName(varargin)
%DAQMXSETAICHANCALOPERATORNAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetAIChanCalOperatorName(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIChanCalOperatorName',varargin{:});
