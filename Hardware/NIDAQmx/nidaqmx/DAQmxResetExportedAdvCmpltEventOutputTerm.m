function varargout = DAQmxResetExportedAdvCmpltEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDADVCMPLTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAdvCmpltEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAdvCmpltEventOutputTerm',varargin{:});
