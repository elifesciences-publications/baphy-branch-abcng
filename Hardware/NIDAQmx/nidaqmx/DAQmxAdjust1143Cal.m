function varargout = DAQmxAdjust1143Cal(varargin)
%DAQMXADJUST1143CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1143Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1143Cal',varargin{:});
