function varargout = DAQmxSetWriteOffset(varargin)
%DAQMXSETWRITEOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetWriteOffset(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWriteOffset',varargin{:});
