function varargout = DAQmxResetCIPeriodMeasTime(varargin)
%DAQMXRESETCIPERIODMEASTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodMeasTime(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodMeasTime',varargin{:});
