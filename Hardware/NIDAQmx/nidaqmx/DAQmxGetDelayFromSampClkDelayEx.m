function varargout = DAQmxGetDelayFromSampClkDelayEx(varargin)
%DAQMXGETDELAYFROMSAMPCLKDELAYEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDelayFromSampClkDelayEx(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDelayFromSampClkDelayEx',varargin{:});
