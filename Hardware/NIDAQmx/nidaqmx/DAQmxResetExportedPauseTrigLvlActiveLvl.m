function varargout = DAQmxResetExportedPauseTrigLvlActiveLvl(varargin)
%DAQMXRESETEXPORTEDPAUSETRIGLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedPauseTrigLvlActiveLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedPauseTrigLvlActiveLvl',varargin{:});
