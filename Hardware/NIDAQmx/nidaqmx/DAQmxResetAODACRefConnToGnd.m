function varargout = DAQmxResetAODACRefConnToGnd(varargin)
%DAQMXRESETAODACREFCONNTOGND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACRefConnToGnd(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACRefConnToGnd',varargin{:});
