function varargout = DAQmxSetCITwoEdgeSepSecondEdge(varargin)
%DAQMXSETCITWOEDGESEPSECONDEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepSecondEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepSecondEdge',varargin{:});
