function varargout = DAQmxGetCIFreqMeasMeth(varargin)
%DAQMXGETCIFREQMEASMETH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIFreqMeasMeth(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqMeasMeth',varargin{:});
