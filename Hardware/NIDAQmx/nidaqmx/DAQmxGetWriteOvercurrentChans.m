function varargout = DAQmxGetWriteOvercurrentChans(varargin)
%DAQMXGETWRITEOVERCURRENTCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetWriteOvercurrentChans(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteOvercurrentChans',varargin{:});
