function varargout = DAQmxResetCOAutoIncrCnt(varargin)
%DAQMXRESETCOAUTOINCRCNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOAutoIncrCnt(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOAutoIncrCnt',varargin{:});
