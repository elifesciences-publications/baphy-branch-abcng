function varargout = DAQmxSetAIGain(varargin)
%DAQMXSETAIGAIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIGain(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIGain',varargin{:});
