function varargout = DAQmxGetCIEncoderAInputDigFltrEnable(varargin)
%DAQMXGETCIENCODERAINPUTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIEncoderAInputDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderAInputDigFltrEnable',varargin{:});
