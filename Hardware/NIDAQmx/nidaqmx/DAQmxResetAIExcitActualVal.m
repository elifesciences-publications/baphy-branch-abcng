function varargout = DAQmxResetAIExcitActualVal(varargin)
%DAQMXRESETAIEXCITACTUALVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIExcitActualVal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIExcitActualVal',varargin{:});
