function varargout = DAQmxResetAOMemMapEnable(varargin)
%DAQMXRESETAOMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOMemMapEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOMemMapEnable',varargin{:});
