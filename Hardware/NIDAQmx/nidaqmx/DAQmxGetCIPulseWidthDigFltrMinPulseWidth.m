function varargout = DAQmxGetCIPulseWidthDigFltrMinPulseWidth(varargin)
%DAQMXGETCIPULSEWIDTHDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIPulseWidthDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPulseWidthDigFltrMinPulseWidth',varargin{:});
