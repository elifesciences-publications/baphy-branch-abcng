function varargout = DAQmxGetDIDigFltrEnable(varargin)
%DAQMXGETDIDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDIDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDIDigFltrEnable',varargin{:});
