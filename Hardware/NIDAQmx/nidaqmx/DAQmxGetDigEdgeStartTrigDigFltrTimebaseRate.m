function varargout = DAQmxGetDigEdgeStartTrigDigFltrTimebaseRate(varargin)
%DAQMXGETDIGEDGESTARTTRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetDigEdgeStartTrigDigFltrTimebaseRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeStartTrigDigFltrTimebaseRate',varargin{:});
