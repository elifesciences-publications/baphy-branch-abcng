function varargout = DAQmxResetAnlgWinRefTrigBtm(varargin)
%DAQMXRESETANLGWINREFTRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinRefTrigBtm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinRefTrigBtm',varargin{:});
