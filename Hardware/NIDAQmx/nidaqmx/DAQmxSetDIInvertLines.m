function varargout = DAQmxSetDIInvertLines(varargin)
%DAQMXSETDIINVERTLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDIInvertLines(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDIInvertLines',varargin{:});
