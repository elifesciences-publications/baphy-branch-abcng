function varargout = DAQmxControlWatchdogTask(varargin)
%DAQMXCONTROLWATCHDOGTASK calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxControlWatchdogTask(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxControlWatchdogTask',varargin{:});
