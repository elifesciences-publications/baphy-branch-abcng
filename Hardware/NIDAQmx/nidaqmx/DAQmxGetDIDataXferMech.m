function varargout = DAQmxGetDIDataXferMech(varargin)
%DAQMXGETDIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDIDataXferMech(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDIDataXferMech',varargin{:});
