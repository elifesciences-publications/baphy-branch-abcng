function varargout = DAQmxSetCICtrTimebaseDigSyncEnable(varargin)
%DAQMXSETCICTRTIMEBASEDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICtrTimebaseDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICtrTimebaseDigSyncEnable',varargin{:});
