function varargout = DAQmxResetCITwoEdgeSepFirstDigFltrMinPulseWidth(varargin)
%DAQMXRESETCITWOEDGESEPFIRSTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepFirstDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepFirstDigFltrMinPulseWidth',varargin{:});
