function varargout = DAQmxResetReadOffset(varargin)
%DAQMXRESETREADOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadOffset(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadOffset',varargin{:});
