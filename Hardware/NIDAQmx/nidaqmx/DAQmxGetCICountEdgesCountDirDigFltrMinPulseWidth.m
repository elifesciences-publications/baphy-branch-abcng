function varargout = DAQmxGetCICountEdgesCountDirDigFltrMinPulseWidth(varargin)
%DAQMXGETCICOUNTEDGESCOUNTDIRDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCICountEdgesCountDirDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesCountDirDigFltrMinPulseWidth',varargin{:});
