function varargout = DAQmxSetRealTimeConvLateErrorsToWarnings(varargin)
%DAQMXSETREALTIMECONVLATEERRORSTOWARNINGS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetRealTimeConvLateErrorsToWarnings(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRealTimeConvLateErrorsToWarnings',varargin{:});
