function varargout = DAQmxGetCIEncoderZInputDigFltrEnable(varargin)
%DAQMXGETCIENCODERZINPUTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIEncoderZInputDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderZInputDigFltrEnable',varargin{:});
