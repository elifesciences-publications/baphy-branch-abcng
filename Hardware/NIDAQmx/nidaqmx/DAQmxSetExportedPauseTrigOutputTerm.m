function varargout = DAQmxSetExportedPauseTrigOutputTerm(varargin)
%DAQMXSETEXPORTEDPAUSETRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedPauseTrigOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedPauseTrigOutputTerm',varargin{:});
