function varargout = DAQmxResetCIPrescaler(varargin)
%DAQMXRESETCIPRESCALER calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPrescaler(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPrescaler',varargin{:});
