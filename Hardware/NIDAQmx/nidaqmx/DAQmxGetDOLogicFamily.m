function varargout = DAQmxGetDOLogicFamily(varargin)
%DAQMXGETDOLOGICFAMILY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDOLogicFamily(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOLogicFamily',varargin{:});
