function varargout = DAQmxSwitchConnect(varargin)
%DAQMXSWITCHCONNECT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSwitchConnect(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchConnect',varargin{:});
