function varargout = DAQmxSwitchSetTopologyAndReset(varargin)
%DAQMXSWITCHSETTOPOLOGYANDRESET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSwitchSetTopologyAndReset(cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchSetTopologyAndReset',varargin{:});
