function varargout = DAQmxGetDOLineStatesDoneState(varargin)
%DAQMXGETDOLINESTATESDONESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDOLineStatesDoneState(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOLineStatesDoneState',varargin{:});
