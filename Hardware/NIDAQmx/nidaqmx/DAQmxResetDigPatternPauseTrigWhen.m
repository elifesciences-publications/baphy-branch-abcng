function varargout = DAQmxResetDigPatternPauseTrigWhen(varargin)
%DAQMXRESETDIGPATTERNPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternPauseTrigWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternPauseTrigWhen',varargin{:});
