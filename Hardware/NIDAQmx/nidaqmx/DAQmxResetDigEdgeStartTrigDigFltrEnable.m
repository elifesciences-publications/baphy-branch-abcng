function varargout = DAQmxResetDigEdgeStartTrigDigFltrEnable(varargin)
%DAQMXRESETDIGEDGESTARTTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeStartTrigDigFltrEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeStartTrigDigFltrEnable',varargin{:});
