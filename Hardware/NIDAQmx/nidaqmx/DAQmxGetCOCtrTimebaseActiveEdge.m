function varargout = DAQmxGetCOCtrTimebaseActiveEdge(varargin)
%DAQMXGETCOCTRTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCOCtrTimebaseActiveEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseActiveEdge',varargin{:});
