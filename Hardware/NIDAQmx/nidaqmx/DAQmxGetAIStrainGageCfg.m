function varargout = DAQmxGetAIStrainGageCfg(varargin)
%DAQMXGETAISTRAINGAGECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIStrainGageCfg(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIStrainGageCfg',varargin{:});
