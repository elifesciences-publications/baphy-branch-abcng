function varargout = DAQmxGetAOFuncGenFMDeviation(varargin)
%DAQMXGETAOFUNCGENFMDEVIATION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOFuncGenFMDeviation(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOFuncGenFMDeviation',varargin{:});
