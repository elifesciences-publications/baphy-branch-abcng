function varargout = DAQmxGetHshkTrigType(varargin)
%DAQMXGETHSHKTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetHshkTrigType(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetHshkTrigType',varargin{:});
