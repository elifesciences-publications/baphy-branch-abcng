function varargout = DAQmxSelfCal(varargin)
%DAQMXSELFCAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSelfCal(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSelfCal',varargin{:});
