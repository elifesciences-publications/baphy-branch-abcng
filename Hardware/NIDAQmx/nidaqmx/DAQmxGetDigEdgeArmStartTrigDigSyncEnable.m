function varargout = DAQmxGetDigEdgeArmStartTrigDigSyncEnable(varargin)
%DAQMXGETDIGEDGEARMSTARTTRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetDigEdgeArmStartTrigDigSyncEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeArmStartTrigDigSyncEnable',varargin{:});
