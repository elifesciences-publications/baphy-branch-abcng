function varargout = DAQmxSetCIFreqTerm(varargin)
%DAQMXSETCIFREQTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIFreqTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqTerm',varargin{:});
