function varargout = DAQmxGetSwitchChanMaxACSwitchCurrent(varargin)
%DAQMXGETSWITCHCHANMAXACSWITCHCURRENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxACSwitchCurrent(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxACSwitchCurrent',varargin{:});
