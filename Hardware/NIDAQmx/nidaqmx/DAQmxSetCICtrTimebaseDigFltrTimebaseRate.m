function varargout = DAQmxSetCICtrTimebaseDigFltrTimebaseRate(varargin)
%DAQMXSETCICTRTIMEBASEDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICtrTimebaseDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICtrTimebaseDigFltrTimebaseRate',varargin{:});
