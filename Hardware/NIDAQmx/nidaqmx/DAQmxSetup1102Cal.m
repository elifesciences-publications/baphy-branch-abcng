function varargout = DAQmxSetup1102Cal(varargin)
%DAQMXSETUP1102CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1102Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1102Cal',varargin{:});
