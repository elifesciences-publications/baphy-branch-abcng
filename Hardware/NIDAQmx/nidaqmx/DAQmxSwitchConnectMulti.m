function varargout = DAQmxSwitchConnectMulti(varargin)
%DAQMXSWITCHCONNECTMULTI calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSwitchConnectMulti(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchConnectMulti',varargin{:});
