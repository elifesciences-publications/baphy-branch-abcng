function varargout = DAQmxResetAnlgEdgeStartTrigSlope(varargin)
%DAQMXRESETANLGEDGESTARTTRIGSLOPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeStartTrigSlope(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeStartTrigSlope',varargin{:});
