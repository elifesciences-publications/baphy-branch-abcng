function varargout = DAQmxSetDigPatternStartTrigPattern(varargin)
%DAQMXSETDIGPATTERNSTARTTRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigPatternStartTrigPattern(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternStartTrigPattern',varargin{:});
