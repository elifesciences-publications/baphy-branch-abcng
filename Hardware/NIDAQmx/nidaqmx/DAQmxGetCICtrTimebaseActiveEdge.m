function varargout = DAQmxGetCICtrTimebaseActiveEdge(varargin)
%DAQMXGETCICTRTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCICtrTimebaseActiveEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseActiveEdge',varargin{:});
