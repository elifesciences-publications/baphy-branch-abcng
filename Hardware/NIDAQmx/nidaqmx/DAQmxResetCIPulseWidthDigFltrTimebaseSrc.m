function varargout = DAQmxResetCIPulseWidthDigFltrTimebaseSrc(varargin)
%DAQMXRESETCIPULSEWIDTHDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPulseWidthDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPulseWidthDigFltrTimebaseSrc',varargin{:});
