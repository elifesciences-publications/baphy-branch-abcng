function varargout = DAQmxResetDOOvercurrentAutoReenable(varargin)
%DAQMXRESETDOOVERCURRENTAUTOREENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOOvercurrentAutoReenable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOOvercurrentAutoReenable',varargin{:});
