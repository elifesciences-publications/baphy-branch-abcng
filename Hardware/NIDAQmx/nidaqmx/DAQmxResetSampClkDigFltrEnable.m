function varargout = DAQmxResetSampClkDigFltrEnable(varargin)
%DAQMXRESETSAMPCLKDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkDigFltrEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkDigFltrEnable',varargin{:});
