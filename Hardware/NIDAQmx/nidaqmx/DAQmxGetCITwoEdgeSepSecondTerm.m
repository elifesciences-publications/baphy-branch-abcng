function varargout = DAQmxGetCITwoEdgeSepSecondTerm(varargin)
%DAQMXGETCITWOEDGESEPSECONDTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCITwoEdgeSepSecondTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepSecondTerm',varargin{:});
