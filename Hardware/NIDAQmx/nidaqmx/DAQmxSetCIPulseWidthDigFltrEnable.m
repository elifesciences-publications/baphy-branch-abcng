function varargout = DAQmxSetCIPulseWidthDigFltrEnable(varargin)
%DAQMXSETCIPULSEWIDTHDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPulseWidthDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPulseWidthDigFltrEnable',varargin{:});
