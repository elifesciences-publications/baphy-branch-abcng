function varargout = DAQmxResetDigEdgeRefTrigSrc(varargin)
%DAQMXRESETDIGEDGEREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeRefTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeRefTrigSrc',varargin{:});
