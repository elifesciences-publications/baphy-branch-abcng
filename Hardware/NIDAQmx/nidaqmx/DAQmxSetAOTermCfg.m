function varargout = DAQmxSetAOTermCfg(varargin)
%DAQMXSETAOTERMCFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOTermCfg(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOTermCfg',varargin{:});
