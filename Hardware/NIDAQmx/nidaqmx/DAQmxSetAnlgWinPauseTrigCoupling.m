function varargout = DAQmxSetAnlgWinPauseTrigCoupling(varargin)
%DAQMXSETANLGWINPAUSETRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinPauseTrigCoupling(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinPauseTrigCoupling',varargin{:});
