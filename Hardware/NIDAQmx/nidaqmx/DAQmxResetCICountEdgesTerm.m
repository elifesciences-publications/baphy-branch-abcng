function varargout = DAQmxResetCICountEdgesTerm(varargin)
%DAQMXRESETCICOUNTEDGESTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesTerm',varargin{:});
