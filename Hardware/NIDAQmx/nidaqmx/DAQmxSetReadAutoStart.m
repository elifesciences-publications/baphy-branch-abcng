function varargout = DAQmxSetReadAutoStart(varargin)
%DAQMXSETREADAUTOSTART calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetReadAutoStart(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadAutoStart',varargin{:});
