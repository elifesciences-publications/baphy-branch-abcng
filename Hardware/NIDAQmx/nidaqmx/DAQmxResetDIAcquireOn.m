function varargout = DAQmxResetDIAcquireOn(varargin)
%DAQMXRESETDIACQUIREON calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDIAcquireOn(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDIAcquireOn',varargin{:});
