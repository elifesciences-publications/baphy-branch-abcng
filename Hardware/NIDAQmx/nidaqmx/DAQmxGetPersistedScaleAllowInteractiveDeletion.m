function varargout = DAQmxGetPersistedScaleAllowInteractiveDeletion(varargin)
%DAQMXGETPERSISTEDSCALEALLOWINTERACTIVEDELETION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPersistedScaleAllowInteractiveDeletion(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedScaleAllowInteractiveDeletion',varargin{:});
