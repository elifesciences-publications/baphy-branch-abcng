function varargout = DAQmxReadDigitalScalarU32(varargin)
%DAQMXREADDIGITALSCALARU32 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr, uint32Ptr] DAQmxReadDigitalScalarU32(uint32, double, uint32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadDigitalScalarU32',varargin{:});
