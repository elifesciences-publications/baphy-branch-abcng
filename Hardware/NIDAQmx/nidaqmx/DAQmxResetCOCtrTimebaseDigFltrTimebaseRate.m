function varargout = DAQmxResetCOCtrTimebaseDigFltrTimebaseRate(varargin)
%DAQMXRESETCOCTRTIMEBASEDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOCtrTimebaseDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOCtrTimebaseDigFltrTimebaseRate',varargin{:});
