function varargout = DAQmxSetDigLvlPauseTrigDigSyncEnable(varargin)
%DAQMXSETDIGLVLPAUSETRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigLvlPauseTrigDigSyncEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigLvlPauseTrigDigSyncEnable',varargin{:});
