function varargout = DAQmxSetCIFreqDigFltrTimebaseSrc(varargin)
%DAQMXSETCIFREQDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIFreqDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqDigFltrTimebaseSrc',varargin{:});
