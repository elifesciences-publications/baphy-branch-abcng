function varargout = DAQmxSwitchWaitForSettling(varargin)
%DAQMXSWITCHWAITFORSETTLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSwitchWaitForSettling(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchWaitForSettling',varargin{:});
