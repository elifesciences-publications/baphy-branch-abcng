function varargout = DAQmxResetCIEncoderBInputDigFltrEnable(varargin)
%DAQMXRESETCIENCODERBINPUTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderBInputDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderBInputDigFltrEnable',varargin{:});
