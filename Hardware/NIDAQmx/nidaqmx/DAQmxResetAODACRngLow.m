function varargout = DAQmxResetAODACRngLow(varargin)
%DAQMXRESETAODACRNGLOW calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACRngLow(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACRngLow',varargin{:});
