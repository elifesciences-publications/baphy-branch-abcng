function varargout = DAQmxGetAIACExcitFreq(varargin)
%DAQMXGETAIACEXCITFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIACExcitFreq(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIACExcitFreq',varargin{:});
