function varargout = DAQmxSetAITempUnits(varargin)
%DAQMXSETAITEMPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAITempUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAITempUnits',varargin{:});
