function varargout = DAQmxGetDevDOMaxRate(varargin)
%DAQMXGETDEVDOMAXRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevDOMaxRate(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDOMaxRate',varargin{:});
