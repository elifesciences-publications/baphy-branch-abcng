function varargout = DAQmxGetAIThrmstrB(varargin)
%DAQMXGETAITHRMSTRB calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIThrmstrB(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmstrB',varargin{:});
