function varargout = DAQmxResetSampClkTimebaseSrc(varargin)
%DAQMXRESETSAMPCLKTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkTimebaseSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkTimebaseSrc',varargin{:});
