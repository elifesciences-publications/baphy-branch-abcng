function varargout = DAQmxGetReadAvailSampPerChan(varargin)
%DAQMXGETREADAVAILSAMPPERCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadAvailSampPerChan(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadAvailSampPerChan',varargin{:});
