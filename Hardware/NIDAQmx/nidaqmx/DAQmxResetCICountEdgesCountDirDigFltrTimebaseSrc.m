function varargout = DAQmxResetCICountEdgesCountDirDigFltrTimebaseSrc(varargin)
%DAQMXRESETCICOUNTEDGESCOUNTDIRDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesCountDirDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesCountDirDigFltrTimebaseSrc',varargin{:});
