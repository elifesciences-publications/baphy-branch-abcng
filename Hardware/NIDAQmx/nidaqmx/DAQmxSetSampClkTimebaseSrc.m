function varargout = DAQmxSetSampClkTimebaseSrc(varargin)
%DAQMXSETSAMPCLKTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetSampClkTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkTimebaseSrc',varargin{:});
