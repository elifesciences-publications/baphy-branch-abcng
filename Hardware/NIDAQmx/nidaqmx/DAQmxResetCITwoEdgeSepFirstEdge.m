function varargout = DAQmxResetCITwoEdgeSepFirstEdge(varargin)
%DAQMXRESETCITWOEDGESEPFIRSTEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepFirstEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepFirstEdge',varargin{:});
