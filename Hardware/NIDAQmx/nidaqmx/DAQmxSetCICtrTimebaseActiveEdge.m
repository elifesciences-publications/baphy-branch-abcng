function varargout = DAQmxSetCICtrTimebaseActiveEdge(varargin)
%DAQMXSETCICTRTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICtrTimebaseActiveEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICtrTimebaseActiveEdge',varargin{:});
