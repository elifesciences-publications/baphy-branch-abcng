function varargout = DAQmxGetDigLvlPauseTrigDigFltrEnable(varargin)
%DAQMXGETDIGLVLPAUSETRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetDigLvlPauseTrigDigFltrEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigLvlPauseTrigDigFltrEnable',varargin{:});
