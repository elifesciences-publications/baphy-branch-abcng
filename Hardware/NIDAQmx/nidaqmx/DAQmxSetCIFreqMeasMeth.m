function varargout = DAQmxSetCIFreqMeasMeth(varargin)
%DAQMXSETCIFREQMEASMETH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqMeasMeth(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqMeasMeth',varargin{:});
