function varargout = DAQmxGetWriteOffset(varargin)
%DAQMXGETWRITEOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetWriteOffset(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteOffset',varargin{:});
