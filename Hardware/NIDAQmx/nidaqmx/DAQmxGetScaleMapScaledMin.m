function varargout = DAQmxGetScaleMapScaledMin(varargin)
%DAQMXGETSCALEMAPSCALEDMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetScaleMapScaledMin(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleMapScaledMin',varargin{:});
