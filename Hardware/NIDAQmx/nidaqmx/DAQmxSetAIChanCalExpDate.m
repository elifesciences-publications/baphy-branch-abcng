function varargout = DAQmxSetAIChanCalExpDate(varargin)
%DAQMXSETAICHANCALEXPDATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIChanCalExpDate(uint32, cstring, uint32, uint32, uint32, uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIChanCalExpDate',varargin{:});
