function varargout = DAQmxGetAnlgEdgeStartTrigCoupling(varargin)
%DAQMXGETANLGEDGESTARTTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgEdgeStartTrigCoupling(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeStartTrigCoupling',varargin{:});
