function varargout = DAQmxGetDigLvlPauseTrigDigFltrTimebaseRate(varargin)
%DAQMXGETDIGLVLPAUSETRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetDigLvlPauseTrigDigFltrTimebaseRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigLvlPauseTrigDigFltrTimebaseRate',varargin{:});
