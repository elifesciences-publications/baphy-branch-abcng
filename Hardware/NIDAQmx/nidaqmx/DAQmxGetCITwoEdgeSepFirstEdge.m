function varargout = DAQmxGetCITwoEdgeSepFirstEdge(varargin)
%DAQMXGETCITWOEDGESEPFIRSTEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCITwoEdgeSepFirstEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepFirstEdge',varargin{:});
