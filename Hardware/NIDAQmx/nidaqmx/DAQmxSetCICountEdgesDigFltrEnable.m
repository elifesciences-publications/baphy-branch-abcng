function varargout = DAQmxSetCICountEdgesDigFltrEnable(varargin)
%DAQMXSETCICOUNTEDGESDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesDigFltrEnable',varargin{:});
