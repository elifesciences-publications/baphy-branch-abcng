function varargout = DAQmxGetCIEncoderBInputDigFltrTimebaseSrc(varargin)
%DAQMXGETCIENCODERBINPUTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIEncoderBInputDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderBInputDigFltrTimebaseSrc',varargin{:});
