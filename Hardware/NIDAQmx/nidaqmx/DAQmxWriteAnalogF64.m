function varargout = DAQmxWriteAnalogF64(varargin)
%DAQMXWRITEANALOGF64 calls nidaqmx library with the appropriate arguments.
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteAnalogF64',varargin{:});
