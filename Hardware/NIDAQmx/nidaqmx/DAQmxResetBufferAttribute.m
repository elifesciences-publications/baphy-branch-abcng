function varargout = DAQmxResetBufferAttribute(varargin)
%DAQMXRESETBUFFERATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetBufferAttribute(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetBufferAttribute',varargin{:});
