function varargout = DAQmxCreateCIPulseWidthChan(varargin)
%DAQMXCREATECIPULSEWIDTHCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateCIPulseWidthChan(uint32, cstring, cstring, double, double, int32, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCIPulseWidthChan',varargin{:});
