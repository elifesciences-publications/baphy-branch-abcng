function varargout = DAQmxSetAIRTDR0(varargin)
%DAQMXSETAIRTDR0 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRTDR0(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRTDR0',varargin{:});
