function varargout = DAQmxGetExportedRdyForXferEventDeassertCondCustomThreshold(varargin)
%DAQMXGETEXPORTEDRDYFORXFEREVENTDEASSERTCONDCUSTOMTHRESHOLD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetExportedRdyForXferEventDeassertCondCustomThreshold(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedRdyForXferEventDeassertCondCustomThreshold',varargin{:});
