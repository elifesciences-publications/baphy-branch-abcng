function varargout = DAQmxSetAIAtten(varargin)
%DAQMXSETAIATTEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIAtten(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIAtten',varargin{:});
