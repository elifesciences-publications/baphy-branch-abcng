function varargout = DAQmxAdjust1503Cal(varargin)
%DAQMXADJUST1503CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1503Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1503Cal',varargin{:});
