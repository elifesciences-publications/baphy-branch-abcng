function varargout = DAQmxSetCIEncoderZInputDigFltrEnable(varargin)
%DAQMXSETCIENCODERZINPUTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderZInputDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZInputDigFltrEnable',varargin{:});
