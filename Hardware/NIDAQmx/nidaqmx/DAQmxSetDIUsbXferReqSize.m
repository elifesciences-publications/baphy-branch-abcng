function varargout = DAQmxSetDIUsbXferReqSize(varargin)
%DAQMXSETDIUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDIUsbXferReqSize(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDIUsbXferReqSize',varargin{:});
