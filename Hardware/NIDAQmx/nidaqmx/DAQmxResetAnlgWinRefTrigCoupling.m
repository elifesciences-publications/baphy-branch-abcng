function varargout = DAQmxResetAnlgWinRefTrigCoupling(varargin)
%DAQMXRESETANLGWINREFTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinRefTrigCoupling(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinRefTrigCoupling',varargin{:});
