function varargout = DAQmxResetDigEdgeWatchdogExpirTrigSrc(varargin)
%DAQMXRESETDIGEDGEWATCHDOGEXPIRTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeWatchdogExpirTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeWatchdogExpirTrigSrc',varargin{:});
