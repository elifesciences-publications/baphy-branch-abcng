function varargout = DAQmxSetDigEdgeWatchdogExpirTrigEdge(varargin)
%DAQMXSETDIGEDGEWATCHDOGEXPIRTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeWatchdogExpirTrigEdge(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeWatchdogExpirTrigEdge',varargin{:});
