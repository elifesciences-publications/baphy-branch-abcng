function varargout = DAQmxResetCITwoEdgeSepFirstDigFltrTimebaseSrc(varargin)
%DAQMXRESETCITWOEDGESEPFIRSTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepFirstDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepFirstDigFltrTimebaseSrc',varargin{:});
