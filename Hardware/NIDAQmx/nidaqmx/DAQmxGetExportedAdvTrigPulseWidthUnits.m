function varargout = DAQmxGetExportedAdvTrigPulseWidthUnits(varargin)
%DAQMXGETEXPORTEDADVTRIGPULSEWIDTHUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedAdvTrigPulseWidthUnits(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAdvTrigPulseWidthUnits',varargin{:});
