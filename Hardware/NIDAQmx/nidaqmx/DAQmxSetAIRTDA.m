function varargout = DAQmxSetAIRTDA(varargin)
%DAQMXSETAIRTDA calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRTDA(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRTDA',varargin{:});
