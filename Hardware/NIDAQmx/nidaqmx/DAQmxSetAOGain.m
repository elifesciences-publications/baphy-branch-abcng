function varargout = DAQmxSetAOGain(varargin)
%DAQMXSETAOGAIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOGain(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOGain',varargin{:});
