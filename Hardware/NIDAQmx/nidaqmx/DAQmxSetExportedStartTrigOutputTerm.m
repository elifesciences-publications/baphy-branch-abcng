function varargout = DAQmxSetExportedStartTrigOutputTerm(varargin)
%DAQMXSETEXPORTEDSTARTTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedStartTrigOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedStartTrigOutputTerm',varargin{:});
