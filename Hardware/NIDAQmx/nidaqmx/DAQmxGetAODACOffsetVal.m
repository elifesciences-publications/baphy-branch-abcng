function varargout = DAQmxGetAODACOffsetVal(varargin)
%DAQMXGETAODACOFFSETVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAODACOffsetVal(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACOffsetVal',varargin{:});
