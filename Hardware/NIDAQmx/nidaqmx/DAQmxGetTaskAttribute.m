function varargout = DAQmxGetTaskAttribute(varargin)
%DAQMXGETTASKATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxGetTaskAttribute(uint32, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTaskAttribute',varargin{:});
