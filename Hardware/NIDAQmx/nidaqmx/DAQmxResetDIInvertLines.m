function varargout = DAQmxResetDIInvertLines(varargin)
%DAQMXRESETDIINVERTLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDIInvertLines(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDIInvertLines',varargin{:});
