function varargout = DAQmxGetCOPulseTicksInitialDelay(varargin)
%DAQMXGETCOPULSETICKSINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOPulseTicksInitialDelay(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseTicksInitialDelay',varargin{:});
