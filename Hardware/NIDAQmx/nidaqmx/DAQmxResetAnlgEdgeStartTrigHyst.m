function varargout = DAQmxResetAnlgEdgeStartTrigHyst(varargin)
%DAQMXRESETANLGEDGESTARTTRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeStartTrigHyst(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeStartTrigHyst',varargin{:});
