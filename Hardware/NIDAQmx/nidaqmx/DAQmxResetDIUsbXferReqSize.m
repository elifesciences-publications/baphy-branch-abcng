function varargout = DAQmxResetDIUsbXferReqSize(varargin)
%DAQMXRESETDIUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDIUsbXferReqSize(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDIUsbXferReqSize',varargin{:});
