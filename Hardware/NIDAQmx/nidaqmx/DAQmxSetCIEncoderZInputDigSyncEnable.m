function varargout = DAQmxSetCIEncoderZInputDigSyncEnable(varargin)
%DAQMXSETCIENCODERZINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderZInputDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZInputDigSyncEnable',varargin{:});
