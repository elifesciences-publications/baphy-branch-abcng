function varargout = DAQmxResetCIPeriodDiv(varargin)
%DAQMXRESETCIPERIODDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodDiv(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodDiv',varargin{:});
