function varargout = DAQmxSetAnlgLvlPauseTrigLvl(varargin)
%DAQMXSETANLGLVLPAUSETRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgLvlPauseTrigLvl(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgLvlPauseTrigLvl',varargin{:});
