function varargout = DAQmxResetAICurrentShuntLoc(varargin)
%DAQMXRESETAICURRENTSHUNTLOC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAICurrentShuntLoc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAICurrentShuntLoc',varargin{:});
