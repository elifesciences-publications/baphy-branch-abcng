function varargout = DAQmxSetDigEdgeStartTrigEdge(varargin)
%DAQMXSETDIGEDGESTARTTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeStartTrigEdge(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeStartTrigEdge',varargin{:});
