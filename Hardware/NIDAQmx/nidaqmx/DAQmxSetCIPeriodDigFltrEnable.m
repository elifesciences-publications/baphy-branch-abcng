function varargout = DAQmxSetCIPeriodDigFltrEnable(varargin)
%DAQMXSETCIPERIODDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodDigFltrEnable',varargin{:});
