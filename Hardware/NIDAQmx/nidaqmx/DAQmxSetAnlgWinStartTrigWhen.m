function varargout = DAQmxSetAnlgWinStartTrigWhen(varargin)
%DAQMXSETANLGWINSTARTTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinStartTrigWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinStartTrigWhen',varargin{:});
