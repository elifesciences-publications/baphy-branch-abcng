function varargout = DAQmxResetDigPatternRefTrigWhen(varargin)
%DAQMXRESETDIGPATTERNREFTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternRefTrigWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternRefTrigWhen',varargin{:});
