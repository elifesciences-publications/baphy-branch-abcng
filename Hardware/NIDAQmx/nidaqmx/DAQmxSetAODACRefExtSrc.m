function varargout = DAQmxSetAODACRefExtSrc(varargin)
%DAQMXSETAODACREFEXTSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetAODACRefExtSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACRefExtSrc',varargin{:});
