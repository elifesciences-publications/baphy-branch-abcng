function varargout = DAQmxSetAnlgLvlPauseTrigSrc(varargin)
%DAQMXSETANLGLVLPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAnlgLvlPauseTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgLvlPauseTrigSrc',varargin{:});
