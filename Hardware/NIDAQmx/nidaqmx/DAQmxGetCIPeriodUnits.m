function varargout = DAQmxGetCIPeriodUnits(varargin)
%DAQMXGETCIPERIODUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIPeriodUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodUnits',varargin{:});
