function varargout = DAQmxGetAIConvTimebaseDivEx(varargin)
%DAQMXGETAICONVTIMEBASEDIVEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIConvTimebaseDivEx(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvTimebaseDivEx',varargin{:});
