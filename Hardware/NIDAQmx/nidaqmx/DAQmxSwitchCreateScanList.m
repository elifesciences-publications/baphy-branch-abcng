function varargout = DAQmxSwitchCreateScanList(varargin)
%DAQMXSWITCHCREATESCANLIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxSwitchCreateScanList(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchCreateScanList',varargin{:});
