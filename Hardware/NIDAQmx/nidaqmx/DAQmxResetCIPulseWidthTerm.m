function varargout = DAQmxResetCIPulseWidthTerm(varargin)
%DAQMXRESETCIPULSEWIDTHTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPulseWidthTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPulseWidthTerm',varargin{:});
