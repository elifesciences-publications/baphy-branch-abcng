function varargout = DAQmxGetReadOverWrite(varargin)
%DAQMXGETREADOVERWRITE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetReadOverWrite(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOverWrite',varargin{:});
