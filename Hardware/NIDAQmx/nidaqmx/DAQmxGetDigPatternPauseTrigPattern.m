function varargout = DAQmxGetDigPatternPauseTrigPattern(varargin)
%DAQMXGETDIGPATTERNPAUSETRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigPatternPauseTrigPattern(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternPauseTrigPattern',varargin{:});
