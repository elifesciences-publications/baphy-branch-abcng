function varargout = DAQmxSetAIConvSrc(varargin)
%DAQMXSETAICONVSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIConvSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvSrc',varargin{:});
