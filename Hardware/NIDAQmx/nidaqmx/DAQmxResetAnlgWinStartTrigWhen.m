function varargout = DAQmxResetAnlgWinStartTrigWhen(varargin)
%DAQMXRESETANLGWINSTARTTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinStartTrigWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinStartTrigWhen',varargin{:});
