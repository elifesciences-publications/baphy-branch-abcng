function varargout = DAQmxExportSignal(varargin)
%DAQMXEXPORTSIGNAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxExportSignal(uint32, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxExportSignal',varargin{:});
