function varargout = DAQmxGetStartTrigType(varargin)
%DAQMXGETSTARTTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetStartTrigType(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetStartTrigType',varargin{:});
