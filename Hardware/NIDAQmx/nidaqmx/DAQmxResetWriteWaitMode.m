function varargout = DAQmxResetWriteWaitMode(varargin)
%DAQMXRESETWRITEWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWriteWaitMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWriteWaitMode',varargin{:});
