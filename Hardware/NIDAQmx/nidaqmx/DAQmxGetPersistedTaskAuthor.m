function varargout = DAQmxGetPersistedTaskAuthor(varargin)
%DAQMXGETPERSISTEDTASKAUTHOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetPersistedTaskAuthor(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedTaskAuthor',varargin{:});
