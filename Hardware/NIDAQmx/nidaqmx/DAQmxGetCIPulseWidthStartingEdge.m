function varargout = DAQmxGetCIPulseWidthStartingEdge(varargin)
%DAQMXGETCIPULSEWIDTHSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIPulseWidthStartingEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPulseWidthStartingEdge',varargin{:});
