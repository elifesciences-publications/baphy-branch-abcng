function varargout = DAQmxGetAIThrmstrA(varargin)
%DAQMXGETAITHRMSTRA calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIThrmstrA(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmstrA',varargin{:});
