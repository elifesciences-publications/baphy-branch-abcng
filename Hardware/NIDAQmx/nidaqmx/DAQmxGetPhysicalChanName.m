function varargout = DAQmxGetPhysicalChanName(varargin)
%DAQMXGETPHYSICALCHANNAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetPhysicalChanName(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanName',varargin{:});
