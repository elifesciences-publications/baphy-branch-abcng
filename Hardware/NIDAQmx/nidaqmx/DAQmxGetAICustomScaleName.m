function varargout = DAQmxGetAICustomScaleName(varargin)
%DAQMXGETAICUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAICustomScaleName(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAICustomScaleName',varargin{:});
