function varargout = DAQmxSetAOMin(varargin)
%DAQMXSETAOMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOMin(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOMin',varargin{:});
