function varargout = DAQmxResetCICtrTimebaseSrc(varargin)
%DAQMXRESETCICTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseSrc',varargin{:});
