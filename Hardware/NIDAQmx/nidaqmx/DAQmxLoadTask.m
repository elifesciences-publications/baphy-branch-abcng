function varargout = DAQmxLoadTask(varargin)
%DAQMXLOADTASK calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxLoadTask(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxLoadTask',varargin{:});
