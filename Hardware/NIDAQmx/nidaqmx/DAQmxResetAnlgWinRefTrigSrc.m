function varargout = DAQmxResetAnlgWinRefTrigSrc(varargin)
%DAQMXRESETANLGWINREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinRefTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinRefTrigSrc',varargin{:});
