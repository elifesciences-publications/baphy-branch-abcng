function varargout = DAQmxResetAIRTDR0(varargin)
%DAQMXRESETAIRTDR0 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRTDR0(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRTDR0',varargin{:});
