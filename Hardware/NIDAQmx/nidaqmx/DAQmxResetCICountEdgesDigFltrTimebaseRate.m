function varargout = DAQmxResetCICountEdgesDigFltrTimebaseRate(varargin)
%DAQMXRESETCICOUNTEDGESDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesDigFltrTimebaseRate',varargin{:});
