function varargout = DAQmxResetDigLvlPauseTrigDigFltrEnable(varargin)
%DAQMXRESETDIGLVLPAUSETRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigLvlPauseTrigDigFltrEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigLvlPauseTrigDigFltrEnable',varargin{:});
