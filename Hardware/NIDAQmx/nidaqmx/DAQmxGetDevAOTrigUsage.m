function varargout = DAQmxGetDevAOTrigUsage(varargin)
%DAQMXGETDEVAOTRIGUSAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevAOTrigUsage(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAOTrigUsage',varargin{:});
