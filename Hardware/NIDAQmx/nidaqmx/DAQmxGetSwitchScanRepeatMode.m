function varargout = DAQmxGetSwitchScanRepeatMode(varargin)
%DAQMXGETSWITCHSCANREPEATMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetSwitchScanRepeatMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchScanRepeatMode',varargin{:});
