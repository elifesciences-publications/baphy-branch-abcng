function varargout = DAQmxResetCIFreqMeasMeth(varargin)
%DAQMXRESETCIFREQMEASMETH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqMeasMeth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqMeasMeth',varargin{:});
