function varargout = DAQmxResetCIEncoderAInputDigFltrEnable(varargin)
%DAQMXRESETCIENCODERAINPUTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderAInputDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderAInputDigFltrEnable',varargin{:});
