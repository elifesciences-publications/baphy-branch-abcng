function varargout = DAQmxGetTaskName(varargin)
%DAQMXGETTASKNAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetTaskName(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTaskName',varargin{:});
