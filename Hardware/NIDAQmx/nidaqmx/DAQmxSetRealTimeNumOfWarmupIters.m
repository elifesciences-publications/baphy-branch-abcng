function varargout = DAQmxSetRealTimeNumOfWarmupIters(varargin)
%DAQMXSETREALTIMENUMOFWARMUPITERS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetRealTimeNumOfWarmupIters(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRealTimeNumOfWarmupIters',varargin{:});
