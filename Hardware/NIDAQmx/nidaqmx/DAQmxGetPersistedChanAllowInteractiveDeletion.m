function varargout = DAQmxGetPersistedChanAllowInteractiveDeletion(varargin)
%DAQMXGETPERSISTEDCHANALLOWINTERACTIVEDELETION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPersistedChanAllowInteractiveDeletion(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedChanAllowInteractiveDeletion',varargin{:});
