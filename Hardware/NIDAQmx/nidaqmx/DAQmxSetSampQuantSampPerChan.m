function varargout = DAQmxSetSampQuantSampPerChan(varargin)
%DAQMXSETSAMPQUANTSAMPPERCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampQuantSampPerChan(uint32, uint64)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampQuantSampPerChan',varargin{:});
