function varargout = DAQmxResetReadSleepTime(varargin)
%DAQMXRESETREADSLEEPTIME calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadSleepTime(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadSleepTime',varargin{:});
