function varargout = DAQmxResetAnlgWinStartTrigCoupling(varargin)
%DAQMXRESETANLGWINSTARTTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinStartTrigCoupling(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinStartTrigCoupling',varargin{:});
