function varargout = DAQmxSetScaleLinSlope(varargin)
%DAQMXSETSCALELINSLOPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetScaleLinSlope(cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleLinSlope',varargin{:});
