function varargout = DAQmxSetDOOvercurrentReenablePeriod(varargin)
%DAQMXSETDOOVERCURRENTREENABLEPERIOD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOOvercurrentReenablePeriod(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOOvercurrentReenablePeriod',varargin{:});
