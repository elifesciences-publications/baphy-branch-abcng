function varargout = DAQmxSetAIConvActiveEdgeEx(varargin)
%DAQMXSETAICONVACTIVEEDGEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIConvActiveEdgeEx(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvActiveEdgeEx',varargin{:});
