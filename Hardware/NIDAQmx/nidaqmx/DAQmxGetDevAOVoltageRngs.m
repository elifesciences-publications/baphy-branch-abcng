function varargout = DAQmxGetDevAOVoltageRngs(varargin)
%DAQMXGETDEVAOVOLTAGERNGS calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxGetDevAOVoltageRngs ( const char device [], float64 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, doublePtr] DAQmxGetDevAOVoltageRngs(cstring, doublePtr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAOVoltageRngs',varargin{:});
