function varargout = DAQmxCreateMapScale(varargin)
%DAQMXCREATEMAPSCALE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateMapScale(cstring, double, double, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateMapScale',varargin{:});
