function varargout = DAQmxResetDelayFromSampClkDelayUnits(varargin)
%DAQMXRESETDELAYFROMSAMPCLKDELAYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDelayFromSampClkDelayUnits(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDelayFromSampClkDelayUnits',varargin{:});
