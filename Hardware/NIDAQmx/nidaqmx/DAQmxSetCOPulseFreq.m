function varargout = DAQmxSetCOPulseFreq(varargin)
%DAQMXSETCOPULSEFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseFreq(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseFreq',varargin{:});
