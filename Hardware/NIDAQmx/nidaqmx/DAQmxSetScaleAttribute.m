function varargout = DAQmxSetScaleAttribute(varargin)
%DAQMXSETSCALEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr] DAQmxSetScaleAttribute(cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleAttribute',varargin{:});
