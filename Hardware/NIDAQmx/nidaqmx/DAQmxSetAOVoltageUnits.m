function varargout = DAQmxSetAOVoltageUnits(varargin)
%DAQMXSETAOVOLTAGEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOVoltageUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOVoltageUnits',varargin{:});
