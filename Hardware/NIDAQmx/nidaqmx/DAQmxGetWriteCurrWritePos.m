function varargout = DAQmxGetWriteCurrWritePos(varargin)
%DAQMXGETWRITECURRWRITEPOS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint64Ptr] DAQmxGetWriteCurrWritePos(uint32, uint64Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteCurrWritePos',varargin{:});
