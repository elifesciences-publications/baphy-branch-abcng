function varargout = DAQmxGetReadCurrReadPos(varargin)
%DAQMXGETREADCURRREADPOS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint64Ptr] DAQmxGetReadCurrReadPos(uint32, uint64Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadCurrReadPos',varargin{:});
