function varargout = DAQmxAdjust1141Cal(varargin)
%DAQMXADJUST1141CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1141Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1141Cal',varargin{:});
