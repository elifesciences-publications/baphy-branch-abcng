function varargout = DAQmxResetCOPulseFreq(varargin)
%DAQMXRESETCOPULSEFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseFreq(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseFreq',varargin{:});
