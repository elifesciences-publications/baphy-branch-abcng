function varargout = DAQmxGetCOCtrTimebaseMasterTimebaseDiv(varargin)
%DAQMXGETCOCTRTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOCtrTimebaseMasterTimebaseDiv(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseMasterTimebaseDiv',varargin{:});
