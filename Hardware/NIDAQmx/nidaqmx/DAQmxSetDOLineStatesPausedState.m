function varargout = DAQmxSetDOLineStatesPausedState(varargin)
%DAQMXSETDOLINESTATESPAUSEDSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOLineStatesPausedState(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOLineStatesPausedState',varargin{:});
