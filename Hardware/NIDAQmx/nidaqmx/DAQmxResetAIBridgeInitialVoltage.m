function varargout = DAQmxResetAIBridgeInitialVoltage(varargin)
%DAQMXRESETAIBRIDGEINITIALVOLTAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIBridgeInitialVoltage(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIBridgeInitialVoltage',varargin{:});
