function varargout = DAQmxResetAIChanCalPolyReverseCoeff(varargin)
%DAQMXRESETAICHANCALPOLYREVERSECOEFF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalPolyReverseCoeff(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalPolyReverseCoeff',varargin{:});
