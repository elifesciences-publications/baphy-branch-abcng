function varargout = DAQmxSetAnlgLvlPauseTrigCoupling(varargin)
%DAQMXSETANLGLVLPAUSETRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgLvlPauseTrigCoupling(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgLvlPauseTrigCoupling',varargin{:});
