function varargout = DAQmxGetExportedAIConvClkOutputTerm(varargin)
%DAQMXGETEXPORTEDAICONVCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedAIConvClkOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAIConvClkOutputTerm',varargin{:});
