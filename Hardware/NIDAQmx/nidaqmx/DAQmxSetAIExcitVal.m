function varargout = DAQmxSetAIExcitVal(varargin)
%DAQMXSETAIEXCITVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIExcitVal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIExcitVal',varargin{:});
