function varargout = DAQmxSetCISemiPeriodDigFltrTimebaseRate(varargin)
%DAQMXSETCISEMIPERIODDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCISemiPeriodDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCISemiPeriodDigFltrTimebaseRate',varargin{:});
