function varargout = DAQmxSetAIStrainGageCfg(varargin)
%DAQMXSETAISTRAINGAGECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIStrainGageCfg(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIStrainGageCfg',varargin{:});
