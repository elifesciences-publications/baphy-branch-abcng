function varargout = DAQmxSetArmStartTrigType(varargin)
%DAQMXSETARMSTARTTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetArmStartTrigType(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetArmStartTrigType',varargin{:});
