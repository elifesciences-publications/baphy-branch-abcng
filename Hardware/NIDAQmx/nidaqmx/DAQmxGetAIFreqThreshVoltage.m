function varargout = DAQmxGetAIFreqThreshVoltage(varargin)
%DAQMXGETAIFREQTHRESHVOLTAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIFreqThreshVoltage(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIFreqThreshVoltage',varargin{:});
