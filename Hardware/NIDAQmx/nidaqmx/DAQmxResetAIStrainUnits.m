function varargout = DAQmxResetAIStrainUnits(varargin)
%DAQMXRESETAISTRAINUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIStrainUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIStrainUnits',varargin{:});
