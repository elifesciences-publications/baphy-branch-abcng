function varargout = DAQmxSetDigLvlPauseTrigDigFltrEnable(varargin)
%DAQMXSETDIGLVLPAUSETRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigLvlPauseTrigDigFltrEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigLvlPauseTrigDigFltrEnable',varargin{:});
