function varargout = DAQmxGetCICountEdgesDir(varargin)
%DAQMXGETCICOUNTEDGESDIR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCICountEdgesDir(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesDir',varargin{:});
