function varargout = DAQmxResetReadReadAllAvailSamp(varargin)
%DAQMXRESETREADREADALLAVAILSAMP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadReadAllAvailSamp(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadReadAllAvailSamp',varargin{:});
