function varargout = DAQmxSetScaleDescr(varargin)
%DAQMXSETSCALEDESCR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetScaleDescr(cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleDescr',varargin{:});
