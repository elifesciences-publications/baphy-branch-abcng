function varargout = DAQmxSetAIMax(varargin)
%DAQMXSETAIMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIMax(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIMax',varargin{:});
