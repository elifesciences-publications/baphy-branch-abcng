function varargout = DAQmxResetCOPulseFreqUnits(varargin)
%DAQMXRESETCOPULSEFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseFreqUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseFreqUnits',varargin{:});
