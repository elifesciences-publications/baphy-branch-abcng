function varargout = DAQmxSetAODACRngLow(varargin)
%DAQMXSETAODACRNGLOW calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODACRngLow(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACRngLow',varargin{:});
