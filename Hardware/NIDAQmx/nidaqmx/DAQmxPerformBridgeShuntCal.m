function varargout = DAQmxPerformBridgeShuntCal(varargin)
%DAQMXPERFORMBRIDGESHUNTCAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxPerformBridgeShuntCal(uint32, cstring, double, int32, double, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxPerformBridgeShuntCal',varargin{:});
