function varargout = DAQmxGetTaskDevices(varargin)
%DAQMXGETTASKDEVICES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetTaskDevices(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTaskDevices',varargin{:});
