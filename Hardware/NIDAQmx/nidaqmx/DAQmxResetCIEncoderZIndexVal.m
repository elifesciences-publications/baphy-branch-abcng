function varargout = DAQmxResetCIEncoderZIndexVal(varargin)
%DAQMXRESETCIENCODERZINDEXVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZIndexVal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZIndexVal',varargin{:});
