function varargout = DAQmxGetCIPeriodDiv(varargin)
%DAQMXGETCIPERIODDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIPeriodDiv(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodDiv',varargin{:});
