function varargout = DAQmxSetSwitchDevPwrDownLatchRelaysAfterSettling(varargin)
%DAQMXSETSWITCHDEVPWRDOWNLATCHRELAYSAFTERSETTLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetSwitchDevPwrDownLatchRelaysAfterSettling(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSwitchDevPwrDownLatchRelaysAfterSettling',varargin{:});
