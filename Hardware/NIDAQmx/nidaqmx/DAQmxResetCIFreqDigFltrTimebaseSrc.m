function varargout = DAQmxResetCIFreqDigFltrTimebaseSrc(varargin)
%DAQMXRESETCIFREQDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqDigFltrTimebaseSrc',varargin{:});
