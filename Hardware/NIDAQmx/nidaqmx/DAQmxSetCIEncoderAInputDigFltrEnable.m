function varargout = DAQmxSetCIEncoderAInputDigFltrEnable(varargin)
%DAQMXSETCIENCODERAINPUTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderAInputDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderAInputDigFltrEnable',varargin{:});
