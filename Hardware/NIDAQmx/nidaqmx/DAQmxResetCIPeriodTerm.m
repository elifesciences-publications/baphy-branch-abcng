function varargout = DAQmxResetCIPeriodTerm(varargin)
%DAQMXRESETCIPERIODTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodTerm',varargin{:});
