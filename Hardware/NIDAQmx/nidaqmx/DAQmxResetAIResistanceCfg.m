function varargout = DAQmxResetAIResistanceCfg(varargin)
%DAQMXRESETAIRESISTANCECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIResistanceCfg(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIResistanceCfg',varargin{:});
