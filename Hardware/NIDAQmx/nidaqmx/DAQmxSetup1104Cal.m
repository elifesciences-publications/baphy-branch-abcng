function varargout = DAQmxSetup1104Cal(varargin)
%DAQMXSETUP1104CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1104Cal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1104Cal',varargin{:});
