function varargout = DAQmxWriteDigitalU16(varargin)
%DAQMXWRITEDIGITALU16 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint16Ptr, int32Ptr, uint32Ptr] DAQmxWriteDigitalU16(uint32, int32, uint32, double, uint32, uint16Ptr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteDigitalU16',varargin{:});
