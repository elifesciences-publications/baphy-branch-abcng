function varargout = DAQmxGetPhysicalChanDOPortWidth(varargin)
%DAQMXGETPHYSICALCHANDOPORTWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanDOPortWidth(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanDOPortWidth',varargin{:});
