function varargout = DAQmxSetCIMax(varargin)
%DAQMXSETCIMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIMax(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIMax',varargin{:});
