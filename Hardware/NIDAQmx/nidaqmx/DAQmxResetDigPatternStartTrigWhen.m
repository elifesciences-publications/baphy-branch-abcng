function varargout = DAQmxResetDigPatternStartTrigWhen(varargin)
%DAQMXRESETDIGPATTERNSTARTTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternStartTrigWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternStartTrigWhen',varargin{:});
