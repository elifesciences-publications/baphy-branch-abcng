function varargout = DAQmxSetAITermCfg(varargin)
%DAQMXSETAITERMCFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAITermCfg(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAITermCfg',varargin{:});
