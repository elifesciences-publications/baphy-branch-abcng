function varargout = DAQmxGetAIConvTimebaseDiv(varargin)
%DAQMXGETAICONVTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetAIConvTimebaseDiv(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvTimebaseDiv',varargin{:});
