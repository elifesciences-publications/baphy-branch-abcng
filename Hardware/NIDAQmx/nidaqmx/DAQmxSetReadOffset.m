function varargout = DAQmxSetReadOffset(varargin)
%DAQMXSETREADOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetReadOffset(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadOffset',varargin{:});
