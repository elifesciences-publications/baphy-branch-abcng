function varargout = DAQmxGetExtCalLastTemp(varargin)
%DAQMXGETEXTCALLASTTEMP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetExtCalLastTemp(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExtCalLastTemp',varargin{:});
