function varargout = DAQmxResetAITermCfg(varargin)
%DAQMXRESETAITERMCFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAITermCfg(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAITermCfg',varargin{:});
