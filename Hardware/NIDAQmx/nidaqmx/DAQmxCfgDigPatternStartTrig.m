function varargout = DAQmxCfgDigPatternStartTrig(varargin)
%DAQMXCFGDIGPATTERNSTARTTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCfgDigPatternStartTrig(uint32, cstring, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgDigPatternStartTrig',varargin{:});
