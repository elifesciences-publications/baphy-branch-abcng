function varargout = DAQmxGetRefClkRate(varargin)
%DAQMXGETREFCLKRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetRefClkRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRefClkRate',varargin{:});
