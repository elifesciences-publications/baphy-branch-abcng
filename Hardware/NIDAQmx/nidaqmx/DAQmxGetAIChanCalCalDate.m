function varargout = DAQmxGetAIChanCalCalDate(varargin)
%DAQMXGETAICHANCALCALDATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr] DAQmxGetAIChanCalCalDate(uint32, cstring, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIChanCalCalDate',varargin{:});
