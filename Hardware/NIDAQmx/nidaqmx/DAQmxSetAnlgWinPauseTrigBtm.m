function varargout = DAQmxSetAnlgWinPauseTrigBtm(varargin)
%DAQMXSETANLGWINPAUSETRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinPauseTrigBtm(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinPauseTrigBtm',varargin{:});
