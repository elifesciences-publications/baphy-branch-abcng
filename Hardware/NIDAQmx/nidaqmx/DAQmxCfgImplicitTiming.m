function varargout = DAQmxCfgImplicitTiming(varargin)
%DAQMXCFGIMPLICITTIMING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxCfgImplicitTiming(uint32, int32, uint64)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgImplicitTiming',varargin{:});
