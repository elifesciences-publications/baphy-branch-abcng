function varargout = DAQmxGetSampClkTimebaseActiveEdge(varargin)
%DAQMXGETSAMPCLKTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetSampClkTimebaseActiveEdge(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkTimebaseActiveEdge',varargin{:});
