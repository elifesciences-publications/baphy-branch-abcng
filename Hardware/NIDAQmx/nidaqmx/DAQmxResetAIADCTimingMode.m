function varargout = DAQmxResetAIADCTimingMode(varargin)
%DAQMXRESETAIADCTIMINGMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIADCTimingMode(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIADCTimingMode',varargin{:});
