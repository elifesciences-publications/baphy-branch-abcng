function varargout = DAQmxSetInterlockedHshkTrigSrc(varargin)
%DAQMXSETINTERLOCKEDHSHKTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetInterlockedHshkTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetInterlockedHshkTrigSrc',varargin{:});
