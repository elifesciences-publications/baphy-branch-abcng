function varargout = DAQmxSetCICountEdgesDigFltrTimebaseSrc(varargin)
%DAQMXSETCICOUNTEDGESDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCICountEdgesDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesDigFltrTimebaseSrc',varargin{:});
