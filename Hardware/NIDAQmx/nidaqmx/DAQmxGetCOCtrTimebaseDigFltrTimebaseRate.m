function varargout = DAQmxGetCOCtrTimebaseDigFltrTimebaseRate(varargin)
%DAQMXGETCOCTRTIMEBASEDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOCtrTimebaseDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseDigFltrTimebaseRate',varargin{:});
