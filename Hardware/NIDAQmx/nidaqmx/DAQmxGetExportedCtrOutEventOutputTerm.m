function varargout = DAQmxGetExportedCtrOutEventOutputTerm(varargin)
%DAQMXGETEXPORTEDCTROUTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedCtrOutEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedCtrOutEventOutputTerm',varargin{:});
