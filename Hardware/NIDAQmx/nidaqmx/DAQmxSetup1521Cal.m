function varargout = DAQmxSetup1521Cal(varargin)
%DAQMXSETUP1521CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1521Cal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1521Cal',varargin{:});
