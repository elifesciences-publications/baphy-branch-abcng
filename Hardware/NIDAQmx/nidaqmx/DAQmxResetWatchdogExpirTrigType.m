function varargout = DAQmxResetWatchdogExpirTrigType(varargin)
%DAQMXRESETWATCHDOGEXPIRTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWatchdogExpirTrigType(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWatchdogExpirTrigType',varargin{:});
