function varargout = DAQmxSetAOResolutionUnits(varargin)
%DAQMXSETAORESOLUTIONUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOResolutionUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOResolutionUnits',varargin{:});
