function varargout = DAQmxGetReadChannelsToRead(varargin)
%DAQMXGETREADCHANNELSTOREAD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetReadChannelsToRead(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadChannelsToRead',varargin{:});
