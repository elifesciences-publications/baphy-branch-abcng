function varargout = DAQmxResetRealTimeReportMissedSamp(varargin)
%DAQMXRESETREALTIMEREPORTMISSEDSAMP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRealTimeReportMissedSamp(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRealTimeReportMissedSamp',varargin{:});
