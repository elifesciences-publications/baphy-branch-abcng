function varargout = DAQmxGetDigEdgeArmStartTrigSrc(varargin)
%DAQMXGETDIGEDGEARMSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigEdgeArmStartTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeArmStartTrigSrc',varargin{:});
