function varargout = DAQmxResetExportedCtrOutEventToggleIdleState(varargin)
%DAQMXRESETEXPORTEDCTROUTEVENTTOGGLEIDLESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedCtrOutEventToggleIdleState(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedCtrOutEventToggleIdleState',varargin{:});
