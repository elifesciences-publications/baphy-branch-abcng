function varargout = DAQmxSwitchOpenRelays(varargin)
%DAQMXSWITCHOPENRELAYS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSwitchOpenRelays(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchOpenRelays',varargin{:});
