function varargout = DAQmxResetAIImpedance(varargin)
%DAQMXRESETAIIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIImpedance(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIImpedance',varargin{:});
