function varargout = DAQmxSetSwitchScanRepeatMode(varargin)
%DAQMXSETSWITCHSCANREPEATMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSwitchScanRepeatMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSwitchScanRepeatMode',varargin{:});
