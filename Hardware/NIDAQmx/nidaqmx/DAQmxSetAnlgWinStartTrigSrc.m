function varargout = DAQmxSetAnlgWinStartTrigSrc(varargin)
%DAQMXSETANLGWINSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAnlgWinStartTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinStartTrigSrc',varargin{:});
