function varargout = DAQmxGetAIAtten(varargin)
%DAQMXGETAIATTEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIAtten(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIAtten',varargin{:});
