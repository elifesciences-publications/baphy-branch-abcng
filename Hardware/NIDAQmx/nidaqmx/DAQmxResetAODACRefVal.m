function varargout = DAQmxResetAODACRefVal(varargin)
%DAQMXRESETAODACREFVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACRefVal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACRefVal',varargin{:});
