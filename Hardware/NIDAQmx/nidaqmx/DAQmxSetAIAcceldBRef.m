function varargout = DAQmxSetAIAcceldBRef(varargin)
%DAQMXSETAIACCELDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIAcceldBRef(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIAcceldBRef',varargin{:});
