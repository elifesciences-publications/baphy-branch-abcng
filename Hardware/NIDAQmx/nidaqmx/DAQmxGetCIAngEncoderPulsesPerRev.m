function varargout = DAQmxGetCIAngEncoderPulsesPerRev(varargin)
%DAQMXGETCIANGENCODERPULSESPERREV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIAngEncoderPulsesPerRev(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIAngEncoderPulsesPerRev',varargin{:});
