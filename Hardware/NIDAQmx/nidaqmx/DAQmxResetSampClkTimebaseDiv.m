function varargout = DAQmxResetSampClkTimebaseDiv(varargin)
%DAQMXRESETSAMPCLKTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkTimebaseDiv(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkTimebaseDiv',varargin{:});
