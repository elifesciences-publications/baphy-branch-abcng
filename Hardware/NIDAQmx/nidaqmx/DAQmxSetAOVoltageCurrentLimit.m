function varargout = DAQmxSetAOVoltageCurrentLimit(varargin)
%DAQMXSETAOVOLTAGECURRENTLIMIT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOVoltageCurrentLimit(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOVoltageCurrentLimit',varargin{:});
