function varargout = DAQmxGetExportedCtrOutEventToggleIdleState(varargin)
%DAQMXGETEXPORTEDCTROUTEVENTTOGGLEIDLESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedCtrOutEventToggleIdleState(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedCtrOutEventToggleIdleState',varargin{:});
