function varargout = DAQmxAdjust4220Cal(varargin)
%DAQMXADJUST4220CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxAdjust4220Cal(uint32, cstring, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust4220Cal',varargin{:});
