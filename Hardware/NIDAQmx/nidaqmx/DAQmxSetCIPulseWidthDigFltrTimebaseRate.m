function varargout = DAQmxSetCIPulseWidthDigFltrTimebaseRate(varargin)
%DAQMXSETCIPULSEWIDTHDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPulseWidthDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPulseWidthDigFltrTimebaseRate',varargin{:});
