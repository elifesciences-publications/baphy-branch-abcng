function varargout = DAQmxGetBufOutputBufSize(varargin)
%DAQMXGETBUFOUTPUTBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetBufOutputBufSize(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetBufOutputBufSize',varargin{:});
