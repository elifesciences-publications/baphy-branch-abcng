function varargout = DAQmxResetAnlgEdgeRefTrigCoupling(varargin)
%DAQMXRESETANLGEDGEREFTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeRefTrigCoupling(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeRefTrigCoupling',varargin{:});
