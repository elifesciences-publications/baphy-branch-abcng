function varargout = DAQmxCreateCILinEncoderChan(varargin)
%DAQMXCREATECILINENCODERCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateCILinEncoderChan(uint32, cstring, cstring, int32, uint32, double, int32, int32, double, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCILinEncoderChan',varargin{:});
