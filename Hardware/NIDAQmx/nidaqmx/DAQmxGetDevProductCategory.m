function varargout = DAQmxGetDevProductCategory(varargin)
%DAQMXGETDEVPRODUCTCATEGORY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevProductCategory(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevProductCategory',varargin{:});
