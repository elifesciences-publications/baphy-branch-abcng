function varargout = DAQmxGetCITwoEdgeSepUnits(varargin)
%DAQMXGETCITWOEDGESEPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCITwoEdgeSepUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepUnits',varargin{:});
