function varargout = DAQmxSetExportedSyncPulseEventOutputTerm(varargin)
%DAQMXSETEXPORTEDSYNCPULSEEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedSyncPulseEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedSyncPulseEventOutputTerm',varargin{:});
