function varargout = DAQmxGetWatchdogTimeout(varargin)
%DAQMXGETWATCHDOGTIMEOUT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetWatchdogTimeout(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWatchdogTimeout',varargin{:});
