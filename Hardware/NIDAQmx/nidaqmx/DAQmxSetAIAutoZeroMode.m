function varargout = DAQmxSetAIAutoZeroMode(varargin)
%DAQMXSETAIAUTOZEROMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIAutoZeroMode(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIAutoZeroMode',varargin{:});
