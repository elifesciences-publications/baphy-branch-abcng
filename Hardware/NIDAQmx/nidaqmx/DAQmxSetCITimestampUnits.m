function varargout = DAQmxSetCITimestampUnits(varargin)
%DAQMXSETCITIMESTAMPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITimestampUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITimestampUnits',varargin{:});
