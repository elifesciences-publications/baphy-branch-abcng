function varargout = DAQmxSetAODACRefSrc(varargin)
%DAQMXSETAODACREFSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODACRefSrc(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACRefSrc',varargin{:});
