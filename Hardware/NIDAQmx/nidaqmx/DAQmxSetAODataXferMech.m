function varargout = DAQmxSetAODataXferMech(varargin)
%DAQMXSETAODATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODataXferMech(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODataXferMech',varargin{:});
