function varargout = DAQmxSwitchDisconnect(varargin)
%DAQMXSWITCHDISCONNECT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSwitchDisconnect(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchDisconnect',varargin{:});
