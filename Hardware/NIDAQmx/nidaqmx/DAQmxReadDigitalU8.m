function varargout = DAQmxReadDigitalU8(varargin)
%DAQMXREADDIGITALU8 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint8Ptr, int32Ptr, uint32Ptr] DAQmxReadDigitalU8(uint32, int32, double, uint32, uint8Ptr, uint32, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadDigitalU8',varargin{:});
