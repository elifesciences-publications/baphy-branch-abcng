function varargout = DAQmxGetAOMin(varargin)
%DAQMXGETAOMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOMin(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOMin',varargin{:});
