function varargout = DAQmxResetCIAngEncoderPulsesPerRev(varargin)
%DAQMXRESETCIANGENCODERPULSESPERREV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIAngEncoderPulsesPerRev(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIAngEncoderPulsesPerRev',varargin{:});
