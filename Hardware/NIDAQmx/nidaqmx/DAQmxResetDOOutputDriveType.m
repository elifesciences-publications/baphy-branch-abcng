function varargout = DAQmxResetDOOutputDriveType(varargin)
%DAQMXRESETDOOUTPUTDRIVETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOOutputDriveType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOOutputDriveType',varargin{:});
