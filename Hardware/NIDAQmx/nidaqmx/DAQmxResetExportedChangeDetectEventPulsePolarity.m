function varargout = DAQmxResetExportedChangeDetectEventPulsePolarity(varargin)
%DAQMXRESETEXPORTEDCHANGEDETECTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedChangeDetectEventPulsePolarity(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedChangeDetectEventPulsePolarity',varargin{:});
