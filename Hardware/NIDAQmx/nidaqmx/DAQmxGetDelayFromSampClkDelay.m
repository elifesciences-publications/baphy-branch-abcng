function varargout = DAQmxGetDelayFromSampClkDelay(varargin)
%DAQMXGETDELAYFROMSAMPCLKDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetDelayFromSampClkDelay(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDelayFromSampClkDelay',varargin{:});
