function varargout = DAQmxSetExportedCtrOutEventToggleIdleState(varargin)
%DAQMXSETEXPORTEDCTROUTEVENTTOGGLEIDLESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedCtrOutEventToggleIdleState(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedCtrOutEventToggleIdleState',varargin{:});
