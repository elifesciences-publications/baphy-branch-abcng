function varargout = DAQmxSetCICustomScaleName(varargin)
%DAQMXSETCICUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCICustomScaleName(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICustomScaleName',varargin{:});
