function varargout = DAQmxResetAIAccelSensitivityUnits(varargin)
%DAQMXRESETAIACCELSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIAccelSensitivityUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIAccelSensitivityUnits',varargin{:});
