function varargout = DAQmxGetCICtrTimebaseSrc(varargin)
%DAQMXGETCICTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCICtrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseSrc',varargin{:});
