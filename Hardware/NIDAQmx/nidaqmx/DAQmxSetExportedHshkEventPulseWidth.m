function varargout = DAQmxSetExportedHshkEventPulseWidth(varargin)
%DAQMXSETEXPORTEDHSHKEVENTPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedHshkEventPulseWidth(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedHshkEventPulseWidth',varargin{:});
