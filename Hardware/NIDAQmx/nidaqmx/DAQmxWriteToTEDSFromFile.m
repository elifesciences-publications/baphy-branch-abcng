function varargout = DAQmxWriteToTEDSFromFile(varargin)
%DAQMXWRITETOTEDSFROMFILE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxWriteToTEDSFromFile(cstring, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteToTEDSFromFile',varargin{:});
