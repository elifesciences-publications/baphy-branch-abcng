function varargout = DAQmxResetAISoundPressureUnits(varargin)
%DAQMXRESETAISOUNDPRESSUREUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAISoundPressureUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAISoundPressureUnits',varargin{:});
