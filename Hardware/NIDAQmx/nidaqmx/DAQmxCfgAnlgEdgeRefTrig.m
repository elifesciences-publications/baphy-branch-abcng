function varargout = DAQmxCfgAnlgEdgeRefTrig(varargin)
%DAQMXCFGANLGEDGEREFTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgAnlgEdgeRefTrig(uint32, cstring, int32, double, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgAnlgEdgeRefTrig',varargin{:});
