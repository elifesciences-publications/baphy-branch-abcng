function varargout = DAQmxResetCICountEdgesActiveEdge(varargin)
%DAQMXRESETCICOUNTEDGESACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesActiveEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesActiveEdge',varargin{:});
