function varargout = DAQmxSetAOLoadImpedance(varargin)
%DAQMXSETAOLOADIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOLoadImpedance(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOLoadImpedance',varargin{:});
