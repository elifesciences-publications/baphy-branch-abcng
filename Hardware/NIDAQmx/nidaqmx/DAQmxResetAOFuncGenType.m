function varargout = DAQmxResetAOFuncGenType(varargin)
%DAQMXRESETAOFUNCGENTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOFuncGenType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOFuncGenType',varargin{:});
