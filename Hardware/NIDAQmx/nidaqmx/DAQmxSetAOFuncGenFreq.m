function varargout = DAQmxSetAOFuncGenFreq(varargin)
%DAQMXSETAOFUNCGENFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOFuncGenFreq(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOFuncGenFreq',varargin{:});
