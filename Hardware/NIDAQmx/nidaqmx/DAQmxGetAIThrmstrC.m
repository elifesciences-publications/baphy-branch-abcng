function varargout = DAQmxGetAIThrmstrC(varargin)
%DAQMXGETAITHRMSTRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIThrmstrC(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmstrC',varargin{:});
