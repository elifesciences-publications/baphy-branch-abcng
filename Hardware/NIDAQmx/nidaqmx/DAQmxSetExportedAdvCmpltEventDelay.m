function varargout = DAQmxSetExportedAdvCmpltEventDelay(varargin)
%DAQMXSETEXPORTEDADVCMPLTEVENTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedAdvCmpltEventDelay(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAdvCmpltEventDelay',varargin{:});
