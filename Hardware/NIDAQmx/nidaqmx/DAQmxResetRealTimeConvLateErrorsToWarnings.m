function varargout = DAQmxResetRealTimeConvLateErrorsToWarnings(varargin)
%DAQMXRESETREALTIMECONVLATEERRORSTOWARNINGS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRealTimeConvLateErrorsToWarnings(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRealTimeConvLateErrorsToWarnings',varargin{:});
