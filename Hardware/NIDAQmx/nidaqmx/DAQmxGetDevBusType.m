function varargout = DAQmxGetDevBusType(varargin)
%DAQMXGETDEVBUSTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevBusType(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevBusType',varargin{:});
