function varargout = DAQmxSetAIThrmcplCJCVal(varargin)
%DAQMXSETAITHRMCPLCJCVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIThrmcplCJCVal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIThrmcplCJCVal',varargin{:});
