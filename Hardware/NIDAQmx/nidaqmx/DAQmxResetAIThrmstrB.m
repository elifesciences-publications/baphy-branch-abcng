function varargout = DAQmxResetAIThrmstrB(varargin)
%DAQMXRESETAITHRMSTRB calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIThrmstrB(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIThrmstrB',varargin{:});
