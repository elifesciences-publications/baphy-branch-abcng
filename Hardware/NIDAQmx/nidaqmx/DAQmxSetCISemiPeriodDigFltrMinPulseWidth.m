function varargout = DAQmxSetCISemiPeriodDigFltrMinPulseWidth(varargin)
%DAQMXSETCISEMIPERIODDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCISemiPeriodDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCISemiPeriodDigFltrMinPulseWidth',varargin{:});
