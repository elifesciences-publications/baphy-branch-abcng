function varargout = DAQmxResetAIResistanceUnits(varargin)
%DAQMXRESETAIRESISTANCEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIResistanceUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIResistanceUnits',varargin{:});
