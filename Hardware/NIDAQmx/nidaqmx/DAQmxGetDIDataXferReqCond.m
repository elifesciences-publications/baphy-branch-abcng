function varargout = DAQmxGetDIDataXferReqCond(varargin)
%DAQMXGETDIDATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDIDataXferReqCond(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDIDataXferReqCond',varargin{:});
