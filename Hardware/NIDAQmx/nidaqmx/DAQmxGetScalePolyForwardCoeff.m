function varargout = DAQmxGetScalePolyForwardCoeff(varargin)
%DAQMXGETSCALEPOLYFORWARDCOEFF calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxGetScalePolyForwardCoeff ( const char scaleName [], float64 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, doublePtr] DAQmxGetScalePolyForwardCoeff(cstring, doublePtr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScalePolyForwardCoeff',varargin{:});
