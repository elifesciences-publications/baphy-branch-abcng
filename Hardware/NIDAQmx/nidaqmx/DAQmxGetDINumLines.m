function varargout = DAQmxGetDINumLines(varargin)
%DAQMXGETDINUMLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDINumLines(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDINumLines',varargin{:});
