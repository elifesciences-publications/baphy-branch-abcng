function varargout = DAQmxResetExportedSampClkPulsePolarity(varargin)
%DAQMXRESETEXPORTEDSAMPCLKPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedSampClkPulsePolarity(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedSampClkPulsePolarity',varargin{:});
