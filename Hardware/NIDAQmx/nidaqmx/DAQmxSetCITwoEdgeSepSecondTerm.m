function varargout = DAQmxSetCITwoEdgeSepSecondTerm(varargin)
%DAQMXSETCITWOEDGESEPSECONDTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCITwoEdgeSepSecondTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepSecondTerm',varargin{:});
