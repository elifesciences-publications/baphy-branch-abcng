function varargout = DAQmxSetCIGPSSyncSrc(varargin)
%DAQMXSETCIGPSSYNCSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIGPSSyncSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIGPSSyncSrc',varargin{:});
