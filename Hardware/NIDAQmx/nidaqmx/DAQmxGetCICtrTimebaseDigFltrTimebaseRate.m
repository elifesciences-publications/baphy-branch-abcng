function varargout = DAQmxGetCICtrTimebaseDigFltrTimebaseRate(varargin)
%DAQMXGETCICTRTIMEBASEDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCICtrTimebaseDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseDigFltrTimebaseRate',varargin{:});
