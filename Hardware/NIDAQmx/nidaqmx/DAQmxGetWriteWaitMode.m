function varargout = DAQmxGetWriteWaitMode(varargin)
%DAQMXGETWRITEWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetWriteWaitMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteWaitMode',varargin{:});
