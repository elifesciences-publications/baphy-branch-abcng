function varargout = DAQmxGetAnlgEdgeStartTrigLvl(varargin)
%DAQMXGETANLGEDGESTARTTRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgEdgeStartTrigLvl(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeStartTrigLvl',varargin{:});
