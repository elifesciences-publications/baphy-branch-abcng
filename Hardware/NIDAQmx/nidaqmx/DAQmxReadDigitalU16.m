function varargout = DAQmxReadDigitalU16(varargin)
%DAQMXREADDIGITALU16 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint16Ptr, int32Ptr, uint32Ptr] DAQmxReadDigitalU16(uint32, int32, double, uint32, uint16Ptr, uint32, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadDigitalU16',varargin{:});
