function varargout = DAQmxSetExportedWatchdogExpiredEventOutputTerm(varargin)
%DAQMXSETEXPORTEDWATCHDOGEXPIREDEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedWatchdogExpiredEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedWatchdogExpiredEventOutputTerm',varargin{:});
