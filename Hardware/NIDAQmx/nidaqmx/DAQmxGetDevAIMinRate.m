function varargout = DAQmxGetDevAIMinRate(varargin)
%DAQMXGETDEVAIMINRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevAIMinRate(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAIMinRate',varargin{:});
