function varargout = DAQmxGetAISoundPressureMaxSoundPressureLvl(varargin)
%DAQMXGETAISOUNDPRESSUREMAXSOUNDPRESSURELVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAISoundPressureMaxSoundPressureLvl(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAISoundPressureMaxSoundPressureLvl',varargin{:});
