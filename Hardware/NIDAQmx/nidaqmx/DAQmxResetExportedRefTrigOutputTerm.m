function varargout = DAQmxResetExportedRefTrigOutputTerm(varargin)
%DAQMXRESETEXPORTEDREFTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedRefTrigOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedRefTrigOutputTerm',varargin{:});
