function varargout = DAQmxSetSwitchChanUsage(varargin)
%DAQMXSETSWITCHCHANUSAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetSwitchChanUsage(cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSwitchChanUsage',varargin{:});
