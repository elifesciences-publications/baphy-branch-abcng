function varargout = DAQmxGetExportedRefTrigOutputTerm(varargin)
%DAQMXGETEXPORTEDREFTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedRefTrigOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedRefTrigOutputTerm',varargin{:});
