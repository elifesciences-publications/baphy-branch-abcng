function varargout = DAQmxGetAIExcitVal(varargin)
%DAQMXGETAIEXCITVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIExcitVal(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIExcitVal',varargin{:});
