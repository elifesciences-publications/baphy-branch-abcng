function varargout = DAQmxSetCOPrescaler(varargin)
%DAQMXSETCOPRESCALER calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPrescaler(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPrescaler',varargin{:});
