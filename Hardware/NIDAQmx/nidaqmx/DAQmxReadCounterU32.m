function varargout = DAQmxReadCounterU32(varargin)
%DAQMXREADCOUNTERU32 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr, int32Ptr, uint32Ptr] DAQmxReadCounterU32(uint32, int32, double, uint32Ptr, uint32, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadCounterU32',varargin{:});
