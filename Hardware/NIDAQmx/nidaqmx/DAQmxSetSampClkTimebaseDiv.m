function varargout = DAQmxSetSampClkTimebaseDiv(varargin)
%DAQMXSETSAMPCLKTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkTimebaseDiv(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkTimebaseDiv',varargin{:});
