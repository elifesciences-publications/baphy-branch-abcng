function varargout = DAQmxResetExportedCtrOutEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDCTROUTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedCtrOutEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedCtrOutEventOutputTerm',varargin{:});
