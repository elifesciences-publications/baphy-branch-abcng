function varargout = DAQmxResetAIBridgeCfg(varargin)
%DAQMXRESETAIBRIDGECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIBridgeCfg(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIBridgeCfg',varargin{:});
