function varargout = DAQmxResetExportedHshkEventPulsePolarity(varargin)
%DAQMXRESETEXPORTEDHSHKEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedHshkEventPulsePolarity(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedHshkEventPulsePolarity',varargin{:});
