function varargout = DAQmxGetAIBridgeShuntCalSelect(varargin)
%DAQMXGETAIBRIDGESHUNTCALSELECT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIBridgeShuntCalSelect(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIBridgeShuntCalSelect',varargin{:});
