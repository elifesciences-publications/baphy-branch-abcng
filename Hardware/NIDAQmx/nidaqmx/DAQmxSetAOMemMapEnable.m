function varargout = DAQmxSetAOMemMapEnable(varargin)
%DAQMXSETAOMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOMemMapEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOMemMapEnable',varargin{:});
