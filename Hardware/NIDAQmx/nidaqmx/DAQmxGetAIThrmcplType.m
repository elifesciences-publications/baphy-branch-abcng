function varargout = DAQmxGetAIThrmcplType(varargin)
%DAQMXGETAITHRMCPLTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIThrmcplType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmcplType',varargin{:});
