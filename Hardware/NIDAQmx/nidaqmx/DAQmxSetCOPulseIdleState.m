function varargout = DAQmxSetCOPulseIdleState(varargin)
%DAQMXSETCOPULSEIDLESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseIdleState(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseIdleState',varargin{:});
