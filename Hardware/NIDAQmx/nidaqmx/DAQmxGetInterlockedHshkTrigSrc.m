function varargout = DAQmxGetInterlockedHshkTrigSrc(varargin)
%DAQMXGETINTERLOCKEDHSHKTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetInterlockedHshkTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetInterlockedHshkTrigSrc',varargin{:});
