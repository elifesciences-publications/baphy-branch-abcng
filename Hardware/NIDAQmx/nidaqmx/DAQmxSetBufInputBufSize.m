function varargout = DAQmxSetBufInputBufSize(varargin)
%DAQMXSETBUFINPUTBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetBufInputBufSize(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetBufInputBufSize',varargin{:});
