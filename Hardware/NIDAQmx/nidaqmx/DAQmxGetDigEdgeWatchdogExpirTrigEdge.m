function varargout = DAQmxGetDigEdgeWatchdogExpirTrigEdge(varargin)
%DAQMXGETDIGEDGEWATCHDOGEXPIRTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigEdgeWatchdogExpirTrigEdge(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeWatchdogExpirTrigEdge',varargin{:});
