function varargout = DAQmxGetAICurrentUnits(varargin)
%DAQMXGETAICURRENTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAICurrentUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAICurrentUnits',varargin{:});
