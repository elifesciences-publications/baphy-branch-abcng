function varargout = DAQmxSetCOCtrTimebaseDigFltrTimebaseRate(varargin)
%DAQMXSETCOCTRTIMEBASEDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOCtrTimebaseDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseDigFltrTimebaseRate',varargin{:});
