function varargout = DAQmxSetAIBridgeBalanceFinePot(varargin)
%DAQMXSETAIBRIDGEBALANCEFINEPOT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIBridgeBalanceFinePot(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIBridgeBalanceFinePot',varargin{:});
