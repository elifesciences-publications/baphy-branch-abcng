function varargout = DAQmxResetSampClkDigFltrMinPulseWidth(varargin)
%DAQMXRESETSAMPCLKDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkDigFltrMinPulseWidth(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkDigFltrMinPulseWidth',varargin{:});
