function varargout = DAQmxGetAIChanCalScaleType(varargin)
%DAQMXGETAICHANCALSCALETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIChanCalScaleType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIChanCalScaleType',varargin{:});
