function varargout = DAQmxSetup1124Cal(varargin)
%DAQMXSETUP1124CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1124Cal(uint32, cstring, int32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1124Cal',varargin{:});
