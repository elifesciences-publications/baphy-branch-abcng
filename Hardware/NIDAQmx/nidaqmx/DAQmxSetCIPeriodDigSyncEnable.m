function varargout = DAQmxSetCIPeriodDigSyncEnable(varargin)
%DAQMXSETCIPERIODDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodDigSyncEnable',varargin{:});
