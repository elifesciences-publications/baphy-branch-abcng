function varargout = DAQmxAdjust1502Cal(varargin)
%DAQMXADJUST1502CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1502Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1502Cal',varargin{:});
