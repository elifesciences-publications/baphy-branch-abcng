function varargout = DAQmxSetCOCtrTimebaseRate(varargin)
%DAQMXSETCOCTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOCtrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseRate',varargin{:});
