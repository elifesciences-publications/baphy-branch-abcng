function varargout = DAQmxResetExportedSampClkOutputTerm(varargin)
%DAQMXRESETEXPORTEDSAMPCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedSampClkOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedSampClkOutputTerm',varargin{:});
