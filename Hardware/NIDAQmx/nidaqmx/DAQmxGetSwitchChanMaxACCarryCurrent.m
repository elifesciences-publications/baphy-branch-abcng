function varargout = DAQmxGetSwitchChanMaxACCarryCurrent(varargin)
%DAQMXGETSWITCHCHANMAXACCARRYCURRENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxACCarryCurrent(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxACCarryCurrent',varargin{:});
