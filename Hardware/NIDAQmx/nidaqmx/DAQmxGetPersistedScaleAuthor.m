function varargout = DAQmxGetPersistedScaleAuthor(varargin)
%DAQMXGETPERSISTEDSCALEAUTHOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetPersistedScaleAuthor(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedScaleAuthor',varargin{:});
