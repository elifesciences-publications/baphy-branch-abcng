function varargout = DAQmxSetExportedRdyForStartEventLvlActiveLvl(varargin)
%DAQMXSETEXPORTEDRDYFORSTARTEVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedRdyForStartEventLvlActiveLvl(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedRdyForStartEventLvlActiveLvl',varargin{:});
