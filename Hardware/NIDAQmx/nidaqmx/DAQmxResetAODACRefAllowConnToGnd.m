function varargout = DAQmxResetAODACRefAllowConnToGnd(varargin)
%DAQMXRESETAODACREFALLOWCONNTOGND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACRefAllowConnToGnd(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACRefAllowConnToGnd',varargin{:});
