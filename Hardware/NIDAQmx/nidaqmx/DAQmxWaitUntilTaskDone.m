function varargout = DAQmxWaitUntilTaskDone(varargin)
%DAQMXWAITUNTILTASKDONE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxWaitUntilTaskDone(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWaitUntilTaskDone',varargin{:});
