function varargout = DAQmxSetCICountEdgesDirTerm(varargin)
%DAQMXSETCICOUNTEDGESDIRTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCICountEdgesDirTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesDirTerm',varargin{:});
