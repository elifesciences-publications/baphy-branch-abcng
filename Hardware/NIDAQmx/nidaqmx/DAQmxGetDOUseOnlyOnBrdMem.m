function varargout = DAQmxGetDOUseOnlyOnBrdMem(varargin)
%DAQMXGETDOUSEONLYONBRDMEM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDOUseOnlyOnBrdMem(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOUseOnlyOnBrdMem',varargin{:});
