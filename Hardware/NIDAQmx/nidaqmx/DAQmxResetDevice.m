function varargout = DAQmxResetDevice(varargin)
%DAQMXRESETDEVICE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDevice(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDevice',varargin{:});
