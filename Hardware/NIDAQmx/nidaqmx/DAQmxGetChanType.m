function varargout = DAQmxGetChanType(varargin)
%DAQMXGETCHANTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetChanType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetChanType',varargin{:});
