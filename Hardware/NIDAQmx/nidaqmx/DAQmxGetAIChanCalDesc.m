function varargout = DAQmxGetAIChanCalDesc(varargin)
%DAQMXGETAICHANCALDESC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAIChanCalDesc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIChanCalDesc',varargin{:});
