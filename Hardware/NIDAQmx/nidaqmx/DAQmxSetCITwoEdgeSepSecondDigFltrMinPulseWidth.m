function varargout = DAQmxSetCITwoEdgeSepSecondDigFltrMinPulseWidth(varargin)
%DAQMXSETCITWOEDGESEPSECONDDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepSecondDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepSecondDigFltrMinPulseWidth',varargin{:});
