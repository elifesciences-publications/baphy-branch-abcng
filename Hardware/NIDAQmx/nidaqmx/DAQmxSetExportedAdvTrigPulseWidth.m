function varargout = DAQmxSetExportedAdvTrigPulseWidth(varargin)
%DAQMXSETEXPORTEDADVTRIGPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedAdvTrigPulseWidth(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAdvTrigPulseWidth',varargin{:});
