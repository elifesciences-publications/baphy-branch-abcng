function varargout = DAQmxGetAIResolutionUnits(varargin)
%DAQMXGETAIRESOLUTIONUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIResolutionUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIResolutionUnits',varargin{:});
