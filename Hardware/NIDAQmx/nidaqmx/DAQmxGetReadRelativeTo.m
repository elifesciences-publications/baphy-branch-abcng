function varargout = DAQmxGetReadRelativeTo(varargin)
%DAQMXGETREADRELATIVETO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetReadRelativeTo(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadRelativeTo',varargin{:});
