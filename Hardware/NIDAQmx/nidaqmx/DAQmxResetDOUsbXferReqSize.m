function varargout = DAQmxResetDOUsbXferReqSize(varargin)
%DAQMXRESETDOUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOUsbXferReqSize(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOUsbXferReqSize',varargin{:});
