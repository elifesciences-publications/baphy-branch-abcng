function varargout = DAQmxResetCIFreqDigFltrTimebaseRate(varargin)
%DAQMXRESETCIFREQDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqDigFltrTimebaseRate',varargin{:});
