function varargout = DAQmxResetCICtrTimebaseDigFltrTimebaseRate(varargin)
%DAQMXRESETCICTRTIMEBASEDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseDigFltrTimebaseRate',varargin{:});
