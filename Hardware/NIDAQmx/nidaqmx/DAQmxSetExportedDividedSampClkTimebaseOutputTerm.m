function varargout = DAQmxSetExportedDividedSampClkTimebaseOutputTerm(varargin)
%DAQMXSETEXPORTEDDIVIDEDSAMPCLKTIMEBASEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedDividedSampClkTimebaseOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedDividedSampClkTimebaseOutputTerm',varargin{:});
