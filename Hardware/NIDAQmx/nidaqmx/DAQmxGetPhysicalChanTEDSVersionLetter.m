function varargout = DAQmxGetPhysicalChanTEDSVersionLetter(varargin)
%DAQMXGETPHYSICALCHANTEDSVERSIONLETTER calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetPhysicalChanTEDSVersionLetter(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanTEDSVersionLetter',varargin{:});
