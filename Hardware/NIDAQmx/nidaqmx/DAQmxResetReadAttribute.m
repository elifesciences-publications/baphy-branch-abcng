function varargout = DAQmxResetReadAttribute(varargin)
%DAQMXRESETREADATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadAttribute(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadAttribute',varargin{:});
