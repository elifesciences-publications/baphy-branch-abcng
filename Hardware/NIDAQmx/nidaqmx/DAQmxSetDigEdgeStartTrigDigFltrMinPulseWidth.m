function varargout = DAQmxSetDigEdgeStartTrigDigFltrMinPulseWidth(varargin)
%DAQMXSETDIGEDGESTARTTRIGDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeStartTrigDigFltrMinPulseWidth(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeStartTrigDigFltrMinPulseWidth',varargin{:});
