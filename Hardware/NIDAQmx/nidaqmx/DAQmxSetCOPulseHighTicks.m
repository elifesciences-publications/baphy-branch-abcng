function varargout = DAQmxSetCOPulseHighTicks(varargin)
%DAQMXSETCOPULSEHIGHTICKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseHighTicks(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseHighTicks',varargin{:});
