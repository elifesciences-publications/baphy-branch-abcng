function varargout = DAQmxGetOnDemandSimultaneousAOEnable(varargin)
%DAQMXGETONDEMANDSIMULTANEOUSAOENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetOnDemandSimultaneousAOEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetOnDemandSimultaneousAOEnable',varargin{:});
