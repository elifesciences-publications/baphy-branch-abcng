function varargout = DAQmxGetCOCtrTimebaseRate(varargin)
%DAQMXGETCOCTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOCtrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseRate',varargin{:});
