function varargout = DAQmxSetCOCtrTimebaseDigFltrEnable(varargin)
%DAQMXSETCOCTRTIMEBASEDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOCtrTimebaseDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseDigFltrEnable',varargin{:});
