function varargout = DAQmxGetExportedSignalAttribute(varargin)
%DAQMXGETEXPORTEDSIGNALATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxGetExportedSignalAttribute(uint32, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedSignalAttribute',varargin{:});
