function varargout = DAQmxGetAOCurrentUnits(varargin)
%DAQMXGETAOCURRENTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAOCurrentUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOCurrentUnits',varargin{:});
