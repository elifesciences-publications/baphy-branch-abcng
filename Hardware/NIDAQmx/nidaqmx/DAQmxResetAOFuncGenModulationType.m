function varargout = DAQmxResetAOFuncGenModulationType(varargin)
%DAQMXRESETAOFUNCGENMODULATIONTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOFuncGenModulationType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOFuncGenModulationType',varargin{:});
