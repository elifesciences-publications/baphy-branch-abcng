function varargout = DAQmxResetSampTimingType(varargin)
%DAQMXRESETSAMPTIMINGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampTimingType(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampTimingType',varargin{:});
