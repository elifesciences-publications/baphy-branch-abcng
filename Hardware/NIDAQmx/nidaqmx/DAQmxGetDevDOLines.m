function varargout = DAQmxGetDevDOLines(varargin)
%DAQMXGETDEVDOLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevDOLines(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDOLines',varargin{:});
