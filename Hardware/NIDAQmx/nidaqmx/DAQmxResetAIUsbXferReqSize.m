function varargout = DAQmxResetAIUsbXferReqSize(varargin)
%DAQMXRESETAIUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIUsbXferReqSize(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIUsbXferReqSize',varargin{:});
