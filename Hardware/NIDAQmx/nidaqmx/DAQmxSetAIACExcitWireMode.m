function varargout = DAQmxSetAIACExcitWireMode(varargin)
%DAQMXSETAIACEXCITWIREMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIACExcitWireMode(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIACExcitWireMode',varargin{:});
