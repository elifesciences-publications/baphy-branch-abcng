function varargout = DAQmxSetCILinEncoderDistPerPulse(varargin)
%DAQMXSETCILINENCODERDISTPERPULSE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCILinEncoderDistPerPulse(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCILinEncoderDistPerPulse',varargin{:});
