function varargout = DAQmxResetCICountEdgesDir(varargin)
%DAQMXRESETCICOUNTEDGESDIR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesDir(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesDir',varargin{:});
