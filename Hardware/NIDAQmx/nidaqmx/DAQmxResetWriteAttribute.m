function varargout = DAQmxResetWriteAttribute(varargin)
%DAQMXRESETWRITEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWriteAttribute(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWriteAttribute',varargin{:});
