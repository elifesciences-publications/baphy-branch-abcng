function varargout = DAQmxGetDevCOTrigUsage(varargin)
%DAQMXGETDEVCOTRIGUSAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevCOTrigUsage(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCOTrigUsage',varargin{:});
