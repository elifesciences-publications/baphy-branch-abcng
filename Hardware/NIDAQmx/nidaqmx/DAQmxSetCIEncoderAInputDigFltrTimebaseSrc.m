function varargout = DAQmxSetCIEncoderAInputDigFltrTimebaseSrc(varargin)
%DAQMXSETCIENCODERAINPUTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIEncoderAInputDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderAInputDigFltrTimebaseSrc',varargin{:});
