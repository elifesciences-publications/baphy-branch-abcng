function varargout = DAQmxSetExportedSampClkPulsePolarity(varargin)
%DAQMXSETEXPORTEDSAMPCLKPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedSampClkPulsePolarity(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedSampClkPulsePolarity',varargin{:});
