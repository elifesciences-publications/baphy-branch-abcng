function varargout = DAQmxGetStartTrigDelayUnits(varargin)
%DAQMXGETSTARTTRIGDELAYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetStartTrigDelayUnits(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetStartTrigDelayUnits',varargin{:});
