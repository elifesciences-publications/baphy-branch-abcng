function varargout = DAQmxSetAICurrentShuntLoc(varargin)
%DAQMXSETAICURRENTSHUNTLOC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAICurrentShuntLoc(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAICurrentShuntLoc',varargin{:});
