function varargout = DAQmxSetExportedStartTrigPulsePolarity(varargin)
%DAQMXSETEXPORTEDSTARTTRIGPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedStartTrigPulsePolarity(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedStartTrigPulsePolarity',varargin{:});
