function varargout = DAQmxDisableRefTrig(varargin)
%DAQMXDISABLEREFTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxDisableRefTrig(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxDisableRefTrig',varargin{:});
