function varargout = DAQmxGetTaskChannels(varargin)
%DAQMXGETTASKCHANNELS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetTaskChannels(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTaskChannels',varargin{:});
