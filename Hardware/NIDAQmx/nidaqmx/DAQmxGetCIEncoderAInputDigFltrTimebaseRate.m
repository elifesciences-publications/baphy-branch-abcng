function varargout = DAQmxGetCIEncoderAInputDigFltrTimebaseRate(varargin)
%DAQMXGETCIENCODERAINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIEncoderAInputDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderAInputDigFltrTimebaseRate',varargin{:});
