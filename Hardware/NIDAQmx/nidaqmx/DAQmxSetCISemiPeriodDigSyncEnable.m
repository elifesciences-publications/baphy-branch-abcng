function varargout = DAQmxSetCISemiPeriodDigSyncEnable(varargin)
%DAQMXSETCISEMIPERIODDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCISemiPeriodDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCISemiPeriodDigSyncEnable',varargin{:});
