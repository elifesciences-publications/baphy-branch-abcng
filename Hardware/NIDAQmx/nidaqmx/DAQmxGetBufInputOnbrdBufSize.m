function varargout = DAQmxGetBufInputOnbrdBufSize(varargin)
%DAQMXGETBUFINPUTONBRDBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetBufInputOnbrdBufSize(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetBufInputOnbrdBufSize',varargin{:});
