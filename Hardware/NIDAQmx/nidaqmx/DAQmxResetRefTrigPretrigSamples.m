function varargout = DAQmxResetRefTrigPretrigSamples(varargin)
%DAQMXRESETREFTRIGPRETRIGSAMPLES calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRefTrigPretrigSamples(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRefTrigPretrigSamples',varargin{:});
