function varargout = DAQmxSetAIFreqHyst(varargin)
%DAQMXSETAIFREQHYST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIFreqHyst(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIFreqHyst',varargin{:});
