function varargout = DAQmxResetAIThrmcplType(varargin)
%DAQMXRESETAITHRMCPLTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIThrmcplType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIThrmcplType',varargin{:});
