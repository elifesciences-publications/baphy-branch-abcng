function varargout = DAQmxResetCOPulseLowTime(varargin)
%DAQMXRESETCOPULSELOWTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseLowTime(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseLowTime',varargin{:});
