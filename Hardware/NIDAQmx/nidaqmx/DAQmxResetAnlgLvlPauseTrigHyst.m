function varargout = DAQmxResetAnlgLvlPauseTrigHyst(varargin)
%DAQMXRESETANLGLVLPAUSETRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgLvlPauseTrigHyst(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgLvlPauseTrigHyst',varargin{:});
