function varargout = DAQmxResetCOCtrTimebaseDigSyncEnable(varargin)
%DAQMXRESETCOCTRTIMEBASEDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOCtrTimebaseDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOCtrTimebaseDigSyncEnable',varargin{:});
