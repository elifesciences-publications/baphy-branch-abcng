function varargout = DAQmxSetAIDitherEnable(varargin)
%DAQMXSETAIDITHERENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIDitherEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIDitherEnable',varargin{:});
