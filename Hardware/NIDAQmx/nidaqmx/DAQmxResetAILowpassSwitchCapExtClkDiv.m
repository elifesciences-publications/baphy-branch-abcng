function varargout = DAQmxResetAILowpassSwitchCapExtClkDiv(varargin)
%DAQMXRESETAILOWPASSSWITCHCAPEXTCLKDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILowpassSwitchCapExtClkDiv(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILowpassSwitchCapExtClkDiv',varargin{:});
