function varargout = DAQmxMSeriesCalAdjust(varargin)
%DAQMXMSERIESCALADJUST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxMSeriesCalAdjust(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxMSeriesCalAdjust',varargin{:});
