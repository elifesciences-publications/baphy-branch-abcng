function varargout = DAQmxResetAOMax(varargin)
%DAQMXRESETAOMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOMax(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOMax',varargin{:});
