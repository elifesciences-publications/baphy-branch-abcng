function varargout = DAQmxResetPauseTrigType(varargin)
%DAQMXRESETPAUSETRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetPauseTrigType(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetPauseTrigType',varargin{:});
