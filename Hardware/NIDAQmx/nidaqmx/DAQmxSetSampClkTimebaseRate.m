function varargout = DAQmxSetSampClkTimebaseRate(varargin)
%DAQMXSETSAMPCLKTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkTimebaseRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkTimebaseRate',varargin{:});
