function varargout = DAQmxResetAIACExcitWireMode(varargin)
%DAQMXRESETAIACEXCITWIREMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIACExcitWireMode(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIACExcitWireMode',varargin{:});
