function varargout = DAQmxResetDigPatternStartTrigPattern(varargin)
%DAQMXRESETDIGPATTERNSTARTTRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternStartTrigPattern(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternStartTrigPattern',varargin{:});
