function varargout = DAQmxGetAIUsbXferReqSize(varargin)
%DAQMXGETAIUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIUsbXferReqSize(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIUsbXferReqSize',varargin{:});
