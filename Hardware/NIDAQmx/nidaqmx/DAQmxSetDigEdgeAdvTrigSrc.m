function varargout = DAQmxSetDigEdgeAdvTrigSrc(varargin)
%DAQMXSETDIGEDGEADVTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigEdgeAdvTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeAdvTrigSrc',varargin{:});
