function varargout = DAQmxGetDITristate(varargin)
%DAQMXGETDITRISTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDITristate(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDITristate',varargin{:});
