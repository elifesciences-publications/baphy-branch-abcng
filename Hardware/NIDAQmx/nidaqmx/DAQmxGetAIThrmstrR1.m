function varargout = DAQmxGetAIThrmstrR1(varargin)
%DAQMXGETAITHRMSTRR1 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIThrmstrR1(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmstrR1',varargin{:});
