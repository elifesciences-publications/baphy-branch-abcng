function varargout = DAQmxGetCIAngEncoderInitialAngle(varargin)
%DAQMXGETCIANGENCODERINITIALANGLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIAngEncoderInitialAngle(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIAngEncoderInitialAngle',varargin{:});
