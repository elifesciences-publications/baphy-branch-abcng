function varargout = DAQmxResetAIMax(varargin)
%DAQMXRESETAIMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIMax(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIMax',varargin{:});
