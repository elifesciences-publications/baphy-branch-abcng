function varargout = DAQmxGetWatchdogExpirTrigType(varargin)
%DAQMXGETWATCHDOGEXPIRTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetWatchdogExpirTrigType(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWatchdogExpirTrigType',varargin{:});
