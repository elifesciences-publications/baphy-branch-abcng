function varargout = DAQmxResetExportedHshkEventInterlockedAssertOnStart(varargin)
%DAQMXRESETEXPORTEDHSHKEVENTINTERLOCKEDASSERTONSTART calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedHshkEventInterlockedAssertOnStart(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedHshkEventInterlockedAssertOnStart',varargin{:});
