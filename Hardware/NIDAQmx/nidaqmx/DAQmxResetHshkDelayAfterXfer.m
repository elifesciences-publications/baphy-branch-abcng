function varargout = DAQmxResetHshkDelayAfterXfer(varargin)
%DAQMXRESETHSHKDELAYAFTERXFER calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetHshkDelayAfterXfer(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetHshkDelayAfterXfer',varargin{:});
