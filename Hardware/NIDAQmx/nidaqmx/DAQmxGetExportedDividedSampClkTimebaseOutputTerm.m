function varargout = DAQmxGetExportedDividedSampClkTimebaseOutputTerm(varargin)
%DAQMXGETEXPORTEDDIVIDEDSAMPCLKTIMEBASEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedDividedSampClkTimebaseOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedDividedSampClkTimebaseOutputTerm',varargin{:});
