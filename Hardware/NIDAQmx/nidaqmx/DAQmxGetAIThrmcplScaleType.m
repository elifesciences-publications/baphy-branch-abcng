function varargout = DAQmxGetAIThrmcplScaleType(varargin)
%DAQMXGETAITHRMCPLSCALETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIThrmcplScaleType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmcplScaleType',varargin{:});
