function varargout = DAQmxSetAIRTDType(varargin)
%DAQMXSETAIRTDTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRTDType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRTDType',varargin{:});
