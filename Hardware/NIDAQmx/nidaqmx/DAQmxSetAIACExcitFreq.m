function varargout = DAQmxSetAIACExcitFreq(varargin)
%DAQMXSETAIACEXCITFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIACExcitFreq(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIACExcitFreq',varargin{:});
