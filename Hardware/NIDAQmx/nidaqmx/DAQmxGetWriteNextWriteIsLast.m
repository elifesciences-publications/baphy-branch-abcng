function varargout = DAQmxGetWriteNextWriteIsLast(varargin)
%DAQMXGETWRITENEXTWRITEISLAST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWriteNextWriteIsLast(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteNextWriteIsLast',varargin{:});
