function varargout = DAQmxResetSyncPulseMinDelayToStart(varargin)
%DAQMXRESETSYNCPULSEMINDELAYTOSTART calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSyncPulseMinDelayToStart(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSyncPulseMinDelayToStart',varargin{:});
