function varargout = DAQmxResetExportedAdvCmpltEventDelay(varargin)
%DAQMXRESETEXPORTEDADVCMPLTEVENTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAdvCmpltEventDelay(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAdvCmpltEventDelay',varargin{:});
