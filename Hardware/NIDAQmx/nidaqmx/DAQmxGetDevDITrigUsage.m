function varargout = DAQmxGetDevDITrigUsage(varargin)
%DAQMXGETDEVDITRIGUSAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevDITrigUsage(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDITrigUsage',varargin{:});
