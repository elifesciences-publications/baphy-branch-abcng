function varargout = DAQmxGetAnlgLvlPauseTrigWhen(varargin)
%DAQMXGETANLGLVLPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgLvlPauseTrigWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgLvlPauseTrigWhen',varargin{:});
