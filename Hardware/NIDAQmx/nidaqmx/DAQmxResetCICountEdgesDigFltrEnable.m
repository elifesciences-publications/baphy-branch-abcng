function varargout = DAQmxResetCICountEdgesDigFltrEnable(varargin)
%DAQMXRESETCICOUNTEDGESDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesDigFltrEnable',varargin{:});
