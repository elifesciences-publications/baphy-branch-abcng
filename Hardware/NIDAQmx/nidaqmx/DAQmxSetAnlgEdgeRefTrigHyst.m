function varargout = DAQmxSetAnlgEdgeRefTrigHyst(varargin)
%DAQMXSETANLGEDGEREFTRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgEdgeRefTrigHyst(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeRefTrigHyst',varargin{:});
