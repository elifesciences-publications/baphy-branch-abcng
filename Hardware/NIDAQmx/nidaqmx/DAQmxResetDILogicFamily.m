function varargout = DAQmxResetDILogicFamily(varargin)
%DAQMXRESETDILOGICFAMILY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDILogicFamily(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDILogicFamily',varargin{:});
