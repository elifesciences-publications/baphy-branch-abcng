function varargout = DAQmxSetAODACOffsetVal(varargin)
%DAQMXSETAODACOFFSETVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODACOffsetVal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACOffsetVal',varargin{:});
