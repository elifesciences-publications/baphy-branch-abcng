function varargout = DAQmxGetDigEdgeStartTrigEdge(varargin)
%DAQMXGETDIGEDGESTARTTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigEdgeStartTrigEdge(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeStartTrigEdge',varargin{:});
