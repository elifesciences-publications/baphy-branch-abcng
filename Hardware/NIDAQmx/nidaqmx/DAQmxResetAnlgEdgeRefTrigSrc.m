function varargout = DAQmxResetAnlgEdgeRefTrigSrc(varargin)
%DAQMXRESETANLGEDGEREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeRefTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeRefTrigSrc',varargin{:});
