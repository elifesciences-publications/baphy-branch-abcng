function varargout = DAQmxSetup1143Cal(varargin)
%DAQMXSETUP1143CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1143Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1143Cal',varargin{:});
