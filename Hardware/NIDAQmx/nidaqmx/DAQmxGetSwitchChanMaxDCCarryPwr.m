function varargout = DAQmxGetSwitchChanMaxDCCarryPwr(varargin)
%DAQMXGETSWITCHCHANMAXDCCARRYPWR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxDCCarryPwr(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxDCCarryPwr',varargin{:});
