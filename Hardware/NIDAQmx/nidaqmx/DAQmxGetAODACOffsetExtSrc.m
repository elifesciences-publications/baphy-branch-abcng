function varargout = DAQmxGetAODACOffsetExtSrc(varargin)
%DAQMXGETAODACOFFSETEXTSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAODACOffsetExtSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACOffsetExtSrc',varargin{:});
