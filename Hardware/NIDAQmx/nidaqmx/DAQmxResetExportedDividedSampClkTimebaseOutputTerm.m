function varargout = DAQmxResetExportedDividedSampClkTimebaseOutputTerm(varargin)
%DAQMXRESETEXPORTEDDIVIDEDSAMPCLKTIMEBASEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedDividedSampClkTimebaseOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedDividedSampClkTimebaseOutputTerm',varargin{:});
