function varargout = DAQmxResetAIThrmstrR1(varargin)
%DAQMXRESETAITHRMSTRR1 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIThrmstrR1(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIThrmstrR1',varargin{:});
