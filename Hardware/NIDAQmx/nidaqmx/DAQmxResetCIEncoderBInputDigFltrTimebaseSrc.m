function varargout = DAQmxResetCIEncoderBInputDigFltrTimebaseSrc(varargin)
%DAQMXRESETCIENCODERBINPUTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderBInputDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderBInputDigFltrTimebaseSrc',varargin{:});
