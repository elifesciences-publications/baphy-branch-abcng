function varargout = DAQmxResetAIRngLow(varargin)
%DAQMXRESETAIRNGLOW calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRngLow(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRngLow',varargin{:});
