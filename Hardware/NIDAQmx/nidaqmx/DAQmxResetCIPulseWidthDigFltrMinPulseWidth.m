function varargout = DAQmxResetCIPulseWidthDigFltrMinPulseWidth(varargin)
%DAQMXRESETCIPULSEWIDTHDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPulseWidthDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPulseWidthDigFltrMinPulseWidth',varargin{:});
