function varargout = DAQmxResetAIExcitVoltageOrCurrent(varargin)
%DAQMXRESETAIEXCITVOLTAGEORCURRENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIExcitVoltageOrCurrent(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIExcitVoltageOrCurrent',varargin{:});
