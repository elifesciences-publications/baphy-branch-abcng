function varargout = DAQmxResetCITwoEdgeSepFirstTerm(varargin)
%DAQMXRESETCITWOEDGESEPFIRSTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepFirstTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepFirstTerm',varargin{:});
