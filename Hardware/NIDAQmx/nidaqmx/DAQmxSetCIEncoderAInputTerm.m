function varargout = DAQmxSetCIEncoderAInputTerm(varargin)
%DAQMXSETCIENCODERAINPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIEncoderAInputTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderAInputTerm',varargin{:});
