function varargout = DAQmxSetAIRngLow(varargin)
%DAQMXSETAIRNGLOW calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRngLow(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRngLow',varargin{:});
