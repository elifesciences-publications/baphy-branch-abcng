function varargout = DAQmxSetCOCtrTimebaseDigFltrMinPulseWidth(varargin)
%DAQMXSETCOCTRTIMEBASEDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOCtrTimebaseDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseDigFltrMinPulseWidth',varargin{:});
