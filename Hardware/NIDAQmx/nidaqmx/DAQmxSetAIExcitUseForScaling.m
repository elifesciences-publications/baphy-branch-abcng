function varargout = DAQmxSetAIExcitUseForScaling(varargin)
%DAQMXSETAIEXCITUSEFORSCALING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIExcitUseForScaling(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIExcitUseForScaling',varargin{:});
