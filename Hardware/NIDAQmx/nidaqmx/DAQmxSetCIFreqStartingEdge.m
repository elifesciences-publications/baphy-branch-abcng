function varargout = DAQmxSetCIFreqStartingEdge(varargin)
%DAQMXSETCIFREQSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqStartingEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqStartingEdge',varargin{:});
