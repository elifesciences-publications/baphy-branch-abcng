function varargout = DAQmxSetAnlgEdgeRefTrigCoupling(varargin)
%DAQMXSETANLGEDGEREFTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgEdgeRefTrigCoupling(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeRefTrigCoupling',varargin{:});
