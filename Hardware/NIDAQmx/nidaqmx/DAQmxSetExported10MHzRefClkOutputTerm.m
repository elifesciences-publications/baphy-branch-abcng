function varargout = DAQmxSetExported10MHzRefClkOutputTerm(varargin)
%DAQMXSETEXPORTED10MHZREFCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExported10MHzRefClkOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExported10MHzRefClkOutputTerm',varargin{:});
