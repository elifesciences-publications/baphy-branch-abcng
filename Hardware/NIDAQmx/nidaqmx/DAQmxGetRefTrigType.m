function varargout = DAQmxGetRefTrigType(varargin)
%DAQMXGETREFTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetRefTrigType(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRefTrigType',varargin{:});
