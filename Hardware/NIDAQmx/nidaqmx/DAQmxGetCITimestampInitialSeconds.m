function varargout = DAQmxGetCITimestampInitialSeconds(varargin)
%DAQMXGETCITIMESTAMPINITIALSECONDS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCITimestampInitialSeconds(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITimestampInitialSeconds',varargin{:});
