function varargout = DAQmxResetAODACOffsetExtSrc(varargin)
%DAQMXRESETAODACOFFSETEXTSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACOffsetExtSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACOffsetExtSrc',varargin{:});
