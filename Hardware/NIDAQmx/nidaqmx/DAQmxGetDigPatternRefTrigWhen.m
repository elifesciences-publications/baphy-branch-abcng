function varargout = DAQmxGetDigPatternRefTrigWhen(varargin)
%DAQMXGETDIGPATTERNREFTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigPatternRefTrigWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternRefTrigWhen',varargin{:});
