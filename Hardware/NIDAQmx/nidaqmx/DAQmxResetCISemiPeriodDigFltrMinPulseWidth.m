function varargout = DAQmxResetCISemiPeriodDigFltrMinPulseWidth(varargin)
%DAQMXRESETCISEMIPERIODDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCISemiPeriodDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCISemiPeriodDigFltrMinPulseWidth',varargin{:});
