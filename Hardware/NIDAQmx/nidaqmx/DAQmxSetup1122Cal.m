function varargout = DAQmxSetup1122Cal(varargin)
%DAQMXSETUP1122CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1122Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1122Cal',varargin{:});
