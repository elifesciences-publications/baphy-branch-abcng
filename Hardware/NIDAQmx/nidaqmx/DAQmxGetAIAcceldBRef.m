function varargout = DAQmxGetAIAcceldBRef(varargin)
%DAQMXGETAIACCELDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIAcceldBRef(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIAcceldBRef',varargin{:});
