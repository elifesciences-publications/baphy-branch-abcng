function varargout = DAQmxSetAISoundPressuredBRef(varargin)
%DAQMXSETAISOUNDPRESSUREDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAISoundPressuredBRef(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAISoundPressuredBRef',varargin{:});
