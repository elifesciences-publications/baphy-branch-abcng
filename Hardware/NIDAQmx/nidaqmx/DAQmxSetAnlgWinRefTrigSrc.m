function varargout = DAQmxSetAnlgWinRefTrigSrc(varargin)
%DAQMXSETANLGWINREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAnlgWinRefTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinRefTrigSrc',varargin{:});
