function varargout = DAQmxGetDevChassisModuleDevNames(varargin)
%DAQMXGETDEVCHASSISMODULEDEVNAMES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevChassisModuleDevNames(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevChassisModuleDevNames',varargin{:});
