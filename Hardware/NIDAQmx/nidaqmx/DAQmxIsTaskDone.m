function varargout = DAQmxIsTaskDone(varargin)
%DAQMXISTASKDONE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxIsTaskDone(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxIsTaskDone',varargin{:});
