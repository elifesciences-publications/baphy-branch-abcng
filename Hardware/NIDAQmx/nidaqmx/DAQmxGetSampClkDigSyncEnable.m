function varargout = DAQmxGetSampClkDigSyncEnable(varargin)
%DAQMXGETSAMPCLKDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetSampClkDigSyncEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkDigSyncEnable',varargin{:});
