function varargout = DAQmxGetPersistedTaskAllowInteractiveEditing(varargin)
%DAQMXGETPERSISTEDTASKALLOWINTERACTIVEEDITING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPersistedTaskAllowInteractiveEditing(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedTaskAllowInteractiveEditing',varargin{:});
