function varargout = DAQmxGetCICountEdgesActiveEdge(varargin)
%DAQMXGETCICOUNTEDGESACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCICountEdgesActiveEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesActiveEdge',varargin{:});
