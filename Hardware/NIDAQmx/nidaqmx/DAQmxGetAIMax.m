function varargout = DAQmxGetAIMax(varargin)
%DAQMXGETAIMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIMax(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIMax',varargin{:});
