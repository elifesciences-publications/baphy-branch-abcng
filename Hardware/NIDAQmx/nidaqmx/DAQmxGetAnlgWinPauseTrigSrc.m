function varargout = DAQmxGetAnlgWinPauseTrigSrc(varargin)
%DAQMXGETANLGWINPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetAnlgWinPauseTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinPauseTrigSrc',varargin{:});
