function varargout = DAQmxGetDevAOMaxRate(varargin)
%DAQMXGETDEVAOMAXRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevAOMaxRate(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAOMaxRate',varargin{:});
