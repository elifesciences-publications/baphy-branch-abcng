function varargout = DAQmxCreateAITempBuiltInSensorChan(varargin)
%DAQMXCREATEAITEMPBUILTINSENSORCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateAITempBuiltInSensorChan(uint32, cstring, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAITempBuiltInSensorChan',varargin{:});
