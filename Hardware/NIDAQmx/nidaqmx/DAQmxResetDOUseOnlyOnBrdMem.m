function varargout = DAQmxResetDOUseOnlyOnBrdMem(varargin)
%DAQMXRESETDOUSEONLYONBRDMEM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOUseOnlyOnBrdMem(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOUseOnlyOnBrdMem',varargin{:});
