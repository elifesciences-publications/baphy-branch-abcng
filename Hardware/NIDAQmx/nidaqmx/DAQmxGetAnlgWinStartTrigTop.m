function varargout = DAQmxGetAnlgWinStartTrigTop(varargin)
%DAQMXGETANLGWINSTARTTRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgWinStartTrigTop(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinStartTrigTop',varargin{:});
