function varargout = DAQmxSetCIEncoderDecodingType(varargin)
%DAQMXSETCIENCODERDECODINGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderDecodingType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderDecodingType',varargin{:});
