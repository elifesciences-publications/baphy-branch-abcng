function varargout = DAQmxGetSampClkTimebaseMasterTimebaseDiv(varargin)
%DAQMXGETSAMPCLKTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetSampClkTimebaseMasterTimebaseDiv(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkTimebaseMasterTimebaseDiv',varargin{:});
