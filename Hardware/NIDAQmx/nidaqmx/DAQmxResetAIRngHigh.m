function varargout = DAQmxResetAIRngHigh(varargin)
%DAQMXRESETAIRNGHIGH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRngHigh(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRngHigh',varargin{:});
