function varargout = DAQmxCreateTEDSAIThrmcplChan(varargin)
%DAQMXCREATETEDSAITHRMCPLCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateTEDSAIThrmcplChan(uint32, cstring, cstring, double, double, int32, int32, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateTEDSAIThrmcplChan',varargin{:});
