function varargout = DAQmxGetCICountEdgesDigFltrMinPulseWidth(varargin)
%DAQMXGETCICOUNTEDGESDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCICountEdgesDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesDigFltrMinPulseWidth',varargin{:});
