function varargout = DAQmxGetCITimestampUnits(varargin)
%DAQMXGETCITIMESTAMPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCITimestampUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITimestampUnits',varargin{:});
