function varargout = DAQmxGetDOLineStatesStartState(varargin)
%DAQMXGETDOLINESTATESSTARTSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDOLineStatesStartState(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOLineStatesStartState',varargin{:});
