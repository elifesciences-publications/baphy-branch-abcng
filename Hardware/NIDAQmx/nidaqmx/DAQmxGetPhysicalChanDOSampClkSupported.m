function varargout = DAQmxGetPhysicalChanDOSampClkSupported(varargin)
%DAQMXGETPHYSICALCHANDOSAMPCLKSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanDOSampClkSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanDOSampClkSupported',varargin{:});
