function varargout = DAQmxCreateDIChan(varargin)
%DAQMXCREATEDICHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateDIChan(uint32, cstring, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateDIChan',varargin{:});
