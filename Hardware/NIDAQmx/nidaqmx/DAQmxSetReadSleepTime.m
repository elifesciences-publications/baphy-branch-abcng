function varargout = DAQmxSetReadSleepTime(varargin)
%DAQMXSETREADSLEEPTIME calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetReadSleepTime(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadSleepTime',varargin{:});
