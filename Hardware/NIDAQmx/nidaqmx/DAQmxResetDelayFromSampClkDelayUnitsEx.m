function varargout = DAQmxResetDelayFromSampClkDelayUnitsEx(varargin)
%DAQMXRESETDELAYFROMSAMPCLKDELAYUNITSEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDelayFromSampClkDelayUnitsEx(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDelayFromSampClkDelayUnitsEx',varargin{:});
