function varargout = DAQmxGetDevAICouplings(varargin)
%DAQMXGETDEVAICOUPLINGS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevAICouplings(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAICouplings',varargin{:});
