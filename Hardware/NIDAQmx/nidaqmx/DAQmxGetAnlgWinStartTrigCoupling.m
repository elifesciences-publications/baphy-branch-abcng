function varargout = DAQmxGetAnlgWinStartTrigCoupling(varargin)
%DAQMXGETANLGWINSTARTTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgWinStartTrigCoupling(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinStartTrigCoupling',varargin{:});
