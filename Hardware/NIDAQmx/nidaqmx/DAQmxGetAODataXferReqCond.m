function varargout = DAQmxGetAODataXferReqCond(varargin)
%DAQMXGETAODATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAODataXferReqCond(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODataXferReqCond',varargin{:});
