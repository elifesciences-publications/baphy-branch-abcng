function varargout = DAQmxSetDOInvertLines(varargin)
%DAQMXSETDOINVERTLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOInvertLines(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOInvertLines',varargin{:});
