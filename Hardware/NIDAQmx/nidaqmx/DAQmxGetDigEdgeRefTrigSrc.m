function varargout = DAQmxGetDigEdgeRefTrigSrc(varargin)
%DAQMXGETDIGEDGEREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigEdgeRefTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeRefTrigSrc',varargin{:});
