function varargout = DAQmxSetAIAccelUnits(varargin)
%DAQMXSETAIACCELUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIAccelUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIAccelUnits',varargin{:});
