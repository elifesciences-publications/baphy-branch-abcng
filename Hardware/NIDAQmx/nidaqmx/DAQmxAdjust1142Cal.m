function varargout = DAQmxAdjust1142Cal(varargin)
%DAQMXADJUST1142CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1142Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1142Cal',varargin{:});
