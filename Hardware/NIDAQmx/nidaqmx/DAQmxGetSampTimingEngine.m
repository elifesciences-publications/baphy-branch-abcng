function varargout = DAQmxGetSampTimingEngine(varargin)
%DAQMXGETSAMPTIMINGENGINE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetSampTimingEngine(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampTimingEngine',varargin{:});
