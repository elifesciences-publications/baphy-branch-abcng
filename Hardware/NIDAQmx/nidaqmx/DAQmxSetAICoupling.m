function varargout = DAQmxSetAICoupling(varargin)
%DAQMXSETAICOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAICoupling(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAICoupling',varargin{:});
