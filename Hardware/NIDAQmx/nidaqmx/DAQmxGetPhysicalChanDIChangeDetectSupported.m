function varargout = DAQmxGetPhysicalChanDIChangeDetectSupported(varargin)
%DAQMXGETPHYSICALCHANDICHANGEDETECTSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanDIChangeDetectSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanDIChangeDetectSupported',varargin{:});
