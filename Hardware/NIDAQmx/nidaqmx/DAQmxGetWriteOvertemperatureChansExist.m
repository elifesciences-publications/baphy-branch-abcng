function varargout = DAQmxGetWriteOvertemperatureChansExist(varargin)
%DAQMXGETWRITEOVERTEMPERATURECHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWriteOvertemperatureChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteOvertemperatureChansExist',varargin{:});
