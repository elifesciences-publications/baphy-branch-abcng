function varargout = DAQmxSetAIRTDB(varargin)
%DAQMXSETAIRTDB calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRTDB(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRTDB',varargin{:});
