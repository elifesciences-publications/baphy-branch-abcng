function varargout = DAQmxResetExportedSampClkDelayOffset(varargin)
%DAQMXRESETEXPORTEDSAMPCLKDELAYOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedSampClkDelayOffset(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedSampClkDelayOffset',varargin{:});
