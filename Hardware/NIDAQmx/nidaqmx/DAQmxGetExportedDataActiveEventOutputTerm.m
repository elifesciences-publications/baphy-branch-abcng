function varargout = DAQmxGetExportedDataActiveEventOutputTerm(varargin)
%DAQMXGETEXPORTEDDATAACTIVEEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedDataActiveEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedDataActiveEventOutputTerm',varargin{:});
