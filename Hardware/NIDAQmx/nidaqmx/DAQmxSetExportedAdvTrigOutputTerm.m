function varargout = DAQmxSetExportedAdvTrigOutputTerm(varargin)
%DAQMXSETEXPORTEDADVTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedAdvTrigOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAdvTrigOutputTerm',varargin{:});
