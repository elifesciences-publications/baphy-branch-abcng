function varargout = DAQmxSetCIEncoderBInputDigFltrTimebaseRate(varargin)
%DAQMXSETCIENCODERBINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderBInputDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderBInputDigFltrTimebaseRate',varargin{:});
