function varargout = DAQmxGetCICountEdgesDigFltrTimebaseSrc(varargin)
%DAQMXGETCICOUNTEDGESDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCICountEdgesDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesDigFltrTimebaseSrc',varargin{:});
