function varargout = DAQmxResetSampClkUnderflowBehavior(varargin)
%DAQMXRESETSAMPCLKUNDERFLOWBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkUnderflowBehavior(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkUnderflowBehavior',varargin{:});
