function varargout = DAQmxResetAnlgWinStartTrigBtm(varargin)
%DAQMXRESETANLGWINSTARTTRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinStartTrigBtm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinStartTrigBtm',varargin{:});
