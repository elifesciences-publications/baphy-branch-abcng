function varargout = DAQmxChangeExtCalPassword(varargin)
%DAQMXCHANGEEXTCALPASSWORD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxChangeExtCalPassword(cstring, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxChangeExtCalPassword',varargin{:});
