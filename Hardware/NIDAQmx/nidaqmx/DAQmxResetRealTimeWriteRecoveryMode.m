function varargout = DAQmxResetRealTimeWriteRecoveryMode(varargin)
%DAQMXRESETREALTIMEWRITERECOVERYMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRealTimeWriteRecoveryMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRealTimeWriteRecoveryMode',varargin{:});
