function varargout = DAQmxSetDigEdgeArmStartTrigDigFltrTimebaseRate(varargin)
%DAQMXSETDIGEDGEARMSTARTTRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeArmStartTrigDigFltrTimebaseRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeArmStartTrigDigFltrTimebaseRate',varargin{:});
