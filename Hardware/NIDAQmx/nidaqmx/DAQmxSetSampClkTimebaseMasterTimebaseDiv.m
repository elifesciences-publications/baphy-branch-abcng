function varargout = DAQmxSetSampClkTimebaseMasterTimebaseDiv(varargin)
%DAQMXSETSAMPCLKTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkTimebaseMasterTimebaseDiv(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkTimebaseMasterTimebaseDiv',varargin{:});
