function varargout = DAQmxSetExportedCtrOutEventOutputTerm(varargin)
%DAQMXSETEXPORTEDCTROUTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedCtrOutEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedCtrOutEventOutputTerm',varargin{:});
