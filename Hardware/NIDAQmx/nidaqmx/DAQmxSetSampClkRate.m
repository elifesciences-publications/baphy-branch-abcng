function varargout = DAQmxSetSampClkRate(varargin)
%DAQMXSETSAMPCLKRATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkRate',varargin{:});
