function varargout = DAQmxResetCISemiPeriodUnits(varargin)
%DAQMXRESETCISEMIPERIODUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCISemiPeriodUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCISemiPeriodUnits',varargin{:});
