function varargout = DAQmxGetDevProductType(varargin)
%DAQMXGETDEVPRODUCTTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevProductType(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevProductType',varargin{:});
