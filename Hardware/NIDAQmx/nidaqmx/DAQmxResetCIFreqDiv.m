function varargout = DAQmxResetCIFreqDiv(varargin)
%DAQMXRESETCIFREQDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqDiv(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqDiv',varargin{:});
