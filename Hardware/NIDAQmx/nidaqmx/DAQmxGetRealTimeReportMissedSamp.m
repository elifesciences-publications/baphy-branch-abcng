function varargout = DAQmxGetRealTimeReportMissedSamp(varargin)
%DAQMXGETREALTIMEREPORTMISSEDSAMP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetRealTimeReportMissedSamp(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRealTimeReportMissedSamp',varargin{:});
