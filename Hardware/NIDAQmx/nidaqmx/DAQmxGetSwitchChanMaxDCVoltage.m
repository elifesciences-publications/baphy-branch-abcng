function varargout = DAQmxGetSwitchChanMaxDCVoltage(varargin)
%DAQMXGETSWITCHCHANMAXDCVOLTAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxDCVoltage(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxDCVoltage',varargin{:});
