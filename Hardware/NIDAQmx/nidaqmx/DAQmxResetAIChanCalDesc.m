function varargout = DAQmxResetAIChanCalDesc(varargin)
%DAQMXRESETAICHANCALDESC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalDesc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalDesc',varargin{:});
