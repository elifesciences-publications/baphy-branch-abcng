function varargout = DAQmxSetDOLineStatesStartState(varargin)
%DAQMXSETDOLINESTATESSTARTSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOLineStatesStartState(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOLineStatesStartState',varargin{:});
