function varargout = DAQmxGetDigEdgeWatchdogExpirTrigSrc(varargin)
%DAQMXGETDIGEDGEWATCHDOGEXPIRTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigEdgeWatchdogExpirTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeWatchdogExpirTrigSrc',varargin{:});
