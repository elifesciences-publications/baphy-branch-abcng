function varargout = DAQmxGetScaleScaledUnits(varargin)
%DAQMXGETSCALESCALEDUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetScaleScaledUnits(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleScaledUnits',varargin{:});
