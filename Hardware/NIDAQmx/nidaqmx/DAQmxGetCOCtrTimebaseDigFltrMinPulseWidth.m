function varargout = DAQmxGetCOCtrTimebaseDigFltrMinPulseWidth(varargin)
%DAQMXGETCOCTRTIMEBASEDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOCtrTimebaseDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseDigFltrMinPulseWidth',varargin{:});
