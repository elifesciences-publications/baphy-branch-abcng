function varargout = DAQmxGetDevCITrigUsage(varargin)
%DAQMXGETDEVCITRIGUSAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevCITrigUsage(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCITrigUsage',varargin{:});
