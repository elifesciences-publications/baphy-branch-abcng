function varargout = DAQmxResetAIBridgeShuntCalSelect(varargin)
%DAQMXRESETAIBRIDGESHUNTCALSELECT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIBridgeShuntCalSelect(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIBridgeShuntCalSelect',varargin{:});
