function varargout = DAQmxResetHshkStartCond(varargin)
%DAQMXRESETHSHKSTARTCOND calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetHshkStartCond(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetHshkStartCond',varargin{:});
