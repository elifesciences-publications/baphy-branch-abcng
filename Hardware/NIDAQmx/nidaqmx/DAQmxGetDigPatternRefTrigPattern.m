function varargout = DAQmxGetDigPatternRefTrigPattern(varargin)
%DAQMXGETDIGPATTERNREFTRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigPatternRefTrigPattern(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternRefTrigPattern',varargin{:});
