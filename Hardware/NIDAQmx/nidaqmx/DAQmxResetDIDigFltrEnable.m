function varargout = DAQmxResetDIDigFltrEnable(varargin)
%DAQMXRESETDIDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDIDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDIDigFltrEnable',varargin{:});
