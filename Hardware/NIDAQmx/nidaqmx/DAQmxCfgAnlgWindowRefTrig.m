function varargout = DAQmxCfgAnlgWindowRefTrig(varargin)
%DAQMXCFGANLGWINDOWREFTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgAnlgWindowRefTrig(uint32, cstring, int32, double, double, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgAnlgWindowRefTrig',varargin{:});
