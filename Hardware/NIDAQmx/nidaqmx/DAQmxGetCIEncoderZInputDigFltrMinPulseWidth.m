function varargout = DAQmxGetCIEncoderZInputDigFltrMinPulseWidth(varargin)
%DAQMXGETCIENCODERZINPUTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIEncoderZInputDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderZInputDigFltrMinPulseWidth',varargin{:});
