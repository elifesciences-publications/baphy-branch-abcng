function varargout = DAQmxCreateCICountEdgesChan(varargin)
%DAQMXCREATECICOUNTEDGESCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateCICountEdgesChan(uint32, cstring, cstring, int32, uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCICountEdgesChan',varargin{:});
