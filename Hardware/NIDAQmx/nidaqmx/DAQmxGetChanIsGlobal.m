function varargout = DAQmxGetChanIsGlobal(varargin)
%DAQMXGETCHANISGLOBAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetChanIsGlobal(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetChanIsGlobal',varargin{:});
