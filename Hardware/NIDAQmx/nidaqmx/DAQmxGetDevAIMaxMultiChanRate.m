function varargout = DAQmxGetDevAIMaxMultiChanRate(varargin)
%DAQMXGETDEVAIMAXMULTICHANRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevAIMaxMultiChanRate(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAIMaxMultiChanRate',varargin{:});
