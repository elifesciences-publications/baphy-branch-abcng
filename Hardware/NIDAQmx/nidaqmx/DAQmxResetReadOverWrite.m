function varargout = DAQmxResetReadOverWrite(varargin)
%DAQMXRESETREADOVERWRITE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadOverWrite(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadOverWrite',varargin{:});
