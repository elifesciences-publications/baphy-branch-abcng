function varargout = DAQmxResetAnlgWinRefTrigTop(varargin)
%DAQMXRESETANLGWINREFTRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinRefTrigTop(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinRefTrigTop',varargin{:});
