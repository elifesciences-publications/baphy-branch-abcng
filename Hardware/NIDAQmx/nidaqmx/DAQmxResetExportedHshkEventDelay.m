function varargout = DAQmxResetExportedHshkEventDelay(varargin)
%DAQMXRESETEXPORTEDHSHKEVENTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedHshkEventDelay(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedHshkEventDelay',varargin{:});
