function varargout = DAQmxResetCITwoEdgeSepSecondDigSyncEnable(varargin)
%DAQMXRESETCITWOEDGESEPSECONDDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepSecondDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepSecondDigSyncEnable',varargin{:});
