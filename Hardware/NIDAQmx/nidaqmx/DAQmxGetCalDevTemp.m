function varargout = DAQmxGetCalDevTemp(varargin)
%DAQMXGETCALDEVTEMP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCalDevTemp(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCalDevTemp',varargin{:});
