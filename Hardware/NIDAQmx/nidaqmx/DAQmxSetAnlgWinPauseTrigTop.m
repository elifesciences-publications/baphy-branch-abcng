function varargout = DAQmxSetAnlgWinPauseTrigTop(varargin)
%DAQMXSETANLGWINPAUSETRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinPauseTrigTop(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinPauseTrigTop',varargin{:});
