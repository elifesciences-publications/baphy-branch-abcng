function varargout = DAQmxGetSwitchScanAttribute(varargin)
%DAQMXGETSWITCHSCANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxGetSwitchScanAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchScanAttribute',varargin{:});
