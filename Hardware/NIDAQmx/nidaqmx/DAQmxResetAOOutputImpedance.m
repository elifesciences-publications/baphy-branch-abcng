function varargout = DAQmxResetAOOutputImpedance(varargin)
%DAQMXRESETAOOUTPUTIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOOutputImpedance(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOOutputImpedance',varargin{:});
