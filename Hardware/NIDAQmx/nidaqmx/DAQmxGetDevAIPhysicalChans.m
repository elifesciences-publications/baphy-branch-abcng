function varargout = DAQmxGetDevAIPhysicalChans(varargin)
%DAQMXGETDEVAIPHYSICALCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevAIPhysicalChans(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAIPhysicalChans',varargin{:});
