function varargout = DAQmxResetCOPulseTimeInitialDelay(varargin)
%DAQMXRESETCOPULSETIMEINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseTimeInitialDelay(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseTimeInitialDelay',varargin{:});
