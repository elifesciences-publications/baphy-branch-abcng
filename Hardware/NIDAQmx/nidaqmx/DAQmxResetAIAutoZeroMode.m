function varargout = DAQmxResetAIAutoZeroMode(varargin)
%DAQMXRESETAIAUTOZEROMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIAutoZeroMode(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIAutoZeroMode',varargin{:});
