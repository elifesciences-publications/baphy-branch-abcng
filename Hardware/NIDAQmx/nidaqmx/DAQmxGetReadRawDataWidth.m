function varargout = DAQmxGetReadRawDataWidth(varargin)
%DAQMXGETREADRAWDATAWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadRawDataWidth(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadRawDataWidth',varargin{:});
