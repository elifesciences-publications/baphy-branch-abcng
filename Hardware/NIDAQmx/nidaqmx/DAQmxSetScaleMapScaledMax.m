function varargout = DAQmxSetScaleMapScaledMax(varargin)
%DAQMXSETSCALEMAPSCALEDMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetScaleMapScaledMax(cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleMapScaledMax',varargin{:});
