function varargout = DAQmxGetBufferAttribute(varargin)
%DAQMXGETBUFFERATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxGetBufferAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetBufferAttribute',varargin{:});
