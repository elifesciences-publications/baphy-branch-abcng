function varargout = DAQmxGetExportedSampClkTimebaseOutputTerm(varargin)
%DAQMXGETEXPORTEDSAMPCLKTIMEBASEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedSampClkTimebaseOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedSampClkTimebaseOutputTerm',varargin{:});
