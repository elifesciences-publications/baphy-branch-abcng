function varargout = DAQmxSetAIFreqUnits(varargin)
%DAQMXSETAIFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIFreqUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIFreqUnits',varargin{:});
