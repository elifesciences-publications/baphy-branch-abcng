function varargout = DAQmxResetAIVoltagedBRef(varargin)
%DAQMXRESETAIVOLTAGEDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIVoltagedBRef(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIVoltagedBRef',varargin{:});
