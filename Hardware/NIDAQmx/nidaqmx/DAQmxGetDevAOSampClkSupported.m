function varargout = DAQmxGetDevAOSampClkSupported(varargin)
%DAQMXGETDEVAOSAMPCLKSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevAOSampClkSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAOSampClkSupported',varargin{:});
