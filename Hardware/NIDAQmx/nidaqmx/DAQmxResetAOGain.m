function varargout = DAQmxResetAOGain(varargin)
%DAQMXRESETAOGAIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOGain(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOGain',varargin{:});
