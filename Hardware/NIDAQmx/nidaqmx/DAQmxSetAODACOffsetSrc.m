function varargout = DAQmxSetAODACOffsetSrc(varargin)
%DAQMXSETAODACOFFSETSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODACOffsetSrc(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACOffsetSrc',varargin{:});
