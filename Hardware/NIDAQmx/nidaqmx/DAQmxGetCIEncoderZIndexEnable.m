function varargout = DAQmxGetCIEncoderZIndexEnable(varargin)
%DAQMXGETCIENCODERZINDEXENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIEncoderZIndexEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderZIndexEnable',varargin{:});
