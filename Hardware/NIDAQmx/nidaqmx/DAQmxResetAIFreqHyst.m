function varargout = DAQmxResetAIFreqHyst(varargin)
%DAQMXRESETAIFREQHYST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIFreqHyst(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIFreqHyst',varargin{:});
