function varargout = DAQmxResetExportedSampClkOutputBehavior(varargin)
%DAQMXRESETEXPORTEDSAMPCLKOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedSampClkOutputBehavior(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedSampClkOutputBehavior',varargin{:});
