function varargout = DAQmxResetCICountEdgesInitialCnt(varargin)
%DAQMXRESETCICOUNTEDGESINITIALCNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesInitialCnt(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesInitialCnt',varargin{:});
