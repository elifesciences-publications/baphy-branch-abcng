function varargout = DAQmxSetCICountEdgesActiveEdge(varargin)
%DAQMXSETCICOUNTEDGESACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesActiveEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesActiveEdge',varargin{:});
