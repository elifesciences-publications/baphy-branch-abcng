function varargout = DAQmxGetSysDevNames(varargin)
%DAQMXGETSYSDEVNAMES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetSysDevNames(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSysDevNames',varargin{:});
