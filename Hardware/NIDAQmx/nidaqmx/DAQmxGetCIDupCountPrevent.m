function varargout = DAQmxGetCIDupCountPrevent(varargin)
%DAQMXGETCIDUPCOUNTPREVENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIDupCountPrevent(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIDupCountPrevent',varargin{:});
