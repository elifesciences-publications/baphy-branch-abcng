function varargout = DAQmxSetCITwoEdgeSepFirstDigFltrMinPulseWidth(varargin)
%DAQMXSETCITWOEDGESEPFIRSTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepFirstDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepFirstDigFltrMinPulseWidth',varargin{:});
