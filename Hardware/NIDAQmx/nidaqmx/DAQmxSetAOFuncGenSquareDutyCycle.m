function varargout = DAQmxSetAOFuncGenSquareDutyCycle(varargin)
%DAQMXSETAOFUNCGENSQUAREDUTYCYCLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOFuncGenSquareDutyCycle(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOFuncGenSquareDutyCycle',varargin{:});
