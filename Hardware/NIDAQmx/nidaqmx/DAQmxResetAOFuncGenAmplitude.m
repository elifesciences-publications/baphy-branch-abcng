function varargout = DAQmxResetAOFuncGenAmplitude(varargin)
%DAQMXRESETAOFUNCGENAMPLITUDE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOFuncGenAmplitude(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOFuncGenAmplitude',varargin{:});
