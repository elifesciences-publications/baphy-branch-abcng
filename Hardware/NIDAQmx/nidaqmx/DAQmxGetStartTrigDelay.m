function varargout = DAQmxGetStartTrigDelay(varargin)
%DAQMXGETSTARTTRIGDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetStartTrigDelay(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetStartTrigDelay',varargin{:});
