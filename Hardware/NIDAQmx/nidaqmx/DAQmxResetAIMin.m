function varargout = DAQmxResetAIMin(varargin)
%DAQMXRESETAIMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIMin(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIMin',varargin{:});
