function varargout = DAQmxGetExportedHshkEventInterlockedDeassertDelay(varargin)
%DAQMXGETEXPORTEDHSHKEVENTINTERLOCKEDDEASSERTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetExportedHshkEventInterlockedDeassertDelay(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedHshkEventInterlockedDeassertDelay',varargin{:});
