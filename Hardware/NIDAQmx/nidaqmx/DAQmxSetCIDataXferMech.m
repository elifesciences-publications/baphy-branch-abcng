function varargout = DAQmxSetCIDataXferMech(varargin)
%DAQMXSETCIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIDataXferMech(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIDataXferMech',varargin{:});
