function varargout = DAQmxGetAIConvTimebaseSrcEx(varargin)
%DAQMXGETAICONVTIMEBASESRCEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIConvTimebaseSrcEx(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvTimebaseSrcEx',varargin{:});
