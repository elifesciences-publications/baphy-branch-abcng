function varargout = DAQmxSetRealTimeAttribute(varargin)
%DAQMXSETREALTIMEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxSetRealTimeAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRealTimeAttribute',varargin{:});
