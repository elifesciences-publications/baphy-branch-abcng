function varargout = DAQmxSetAnlgWinRefTrigCoupling(varargin)
%DAQMXSETANLGWINREFTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinRefTrigCoupling(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinRefTrigCoupling',varargin{:});
