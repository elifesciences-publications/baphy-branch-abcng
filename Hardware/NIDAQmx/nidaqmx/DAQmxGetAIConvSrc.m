function varargout = DAQmxGetAIConvSrc(varargin)
%DAQMXGETAICONVSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetAIConvSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvSrc',varargin{:});
