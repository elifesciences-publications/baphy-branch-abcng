function varargout = DAQmxGetAIStrainUnits(varargin)
%DAQMXGETAISTRAINUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIStrainUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIStrainUnits',varargin{:});
