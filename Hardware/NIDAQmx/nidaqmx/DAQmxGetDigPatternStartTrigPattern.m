function varargout = DAQmxGetDigPatternStartTrigPattern(varargin)
%DAQMXGETDIGPATTERNSTARTTRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigPatternStartTrigPattern(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternStartTrigPattern',varargin{:});
