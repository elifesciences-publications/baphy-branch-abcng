function varargout = DAQmxGetCICountEdgesDirTerm(varargin)
%DAQMXGETCICOUNTEDGESDIRTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCICountEdgesDirTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesDirTerm',varargin{:});
