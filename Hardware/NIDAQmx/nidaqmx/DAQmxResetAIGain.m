function varargout = DAQmxResetAIGain(varargin)
%DAQMXRESETAIGAIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIGain(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIGain',varargin{:});
