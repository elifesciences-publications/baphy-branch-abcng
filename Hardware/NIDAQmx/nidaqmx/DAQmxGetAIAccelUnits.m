function varargout = DAQmxGetAIAccelUnits(varargin)
%DAQMXGETAIACCELUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIAccelUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIAccelUnits',varargin{:});
