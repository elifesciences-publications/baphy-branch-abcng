function varargout = DAQmxGetExported10MHzRefClkOutputTerm(varargin)
%DAQMXGETEXPORTED10MHZREFCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExported10MHzRefClkOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExported10MHzRefClkOutputTerm',varargin{:});
