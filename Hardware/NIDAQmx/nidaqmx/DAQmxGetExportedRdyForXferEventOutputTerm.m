function varargout = DAQmxGetExportedRdyForXferEventOutputTerm(varargin)
%DAQMXGETEXPORTEDRDYFORXFEREVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedRdyForXferEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedRdyForXferEventOutputTerm',varargin{:});
