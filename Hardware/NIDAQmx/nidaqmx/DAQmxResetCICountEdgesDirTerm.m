function varargout = DAQmxResetCICountEdgesDirTerm(varargin)
%DAQMXRESETCICOUNTEDGESDIRTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesDirTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesDirTerm',varargin{:});
