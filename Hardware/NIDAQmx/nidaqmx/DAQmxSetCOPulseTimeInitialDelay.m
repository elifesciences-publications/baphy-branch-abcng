function varargout = DAQmxSetCOPulseTimeInitialDelay(varargin)
%DAQMXSETCOPULSETIMEINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseTimeInitialDelay(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseTimeInitialDelay',varargin{:});
