function varargout = DAQmxResetExportedRdyForStartEventLvlActiveLvl(varargin)
%DAQMXRESETEXPORTEDRDYFORSTARTEVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedRdyForStartEventLvlActiveLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedRdyForStartEventLvlActiveLvl',varargin{:});
