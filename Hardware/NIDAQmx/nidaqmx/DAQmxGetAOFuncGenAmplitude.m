function varargout = DAQmxGetAOFuncGenAmplitude(varargin)
%DAQMXGETAOFUNCGENAMPLITUDE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOFuncGenAmplitude(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOFuncGenAmplitude',varargin{:});
