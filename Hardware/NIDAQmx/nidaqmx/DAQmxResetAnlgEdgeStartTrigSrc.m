function varargout = DAQmxResetAnlgEdgeStartTrigSrc(varargin)
%DAQMXRESETANLGEDGESTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeStartTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeStartTrigSrc',varargin{:});
