function varargout = DAQmxSetDITristate(varargin)
%DAQMXSETDITRISTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDITristate(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDITristate',varargin{:});
