function varargout = DAQmxSetSwitchDevAutoConnAnlgBus(varargin)
%DAQMXSETSWITCHDEVAUTOCONNANLGBUS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetSwitchDevAutoConnAnlgBus(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSwitchDevAutoConnAnlgBus',varargin{:});
