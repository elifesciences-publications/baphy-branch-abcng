function varargout = DAQmxResetCIMin(varargin)
%DAQMXRESETCIMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIMin(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIMin',varargin{:});
