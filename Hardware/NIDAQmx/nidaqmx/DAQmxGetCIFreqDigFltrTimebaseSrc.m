function varargout = DAQmxGetCIFreqDigFltrTimebaseSrc(varargin)
%DAQMXGETCIFREQDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIFreqDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqDigFltrTimebaseSrc',varargin{:});
