function varargout = DAQmxGetDIInvertLines(varargin)
%DAQMXGETDIINVERTLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDIInvertLines(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDIInvertLines',varargin{:});
