function varargout = DAQmxGetCOPulseHighTicks(varargin)
%DAQMXGETCOPULSEHIGHTICKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOPulseHighTicks(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseHighTicks',varargin{:});
