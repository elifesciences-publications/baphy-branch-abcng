function varargout = DAQmxGetSwitchDevSwitchChanList(varargin)
%DAQMXGETSWITCHDEVSWITCHCHANLIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetSwitchDevSwitchChanList(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevSwitchChanList',varargin{:});
