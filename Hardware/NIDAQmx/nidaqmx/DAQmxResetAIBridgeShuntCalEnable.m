function varargout = DAQmxResetAIBridgeShuntCalEnable(varargin)
%DAQMXRESETAIBRIDGESHUNTCALENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIBridgeShuntCalEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIBridgeShuntCalEnable',varargin{:});
