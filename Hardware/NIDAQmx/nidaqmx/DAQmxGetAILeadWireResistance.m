function varargout = DAQmxGetAILeadWireResistance(varargin)
%DAQMXGETAILEADWIRERESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAILeadWireResistance(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILeadWireResistance',varargin{:});
