function varargout = DAQmxSetCICountEdgesDigSyncEnable(varargin)
%DAQMXSETCICOUNTEDGESDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesDigSyncEnable',varargin{:});
