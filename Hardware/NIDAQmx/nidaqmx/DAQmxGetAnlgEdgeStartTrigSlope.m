function varargout = DAQmxGetAnlgEdgeStartTrigSlope(varargin)
%DAQMXGETANLGEDGESTARTTRIGSLOPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgEdgeStartTrigSlope(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeStartTrigSlope',varargin{:});
