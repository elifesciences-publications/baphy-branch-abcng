function varargout = DAQmxGetCICountEdgesCountDirDigFltrEnable(varargin)
%DAQMXGETCICOUNTEDGESCOUNTDIRDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCICountEdgesCountDirDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesCountDirDigFltrEnable',varargin{:});
