function varargout = DAQmxCfgBurstHandshakingTimingExportClock(varargin)
%DAQMXCFGBURSTHANDSHAKINGTIMINGEXPORTCLOCK calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgBurstHandshakingTimingExportClock(uint32, int32, uint64, double, cstring, int32, int32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgBurstHandshakingTimingExportClock',varargin{:});
