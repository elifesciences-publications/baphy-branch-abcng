function varargout = DAQmxReadCounterScalarU32(varargin)
%DAQMXREADCOUNTERSCALARU32 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr, uint32Ptr] DAQmxReadCounterScalarU32(uint32, double, uint32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadCounterScalarU32',varargin{:});
