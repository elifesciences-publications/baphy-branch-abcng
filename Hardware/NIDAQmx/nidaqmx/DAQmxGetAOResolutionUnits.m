function varargout = DAQmxGetAOResolutionUnits(varargin)
%DAQMXGETAORESOLUTIONUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAOResolutionUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOResolutionUnits',varargin{:});
