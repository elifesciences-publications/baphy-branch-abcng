function varargout = DAQmxGetScaleLinSlope(varargin)
%DAQMXGETSCALELINSLOPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetScaleLinSlope(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleLinSlope',varargin{:});
