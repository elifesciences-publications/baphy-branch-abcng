function varargout = DAQmxGetReadOpenThrmcplChans(varargin)
%DAQMXGETREADOPENTHRMCPLCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetReadOpenThrmcplChans(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOpenThrmcplChans',varargin{:});
