function varargout = DAQmxSetDigPatternStartTrigWhen(varargin)
%DAQMXSETDIGPATTERNSTARTTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigPatternStartTrigWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternStartTrigWhen',varargin{:});
