function varargout = DAQmxSetAILowpassSwitchCapClkSrc(varargin)
%DAQMXSETAILOWPASSSWITCHCAPCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILowpassSwitchCapClkSrc(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILowpassSwitchCapClkSrc',varargin{:});
