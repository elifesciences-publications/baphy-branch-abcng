function varargout = DAQmxSetAIRVDTUnits(varargin)
%DAQMXSETAIRVDTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRVDTUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRVDTUnits',varargin{:});
