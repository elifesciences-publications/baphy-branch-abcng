function varargout = DAQmxGetDeviceAttribute(varargin)
%DAQMXGETDEVICEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetDeviceAttribute(cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDeviceAttribute',varargin{:});
