function varargout = DAQmxGetWriteOpenCurrentLoopChansExist(varargin)
%DAQMXGETWRITEOPENCURRENTLOOPCHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWriteOpenCurrentLoopChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteOpenCurrentLoopChansExist',varargin{:});
