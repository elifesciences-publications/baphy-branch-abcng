function varargout = DAQmxResetExportedAIConvClkOutputTerm(varargin)
%DAQMXRESETEXPORTEDAICONVCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAIConvClkOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAIConvClkOutputTerm',varargin{:});
