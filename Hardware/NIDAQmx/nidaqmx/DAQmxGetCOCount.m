function varargout = DAQmxGetCOCount(varargin)
%DAQMXGETCOCOUNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOCount(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCount',varargin{:});
