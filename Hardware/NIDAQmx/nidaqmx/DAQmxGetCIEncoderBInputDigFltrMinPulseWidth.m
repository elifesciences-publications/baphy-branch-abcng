function varargout = DAQmxGetCIEncoderBInputDigFltrMinPulseWidth(varargin)
%DAQMXGETCIENCODERBINPUTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIEncoderBInputDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderBInputDigFltrMinPulseWidth',varargin{:});
