function varargout = DAQmxCreateAIPosLVDTChan(varargin)
%DAQMXCREATEAIPOSLVDTCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAIPosLVDTChan(uint32, cstring, cstring, double, double, int32, double, int32, int32, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIPosLVDTChan',varargin{:});
