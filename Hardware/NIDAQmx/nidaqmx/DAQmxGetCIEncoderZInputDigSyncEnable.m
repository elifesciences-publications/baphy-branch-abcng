function varargout = DAQmxGetCIEncoderZInputDigSyncEnable(varargin)
%DAQMXGETCIENCODERZINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIEncoderZInputDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderZInputDigSyncEnable',varargin{:});
