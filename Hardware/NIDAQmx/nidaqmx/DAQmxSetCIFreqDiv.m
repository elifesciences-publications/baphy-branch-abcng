function varargout = DAQmxSetCIFreqDiv(varargin)
%DAQMXSETCIFREQDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqDiv(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqDiv',varargin{:});
