function varargout = DAQmxSetCOPulseTimeUnits(varargin)
%DAQMXSETCOPULSETIMEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseTimeUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseTimeUnits',varargin{:});
