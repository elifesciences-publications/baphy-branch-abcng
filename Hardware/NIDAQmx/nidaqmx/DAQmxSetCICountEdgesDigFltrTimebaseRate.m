function varargout = DAQmxSetCICountEdgesDigFltrTimebaseRate(varargin)
%DAQMXSETCICOUNTEDGESDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesDigFltrTimebaseRate',varargin{:});
