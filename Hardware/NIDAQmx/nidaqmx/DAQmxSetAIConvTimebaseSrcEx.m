function varargout = DAQmxSetAIConvTimebaseSrcEx(varargin)
%DAQMXSETAICONVTIMEBASESRCEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIConvTimebaseSrcEx(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvTimebaseSrcEx',varargin{:});
