function varargout = DAQmxConfigureTEDS(varargin)
%DAQMXCONFIGURETEDS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxConfigureTEDS(cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxConfigureTEDS',varargin{:});
