function varargout = DAQmxGetDevCOMaxTimebase(varargin)
%DAQMXGETDEVCOMAXTIMEBASE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevCOMaxTimebase(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCOMaxTimebase',varargin{:});
