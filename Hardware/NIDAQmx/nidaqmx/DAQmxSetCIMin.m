function varargout = DAQmxSetCIMin(varargin)
%DAQMXSETCIMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIMin(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIMin',varargin{:});
