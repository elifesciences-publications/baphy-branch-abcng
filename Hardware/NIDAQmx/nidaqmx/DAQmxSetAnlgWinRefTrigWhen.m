function varargout = DAQmxSetAnlgWinRefTrigWhen(varargin)
%DAQMXSETANLGWINREFTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinRefTrigWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinRefTrigWhen',varargin{:});
