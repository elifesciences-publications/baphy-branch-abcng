function varargout = DAQmxResetInterlockedHshkTrigAssertedLvl(varargin)
%DAQMXRESETINTERLOCKEDHSHKTRIGASSERTEDLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetInterlockedHshkTrigAssertedLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetInterlockedHshkTrigAssertedLvl',varargin{:});
