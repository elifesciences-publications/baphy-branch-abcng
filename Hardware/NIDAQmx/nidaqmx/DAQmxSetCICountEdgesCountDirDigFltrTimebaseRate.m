function varargout = DAQmxSetCICountEdgesCountDirDigFltrTimebaseRate(varargin)
%DAQMXSETCICOUNTEDGESCOUNTDIRDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesCountDirDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesCountDirDigFltrTimebaseRate',varargin{:});
