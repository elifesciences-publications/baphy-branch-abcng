function varargout = DAQmxReadAnalogF64(varargin)
%DAQMXREADANALOGF64 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr, int32Ptr, uint32Ptr] DAQmxReadAnalogF64(uint32, int32, double, uint32, doublePtr, uint32, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadAnalogF64',varargin{:});
