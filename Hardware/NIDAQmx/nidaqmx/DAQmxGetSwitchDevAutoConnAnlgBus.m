function varargout = DAQmxGetSwitchDevAutoConnAnlgBus(varargin)
%DAQMXGETSWITCHDEVAUTOCONNANLGBUS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSwitchDevAutoConnAnlgBus(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevAutoConnAnlgBus',varargin{:});
