function varargout = DAQmxResetAIChanCalEnableCal(varargin)
%DAQMXRESETAICHANCALENABLECAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalEnableCal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalEnableCal',varargin{:});
