function varargout = DAQmxCreateAIThrmstrChanVex(varargin)
%DAQMXCREATEAITHRMSTRCHANVEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateAIThrmstrChanVex(uint32, cstring, cstring, double, double, int32, int32, int32, double, double, double, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIThrmstrChanVex',varargin{:});
