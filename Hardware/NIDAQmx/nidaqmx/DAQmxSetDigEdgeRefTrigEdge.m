function varargout = DAQmxSetDigEdgeRefTrigEdge(varargin)
%DAQMXSETDIGEDGEREFTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeRefTrigEdge(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeRefTrigEdge',varargin{:});
