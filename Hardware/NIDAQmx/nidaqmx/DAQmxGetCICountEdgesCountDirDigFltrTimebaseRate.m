function varargout = DAQmxGetCICountEdgesCountDirDigFltrTimebaseRate(varargin)
%DAQMXGETCICOUNTEDGESCOUNTDIRDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCICountEdgesCountDirDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesCountDirDigFltrTimebaseRate',varargin{:});
