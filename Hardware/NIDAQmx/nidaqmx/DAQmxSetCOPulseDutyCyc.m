function varargout = DAQmxSetCOPulseDutyCyc(varargin)
%DAQMXSETCOPULSEDUTYCYC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseDutyCyc(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseDutyCyc',varargin{:});
