function varargout = DAQmxResetSampClkDigFltrTimebaseSrc(varargin)
%DAQMXRESETSAMPCLKDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkDigFltrTimebaseSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkDigFltrTimebaseSrc',varargin{:});
