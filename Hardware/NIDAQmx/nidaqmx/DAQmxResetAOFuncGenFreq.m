function varargout = DAQmxResetAOFuncGenFreq(varargin)
%DAQMXRESETAOFUNCGENFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOFuncGenFreq(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOFuncGenFreq',varargin{:});
