function varargout = DAQmxGetCISemiPeriodDigFltrEnable(varargin)
%DAQMXGETCISEMIPERIODDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCISemiPeriodDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCISemiPeriodDigFltrEnable',varargin{:});
