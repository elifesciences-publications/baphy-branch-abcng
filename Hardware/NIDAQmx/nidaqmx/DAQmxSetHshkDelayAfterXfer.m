function varargout = DAQmxSetHshkDelayAfterXfer(varargin)
%DAQMXSETHSHKDELAYAFTERXFER calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetHshkDelayAfterXfer(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetHshkDelayAfterXfer',varargin{:});
