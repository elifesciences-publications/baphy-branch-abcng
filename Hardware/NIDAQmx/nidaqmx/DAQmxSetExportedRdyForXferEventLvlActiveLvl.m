function varargout = DAQmxSetExportedRdyForXferEventLvlActiveLvl(varargin)
%DAQMXSETEXPORTEDRDYFORXFEREVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedRdyForXferEventLvlActiveLvl(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedRdyForXferEventLvlActiveLvl',varargin{:});
