function varargout = DAQmxGetRefTrigPretrigSamples(varargin)
%DAQMXGETREFTRIGPRETRIGSAMPLES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetRefTrigPretrigSamples(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRefTrigPretrigSamples',varargin{:});
