function varargout = DAQmxResetAIConvTimebaseSrc(varargin)
%DAQMXRESETAICONVTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAIConvTimebaseSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvTimebaseSrc',varargin{:});
