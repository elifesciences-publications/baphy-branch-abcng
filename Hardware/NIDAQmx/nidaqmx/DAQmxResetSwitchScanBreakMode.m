function varargout = DAQmxResetSwitchScanBreakMode(varargin)
%DAQMXRESETSWITCHSCANBREAKMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSwitchScanBreakMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSwitchScanBreakMode',varargin{:});
