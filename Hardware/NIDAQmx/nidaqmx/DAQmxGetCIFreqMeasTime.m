function varargout = DAQmxGetCIFreqMeasTime(varargin)
%DAQMXGETCIFREQMEASTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIFreqMeasTime(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqMeasTime',varargin{:});
