function varargout = DAQmxSetDigEdgeArmStartTrigSrc(varargin)
%DAQMXSETDIGEDGEARMSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigEdgeArmStartTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeArmStartTrigSrc',varargin{:});
