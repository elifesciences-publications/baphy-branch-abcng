function varargout = DAQmxSetRealTimeWriteRecoveryMode(varargin)
%DAQMXSETREALTIMEWRITERECOVERYMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetRealTimeWriteRecoveryMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRealTimeWriteRecoveryMode',varargin{:});
