function varargout = DAQmxGetExportedChangeDetectEventOutputTerm(varargin)
%DAQMXGETEXPORTEDCHANGEDETECTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedChangeDetectEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedChangeDetectEventOutputTerm',varargin{:});
