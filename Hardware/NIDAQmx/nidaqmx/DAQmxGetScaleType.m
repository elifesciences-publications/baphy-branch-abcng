function varargout = DAQmxGetScaleType(varargin)
%DAQMXGETSCALETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetScaleType(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleType',varargin{:});
