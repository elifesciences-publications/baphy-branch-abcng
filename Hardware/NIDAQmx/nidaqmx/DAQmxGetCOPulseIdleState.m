function varargout = DAQmxGetCOPulseIdleState(varargin)
%DAQMXGETCOPULSEIDLESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCOPulseIdleState(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseIdleState',varargin{:});
