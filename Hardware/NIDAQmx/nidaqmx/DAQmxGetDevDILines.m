function varargout = DAQmxGetDevDILines(varargin)
%DAQMXGETDEVDILINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevDILines(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDILines',varargin{:});
