function varargout = DAQmxGetAIMin(varargin)
%DAQMXGETAIMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIMin(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIMin',varargin{:});
