function varargout = DAQmxSetCOPulseHighTime(varargin)
%DAQMXSETCOPULSEHIGHTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseHighTime(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseHighTime',varargin{:});
