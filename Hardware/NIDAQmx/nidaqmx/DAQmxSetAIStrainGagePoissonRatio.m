function varargout = DAQmxSetAIStrainGagePoissonRatio(varargin)
%DAQMXSETAISTRAINGAGEPOISSONRATIO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIStrainGagePoissonRatio(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIStrainGagePoissonRatio',varargin{:});
