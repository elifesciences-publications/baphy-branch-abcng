function varargout = DAQmxResetAIThrmcplScaleType(varargin)
%DAQMXRESETAITHRMCPLSCALETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIThrmcplScaleType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIThrmcplScaleType',varargin{:});
