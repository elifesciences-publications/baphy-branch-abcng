function varargout = DAQmxSetAIRVDTSensitivityUnits(varargin)
%DAQMXSETAIRVDTSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRVDTSensitivityUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRVDTSensitivityUnits',varargin{:});
