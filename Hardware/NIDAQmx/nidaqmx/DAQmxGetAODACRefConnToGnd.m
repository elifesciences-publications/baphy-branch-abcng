function varargout = DAQmxGetAODACRefConnToGnd(varargin)
%DAQMXGETAODACREFCONNTOGND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAODACRefConnToGnd(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACRefConnToGnd',varargin{:});
