function varargout = DAQmxGetCIPulseWidthDigSyncEnable(varargin)
%DAQMXGETCIPULSEWIDTHDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIPulseWidthDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPulseWidthDigSyncEnable',varargin{:});
