function varargout = DAQmxResetCOPulseTerm(varargin)
%DAQMXRESETCOPULSETERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseTerm',varargin{:});
