function varargout = DAQmxSetDelayFromSampClkDelay(varargin)
%DAQMXSETDELAYFROMSAMPCLKDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDelayFromSampClkDelay(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDelayFromSampClkDelay',varargin{:});
