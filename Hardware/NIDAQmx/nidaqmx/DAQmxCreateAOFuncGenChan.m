function varargout = DAQmxCreateAOFuncGenChan(varargin)
%DAQMXCREATEAOFUNCGENCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateAOFuncGenChan(uint32, cstring, cstring, int32, double, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAOFuncGenChan',varargin{:});
