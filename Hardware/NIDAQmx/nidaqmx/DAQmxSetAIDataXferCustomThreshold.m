function varargout = DAQmxSetAIDataXferCustomThreshold(varargin)
%DAQMXSETAIDATAXFERCUSTOMTHRESHOLD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIDataXferCustomThreshold(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIDataXferCustomThreshold',varargin{:});
