function varargout = DAQmxResetAILowpassSwitchCapClkSrc(varargin)
%DAQMXRESETAILOWPASSSWITCHCAPCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILowpassSwitchCapClkSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILowpassSwitchCapClkSrc',varargin{:});
