function varargout = DAQmxCreateTEDSAIAccelChan(varargin)
%DAQMXCREATETEDSAIACCELCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateTEDSAIAccelChan(uint32, cstring, cstring, int32, double, double, int32, int32, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateTEDSAIAccelChan',varargin{:});
