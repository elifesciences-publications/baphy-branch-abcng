function varargout = DAQmxSetPauseTrigType(varargin)
%DAQMXSETPAUSETRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetPauseTrigType(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetPauseTrigType',varargin{:});
