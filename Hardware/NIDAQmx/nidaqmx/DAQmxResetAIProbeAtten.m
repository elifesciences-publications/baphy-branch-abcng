function varargout = DAQmxResetAIProbeAtten(varargin)
%DAQMXRESETAIPROBEATTEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIProbeAtten(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIProbeAtten',varargin{:});
