function varargout = DAQmxSetAIDataXferReqCond(varargin)
%DAQMXSETAIDATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIDataXferReqCond(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIDataXferReqCond',varargin{:});
