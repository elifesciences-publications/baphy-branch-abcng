function varargout = DAQmxGetPhysicalChanTEDSBitStream(varargin)
%DAQMXGETPHYSICALCHANTEDSBITSTREAM calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxGetPhysicalChanTEDSBitStream ( const char physicalChannel [], uInt8 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, uint8Ptr] DAQmxGetPhysicalChanTEDSBitStream(cstring, uint8Ptr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanTEDSBitStream',varargin{:});
