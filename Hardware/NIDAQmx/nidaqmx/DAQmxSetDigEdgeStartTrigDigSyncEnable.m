function varargout = DAQmxSetDigEdgeStartTrigDigSyncEnable(varargin)
%DAQMXSETDIGEDGESTARTTRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeStartTrigDigSyncEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeStartTrigDigSyncEnable',varargin{:});
