function varargout = DAQmxGetAIBridgeInitialVoltage(varargin)
%DAQMXGETAIBRIDGEINITIALVOLTAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIBridgeInitialVoltage(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIBridgeInitialVoltage',varargin{:});
