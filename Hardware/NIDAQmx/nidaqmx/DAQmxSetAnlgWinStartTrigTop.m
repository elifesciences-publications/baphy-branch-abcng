function varargout = DAQmxSetAnlgWinStartTrigTop(varargin)
%DAQMXSETANLGWINSTARTTRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinStartTrigTop(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinStartTrigTop',varargin{:});
