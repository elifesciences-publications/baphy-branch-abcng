function varargout = DAQmxResetExported10MHzRefClkOutputTerm(varargin)
%DAQMXRESETEXPORTED10MHZREFCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExported10MHzRefClkOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExported10MHzRefClkOutputTerm',varargin{:});
