function varargout = DAQmxSetExportedHshkEventDelay(varargin)
%DAQMXSETEXPORTEDHSHKEVENTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedHshkEventDelay(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedHshkEventDelay',varargin{:});
