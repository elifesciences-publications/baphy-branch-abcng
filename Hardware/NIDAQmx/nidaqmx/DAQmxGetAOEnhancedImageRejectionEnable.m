function varargout = DAQmxGetAOEnhancedImageRejectionEnable(varargin)
%DAQMXGETAOENHANCEDIMAGEREJECTIONENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAOEnhancedImageRejectionEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOEnhancedImageRejectionEnable',varargin{:});
