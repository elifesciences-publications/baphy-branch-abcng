function varargout = DAQmxResetExportedRdyForXferEventDeassertCondCustomThreshold(varargin)
%DAQMXRESETEXPORTEDRDYFORXFEREVENTDEASSERTCONDCUSTOMTHRESHOLD calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedRdyForXferEventDeassertCondCustomThreshold(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedRdyForXferEventDeassertCondCustomThreshold',varargin{:});
