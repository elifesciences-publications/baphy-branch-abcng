function varargout = DAQmxSetAIChanCalEnableCal(varargin)
%DAQMXSETAICHANCALENABLECAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIChanCalEnableCal(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIChanCalEnableCal',varargin{:});
