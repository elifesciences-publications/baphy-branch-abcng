function varargout = DAQmxGetAnlgWinStartTrigSrc(varargin)
%DAQMXGETANLGWINSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetAnlgWinStartTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinStartTrigSrc',varargin{:});
