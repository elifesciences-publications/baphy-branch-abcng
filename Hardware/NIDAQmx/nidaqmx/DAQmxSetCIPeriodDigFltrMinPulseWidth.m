function varargout = DAQmxSetCIPeriodDigFltrMinPulseWidth(varargin)
%DAQMXSETCIPERIODDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodDigFltrMinPulseWidth',varargin{:});
