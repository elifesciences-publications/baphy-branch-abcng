function varargout = DAQmxGetCOCtrTimebaseDigFltrTimebaseSrc(varargin)
%DAQMXGETCOCTRTIMEBASEDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCOCtrTimebaseDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseDigFltrTimebaseSrc',varargin{:});
