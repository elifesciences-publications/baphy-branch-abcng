function varargout = DAQmxResetAILVDTUnits(varargin)
%DAQMXRESETAILVDTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILVDTUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILVDTUnits',varargin{:});
