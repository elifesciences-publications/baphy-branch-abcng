function varargout = DAQmxResetCIFreqTerm(varargin)
%DAQMXRESETCIFREQTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqTerm',varargin{:});
