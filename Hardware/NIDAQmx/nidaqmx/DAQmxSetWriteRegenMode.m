function varargout = DAQmxSetWriteRegenMode(varargin)
%DAQMXSETWRITEREGENMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetWriteRegenMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWriteRegenMode',varargin{:});
