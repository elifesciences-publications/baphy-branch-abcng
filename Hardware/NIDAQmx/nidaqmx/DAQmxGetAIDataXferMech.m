function varargout = DAQmxGetAIDataXferMech(varargin)
%DAQMXGETAIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIDataXferMech(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIDataXferMech',varargin{:});
