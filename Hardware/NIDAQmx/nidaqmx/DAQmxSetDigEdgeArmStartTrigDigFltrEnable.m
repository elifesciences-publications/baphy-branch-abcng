function varargout = DAQmxSetDigEdgeArmStartTrigDigFltrEnable(varargin)
%DAQMXSETDIGEDGEARMSTARTTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeArmStartTrigDigFltrEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeArmStartTrigDigFltrEnable',varargin{:});
