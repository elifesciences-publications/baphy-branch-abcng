function varargout = DAQmxSetCIEncoderZIndexVal(varargin)
%DAQMXSETCIENCODERZINDEXVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderZIndexVal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZIndexVal',varargin{:});
