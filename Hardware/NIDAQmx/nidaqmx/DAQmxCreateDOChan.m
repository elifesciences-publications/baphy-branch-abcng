function varargout = DAQmxCreateDOChan(varargin)
%DAQMXCREATEDOCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateDOChan(uint32, cstring, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateDOChan',varargin{:});
