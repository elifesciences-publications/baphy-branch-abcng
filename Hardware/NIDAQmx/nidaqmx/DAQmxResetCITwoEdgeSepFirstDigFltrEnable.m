function varargout = DAQmxResetCITwoEdgeSepFirstDigFltrEnable(varargin)
%DAQMXRESETCITWOEDGESEPFIRSTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepFirstDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepFirstDigFltrEnable',varargin{:});
