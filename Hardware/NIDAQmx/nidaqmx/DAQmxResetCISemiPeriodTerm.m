function varargout = DAQmxResetCISemiPeriodTerm(varargin)
%DAQMXRESETCISEMIPERIODTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCISemiPeriodTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCISemiPeriodTerm',varargin{:});
