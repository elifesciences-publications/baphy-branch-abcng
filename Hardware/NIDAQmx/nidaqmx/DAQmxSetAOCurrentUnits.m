function varargout = DAQmxSetAOCurrentUnits(varargin)
%DAQMXSETAOCURRENTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOCurrentUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOCurrentUnits',varargin{:});
