function varargout = DAQmxCreateAIPosRVDTChan(varargin)
%DAQMXCREATEAIPOSRVDTCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAIPosRVDTChan(uint32, cstring, cstring, double, double, int32, double, int32, int32, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIPosRVDTChan',varargin{:});
