function varargout = DAQmxGetAIConvSrcEx(varargin)
%DAQMXGETAICONVSRCEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAIConvSrcEx(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvSrcEx',varargin{:});
