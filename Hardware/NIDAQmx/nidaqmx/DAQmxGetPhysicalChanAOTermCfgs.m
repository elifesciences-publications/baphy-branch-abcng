function varargout = DAQmxGetPhysicalChanAOTermCfgs(varargin)
%DAQMXGETPHYSICALCHANAOTERMCFGS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetPhysicalChanAOTermCfgs(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanAOTermCfgs',varargin{:});
