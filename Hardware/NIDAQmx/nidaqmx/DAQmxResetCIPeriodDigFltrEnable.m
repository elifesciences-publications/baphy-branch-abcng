function varargout = DAQmxResetCIPeriodDigFltrEnable(varargin)
%DAQMXRESETCIPERIODDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodDigFltrEnable',varargin{:});
