function varargout = DAQmxSetWatchdogTimeout(varargin)
%DAQMXSETWATCHDOGTIMEOUT calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetWatchdogTimeout(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWatchdogTimeout',varargin{:});
