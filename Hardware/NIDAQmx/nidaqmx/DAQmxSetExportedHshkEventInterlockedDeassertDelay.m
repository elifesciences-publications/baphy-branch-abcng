function varargout = DAQmxSetExportedHshkEventInterlockedDeassertDelay(varargin)
%DAQMXSETEXPORTEDHSHKEVENTINTERLOCKEDDEASSERTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedHshkEventInterlockedDeassertDelay(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedHshkEventInterlockedDeassertDelay',varargin{:});
