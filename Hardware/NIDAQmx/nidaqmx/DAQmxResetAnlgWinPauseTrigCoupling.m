function varargout = DAQmxResetAnlgWinPauseTrigCoupling(varargin)
%DAQMXRESETANLGWINPAUSETRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinPauseTrigCoupling(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinPauseTrigCoupling',varargin{:});
