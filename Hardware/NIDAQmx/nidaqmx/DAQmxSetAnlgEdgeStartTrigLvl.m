function varargout = DAQmxSetAnlgEdgeStartTrigLvl(varargin)
%DAQMXSETANLGEDGESTARTTRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgEdgeStartTrigLvl(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeStartTrigLvl',varargin{:});
