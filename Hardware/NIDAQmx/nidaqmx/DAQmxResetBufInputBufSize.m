function varargout = DAQmxResetBufInputBufSize(varargin)
%DAQMXRESETBUFINPUTBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetBufInputBufSize(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetBufInputBufSize',varargin{:});
