function varargout = DAQmxSetCITwoEdgeSepSecondDigFltrTimebaseRate(varargin)
%DAQMXSETCITWOEDGESEPSECONDDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepSecondDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepSecondDigFltrTimebaseRate',varargin{:});
