function varargout = DAQmxSetAOFuncGenAmplitude(varargin)
%DAQMXSETAOFUNCGENAMPLITUDE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOFuncGenAmplitude(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOFuncGenAmplitude',varargin{:});
