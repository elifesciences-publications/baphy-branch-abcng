function varargout = DAQmxGetAOFuncGenModulationType(varargin)
%DAQMXGETAOFUNCGENMODULATIONTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAOFuncGenModulationType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOFuncGenModulationType',varargin{:});
