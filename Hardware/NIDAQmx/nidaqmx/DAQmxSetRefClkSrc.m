function varargout = DAQmxSetRefClkSrc(varargin)
%DAQMXSETREFCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetRefClkSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRefClkSrc',varargin{:});
