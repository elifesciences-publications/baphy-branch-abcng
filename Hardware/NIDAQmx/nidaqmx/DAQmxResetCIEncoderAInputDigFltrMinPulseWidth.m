function varargout = DAQmxResetCIEncoderAInputDigFltrMinPulseWidth(varargin)
%DAQMXRESETCIENCODERAINPUTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderAInputDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderAInputDigFltrMinPulseWidth',varargin{:});
