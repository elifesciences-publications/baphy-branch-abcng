function varargout = DAQmxGetRealTimeWaitForNextSampClkWaitMode(varargin)
%DAQMXGETREALTIMEWAITFORNEXTSAMPCLKWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetRealTimeWaitForNextSampClkWaitMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRealTimeWaitForNextSampClkWaitMode',varargin{:});
