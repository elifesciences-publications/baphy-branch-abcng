function varargout = DAQmxGetScaleDescr(varargin)
%DAQMXGETSCALEDESCR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetScaleDescr(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleDescr',varargin{:});
