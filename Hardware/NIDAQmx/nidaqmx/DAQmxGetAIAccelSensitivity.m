function varargout = DAQmxGetAIAccelSensitivity(varargin)
%DAQMXGETAIACCELSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIAccelSensitivity(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIAccelSensitivity',varargin{:});
