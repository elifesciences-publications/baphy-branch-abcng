function varargout = DAQmxGetExportedAIHoldCmpltEventPulsePolarity(varargin)
%DAQMXGETEXPORTEDAIHOLDCMPLTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedAIHoldCmpltEventPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAIHoldCmpltEventPulsePolarity',varargin{:});
