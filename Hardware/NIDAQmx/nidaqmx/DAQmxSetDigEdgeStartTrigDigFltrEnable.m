function varargout = DAQmxSetDigEdgeStartTrigDigFltrEnable(varargin)
%DAQMXSETDIGEDGESTARTTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeStartTrigDigFltrEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeStartTrigDigFltrEnable',varargin{:});
