function varargout = DAQmxSwitchGetMultiRelayCount(varargin)
%DAQMXSWITCHGETMULTIRELAYCOUNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr, uint32Ptr] DAQmxSwitchGetMultiRelayCount(cstring, uint32Ptr, uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchGetMultiRelayCount',varargin{:});
