function varargout = DAQmxGetSampClkActiveEdge(varargin)
%DAQMXGETSAMPCLKACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetSampClkActiveEdge(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkActiveEdge',varargin{:});
