function varargout = DAQmxResetAILVDTSensitivityUnits(varargin)
%DAQMXRESETAILVDTSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILVDTSensitivityUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILVDTSensitivityUnits',varargin{:});
