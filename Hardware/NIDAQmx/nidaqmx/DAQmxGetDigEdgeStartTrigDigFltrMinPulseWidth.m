function varargout = DAQmxGetDigEdgeStartTrigDigFltrMinPulseWidth(varargin)
%DAQMXGETDIGEDGESTARTTRIGDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetDigEdgeStartTrigDigFltrMinPulseWidth(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeStartTrigDigFltrMinPulseWidth',varargin{:});
