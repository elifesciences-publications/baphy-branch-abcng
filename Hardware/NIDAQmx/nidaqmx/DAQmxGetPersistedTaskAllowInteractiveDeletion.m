function varargout = DAQmxGetPersistedTaskAllowInteractiveDeletion(varargin)
%DAQMXGETPERSISTEDTASKALLOWINTERACTIVEDELETION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPersistedTaskAllowInteractiveDeletion(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedTaskAllowInteractiveDeletion',varargin{:});
