function varargout = DAQmxResetExportedCtrOutEventOutputBehavior(varargin)
%DAQMXRESETEXPORTEDCTROUTEVENTOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedCtrOutEventOutputBehavior(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedCtrOutEventOutputBehavior',varargin{:});
