function varargout = DAQmxSetCITwoEdgeSepFirstEdge(varargin)
%DAQMXSETCITWOEDGESEPFIRSTEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepFirstEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepFirstEdge',varargin{:});
