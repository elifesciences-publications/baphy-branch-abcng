function varargout = DAQmxGetAIChanCalApplyCalIfExp(varargin)
%DAQMXGETAICHANCALAPPLYCALIFEXP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIChanCalApplyCalIfExp(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIChanCalApplyCalIfExp',varargin{:});
