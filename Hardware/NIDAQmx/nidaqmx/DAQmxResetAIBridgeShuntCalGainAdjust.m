function varargout = DAQmxResetAIBridgeShuntCalGainAdjust(varargin)
%DAQMXRESETAIBRIDGESHUNTCALGAINADJUST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIBridgeShuntCalGainAdjust(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIBridgeShuntCalGainAdjust',varargin{:});
