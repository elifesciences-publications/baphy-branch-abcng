function varargout = DAQmxGetCITwoEdgeSepFirstDigFltrMinPulseWidth(varargin)
%DAQMXGETCITWOEDGESEPFIRSTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCITwoEdgeSepFirstDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepFirstDigFltrMinPulseWidth',varargin{:});
