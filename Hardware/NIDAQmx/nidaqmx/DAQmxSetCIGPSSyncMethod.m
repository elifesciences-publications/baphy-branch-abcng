function varargout = DAQmxSetCIGPSSyncMethod(varargin)
%DAQMXSETCIGPSSYNCMETHOD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIGPSSyncMethod(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIGPSSyncMethod',varargin{:});
