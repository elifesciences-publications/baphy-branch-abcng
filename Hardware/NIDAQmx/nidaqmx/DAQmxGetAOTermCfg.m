function varargout = DAQmxGetAOTermCfg(varargin)
%DAQMXGETAOTERMCFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAOTermCfg(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOTermCfg',varargin{:});
