function varargout = DAQmxSetAnlgWinStartTrigBtm(varargin)
%DAQMXSETANLGWINSTARTTRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinStartTrigBtm(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinStartTrigBtm',varargin{:});
