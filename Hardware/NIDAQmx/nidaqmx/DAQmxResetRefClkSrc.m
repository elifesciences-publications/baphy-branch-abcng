function varargout = DAQmxResetRefClkSrc(varargin)
%DAQMXRESETREFCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRefClkSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRefClkSrc',varargin{:});
