function varargout = DAQmxGetAIExcitUseForScaling(varargin)
%DAQMXGETAIEXCITUSEFORSCALING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIExcitUseForScaling(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIExcitUseForScaling',varargin{:});
