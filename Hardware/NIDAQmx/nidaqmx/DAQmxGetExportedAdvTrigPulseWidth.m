function varargout = DAQmxGetExportedAdvTrigPulseWidth(varargin)
%DAQMXGETEXPORTEDADVTRIGPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetExportedAdvTrigPulseWidth(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAdvTrigPulseWidth',varargin{:});
