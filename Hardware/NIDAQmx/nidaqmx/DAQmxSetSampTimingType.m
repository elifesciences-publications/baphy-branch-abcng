function varargout = DAQmxSetSampTimingType(varargin)
%DAQMXSETSAMPTIMINGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampTimingType(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampTimingType',varargin{:});
