function varargout = DAQmxResetSampClkDigFltrTimebaseRate(varargin)
%DAQMXRESETSAMPCLKDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkDigFltrTimebaseRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkDigFltrTimebaseRate',varargin{:});
