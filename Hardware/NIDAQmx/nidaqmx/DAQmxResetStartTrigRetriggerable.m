function varargout = DAQmxResetStartTrigRetriggerable(varargin)
%DAQMXRESETSTARTTRIGRETRIGGERABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetStartTrigRetriggerable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetStartTrigRetriggerable',varargin{:});
