function varargout = DAQmxGetDevTerminals(varargin)
%DAQMXGETDEVTERMINALS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevTerminals(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevTerminals',varargin{:});
