function varargout = DAQmxGetDigEdgeStartTrigSrc(varargin)
%DAQMXGETDIGEDGESTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigEdgeStartTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeStartTrigSrc',varargin{:});
