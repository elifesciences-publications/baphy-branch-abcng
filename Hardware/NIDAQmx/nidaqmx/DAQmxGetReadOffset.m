function varargout = DAQmxGetReadOffset(varargin)
%DAQMXGETREADOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetReadOffset(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOffset',varargin{:});
