function varargout = DAQmxSetCITwoEdgeSepUnits(varargin)
%DAQMXSETCITWOEDGESEPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepUnits',varargin{:});
