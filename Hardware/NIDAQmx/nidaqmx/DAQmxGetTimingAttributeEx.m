function varargout = DAQmxGetTimingAttributeEx(varargin)
%DAQMXGETTIMINGATTRIBUTEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetTimingAttributeEx(uint32, cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTimingAttributeEx',varargin{:});
