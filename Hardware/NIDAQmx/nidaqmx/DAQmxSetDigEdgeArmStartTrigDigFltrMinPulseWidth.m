function varargout = DAQmxSetDigEdgeArmStartTrigDigFltrMinPulseWidth(varargin)
%DAQMXSETDIGEDGEARMSTARTTRIGDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeArmStartTrigDigFltrMinPulseWidth(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeArmStartTrigDigFltrMinPulseWidth',varargin{:});
