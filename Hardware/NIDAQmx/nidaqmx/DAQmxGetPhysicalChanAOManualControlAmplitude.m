function varargout = DAQmxGetPhysicalChanAOManualControlAmplitude(varargin)
%DAQMXGETPHYSICALCHANAOMANUALCONTROLAMPLITUDE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetPhysicalChanAOManualControlAmplitude(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanAOManualControlAmplitude',varargin{:});
