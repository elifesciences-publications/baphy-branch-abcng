function varargout = DAQmxSetSampClkDigSyncEnable(varargin)
%DAQMXSETSAMPCLKDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkDigSyncEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkDigSyncEnable',varargin{:});
