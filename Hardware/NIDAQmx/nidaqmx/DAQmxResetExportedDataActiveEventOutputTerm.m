function varargout = DAQmxResetExportedDataActiveEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDDATAACTIVEEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedDataActiveEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedDataActiveEventOutputTerm',varargin{:});
