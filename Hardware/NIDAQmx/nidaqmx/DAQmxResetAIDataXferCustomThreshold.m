function varargout = DAQmxResetAIDataXferCustomThreshold(varargin)
%DAQMXRESETAIDATAXFERCUSTOMTHRESHOLD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIDataXferCustomThreshold(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIDataXferCustomThreshold',varargin{:});
