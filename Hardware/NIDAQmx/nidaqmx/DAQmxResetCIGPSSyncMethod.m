function varargout = DAQmxResetCIGPSSyncMethod(varargin)
%DAQMXRESETCIGPSSYNCMETHOD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIGPSSyncMethod(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIGPSSyncMethod',varargin{:});
