function varargout = DAQmxResetCICtrTimebaseDigSyncEnable(varargin)
%DAQMXRESETCICTRTIMEBASEDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseDigSyncEnable',varargin{:});
