function varargout = DAQmxCfgDigEdgeStartTrig(varargin)
%DAQMXCFGDIGEDGESTARTTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgDigEdgeStartTrig(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgDigEdgeStartTrig',varargin{:});
