function varargout = DAQmxGetCarrierSerialNum(varargin)
%DAQMXGETCARRIERSERIALNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCarrierSerialNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCarrierSerialNum',varargin{:});
