function varargout = DAQmxSetAIThrmcplType(varargin)
%DAQMXSETAITHRMCPLTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIThrmcplType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIThrmcplType',varargin{:});
