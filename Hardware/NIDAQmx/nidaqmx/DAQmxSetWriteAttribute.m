function varargout = DAQmxSetWriteAttribute(varargin)
%DAQMXSETWRITEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxSetWriteAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWriteAttribute',varargin{:});
