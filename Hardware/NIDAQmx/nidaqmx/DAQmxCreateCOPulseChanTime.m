function varargout = DAQmxCreateCOPulseChanTime(varargin)
%DAQMXCREATECOPULSECHANTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateCOPulseChanTime(uint32, cstring, cstring, int32, int32, double, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCOPulseChanTime',varargin{:});
