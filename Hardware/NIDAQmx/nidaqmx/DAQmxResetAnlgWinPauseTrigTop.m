function varargout = DAQmxResetAnlgWinPauseTrigTop(varargin)
%DAQMXRESETANLGWINPAUSETRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinPauseTrigTop(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinPauseTrigTop',varargin{:});
