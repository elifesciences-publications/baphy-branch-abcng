function varargout = DAQmxClearTask(varargin)
%DAQMXCLEARTASK calls nidaqmx library with the appropriate arguments.
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxClearTask',varargin{:});
