function varargout = DAQmxSetCIAngEncoderUnits(varargin)
%DAQMXSETCIANGENCODERUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIAngEncoderUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIAngEncoderUnits',varargin{:});
