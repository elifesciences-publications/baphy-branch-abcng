function varargout = DAQmxResetAIVoltageACRMSUnits(varargin)
%DAQMXRESETAIVOLTAGEACRMSUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIVoltageACRMSUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIVoltageACRMSUnits',varargin{:});
