function varargout = DAQmxResetStartTrigDelayUnits(varargin)
%DAQMXRESETSTARTTRIGDELAYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetStartTrigDelayUnits(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetStartTrigDelayUnits',varargin{:});
