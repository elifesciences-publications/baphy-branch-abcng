function varargout = DAQmxGetExportedCtrOutEventPulsePolarity(varargin)
%DAQMXGETEXPORTEDCTROUTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedCtrOutEventPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedCtrOutEventPulsePolarity',varargin{:});
