function varargout = DAQmxResetCIEncoderBInputTerm(varargin)
%DAQMXRESETCIENCODERBINPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderBInputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderBInputTerm',varargin{:});
