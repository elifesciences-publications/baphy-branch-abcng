function varargout = DAQmxSetAIExcitActualVal(varargin)
%DAQMXSETAIEXCITACTUALVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIExcitActualVal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIExcitActualVal',varargin{:});
