function varargout = DAQmxResetAIChanCalPolyForwardCoeff(varargin)
%DAQMXRESETAICHANCALPOLYFORWARDCOEFF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalPolyForwardCoeff(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalPolyForwardCoeff',varargin{:});
