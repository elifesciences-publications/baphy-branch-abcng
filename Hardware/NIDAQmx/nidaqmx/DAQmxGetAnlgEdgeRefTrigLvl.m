function varargout = DAQmxGetAnlgEdgeRefTrigLvl(varargin)
%DAQMXGETANLGEDGEREFTRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgEdgeRefTrigLvl(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeRefTrigLvl',varargin{:});
