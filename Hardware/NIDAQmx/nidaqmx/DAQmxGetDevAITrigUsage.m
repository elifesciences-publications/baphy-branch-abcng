function varargout = DAQmxGetDevAITrigUsage(varargin)
%DAQMXGETDEVAITRIGUSAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevAITrigUsage(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAITrigUsage',varargin{:});
