function varargout = DAQmxSetAISoundPressureMaxSoundPressureLvl(varargin)
%DAQMXSETAISOUNDPRESSUREMAXSOUNDPRESSURELVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAISoundPressureMaxSoundPressureLvl(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAISoundPressureMaxSoundPressureLvl',varargin{:});
