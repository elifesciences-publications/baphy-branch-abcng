function varargout = DAQmxSetStartTrigRetriggerable(varargin)
%DAQMXSETSTARTTRIGRETRIGGERABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetStartTrigRetriggerable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetStartTrigRetriggerable',varargin{:});
