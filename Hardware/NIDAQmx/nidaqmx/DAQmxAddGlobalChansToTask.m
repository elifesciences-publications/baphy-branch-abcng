function varargout = DAQmxAddGlobalChansToTask(varargin)
%DAQMXADDGLOBALCHANSTOTASK calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxAddGlobalChansToTask(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAddGlobalChansToTask',varargin{:});
