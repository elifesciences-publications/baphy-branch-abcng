function varargout = DAQmxCreateTEDSAIThrmstrChanVex(varargin)
%DAQMXCREATETEDSAITHRMSTRCHANVEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateTEDSAIThrmstrChanVex(uint32, cstring, cstring, double, double, int32, int32, int32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateTEDSAIThrmstrChanVex',varargin{:});
