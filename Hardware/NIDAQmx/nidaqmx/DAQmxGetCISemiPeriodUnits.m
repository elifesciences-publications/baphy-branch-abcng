function varargout = DAQmxGetCISemiPeriodUnits(varargin)
%DAQMXGETCISEMIPERIODUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCISemiPeriodUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCISemiPeriodUnits',varargin{:});
