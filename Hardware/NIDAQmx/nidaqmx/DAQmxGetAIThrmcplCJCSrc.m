function varargout = DAQmxGetAIThrmcplCJCSrc(varargin)
%DAQMXGETAITHRMCPLCJCSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIThrmcplCJCSrc(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmcplCJCSrc',varargin{:});
