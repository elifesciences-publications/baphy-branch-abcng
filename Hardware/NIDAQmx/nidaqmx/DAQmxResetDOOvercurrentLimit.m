function varargout = DAQmxResetDOOvercurrentLimit(varargin)
%DAQMXRESETDOOVERCURRENTLIMIT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOOvercurrentLimit(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOOvercurrentLimit',varargin{:});
