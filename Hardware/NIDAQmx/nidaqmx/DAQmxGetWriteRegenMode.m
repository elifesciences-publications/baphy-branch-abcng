function varargout = DAQmxGetWriteRegenMode(varargin)
%DAQMXGETWRITEREGENMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetWriteRegenMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteRegenMode',varargin{:});
