function varargout = DAQmxResetCOPrescaler(varargin)
%DAQMXRESETCOPRESCALER calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPrescaler(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPrescaler',varargin{:});
