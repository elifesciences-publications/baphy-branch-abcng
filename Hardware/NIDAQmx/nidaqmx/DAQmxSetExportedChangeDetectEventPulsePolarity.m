function varargout = DAQmxSetExportedChangeDetectEventPulsePolarity(varargin)
%DAQMXSETEXPORTEDCHANGEDETECTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedChangeDetectEventPulsePolarity(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedChangeDetectEventPulsePolarity',varargin{:});
