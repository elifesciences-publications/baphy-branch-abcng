function varargout = DAQmxResetAILowpassSwitchCapOutClkDiv(varargin)
%DAQMXRESETAILOWPASSSWITCHCAPOUTCLKDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILowpassSwitchCapOutClkDiv(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILowpassSwitchCapOutClkDiv',varargin{:});
