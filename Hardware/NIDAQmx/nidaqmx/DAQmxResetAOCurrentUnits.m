function varargout = DAQmxResetAOCurrentUnits(varargin)
%DAQMXRESETAOCURRENTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOCurrentUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOCurrentUnits',varargin{:});
