function varargout = DAQmxGetSwitchDevNumRelays(varargin)
%DAQMXGETSWITCHDEVNUMRELAYS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSwitchDevNumRelays(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevNumRelays',varargin{:});
