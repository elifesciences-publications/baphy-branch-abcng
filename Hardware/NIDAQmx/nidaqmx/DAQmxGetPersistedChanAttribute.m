function varargout = DAQmxGetPersistedChanAttribute(varargin)
%DAQMXGETPERSISTEDCHANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetPersistedChanAttribute(cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedChanAttribute',varargin{:});
