function varargout = DAQmxResetDIMemMapEnable(varargin)
%DAQMXRESETDIMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDIMemMapEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDIMemMapEnable',varargin{:});
