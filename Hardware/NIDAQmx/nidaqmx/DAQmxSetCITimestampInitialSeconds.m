function varargout = DAQmxSetCITimestampInitialSeconds(varargin)
%DAQMXSETCITIMESTAMPINITIALSECONDS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITimestampInitialSeconds(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITimestampInitialSeconds',varargin{:});
