function varargout = DAQmxResetCOConstrainedGenMode(varargin)
%DAQMXRESETCOCONSTRAINEDGENMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOConstrainedGenMode(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOConstrainedGenMode',varargin{:});
