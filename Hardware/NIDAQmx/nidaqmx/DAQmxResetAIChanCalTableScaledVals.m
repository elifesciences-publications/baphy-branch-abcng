function varargout = DAQmxResetAIChanCalTableScaledVals(varargin)
%DAQMXRESETAICHANCALTABLESCALEDVALS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalTableScaledVals(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalTableScaledVals',varargin{:});
