function varargout = DAQmxSetExportedHshkEventOutputTerm(varargin)
%DAQMXSETEXPORTEDHSHKEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedHshkEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedHshkEventOutputTerm',varargin{:});
