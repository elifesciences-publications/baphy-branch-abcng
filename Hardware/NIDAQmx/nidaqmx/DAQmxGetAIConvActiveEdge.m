function varargout = DAQmxGetAIConvActiveEdge(varargin)
%DAQMXGETAICONVACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAIConvActiveEdge(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvActiveEdge',varargin{:});
