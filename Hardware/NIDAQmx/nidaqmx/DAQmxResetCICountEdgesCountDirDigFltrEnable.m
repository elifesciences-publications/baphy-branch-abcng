function varargout = DAQmxResetCICountEdgesCountDirDigFltrEnable(varargin)
%DAQMXRESETCICOUNTEDGESCOUNTDIRDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesCountDirDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesCountDirDigFltrEnable',varargin{:});
