function varargout = DAQmxGetDevAOMinRate(varargin)
%DAQMXGETDEVAOMINRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevAOMinRate(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAOMinRate',varargin{:});
