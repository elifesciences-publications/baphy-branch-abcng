function varargout = DAQmxGetAnlgWinStartTrigBtm(varargin)
%DAQMXGETANLGWINSTARTTRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgWinStartTrigBtm(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinStartTrigBtm',varargin{:});
