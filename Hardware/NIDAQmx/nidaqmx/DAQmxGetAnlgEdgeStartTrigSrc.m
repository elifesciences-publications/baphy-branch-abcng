function varargout = DAQmxGetAnlgEdgeStartTrigSrc(varargin)
%DAQMXGETANLGEDGESTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetAnlgEdgeStartTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeStartTrigSrc',varargin{:});
