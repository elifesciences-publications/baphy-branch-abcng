function varargout = DAQmxGetSwitchDeviceAttribute(varargin)
%DAQMXGETSWITCHDEVICEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetSwitchDeviceAttribute(cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDeviceAttribute',varargin{:});
