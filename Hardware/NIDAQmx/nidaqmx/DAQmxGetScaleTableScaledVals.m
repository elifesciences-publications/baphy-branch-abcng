function varargout = DAQmxGetScaleTableScaledVals(varargin)
%DAQMXGETSCALETABLESCALEDVALS calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxGetScaleTableScaledVals ( const char scaleName [], float64 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, doublePtr] DAQmxGetScaleTableScaledVals(cstring, doublePtr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleTableScaledVals',varargin{:});
