function varargout = DAQmxGetAnlgWinRefTrigTop(varargin)
%DAQMXGETANLGWINREFTRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgWinRefTrigTop(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinRefTrigTop',varargin{:});
