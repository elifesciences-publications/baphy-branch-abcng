function varargout = DAQmxSetDILogicFamily(varargin)
%DAQMXSETDILOGICFAMILY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDILogicFamily(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDILogicFamily',varargin{:});
