function varargout = DAQmxGetDevAIMaxSingleChanRate(varargin)
%DAQMXGETDEVAIMAXSINGLECHANRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevAIMaxSingleChanRate(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAIMaxSingleChanRate',varargin{:});
