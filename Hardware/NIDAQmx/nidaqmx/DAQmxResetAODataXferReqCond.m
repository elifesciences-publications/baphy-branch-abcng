function varargout = DAQmxResetAODataXferReqCond(varargin)
%DAQMXRESETAODATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODataXferReqCond(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODataXferReqCond',varargin{:});
