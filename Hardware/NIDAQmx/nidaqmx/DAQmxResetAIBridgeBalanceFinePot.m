function varargout = DAQmxResetAIBridgeBalanceFinePot(varargin)
%DAQMXRESETAIBRIDGEBALANCEFINEPOT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIBridgeBalanceFinePot(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIBridgeBalanceFinePot',varargin{:});
