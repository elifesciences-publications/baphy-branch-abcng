function varargout = DAQmxSetCIEncoderBInputDigFltrTimebaseSrc(varargin)
%DAQMXSETCIENCODERBINPUTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIEncoderBInputDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderBInputDigFltrTimebaseSrc',varargin{:});
