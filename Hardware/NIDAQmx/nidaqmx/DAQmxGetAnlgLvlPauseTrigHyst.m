function varargout = DAQmxGetAnlgLvlPauseTrigHyst(varargin)
%DAQMXGETANLGLVLPAUSETRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgLvlPauseTrigHyst(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgLvlPauseTrigHyst',varargin{:});
