function varargout = DAQmxGetAIRVDTUnits(varargin)
%DAQMXGETAIRVDTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIRVDTUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRVDTUnits',varargin{:});
