function varargout = DAQmxResetDigPatternRefTrigPattern(varargin)
%DAQMXRESETDIGPATTERNREFTRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternRefTrigPattern(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternRefTrigPattern',varargin{:});
