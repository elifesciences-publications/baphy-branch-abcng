function varargout = DAQmxGetCIMax(varargin)
%DAQMXGETCIMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIMax(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIMax',varargin{:});
