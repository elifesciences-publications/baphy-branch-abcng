function varargout = DAQmxGetCIPeriodStartingEdge(varargin)
%DAQMXGETCIPERIODSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIPeriodStartingEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodStartingEdge',varargin{:});
