function varargout = DAQmxTaskControl(varargin)
%DAQMXTASKCONTROL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxTaskControl(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxTaskControl',varargin{:});
