function varargout = DAQmxGetDevCompactDAQChassisDevName(varargin)
%DAQMXGETDEVCOMPACTDAQCHASSISDEVNAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevCompactDAQChassisDevName(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCompactDAQChassisDevName',varargin{:});
