function varargout = DAQmxGetDigEdgeAdvTrigEdge(varargin)
%DAQMXGETDIGEDGEADVTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigEdgeAdvTrigEdge(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeAdvTrigEdge',varargin{:});
