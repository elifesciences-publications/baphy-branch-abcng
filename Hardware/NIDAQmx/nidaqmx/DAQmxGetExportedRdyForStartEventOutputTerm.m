function varargout = DAQmxGetExportedRdyForStartEventOutputTerm(varargin)
%DAQMXGETEXPORTEDRDYFORSTARTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedRdyForStartEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedRdyForStartEventOutputTerm',varargin{:});
