function varargout = DAQmxSetDigEdgeWatchdogExpirTrigSrc(varargin)
%DAQMXSETDIGEDGEWATCHDOGEXPIRTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigEdgeWatchdogExpirTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeWatchdogExpirTrigSrc',varargin{:});
