function varargout = DAQmxSetMasterTimebaseRate(varargin)
%DAQMXSETMASTERTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetMasterTimebaseRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetMasterTimebaseRate',varargin{:});
