function varargout = DAQmxGetPhysicalChanDISampClkSupported(varargin)
%DAQMXGETPHYSICALCHANDISAMPCLKSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanDISampClkSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanDISampClkSupported',varargin{:});
