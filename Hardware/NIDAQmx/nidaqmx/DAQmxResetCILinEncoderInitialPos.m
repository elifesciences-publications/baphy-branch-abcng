function varargout = DAQmxResetCILinEncoderInitialPos(varargin)
%DAQMXRESETCILINENCODERINITIALPOS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCILinEncoderInitialPos(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCILinEncoderInitialPos',varargin{:});
