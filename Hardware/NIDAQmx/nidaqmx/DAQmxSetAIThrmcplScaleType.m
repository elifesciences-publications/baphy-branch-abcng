function varargout = DAQmxSetAIThrmcplScaleType(varargin)
%DAQMXSETAITHRMCPLSCALETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIThrmcplScaleType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIThrmcplScaleType',varargin{:});
