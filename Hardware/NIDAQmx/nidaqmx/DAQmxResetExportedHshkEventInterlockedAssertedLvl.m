function varargout = DAQmxResetExportedHshkEventInterlockedAssertedLvl(varargin)
%DAQMXRESETEXPORTEDHSHKEVENTINTERLOCKEDASSERTEDLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedHshkEventInterlockedAssertedLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedHshkEventInterlockedAssertedLvl',varargin{:});
