function varargout = DAQmxSetAIConvRateEx(varargin)
%DAQMXSETAICONVRATEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIConvRateEx(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvRateEx',varargin{:});
