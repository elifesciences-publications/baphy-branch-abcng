function varargout = DAQmxSetDOTristate(varargin)
%DAQMXSETDOTRISTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOTristate(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOTristate',varargin{:});
