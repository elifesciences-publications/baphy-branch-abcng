function varargout = DAQmxAdjust1521Cal(varargin)
%DAQMXADJUST1521CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1521Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1521Cal',varargin{:});
