function varargout = DAQmxSwitchDisconnectMulti(varargin)
%DAQMXSWITCHDISCONNECTMULTI calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSwitchDisconnectMulti(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchDisconnectMulti',varargin{:});
