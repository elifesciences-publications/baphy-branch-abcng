function varargout = DAQmxGetCIPulseWidthUnits(varargin)
%DAQMXGETCIPULSEWIDTHUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIPulseWidthUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPulseWidthUnits',varargin{:});
