function varargout = DAQmxResetCICtrTimebaseRate(varargin)
%DAQMXRESETCICTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseRate',varargin{:});
