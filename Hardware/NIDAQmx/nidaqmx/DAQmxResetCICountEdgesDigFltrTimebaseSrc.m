function varargout = DAQmxResetCICountEdgesDigFltrTimebaseSrc(varargin)
%DAQMXRESETCICOUNTEDGESDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesDigFltrTimebaseSrc',varargin{:});
