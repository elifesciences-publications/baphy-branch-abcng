function varargout = DAQmxResetDOOvercurrentReenablePeriod(varargin)
%DAQMXRESETDOOVERCURRENTREENABLEPERIOD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOOvercurrentReenablePeriod(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOOvercurrentReenablePeriod',varargin{:});
