function varargout = DAQmxGetCIFreqDigFltrTimebaseRate(varargin)
%DAQMXGETCIFREQDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIFreqDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqDigFltrTimebaseRate',varargin{:});
