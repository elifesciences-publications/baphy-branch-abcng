function varargout = DAQmxResetCIMax(varargin)
%DAQMXRESETCIMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIMax(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIMax',varargin{:});
