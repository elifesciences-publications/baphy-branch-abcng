function varargout = DAQmxGetWriteOpenCurrentLoopChans(varargin)
%DAQMXGETWRITEOPENCURRENTLOOPCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetWriteOpenCurrentLoopChans(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteOpenCurrentLoopChans',varargin{:});
