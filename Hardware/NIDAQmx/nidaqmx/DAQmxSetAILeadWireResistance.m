function varargout = DAQmxSetAILeadWireResistance(varargin)
%DAQMXSETAILEADWIRERESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILeadWireResistance(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILeadWireResistance',varargin{:});
