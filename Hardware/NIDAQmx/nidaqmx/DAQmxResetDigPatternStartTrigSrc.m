function varargout = DAQmxResetDigPatternStartTrigSrc(varargin)
%DAQMXRESETDIGPATTERNSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternStartTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternStartTrigSrc',varargin{:});
