function varargout = DAQmxGetAIRngHigh(varargin)
%DAQMXGETAIRNGHIGH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIRngHigh(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRngHigh',varargin{:});
