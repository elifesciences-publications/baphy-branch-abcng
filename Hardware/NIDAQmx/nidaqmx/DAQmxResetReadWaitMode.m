function varargout = DAQmxResetReadWaitMode(varargin)
%DAQMXRESETREADWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadWaitMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadWaitMode',varargin{:});
