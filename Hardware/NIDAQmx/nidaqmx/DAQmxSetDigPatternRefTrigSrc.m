function varargout = DAQmxSetDigPatternRefTrigSrc(varargin)
%DAQMXSETDIGPATTERNREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigPatternRefTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternRefTrigSrc',varargin{:});
