function varargout = DAQmxResetSwitchScanRepeatMode(varargin)
%DAQMXRESETSWITCHSCANREPEATMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSwitchScanRepeatMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSwitchScanRepeatMode',varargin{:});
