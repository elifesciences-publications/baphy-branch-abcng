function varargout = DAQmxSetCIEncoderZIndexEnable(varargin)
%DAQMXSETCIENCODERZINDEXENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderZIndexEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZIndexEnable',varargin{:});
