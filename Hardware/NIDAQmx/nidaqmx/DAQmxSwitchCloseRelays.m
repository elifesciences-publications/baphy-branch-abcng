function varargout = DAQmxSwitchCloseRelays(varargin)
%DAQMXSWITCHCLOSERELAYS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSwitchCloseRelays(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchCloseRelays',varargin{:});
