function varargout = DAQmxSetAIRTDC(varargin)
%DAQMXSETAIRTDC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRTDC(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRTDC',varargin{:});
