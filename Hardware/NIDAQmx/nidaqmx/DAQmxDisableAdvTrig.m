function varargout = DAQmxDisableAdvTrig(varargin)
%DAQMXDISABLEADVTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxDisableAdvTrig(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxDisableAdvTrig',varargin{:});
