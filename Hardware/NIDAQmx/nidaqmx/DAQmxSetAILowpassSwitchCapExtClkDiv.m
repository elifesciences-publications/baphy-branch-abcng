function varargout = DAQmxSetAILowpassSwitchCapExtClkDiv(varargin)
%DAQMXSETAILOWPASSSWITCHCAPEXTCLKDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILowpassSwitchCapExtClkDiv(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILowpassSwitchCapExtClkDiv',varargin{:});
