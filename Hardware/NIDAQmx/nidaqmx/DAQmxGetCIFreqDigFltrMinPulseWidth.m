function varargout = DAQmxGetCIFreqDigFltrMinPulseWidth(varargin)
%DAQMXGETCIFREQDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIFreqDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqDigFltrMinPulseWidth',varargin{:});
