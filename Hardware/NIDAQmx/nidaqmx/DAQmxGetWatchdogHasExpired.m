function varargout = DAQmxGetWatchdogHasExpired(varargin)
%DAQMXGETWATCHDOGHASEXPIRED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWatchdogHasExpired(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWatchdogHasExpired',varargin{:});
