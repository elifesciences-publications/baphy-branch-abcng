function varargout = DAQmxGetCISemiPeriodDigFltrTimebaseSrc(varargin)
%DAQMXGETCISEMIPERIODDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCISemiPeriodDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCISemiPeriodDigFltrTimebaseSrc',varargin{:});
