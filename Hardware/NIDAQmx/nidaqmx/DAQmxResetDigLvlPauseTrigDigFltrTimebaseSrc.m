function varargout = DAQmxResetDigLvlPauseTrigDigFltrTimebaseSrc(varargin)
%DAQMXRESETDIGLVLPAUSETRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigLvlPauseTrigDigFltrTimebaseSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigLvlPauseTrigDigFltrTimebaseSrc',varargin{:});
