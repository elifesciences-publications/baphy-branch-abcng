function varargout = DAQmxSetCIPeriodTerm(varargin)
%DAQMXSETCIPERIODTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIPeriodTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodTerm',varargin{:});
