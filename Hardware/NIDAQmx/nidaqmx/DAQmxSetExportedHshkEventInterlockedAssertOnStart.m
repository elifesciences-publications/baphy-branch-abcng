function varargout = DAQmxSetExportedHshkEventInterlockedAssertOnStart(varargin)
%DAQMXSETEXPORTEDHSHKEVENTINTERLOCKEDASSERTONSTART calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedHshkEventInterlockedAssertOnStart(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedHshkEventInterlockedAssertOnStart',varargin{:});
