function varargout = DAQmxSetAICurrentACRMSUnits(varargin)
%DAQMXSETAICURRENTACRMSUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAICurrentACRMSUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAICurrentACRMSUnits',varargin{:});
