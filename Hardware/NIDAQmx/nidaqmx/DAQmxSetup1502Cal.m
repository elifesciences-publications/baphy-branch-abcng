function varargout = DAQmxSetup1502Cal(varargin)
%DAQMXSETUP1502CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1502Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1502Cal',varargin{:});
