function varargout = DAQmxGetSwitchDevNumColumns(varargin)
%DAQMXGETSWITCHDEVNUMCOLUMNS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSwitchDevNumColumns(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevNumColumns',varargin{:});
