function varargout = DAQmxGetDigPatternPauseTrigSrc(varargin)
%DAQMXGETDIGPATTERNPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigPatternPauseTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternPauseTrigSrc',varargin{:});
