function varargout = DAQmxGetErrorString(varargin)
%DAQMXGETERRORSTRING calls nidaqmx library with the appropriate arguments.
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetErrorString',varargin{:});
