function varargout = DAQmxResetExportedHshkEventPulseWidth(varargin)
%DAQMXRESETEXPORTEDHSHKEVENTPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedHshkEventPulseWidth(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedHshkEventPulseWidth',varargin{:});
