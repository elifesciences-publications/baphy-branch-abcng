function varargout = DAQmxResetAOUseOnlyOnBrdMem(varargin)
%DAQMXRESETAOUSEONLYONBRDMEM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOUseOnlyOnBrdMem(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOUseOnlyOnBrdMem',varargin{:});
