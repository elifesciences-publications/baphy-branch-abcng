function varargout = DAQmxSetAIAccelSensitivity(varargin)
%DAQMXSETAIACCELSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIAccelSensitivity(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIAccelSensitivity',varargin{:});
