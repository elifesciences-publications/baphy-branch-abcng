function varargout = DAQmxResetWriteOffset(varargin)
%DAQMXRESETWRITEOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWriteOffset(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWriteOffset',varargin{:});
