function varargout = DAQmxGetCITwoEdgeSepSecondDigFltrTimebaseRate(varargin)
%DAQMXGETCITWOEDGESEPSECONDDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCITwoEdgeSepSecondDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepSecondDigFltrTimebaseRate',varargin{:});
