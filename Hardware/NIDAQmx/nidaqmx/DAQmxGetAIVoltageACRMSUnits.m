function varargout = DAQmxGetAIVoltageACRMSUnits(varargin)
%DAQMXGETAIVOLTAGEACRMSUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIVoltageACRMSUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIVoltageACRMSUnits',varargin{:});
