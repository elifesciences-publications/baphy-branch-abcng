function varargout = DAQmxGetAnlgWinRefTrigWhen(varargin)
%DAQMXGETANLGWINREFTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgWinRefTrigWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinRefTrigWhen',varargin{:});
