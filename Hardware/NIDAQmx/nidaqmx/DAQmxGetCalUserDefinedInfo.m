function varargout = DAQmxGetCalUserDefinedInfo(varargin)
%DAQMXGETCALUSERDEFINEDINFO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCalUserDefinedInfo(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCalUserDefinedInfo',varargin{:});
