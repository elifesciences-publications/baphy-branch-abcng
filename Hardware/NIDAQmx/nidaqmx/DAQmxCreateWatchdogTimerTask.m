function varargout = DAQmxCreateWatchdogTimerTask(varargin)
%DAQMXCREATEWATCHDOGTIMERTASK calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, uint32Ptr, cstring, voidPtr] DAQmxCreateWatchdogTimerTask(cstring, cstring, uint32Ptr, double, cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateWatchdogTimerTask',varargin{:});
