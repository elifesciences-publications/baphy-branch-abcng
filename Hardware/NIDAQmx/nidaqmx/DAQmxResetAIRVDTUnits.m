function varargout = DAQmxResetAIRVDTUnits(varargin)
%DAQMXRESETAIRVDTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRVDTUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRVDTUnits',varargin{:});
