function varargout = DAQmxCreateAIVoltageRMSChan(varargin)
%DAQMXCREATEAIVOLTAGERMSCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAIVoltageRMSChan(uint32, cstring, cstring, int32, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIVoltageRMSChan',varargin{:});
