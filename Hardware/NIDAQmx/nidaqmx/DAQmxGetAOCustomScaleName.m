function varargout = DAQmxGetAOCustomScaleName(varargin)
%DAQMXGETAOCUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAOCustomScaleName(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOCustomScaleName',varargin{:});
