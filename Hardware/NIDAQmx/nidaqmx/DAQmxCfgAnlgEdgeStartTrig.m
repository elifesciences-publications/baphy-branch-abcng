function varargout = DAQmxCfgAnlgEdgeStartTrig(varargin)
%DAQMXCFGANLGEDGESTARTTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgAnlgEdgeStartTrig(uint32, cstring, int32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgAnlgEdgeStartTrig',varargin{:});
