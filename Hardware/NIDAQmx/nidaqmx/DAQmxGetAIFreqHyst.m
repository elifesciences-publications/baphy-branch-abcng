function varargout = DAQmxGetAIFreqHyst(varargin)
%DAQMXGETAIFREQHYST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIFreqHyst(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIFreqHyst',varargin{:});
