function varargout = DAQmxSetDOOvercurrentLimit(varargin)
%DAQMXSETDOOVERCURRENTLIMIT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOOvercurrentLimit(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOOvercurrentLimit',varargin{:});
