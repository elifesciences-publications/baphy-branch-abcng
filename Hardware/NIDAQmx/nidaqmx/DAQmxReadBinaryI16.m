function varargout = DAQmxReadBinaryI16(varargin)
%DAQMXREADBINARYI16 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int16Ptr, int32Ptr, uint32Ptr] DAQmxReadBinaryI16(uint32, int32, double, uint32, int16Ptr, uint32, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadBinaryI16',varargin{:});
