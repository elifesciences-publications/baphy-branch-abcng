function varargout = DAQmxGetSampClkTimebaseDiv(varargin)
%DAQMXGETSAMPCLKTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetSampClkTimebaseDiv(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkTimebaseDiv',varargin{:});
