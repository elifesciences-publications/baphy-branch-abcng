function varargout = DAQmxCreateAIMicrophoneChan(varargin)
%DAQMXCREATEAIMICROPHONECHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAIMicrophoneChan(uint32, cstring, cstring, int32, int32, double, double, int32, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIMicrophoneChan',varargin{:});
