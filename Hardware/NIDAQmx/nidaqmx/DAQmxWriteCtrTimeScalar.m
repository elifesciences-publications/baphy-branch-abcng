function varargout = DAQmxWriteCtrTimeScalar(varargin)
%DAQMXWRITECTRTIMESCALAR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxWriteCtrTimeScalar(uint32, uint32, double, double, double, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteCtrTimeScalar',varargin{:});
