function varargout = DAQmxGetCIPeriodDigFltrTimebaseRate(varargin)
%DAQMXGETCIPERIODDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIPeriodDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodDigFltrTimebaseRate',varargin{:});
