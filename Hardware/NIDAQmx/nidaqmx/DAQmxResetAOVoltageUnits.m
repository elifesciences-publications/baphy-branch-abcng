function varargout = DAQmxResetAOVoltageUnits(varargin)
%DAQMXRESETAOVOLTAGEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOVoltageUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOVoltageUnits',varargin{:});
