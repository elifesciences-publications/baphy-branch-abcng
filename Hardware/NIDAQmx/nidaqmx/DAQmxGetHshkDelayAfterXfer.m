function varargout = DAQmxGetHshkDelayAfterXfer(varargin)
%DAQMXGETHSHKDELAYAFTERXFER calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetHshkDelayAfterXfer(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetHshkDelayAfterXfer',varargin{:});
