function varargout = DAQmxGetAnlgWinRefTrigSrc(varargin)
%DAQMXGETANLGWINREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetAnlgWinRefTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinRefTrigSrc',varargin{:});
