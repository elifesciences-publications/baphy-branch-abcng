function varargout = DAQmxGetSwitchDevSettled(varargin)
%DAQMXGETSWITCHDEVSETTLED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSwitchDevSettled(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevSettled',varargin{:});
