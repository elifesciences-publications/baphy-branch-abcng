function varargout = DAQmxSetAIEnhancedAliasRejectionEnable(varargin)
%DAQMXSETAIENHANCEDALIASREJECTIONENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIEnhancedAliasRejectionEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIEnhancedAliasRejectionEnable',varargin{:});
