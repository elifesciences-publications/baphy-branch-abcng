function varargout = DAQmxGetExportedSampClkPulsePolarity(varargin)
%DAQMXGETEXPORTEDSAMPCLKPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedSampClkPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedSampClkPulsePolarity',varargin{:});
