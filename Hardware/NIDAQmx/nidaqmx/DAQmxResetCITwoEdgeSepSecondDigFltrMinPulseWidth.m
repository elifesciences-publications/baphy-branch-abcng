function varargout = DAQmxResetCITwoEdgeSepSecondDigFltrMinPulseWidth(varargin)
%DAQMXRESETCITWOEDGESEPSECONDDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepSecondDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepSecondDigFltrMinPulseWidth',varargin{:});
