function varargout = DAQmxGetCICtrTimebaseDigFltrTimebaseSrc(varargin)
%DAQMXGETCICTRTIMEBASEDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCICtrTimebaseDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseDigFltrTimebaseSrc',varargin{:});
