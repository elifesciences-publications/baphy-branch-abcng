function varargout = DAQmxResetCIAngEncoderUnits(varargin)
%DAQMXRESETCIANGENCODERUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIAngEncoderUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIAngEncoderUnits',varargin{:});
