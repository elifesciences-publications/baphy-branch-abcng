function varargout = DAQmxWriteBinaryI16(varargin)
%DAQMXWRITEBINARYI16 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int16Ptr, int32Ptr, uint32Ptr] DAQmxWriteBinaryI16(uint32, int32, uint32, double, uint32, int16Ptr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteBinaryI16',varargin{:});
