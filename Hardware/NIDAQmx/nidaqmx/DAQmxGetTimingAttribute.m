function varargout = DAQmxGetTimingAttribute(varargin)
%DAQMXGETTIMINGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxGetTimingAttribute(uint32, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTimingAttribute',varargin{:});
