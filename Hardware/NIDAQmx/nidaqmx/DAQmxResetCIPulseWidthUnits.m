function varargout = DAQmxResetCIPulseWidthUnits(varargin)
%DAQMXRESETCIPULSEWIDTHUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPulseWidthUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPulseWidthUnits',varargin{:});
