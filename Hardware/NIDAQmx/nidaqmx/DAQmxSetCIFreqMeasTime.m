function varargout = DAQmxSetCIFreqMeasTime(varargin)
%DAQMXSETCIFREQMEASTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqMeasTime(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqMeasTime',varargin{:});
