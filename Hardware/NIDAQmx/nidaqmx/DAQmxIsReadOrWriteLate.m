function varargout = DAQmxIsReadOrWriteLate(varargin)
%DAQMXISREADORWRITELATE calls nidaqmx library with the appropriate arguments.
%
...
%	uint32 DAQmxIsReadOrWriteLate(int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxIsReadOrWriteLate',varargin{:});
