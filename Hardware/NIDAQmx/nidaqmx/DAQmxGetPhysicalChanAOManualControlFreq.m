function varargout = DAQmxGetPhysicalChanAOManualControlFreq(varargin)
%DAQMXGETPHYSICALCHANAOMANUALCONTROLFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetPhysicalChanAOManualControlFreq(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanAOManualControlFreq',varargin{:});
