function varargout = DAQmxSetCIPeriodDiv(varargin)
%DAQMXSETCIPERIODDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodDiv(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodDiv',varargin{:});
