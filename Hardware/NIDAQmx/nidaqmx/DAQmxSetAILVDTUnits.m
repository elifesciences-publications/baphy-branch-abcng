function varargout = DAQmxSetAILVDTUnits(varargin)
%DAQMXSETAILVDTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILVDTUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILVDTUnits',varargin{:});
