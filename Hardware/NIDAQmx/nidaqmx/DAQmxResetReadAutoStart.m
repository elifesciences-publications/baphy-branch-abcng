function varargout = DAQmxResetReadAutoStart(varargin)
%DAQMXRESETREADAUTOSTART calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadAutoStart(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadAutoStart',varargin{:});
