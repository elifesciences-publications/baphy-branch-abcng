function varargout = DAQmxResetBufOutputBufSize(varargin)
%DAQMXRESETBUFOUTPUTBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetBufOutputBufSize(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetBufOutputBufSize',varargin{:});
