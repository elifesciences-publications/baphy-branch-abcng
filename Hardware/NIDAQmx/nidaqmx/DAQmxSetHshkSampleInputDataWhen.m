function varargout = DAQmxSetHshkSampleInputDataWhen(varargin)
%DAQMXSETHSHKSAMPLEINPUTDATAWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetHshkSampleInputDataWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetHshkSampleInputDataWhen',varargin{:});
