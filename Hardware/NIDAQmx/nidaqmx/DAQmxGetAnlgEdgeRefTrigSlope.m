function varargout = DAQmxGetAnlgEdgeRefTrigSlope(varargin)
%DAQMXGETANLGEDGEREFTRIGSLOPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgEdgeRefTrigSlope(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeRefTrigSlope',varargin{:});
