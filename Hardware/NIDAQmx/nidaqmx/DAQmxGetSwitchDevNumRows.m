function varargout = DAQmxGetSwitchDevNumRows(varargin)
%DAQMXGETSWITCHDEVNUMROWS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSwitchDevNumRows(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevNumRows',varargin{:});
