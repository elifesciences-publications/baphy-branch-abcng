function varargout = DAQmxResetHshkSampleInputDataWhen(varargin)
%DAQMXRESETHSHKSAMPLEINPUTDATAWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetHshkSampleInputDataWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetHshkSampleInputDataWhen',varargin{:});
