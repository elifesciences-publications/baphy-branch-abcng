function varargout = DAQmxSetCICtrTimebaseRate(varargin)
%DAQMXSETCICTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICtrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICtrTimebaseRate',varargin{:});
