function varargout = DAQmxGetAIExcitSrc(varargin)
%DAQMXGETAIEXCITSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIExcitSrc(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIExcitSrc',varargin{:});
