function varargout = DAQmxSetDigLvlPauseTrigDigFltrMinPulseWidth(varargin)
%DAQMXSETDIGLVLPAUSETRIGDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigLvlPauseTrigDigFltrMinPulseWidth(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigLvlPauseTrigDigFltrMinPulseWidth',varargin{:});
