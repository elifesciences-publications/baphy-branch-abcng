function varargout = DAQmxSetCIEncoderBInputTerm(varargin)
%DAQMXSETCIENCODERBINPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIEncoderBInputTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderBInputTerm',varargin{:});
