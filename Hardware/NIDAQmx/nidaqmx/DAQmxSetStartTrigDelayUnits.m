function varargout = DAQmxSetStartTrigDelayUnits(varargin)
%DAQMXSETSTARTTRIGDELAYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetStartTrigDelayUnits(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetStartTrigDelayUnits',varargin{:});
