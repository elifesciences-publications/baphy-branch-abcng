function varargout = DAQmxGetSwitchChanMaxACVoltage(varargin)
%DAQMXGETSWITCHCHANMAXACVOLTAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxACVoltage(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxACVoltage',varargin{:});
