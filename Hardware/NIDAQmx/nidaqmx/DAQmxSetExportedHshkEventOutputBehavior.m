function varargout = DAQmxSetExportedHshkEventOutputBehavior(varargin)
%DAQMXSETEXPORTEDHSHKEVENTOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedHshkEventOutputBehavior(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedHshkEventOutputBehavior',varargin{:});
