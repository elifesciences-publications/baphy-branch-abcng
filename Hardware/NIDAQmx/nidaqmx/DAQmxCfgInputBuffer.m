function varargout = DAQmxCfgInputBuffer(varargin)
%DAQMXCFGINPUTBUFFER calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxCfgInputBuffer(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgInputBuffer',varargin{:});
