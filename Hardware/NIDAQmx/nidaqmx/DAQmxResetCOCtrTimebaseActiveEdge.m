function varargout = DAQmxResetCOCtrTimebaseActiveEdge(varargin)
%DAQMXRESETCOCTRTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOCtrTimebaseActiveEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOCtrTimebaseActiveEdge',varargin{:});
