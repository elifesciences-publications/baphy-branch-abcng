function varargout = DAQmxSetCICtrTimebaseDigFltrEnable(varargin)
%DAQMXSETCICTRTIMEBASEDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICtrTimebaseDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICtrTimebaseDigFltrEnable',varargin{:});
