function varargout = DAQmxResetDigLvlPauseTrigDigSyncEnable(varargin)
%DAQMXRESETDIGLVLPAUSETRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigLvlPauseTrigDigSyncEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigLvlPauseTrigDigSyncEnable',varargin{:});
