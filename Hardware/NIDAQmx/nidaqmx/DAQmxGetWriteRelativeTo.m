function varargout = DAQmxGetWriteRelativeTo(varargin)
%DAQMXGETWRITERELATIVETO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetWriteRelativeTo(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteRelativeTo',varargin{:});
