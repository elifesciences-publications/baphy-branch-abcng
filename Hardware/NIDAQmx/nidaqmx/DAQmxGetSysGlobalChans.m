function varargout = DAQmxGetSysGlobalChans(varargin)
%DAQMXGETSYSGLOBALCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetSysGlobalChans(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSysGlobalChans',varargin{:});
