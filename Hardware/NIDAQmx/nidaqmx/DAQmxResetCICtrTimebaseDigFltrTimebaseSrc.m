function varargout = DAQmxResetCICtrTimebaseDigFltrTimebaseSrc(varargin)
%DAQMXRESETCICTRTIMEBASEDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseDigFltrTimebaseSrc',varargin{:});
