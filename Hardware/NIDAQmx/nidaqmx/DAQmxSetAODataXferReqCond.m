function varargout = DAQmxSetAODataXferReqCond(varargin)
%DAQMXSETAODATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODataXferReqCond(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODataXferReqCond',varargin{:});
