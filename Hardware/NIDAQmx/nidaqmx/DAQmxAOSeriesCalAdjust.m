function varargout = DAQmxAOSeriesCalAdjust(varargin)
%DAQMXAOSERIESCALADJUST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAOSeriesCalAdjust(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAOSeriesCalAdjust',varargin{:});
