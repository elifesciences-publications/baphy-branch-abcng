function varargout = DAQmxResetCICountEdgesCountDirDigSyncEnable(varargin)
%DAQMXRESETCICOUNTEDGESCOUNTDIRDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesCountDirDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesCountDirDigSyncEnable',varargin{:});
