function varargout = DAQmxSetChanAttribute(varargin)
%DAQMXSETCHANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr] DAQmxSetChanAttribute(uint32, cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetChanAttribute',varargin{:});
