function varargout = DAQmxSetCOCtrTimebaseActiveEdge(varargin)
%DAQMXSETCOCTRTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOCtrTimebaseActiveEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseActiveEdge',varargin{:});
