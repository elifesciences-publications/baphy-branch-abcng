function varargout = DAQmxGetSelfCalSupported(varargin)
%DAQMXGETSELFCALSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSelfCalSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSelfCalSupported',varargin{:});
