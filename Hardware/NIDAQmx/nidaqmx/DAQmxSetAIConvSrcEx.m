function varargout = DAQmxSetAIConvSrcEx(varargin)
%DAQMXSETAICONVSRCEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetAIConvSrcEx(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvSrcEx',varargin{:});
