function varargout = DAQmxSetCIPeriodDigFltrTimebaseSrc(varargin)
%DAQMXSETCIPERIODDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIPeriodDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodDigFltrTimebaseSrc',varargin{:});
