function varargout = DAQmxGetSysScales(varargin)
%DAQMXGETSYSSCALES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetSysScales(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSysScales',varargin{:});
