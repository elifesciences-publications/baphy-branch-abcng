function varargout = DAQmxResetAOEnhancedImageRejectionEnable(varargin)
%DAQMXRESETAOENHANCEDIMAGEREJECTIONENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOEnhancedImageRejectionEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOEnhancedImageRejectionEnable',varargin{:});
