function varargout = DAQmxGetWriteTotalSampPerChanGenerated(varargin)
%DAQMXGETWRITETOTALSAMPPERCHANGENERATED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint64Ptr] DAQmxGetWriteTotalSampPerChanGenerated(uint32, uint64Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteTotalSampPerChanGenerated',varargin{:});
