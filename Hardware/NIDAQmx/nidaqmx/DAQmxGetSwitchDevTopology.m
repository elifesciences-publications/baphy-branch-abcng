function varargout = DAQmxGetSwitchDevTopology(varargin)
%DAQMXGETSWITCHDEVTOPOLOGY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetSwitchDevTopology(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevTopology',varargin{:});
