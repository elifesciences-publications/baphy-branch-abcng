function varargout = DAQmxGetAILowpassSwitchCapExtClkFreq(varargin)
%DAQMXGETAILOWPASSSWITCHCAPEXTCLKFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAILowpassSwitchCapExtClkFreq(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILowpassSwitchCapExtClkFreq',varargin{:});
