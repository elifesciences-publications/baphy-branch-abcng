function varargout = DAQmxGetCIEncoderDecodingType(varargin)
%DAQMXGETCIENCODERDECODINGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIEncoderDecodingType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderDecodingType',varargin{:});
