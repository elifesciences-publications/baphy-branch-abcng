function varargout = DAQmxGetCITCReached(varargin)
%DAQMXGETCITCREACHED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCITCReached(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITCReached',varargin{:});
