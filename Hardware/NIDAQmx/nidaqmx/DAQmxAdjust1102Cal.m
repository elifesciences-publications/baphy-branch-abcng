function varargout = DAQmxAdjust1102Cal(varargin)
%DAQMXADJUST1102CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1102Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1102Cal',varargin{:});
