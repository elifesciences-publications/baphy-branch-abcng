function varargout = DAQmxGetAIEnhancedAliasRejectionEnable(varargin)
%DAQMXGETAIENHANCEDALIASREJECTIONENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIEnhancedAliasRejectionEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIEnhancedAliasRejectionEnable',varargin{:});
