function varargout = DAQmxResetAOTermCfg(varargin)
%DAQMXRESETAOTERMCFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOTermCfg(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOTermCfg',varargin{:});
