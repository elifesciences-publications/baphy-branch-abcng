function varargout = DAQmxSetDelayFromSampClkDelayUnits(varargin)
%DAQMXSETDELAYFROMSAMPCLKDELAYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDelayFromSampClkDelayUnits(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDelayFromSampClkDelayUnits',varargin{:});
