function varargout = DAQmxAdjust4224Cal(varargin)
%DAQMXADJUST4224CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxAdjust4224Cal(uint32, cstring, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust4224Cal',varargin{:});
