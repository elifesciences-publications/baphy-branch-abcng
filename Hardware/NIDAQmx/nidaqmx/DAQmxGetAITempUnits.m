function varargout = DAQmxGetAITempUnits(varargin)
%DAQMXGETAITEMPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAITempUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAITempUnits',varargin{:});
