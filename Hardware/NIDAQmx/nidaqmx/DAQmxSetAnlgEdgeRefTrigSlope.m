function varargout = DAQmxSetAnlgEdgeRefTrigSlope(varargin)
%DAQMXSETANLGEDGEREFTRIGSLOPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgEdgeRefTrigSlope(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeRefTrigSlope',varargin{:});
