function varargout = DAQmxGetExportedAdvTrigPulsePolarity(varargin)
%DAQMXGETEXPORTEDADVTRIGPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedAdvTrigPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAdvTrigPulsePolarity',varargin{:});
