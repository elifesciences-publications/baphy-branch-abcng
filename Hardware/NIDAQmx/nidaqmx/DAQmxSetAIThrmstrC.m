function varargout = DAQmxSetAIThrmstrC(varargin)
%DAQMXSETAITHRMSTRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIThrmstrC(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIThrmstrC',varargin{:});
