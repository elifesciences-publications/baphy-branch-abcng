function varargout = DAQmxReadDigitalLines(varargin)
%DAQMXREADDIGITALLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint8Ptr, int32Ptr, int32Ptr, uint32Ptr] DAQmxReadDigitalLines(uint32, int32, double, uint32, uint8Ptr, uint32, int32Ptr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadDigitalLines',varargin{:});
