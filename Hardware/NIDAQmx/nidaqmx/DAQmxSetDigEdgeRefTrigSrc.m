function varargout = DAQmxSetDigEdgeRefTrigSrc(varargin)
%DAQMXSETDIGEDGEREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigEdgeRefTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeRefTrigSrc',varargin{:});
