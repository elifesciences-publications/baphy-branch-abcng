function varargout = DAQmxSetAnlgEdgeStartTrigSrc(varargin)
%DAQMXSETANLGEDGESTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAnlgEdgeStartTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeStartTrigSrc',varargin{:});
