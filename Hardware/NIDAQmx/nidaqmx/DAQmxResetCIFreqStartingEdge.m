function varargout = DAQmxResetCIFreqStartingEdge(varargin)
%DAQMXRESETCIFREQSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqStartingEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqStartingEdge',varargin{:});
