function varargout = DAQmxResetMasterTimebaseSrc(varargin)
%DAQMXRESETMASTERTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetMasterTimebaseSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetMasterTimebaseSrc',varargin{:});
