function varargout = DAQmxGetAnlgWinStartTrigWhen(varargin)
%DAQMXGETANLGWINSTARTTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgWinStartTrigWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinStartTrigWhen',varargin{:});
