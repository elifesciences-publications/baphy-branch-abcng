function varargout = DAQmxGetExtCalLastDateAndTime(varargin)
%DAQMXGETEXTCALLASTDATEANDTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr] DAQmxGetExtCalLastDateAndTime(cstring, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExtCalLastDateAndTime',varargin{:});
