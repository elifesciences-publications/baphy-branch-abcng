function varargout = DAQmxResetExportedChangeDetectEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDCHANGEDETECTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedChangeDetectEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedChangeDetectEventOutputTerm',varargin{:});
