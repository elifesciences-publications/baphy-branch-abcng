function varargout = DAQmxSetCIPulseWidthUnits(varargin)
%DAQMXSETCIPULSEWIDTHUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPulseWidthUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPulseWidthUnits',varargin{:});
