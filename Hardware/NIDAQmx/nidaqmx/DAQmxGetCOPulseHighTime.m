function varargout = DAQmxGetCOPulseHighTime(varargin)
%DAQMXGETCOPULSEHIGHTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOPulseHighTime(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseHighTime',varargin{:});
