function varargout = DAQmxSaveGlobalChan(varargin)
%DAQMXSAVEGLOBALCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxSaveGlobalChan(uint32, cstring, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSaveGlobalChan',varargin{:});
