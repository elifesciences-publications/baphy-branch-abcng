function varargout = DAQmxSetCIDupCountPrevent(varargin)
%DAQMXSETCIDUPCOUNTPREVENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIDupCountPrevent(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIDupCountPrevent',varargin{:});
