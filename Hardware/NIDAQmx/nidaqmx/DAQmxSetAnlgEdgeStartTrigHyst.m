function varargout = DAQmxSetAnlgEdgeStartTrigHyst(varargin)
%DAQMXSETANLGEDGESTARTTRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgEdgeStartTrigHyst(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeStartTrigHyst',varargin{:});
