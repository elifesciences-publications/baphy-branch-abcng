function varargout = DAQmxGetExportedHshkEventOutputBehavior(varargin)
%DAQMXGETEXPORTEDHSHKEVENTOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedHshkEventOutputBehavior(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedHshkEventOutputBehavior',varargin{:});
