function varargout = DAQmxGetAOReglitchEnable(varargin)
%DAQMXGETAOREGLITCHENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAOReglitchEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOReglitchEnable',varargin{:});
