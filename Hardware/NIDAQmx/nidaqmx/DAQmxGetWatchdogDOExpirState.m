function varargout = DAQmxGetWatchdogDOExpirState(varargin)
%DAQMXGETWATCHDOGDOEXPIRSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetWatchdogDOExpirState(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWatchdogDOExpirState',varargin{:});
