function varargout = DAQmxGetDigPatternStartTrigWhen(varargin)
%DAQMXGETDIGPATTERNSTARTTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigPatternStartTrigWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternStartTrigWhen',varargin{:});
