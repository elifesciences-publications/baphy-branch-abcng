function varargout = DAQmxSaveTask(varargin)
%DAQMXSAVETASK calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSaveTask(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSaveTask',varargin{:});
