function varargout = DAQmxWriteToTEDSFromArray(varargin)
%DAQMXWRITETOTEDSFROMARRAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint8Ptr] DAQmxWriteToTEDSFromArray(cstring, uint8Ptr, uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteToTEDSFromArray',varargin{:});
