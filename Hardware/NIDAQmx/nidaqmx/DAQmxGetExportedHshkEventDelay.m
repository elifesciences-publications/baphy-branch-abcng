function varargout = DAQmxGetExportedHshkEventDelay(varargin)
%DAQMXGETEXPORTEDHSHKEVENTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetExportedHshkEventDelay(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedHshkEventDelay',varargin{:});
