function varargout = DAQmxResetReadChannelsToRead(varargin)
%DAQMXRESETREADCHANNELSTOREAD calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetReadChannelsToRead(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetReadChannelsToRead',varargin{:});
