function varargout = DAQmxGetAnlgWinRefTrigCoupling(varargin)
%DAQMXGETANLGWINREFTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgWinRefTrigCoupling(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinRefTrigCoupling',varargin{:});
