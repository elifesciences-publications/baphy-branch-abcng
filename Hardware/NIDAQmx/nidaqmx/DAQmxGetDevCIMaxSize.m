function varargout = DAQmxGetDevCIMaxSize(varargin)
%DAQMXGETDEVCIMAXSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevCIMaxSize(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCIMaxSize',varargin{:});
