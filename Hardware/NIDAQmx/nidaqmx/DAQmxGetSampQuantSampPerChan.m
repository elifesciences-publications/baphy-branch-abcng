function varargout = DAQmxGetSampQuantSampPerChan(varargin)
%DAQMXGETSAMPQUANTSAMPPERCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint64Ptr] DAQmxGetSampQuantSampPerChan(uint32, uint64Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampQuantSampPerChan',varargin{:});
