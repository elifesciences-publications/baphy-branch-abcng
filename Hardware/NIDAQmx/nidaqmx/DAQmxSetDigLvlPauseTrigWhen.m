function varargout = DAQmxSetDigLvlPauseTrigWhen(varargin)
%DAQMXSETDIGLVLPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigLvlPauseTrigWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigLvlPauseTrigWhen',varargin{:});
