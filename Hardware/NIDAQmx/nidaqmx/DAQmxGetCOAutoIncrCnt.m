function varargout = DAQmxGetCOAutoIncrCnt(varargin)
%DAQMXGETCOAUTOINCRCNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOAutoIncrCnt(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOAutoIncrCnt',varargin{:});
