function varargout = DAQmxGetAILVDTSensitivity(varargin)
%DAQMXGETAILVDTSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAILVDTSensitivity(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILVDTSensitivity',varargin{:});
