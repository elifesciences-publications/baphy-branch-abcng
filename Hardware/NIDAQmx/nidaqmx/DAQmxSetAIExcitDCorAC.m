function varargout = DAQmxSetAIExcitDCorAC(varargin)
%DAQMXSETAIEXCITDCORAC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIExcitDCorAC(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIExcitDCorAC',varargin{:});
