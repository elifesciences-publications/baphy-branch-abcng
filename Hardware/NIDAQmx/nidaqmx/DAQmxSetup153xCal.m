function varargout = DAQmxSetup153xCal(varargin)
%DAQMXSETUP153XCAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup153xCal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup153xCal',varargin{:});
