function varargout = DAQmxGetCITwoEdgeSepFirstDigFltrTimebaseRate(varargin)
%DAQMXGETCITWOEDGESEPFIRSTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCITwoEdgeSepFirstDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepFirstDigFltrTimebaseRate',varargin{:});
