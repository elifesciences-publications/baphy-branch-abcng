function varargout = DAQmxGetAIMeasType(varargin)
%DAQMXGETAIMEASTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIMeasType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIMeasType',varargin{:});
