function varargout = DAQmxSetReadAttribute(varargin)
%DAQMXSETREADATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxSetReadAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadAttribute',varargin{:});
