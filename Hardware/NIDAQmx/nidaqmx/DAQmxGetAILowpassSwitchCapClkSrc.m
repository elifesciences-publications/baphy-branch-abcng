function varargout = DAQmxGetAILowpassSwitchCapClkSrc(varargin)
%DAQMXGETAILOWPASSSWITCHCAPCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAILowpassSwitchCapClkSrc(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILowpassSwitchCapClkSrc',varargin{:});
