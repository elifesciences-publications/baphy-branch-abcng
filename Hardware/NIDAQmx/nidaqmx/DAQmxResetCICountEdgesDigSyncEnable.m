function varargout = DAQmxResetCICountEdgesDigSyncEnable(varargin)
%DAQMXRESETCICOUNTEDGESDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesDigSyncEnable',varargin{:});
