function varargout = DAQmxGetAODACRefAllowConnToGnd(varargin)
%DAQMXGETAODACREFALLOWCONNTOGND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAODACRefAllowConnToGnd(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACRefAllowConnToGnd',varargin{:});
