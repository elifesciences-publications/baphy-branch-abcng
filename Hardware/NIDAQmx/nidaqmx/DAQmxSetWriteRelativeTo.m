function varargout = DAQmxSetWriteRelativeTo(varargin)
%DAQMXSETWRITERELATIVETO calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetWriteRelativeTo(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWriteRelativeTo',varargin{:});
