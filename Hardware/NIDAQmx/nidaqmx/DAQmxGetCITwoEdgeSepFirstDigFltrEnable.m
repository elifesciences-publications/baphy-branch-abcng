function varargout = DAQmxGetCITwoEdgeSepFirstDigFltrEnable(varargin)
%DAQMXGETCITWOEDGESEPFIRSTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCITwoEdgeSepFirstDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepFirstDigFltrEnable',varargin{:});
