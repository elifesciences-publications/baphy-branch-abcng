function varargout = DAQmxGetAIDataXferReqCond(varargin)
%DAQMXGETAIDATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIDataXferReqCond(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIDataXferReqCond',varargin{:});
