function varargout = DAQmxGetArmStartTrigType(varargin)
%DAQMXGETARMSTARTTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetArmStartTrigType(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetArmStartTrigType',varargin{:});
