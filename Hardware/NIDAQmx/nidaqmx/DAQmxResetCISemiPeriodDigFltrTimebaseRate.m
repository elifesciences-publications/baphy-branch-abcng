function varargout = DAQmxResetCISemiPeriodDigFltrTimebaseRate(varargin)
%DAQMXRESETCISEMIPERIODDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCISemiPeriodDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCISemiPeriodDigFltrTimebaseRate',varargin{:});
