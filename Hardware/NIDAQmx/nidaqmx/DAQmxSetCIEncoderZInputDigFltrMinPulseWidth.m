function varargout = DAQmxSetCIEncoderZInputDigFltrMinPulseWidth(varargin)
%DAQMXSETCIENCODERZINPUTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderZInputDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZInputDigFltrMinPulseWidth',varargin{:});
