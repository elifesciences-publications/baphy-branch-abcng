function varargout = DAQmxGetCIPeriodMeasMeth(varargin)
%DAQMXGETCIPERIODMEASMETH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIPeriodMeasMeth(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodMeasMeth',varargin{:});
