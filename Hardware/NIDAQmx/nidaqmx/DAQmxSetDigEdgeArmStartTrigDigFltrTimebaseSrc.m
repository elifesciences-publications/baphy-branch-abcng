function varargout = DAQmxSetDigEdgeArmStartTrigDigFltrTimebaseSrc(varargin)
%DAQMXSETDIGEDGEARMSTARTTRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigEdgeArmStartTrigDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeArmStartTrigDigFltrTimebaseSrc',varargin{:});
