function varargout = DAQmxSetCIPulseWidthDigFltrMinPulseWidth(varargin)
%DAQMXSETCIPULSEWIDTHDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPulseWidthDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPulseWidthDigFltrMinPulseWidth',varargin{:});
