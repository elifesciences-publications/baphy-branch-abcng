function varargout = DAQmxSetExported20MHzTimebaseOutputTerm(varargin)
%DAQMXSETEXPORTED20MHZTIMEBASEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExported20MHzTimebaseOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExported20MHzTimebaseOutputTerm',varargin{:});
