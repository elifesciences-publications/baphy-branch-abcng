function varargout = DAQmxGetAIStrainGageGageFactor(varargin)
%DAQMXGETAISTRAINGAGEGAGEFACTOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIStrainGageGageFactor(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIStrainGageGageFactor',varargin{:});
