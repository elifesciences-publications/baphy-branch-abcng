function varargout = DAQmxSetup1141Cal(varargin)
%DAQMXSETUP1141CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1141Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1141Cal',varargin{:});
