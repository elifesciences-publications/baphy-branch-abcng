function varargout = DAQmxSetExportedCtrOutEventPulsePolarity(varargin)
%DAQMXSETEXPORTEDCTROUTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedCtrOutEventPulsePolarity(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedCtrOutEventPulsePolarity',varargin{:});
