function varargout = DAQmxSetHshkTrigType(varargin)
%DAQMXSETHSHKTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetHshkTrigType(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetHshkTrigType',varargin{:});
