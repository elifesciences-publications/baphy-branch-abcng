function varargout = DAQmxResetDigPatternPauseTrigPattern(varargin)
%DAQMXRESETDIGPATTERNPAUSETRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternPauseTrigPattern(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternPauseTrigPattern',varargin{:});
