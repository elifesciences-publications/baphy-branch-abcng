function varargout = DAQmxResetAICurrentShuntResistance(varargin)
%DAQMXRESETAICURRENTSHUNTRESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAICurrentShuntResistance(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAICurrentShuntResistance',varargin{:});
