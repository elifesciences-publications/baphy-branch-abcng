function varargout = DAQmxSetCIUsbXferReqSize(varargin)
%DAQMXSETCIUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIUsbXferReqSize(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIUsbXferReqSize',varargin{:});
