function varargout = DAQmxSetCIPulseWidthStartingEdge(varargin)
%DAQMXSETCIPULSEWIDTHSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPulseWidthStartingEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPulseWidthStartingEdge',varargin{:});
