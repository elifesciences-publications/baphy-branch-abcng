function varargout = DAQmxGetSampClkTimebaseSrc(varargin)
%DAQMXGETSAMPCLKTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetSampClkTimebaseSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkTimebaseSrc',varargin{:});
