function varargout = DAQmxGetReadOverloadedChans(varargin)
%DAQMXGETREADOVERLOADEDCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetReadOverloadedChans(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOverloadedChans',varargin{:});
