function varargout = DAQmxResetExportedDataActiveEventLvlActiveLvl(varargin)
%DAQMXRESETEXPORTEDDATAACTIVEEVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedDataActiveEventLvlActiveLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedDataActiveEventLvlActiveLvl',varargin{:});
