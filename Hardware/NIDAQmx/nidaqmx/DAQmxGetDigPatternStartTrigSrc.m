function varargout = DAQmxGetDigPatternStartTrigSrc(varargin)
%DAQMXGETDIGPATTERNSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigPatternStartTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternStartTrigSrc',varargin{:});
