function varargout = DAQmxSetSampClkTimebaseActiveEdge(varargin)
%DAQMXSETSAMPCLKTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkTimebaseActiveEdge(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkTimebaseActiveEdge',varargin{:});
