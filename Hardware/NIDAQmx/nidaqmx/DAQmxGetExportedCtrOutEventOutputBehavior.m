function varargout = DAQmxGetExportedCtrOutEventOutputBehavior(varargin)
%DAQMXGETEXPORTEDCTROUTEVENTOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedCtrOutEventOutputBehavior(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedCtrOutEventOutputBehavior',varargin{:});
