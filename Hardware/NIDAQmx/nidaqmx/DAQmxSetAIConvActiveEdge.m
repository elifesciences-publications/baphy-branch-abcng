function varargout = DAQmxSetAIConvActiveEdge(varargin)
%DAQMXSETAICONVACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAIConvActiveEdge(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvActiveEdge',varargin{:});
