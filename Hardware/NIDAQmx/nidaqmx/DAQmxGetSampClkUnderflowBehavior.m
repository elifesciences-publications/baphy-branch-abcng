function varargout = DAQmxGetSampClkUnderflowBehavior(varargin)
%DAQMXGETSAMPCLKUNDERFLOWBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetSampClkUnderflowBehavior(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkUnderflowBehavior',varargin{:});
