function varargout = DAQmxGetDevCIMaxTimebase(varargin)
%DAQMXGETDEVCIMAXTIMEBASE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevCIMaxTimebase(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCIMaxTimebase',varargin{:});
