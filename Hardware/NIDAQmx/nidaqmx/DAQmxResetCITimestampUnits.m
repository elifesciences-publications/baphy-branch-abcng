function varargout = DAQmxResetCITimestampUnits(varargin)
%DAQMXRESETCITIMESTAMPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITimestampUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITimestampUnits',varargin{:});
