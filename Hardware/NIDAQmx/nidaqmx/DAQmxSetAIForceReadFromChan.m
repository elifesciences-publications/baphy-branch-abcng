function varargout = DAQmxSetAIForceReadFromChan(varargin)
%DAQMXSETAIFORCEREADFROMCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIForceReadFromChan(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIForceReadFromChan',varargin{:});
