function varargout = DAQmxSetCIPeriodMeasTime(varargin)
%DAQMXSETCIPERIODMEASTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodMeasTime(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodMeasTime',varargin{:});
