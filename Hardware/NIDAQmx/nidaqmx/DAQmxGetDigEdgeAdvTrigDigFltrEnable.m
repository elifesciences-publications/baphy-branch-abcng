function varargout = DAQmxGetDigEdgeAdvTrigDigFltrEnable(varargin)
%DAQMXGETDIGEDGEADVTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetDigEdgeAdvTrigDigFltrEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeAdvTrigDigFltrEnable',varargin{:});
