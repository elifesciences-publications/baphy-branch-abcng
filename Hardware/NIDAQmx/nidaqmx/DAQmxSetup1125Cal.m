function varargout = DAQmxSetup1125Cal(varargin)
%DAQMXSETUP1125CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1125Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1125Cal',varargin{:});
