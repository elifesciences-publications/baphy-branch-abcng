function varargout = DAQmxSetCIPulseWidthDigFltrTimebaseSrc(varargin)
%DAQMXSETCIPULSEWIDTHDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIPulseWidthDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPulseWidthDigFltrTimebaseSrc',varargin{:});
