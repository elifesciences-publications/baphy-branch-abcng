function varargout = DAQmxGetExportedHshkEventPulseWidth(varargin)
%DAQMXGETEXPORTEDHSHKEVENTPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetExportedHshkEventPulseWidth(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedHshkEventPulseWidth',varargin{:});
