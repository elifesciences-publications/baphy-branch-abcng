function varargout = DAQmxResetAnlgWinStartTrigSrc(varargin)
%DAQMXRESETANLGWINSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinStartTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinStartTrigSrc',varargin{:});
