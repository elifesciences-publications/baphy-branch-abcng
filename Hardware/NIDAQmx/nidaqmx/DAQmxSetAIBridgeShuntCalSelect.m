function varargout = DAQmxSetAIBridgeShuntCalSelect(varargin)
%DAQMXSETAIBRIDGESHUNTCALSELECT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIBridgeShuntCalSelect(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIBridgeShuntCalSelect',varargin{:});
