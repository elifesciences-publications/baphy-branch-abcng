function varargout = DAQmxCfgAnlgWindowStartTrig(varargin)
%DAQMXCFGANLGWINDOWSTARTTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgAnlgWindowStartTrig(uint32, cstring, int32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgAnlgWindowStartTrig',varargin{:});
