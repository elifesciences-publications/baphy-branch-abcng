function varargout = DAQmxResetAILeadWireResistance(varargin)
%DAQMXRESETAILEADWIRERESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILeadWireResistance(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILeadWireResistance',varargin{:});
