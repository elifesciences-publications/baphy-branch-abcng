function varargout = DAQmxResetAIStrainGageCfg(varargin)
%DAQMXRESETAISTRAINGAGECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIStrainGageCfg(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIStrainGageCfg',varargin{:});
