function varargout = DAQmxResetCITimestampInitialSeconds(varargin)
%DAQMXRESETCITIMESTAMPINITIALSECONDS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITimestampInitialSeconds(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITimestampInitialSeconds',varargin{:});
