function varargout = DAQmxResetDigEdgeStartTrigSrc(varargin)
%DAQMXRESETDIGEDGESTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeStartTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeStartTrigSrc',varargin{:});
