function varargout = DAQmxSetAOFuncGenModulationType(varargin)
%DAQMXSETAOFUNCGENMODULATIONTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOFuncGenModulationType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOFuncGenModulationType',varargin{:});
