function varargout = DAQmxResetCICustomScaleName(varargin)
%DAQMXRESETCICUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICustomScaleName(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICustomScaleName',varargin{:});
