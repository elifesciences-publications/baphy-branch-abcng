function varargout = DAQmxResetDigEdgeArmStartTrigDigFltrTimebaseRate(varargin)
%DAQMXRESETDIGEDGEARMSTARTTRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeArmStartTrigDigFltrTimebaseRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeArmStartTrigDigFltrTimebaseRate',varargin{:});
