function varargout = DAQmxSetSampTimingEngine(varargin)
%DAQMXSETSAMPTIMINGENGINE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampTimingEngine(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampTimingEngine',varargin{:});
