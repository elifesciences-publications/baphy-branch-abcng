function varargout = DAQmxGetAOMax(varargin)
%DAQMXGETAOMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOMax(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOMax',varargin{:});
