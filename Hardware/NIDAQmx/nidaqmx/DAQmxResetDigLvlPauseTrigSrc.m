function varargout = DAQmxResetDigLvlPauseTrigSrc(varargin)
%DAQMXRESETDIGLVLPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigLvlPauseTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigLvlPauseTrigSrc',varargin{:});
