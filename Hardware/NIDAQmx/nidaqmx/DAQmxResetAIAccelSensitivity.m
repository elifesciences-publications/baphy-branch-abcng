function varargout = DAQmxResetAIAccelSensitivity(varargin)
%DAQMXRESETAIACCELSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIAccelSensitivity(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIAccelSensitivity',varargin{:});
