function varargout = DAQmxCreateAIVoltageChan(varargin)
%DAQMXCREATEAIVOLTAGECHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAIVoltageChan(uint32, cstring, cstring, int32, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIVoltageChan',varargin{:});
