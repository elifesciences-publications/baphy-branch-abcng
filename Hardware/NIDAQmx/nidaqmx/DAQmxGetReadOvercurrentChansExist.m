function varargout = DAQmxGetReadOvercurrentChansExist(varargin)
%DAQMXGETREADOVERCURRENTCHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadOvercurrentChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOvercurrentChansExist',varargin{:});
