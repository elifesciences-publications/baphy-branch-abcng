function varargout = DAQmxGetStartTrigRetriggerable(varargin)
%DAQMXGETSTARTTRIGRETRIGGERABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetStartTrigRetriggerable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetStartTrigRetriggerable',varargin{:});
