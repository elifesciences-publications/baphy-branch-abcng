function varargout = DAQmxGetScaleLinYIntercept(varargin)
%DAQMXGETSCALELINYINTERCEPT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetScaleLinYIntercept(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleLinYIntercept',varargin{:});
