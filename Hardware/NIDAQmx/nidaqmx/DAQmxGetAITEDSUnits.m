function varargout = DAQmxGetAITEDSUnits(varargin)
%DAQMXGETAITEDSUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAITEDSUnits(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAITEDSUnits',varargin{:});
