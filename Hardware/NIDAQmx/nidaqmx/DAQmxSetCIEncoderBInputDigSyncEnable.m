function varargout = DAQmxSetCIEncoderBInputDigSyncEnable(varargin)
%DAQMXSETCIENCODERBINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderBInputDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderBInputDigSyncEnable',varargin{:});
