function varargout = DAQmxGetCISemiPeriodDigFltrTimebaseRate(varargin)
%DAQMXGETCISEMIPERIODDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCISemiPeriodDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCISemiPeriodDigFltrTimebaseRate',varargin{:});
