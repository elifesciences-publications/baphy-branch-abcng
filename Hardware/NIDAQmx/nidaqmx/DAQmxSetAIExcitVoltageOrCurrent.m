function varargout = DAQmxSetAIExcitVoltageOrCurrent(varargin)
%DAQMXSETAIEXCITVOLTAGEORCURRENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIExcitVoltageOrCurrent(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIExcitVoltageOrCurrent',varargin{:});
