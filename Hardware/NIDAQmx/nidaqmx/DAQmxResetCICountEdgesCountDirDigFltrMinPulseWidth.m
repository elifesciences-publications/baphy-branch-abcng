function varargout = DAQmxResetCICountEdgesCountDirDigFltrMinPulseWidth(varargin)
%DAQMXRESETCICOUNTEDGESCOUNTDIRDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesCountDirDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesCountDirDigFltrMinPulseWidth',varargin{:});
