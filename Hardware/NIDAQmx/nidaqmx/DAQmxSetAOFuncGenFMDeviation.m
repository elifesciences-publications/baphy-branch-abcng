function varargout = DAQmxSetAOFuncGenFMDeviation(varargin)
%DAQMXSETAOFUNCGENFMDEVIATION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOFuncGenFMDeviation(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOFuncGenFMDeviation',varargin{:});
