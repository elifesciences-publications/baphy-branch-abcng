function varargout = DAQmxSetAIImpedance(varargin)
%DAQMXSETAIIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIImpedance(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIImpedance',varargin{:});
