function varargout = DAQmxSetAOFuncGenOffset(varargin)
%DAQMXSETAOFUNCGENOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOFuncGenOffset(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOFuncGenOffset',varargin{:});
