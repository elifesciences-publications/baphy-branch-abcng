function varargout = DAQmxResetAIChanCalVerifRefVals(varargin)
%DAQMXRESETAICHANCALVERIFREFVALS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalVerifRefVals(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalVerifRefVals',varargin{:});
