function varargout = DAQmxGetExportedAdvCmpltEventDelay(varargin)
%DAQMXGETEXPORTEDADVCMPLTEVENTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetExportedAdvCmpltEventDelay(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAdvCmpltEventDelay',varargin{:});
