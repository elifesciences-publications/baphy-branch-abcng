function varargout = DAQmxGetAIRTDC(varargin)
%DAQMXGETAIRTDC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIRTDC(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRTDC',varargin{:});
