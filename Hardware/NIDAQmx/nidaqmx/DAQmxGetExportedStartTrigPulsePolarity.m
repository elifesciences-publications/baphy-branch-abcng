function varargout = DAQmxGetExportedStartTrigPulsePolarity(varargin)
%DAQMXGETEXPORTEDSTARTTRIGPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedStartTrigPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedStartTrigPulsePolarity',varargin{:});
