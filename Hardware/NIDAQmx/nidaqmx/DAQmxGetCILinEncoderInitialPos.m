function varargout = DAQmxGetCILinEncoderInitialPos(varargin)
%DAQMXGETCILINENCODERINITIALPOS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCILinEncoderInitialPos(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCILinEncoderInitialPos',varargin{:});
