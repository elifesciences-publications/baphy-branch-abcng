function varargout = DAQmxSetSampClkDigFltrTimebaseRate(varargin)
%DAQMXSETSAMPCLKDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkDigFltrTimebaseRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkDigFltrTimebaseRate',varargin{:});
