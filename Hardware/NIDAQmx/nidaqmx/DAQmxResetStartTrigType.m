function varargout = DAQmxResetStartTrigType(varargin)
%DAQMXRESETSTARTTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetStartTrigType(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetStartTrigType',varargin{:});
