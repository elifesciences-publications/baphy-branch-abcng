function varargout = DAQmxGetAIConvRateEx(varargin)
%DAQMXGETAICONVRATEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIConvRateEx(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvRateEx',varargin{:});
