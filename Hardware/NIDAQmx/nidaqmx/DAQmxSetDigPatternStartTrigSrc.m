function varargout = DAQmxSetDigPatternStartTrigSrc(varargin)
%DAQMXSETDIGPATTERNSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigPatternStartTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternStartTrigSrc',varargin{:});
