function varargout = DAQmxGetReadSleepTime(varargin)
%DAQMXGETREADSLEEPTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetReadSleepTime(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadSleepTime',varargin{:});
