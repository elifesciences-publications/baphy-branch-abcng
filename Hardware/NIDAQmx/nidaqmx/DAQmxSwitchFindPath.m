function varargout = DAQmxSwitchFindPath(varargin)
%DAQMXSWITCHFINDPATH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring, int32Ptr] DAQmxSwitchFindPath(cstring, cstring, cstring, uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchFindPath',varargin{:});
