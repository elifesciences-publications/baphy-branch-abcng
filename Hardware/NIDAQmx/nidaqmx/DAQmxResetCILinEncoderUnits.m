function varargout = DAQmxResetCILinEncoderUnits(varargin)
%DAQMXRESETCILINENCODERUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCILinEncoderUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCILinEncoderUnits',varargin{:});
