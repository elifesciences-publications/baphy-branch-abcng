function varargout = DAQmxSetExportedRefTrigPulsePolarity(varargin)
%DAQMXSETEXPORTEDREFTRIGPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedRefTrigPulsePolarity(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedRefTrigPulsePolarity',varargin{:});
