function varargout = DAQmxGetExportedAdvCmpltEventOutputTerm(varargin)
%DAQMXGETEXPORTEDADVCMPLTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedAdvCmpltEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAdvCmpltEventOutputTerm',varargin{:});
