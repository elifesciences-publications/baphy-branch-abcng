function varargout = DAQmxSetAdvTrigType(varargin)
%DAQMXSETADVTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAdvTrigType(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAdvTrigType',varargin{:});
