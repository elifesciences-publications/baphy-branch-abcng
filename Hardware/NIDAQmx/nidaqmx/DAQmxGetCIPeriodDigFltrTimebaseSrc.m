function varargout = DAQmxGetCIPeriodDigFltrTimebaseSrc(varargin)
%DAQMXGETCIPERIODDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIPeriodDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodDigFltrTimebaseSrc',varargin{:});
