function varargout = DAQmxResetExportedAIHoldCmpltEventPulsePolarity(varargin)
%DAQMXRESETEXPORTEDAIHOLDCMPLTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAIHoldCmpltEventPulsePolarity(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAIHoldCmpltEventPulsePolarity',varargin{:});
