function varargout = DAQmxGetExportedAdvTrigOutputTerm(varargin)
%DAQMXGETEXPORTEDADVTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedAdvTrigOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAdvTrigOutputTerm',varargin{:});
