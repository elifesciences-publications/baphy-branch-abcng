function varargout = DAQmxGetExportedSyncPulseEventOutputTerm(varargin)
%DAQMXGETEXPORTEDSYNCPULSEEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedSyncPulseEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedSyncPulseEventOutputTerm',varargin{:});
