function varargout = DAQmxSetCOPulseLowTime(varargin)
%DAQMXSETCOPULSELOWTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseLowTime(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseLowTime',varargin{:});
