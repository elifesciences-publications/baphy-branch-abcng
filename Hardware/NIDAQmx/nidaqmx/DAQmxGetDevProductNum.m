function varargout = DAQmxGetDevProductNum(varargin)
%DAQMXGETDEVPRODUCTNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevProductNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevProductNum',varargin{:});
