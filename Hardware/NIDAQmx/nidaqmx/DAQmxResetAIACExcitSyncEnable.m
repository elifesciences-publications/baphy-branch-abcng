function varargout = DAQmxResetAIACExcitSyncEnable(varargin)
%DAQMXRESETAIACEXCITSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIACExcitSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIACExcitSyncEnable',varargin{:});
