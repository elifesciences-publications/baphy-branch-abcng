function varargout = DAQmxResetAIStrainGageGageFactor(varargin)
%DAQMXRESETAISTRAINGAGEGAGEFACTOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIStrainGageGageFactor(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIStrainGageGageFactor',varargin{:});
