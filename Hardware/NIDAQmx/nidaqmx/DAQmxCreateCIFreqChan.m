function varargout = DAQmxCreateCIFreqChan(varargin)
%DAQMXCREATECIFREQCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateCIFreqChan(uint32, cstring, cstring, double, double, int32, int32, int32, double, uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCIFreqChan',varargin{:});
