function varargout = DAQmxCfgPipelinedSampClkTiming(varargin)
%DAQMXCFGPIPELINEDSAMPCLKTIMING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgPipelinedSampClkTiming(uint32, cstring, double, int32, int32, uint64)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgPipelinedSampClkTiming',varargin{:});
