function varargout = DAQmxGetSwitchScanWaitingForAdv(varargin)
%DAQMXGETSWITCHSCANWAITINGFORADV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetSwitchScanWaitingForAdv(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchScanWaitingForAdv',varargin{:});
