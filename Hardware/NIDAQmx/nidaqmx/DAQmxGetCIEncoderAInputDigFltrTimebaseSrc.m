function varargout = DAQmxGetCIEncoderAInputDigFltrTimebaseSrc(varargin)
%DAQMXGETCIENCODERAINPUTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIEncoderAInputDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderAInputDigFltrTimebaseSrc',varargin{:});
