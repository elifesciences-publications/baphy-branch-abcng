function varargout = DAQmxResetAIRVDTSensitivity(varargin)
%DAQMXRESETAIRVDTSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRVDTSensitivity(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRVDTSensitivity',varargin{:});
