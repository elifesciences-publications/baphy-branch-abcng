function varargout = DAQmxResetCIDupCountPrevent(varargin)
%DAQMXRESETCIDUPCOUNTPREVENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIDupCountPrevent(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIDupCountPrevent',varargin{:});
