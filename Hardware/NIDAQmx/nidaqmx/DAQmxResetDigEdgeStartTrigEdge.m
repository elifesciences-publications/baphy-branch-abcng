function varargout = DAQmxResetDigEdgeStartTrigEdge(varargin)
%DAQMXRESETDIGEDGESTARTTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeStartTrigEdge(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeStartTrigEdge',varargin{:});
