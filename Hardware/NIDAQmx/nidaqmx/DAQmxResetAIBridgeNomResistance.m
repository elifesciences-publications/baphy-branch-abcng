function varargout = DAQmxResetAIBridgeNomResistance(varargin)
%DAQMXRESETAIBRIDGENOMRESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIBridgeNomResistance(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIBridgeNomResistance',varargin{:});
