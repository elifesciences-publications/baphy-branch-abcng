function varargout = DAQmxSetAOFuncGenType(varargin)
%DAQMXSETAOFUNCGENTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOFuncGenType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOFuncGenType',varargin{:});
