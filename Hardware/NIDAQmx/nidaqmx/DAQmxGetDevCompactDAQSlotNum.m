function varargout = DAQmxGetDevCompactDAQSlotNum(varargin)
%DAQMXGETDEVCOMPACTDAQSLOTNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevCompactDAQSlotNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCompactDAQSlotNum',varargin{:});
