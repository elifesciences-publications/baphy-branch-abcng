function varargout = DAQmxGetCITwoEdgeSepSecondDigFltrEnable(varargin)
%DAQMXGETCITWOEDGESEPSECONDDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCITwoEdgeSepSecondDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepSecondDigFltrEnable',varargin{:});
