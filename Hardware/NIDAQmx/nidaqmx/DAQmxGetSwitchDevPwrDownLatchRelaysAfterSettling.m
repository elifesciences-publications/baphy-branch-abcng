function varargout = DAQmxGetSwitchDevPwrDownLatchRelaysAfterSettling(varargin)
%DAQMXGETSWITCHDEVPWRDOWNLATCHRELAYSAFTERSETTLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSwitchDevPwrDownLatchRelaysAfterSettling(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevPwrDownLatchRelaysAfterSettling',varargin{:});
