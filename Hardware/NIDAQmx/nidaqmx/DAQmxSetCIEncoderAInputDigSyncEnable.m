function varargout = DAQmxSetCIEncoderAInputDigSyncEnable(varargin)
%DAQMXSETCIENCODERAINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderAInputDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderAInputDigSyncEnable',varargin{:});
