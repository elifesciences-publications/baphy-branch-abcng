function varargout = DAQmxSetWatchdogAttribute(varargin)
%DAQMXSETWATCHDOGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr] DAQmxSetWatchdogAttribute(uint32, cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWatchdogAttribute',varargin{:});
