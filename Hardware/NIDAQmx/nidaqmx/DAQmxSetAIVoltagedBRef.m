function varargout = DAQmxSetAIVoltagedBRef(varargin)
%DAQMXSETAIVOLTAGEDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIVoltagedBRef(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIVoltagedBRef',varargin{:});
