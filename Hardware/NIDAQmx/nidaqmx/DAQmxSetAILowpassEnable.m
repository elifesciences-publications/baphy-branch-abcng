function varargout = DAQmxSetAILowpassEnable(varargin)
%DAQMXSETAILOWPASSENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILowpassEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILowpassEnable',varargin{:});
