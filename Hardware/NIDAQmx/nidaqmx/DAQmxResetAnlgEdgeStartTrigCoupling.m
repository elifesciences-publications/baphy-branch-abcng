function varargout = DAQmxResetAnlgEdgeStartTrigCoupling(varargin)
%DAQMXRESETANLGEDGESTARTTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeStartTrigCoupling(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeStartTrigCoupling',varargin{:});
