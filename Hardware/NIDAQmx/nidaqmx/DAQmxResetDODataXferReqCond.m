function varargout = DAQmxResetDODataXferReqCond(varargin)
%DAQMXRESETDODATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDODataXferReqCond(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDODataXferReqCond',varargin{:});
