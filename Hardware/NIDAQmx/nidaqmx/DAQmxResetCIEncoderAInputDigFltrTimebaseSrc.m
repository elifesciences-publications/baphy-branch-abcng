function varargout = DAQmxResetCIEncoderAInputDigFltrTimebaseSrc(varargin)
%DAQMXRESETCIENCODERAINPUTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderAInputDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderAInputDigFltrTimebaseSrc',varargin{:});
