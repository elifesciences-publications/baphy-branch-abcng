function varargout = DAQmxResetCIPulseWidthStartingEdge(varargin)
%DAQMXRESETCIPULSEWIDTHSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPulseWidthStartingEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPulseWidthStartingEdge',varargin{:});
