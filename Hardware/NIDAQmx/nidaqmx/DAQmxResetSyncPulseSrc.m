function varargout = DAQmxResetSyncPulseSrc(varargin)
%DAQMXRESETSYNCPULSESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSyncPulseSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSyncPulseSrc',varargin{:});
