function varargout = DAQmxSetScalePreScaledUnits(varargin)
%DAQMXSETSCALEPRESCALEDUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetScalePreScaledUnits(cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScalePreScaledUnits',varargin{:});
