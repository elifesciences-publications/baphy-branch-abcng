function varargout = DAQmxTristateOutputTerm(varargin)
%DAQMXTRISTATEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxTristateOutputTerm(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxTristateOutputTerm',varargin{:});
