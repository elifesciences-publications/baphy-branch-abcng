function varargout = DAQmxResetCITwoEdgeSepUnits(varargin)
%DAQMXRESETCITWOEDGESEPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepUnits',varargin{:});
