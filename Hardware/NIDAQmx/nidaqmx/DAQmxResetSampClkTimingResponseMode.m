function varargout = DAQmxResetSampClkTimingResponseMode(varargin)
%DAQMXRESETSAMPCLKTIMINGRESPONSEMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkTimingResponseMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkTimingResponseMode',varargin{:});
