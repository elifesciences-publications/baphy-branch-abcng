function varargout = DAQmxResetAIChanCalApplyCalIfExp(varargin)
%DAQMXRESETAICHANCALAPPLYCALIFEXP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalApplyCalIfExp(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalApplyCalIfExp',varargin{:});
