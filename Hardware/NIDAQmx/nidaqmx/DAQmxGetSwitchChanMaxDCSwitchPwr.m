function varargout = DAQmxGetSwitchChanMaxDCSwitchPwr(varargin)
%DAQMXGETSWITCHCHANMAXDCSWITCHPWR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxDCSwitchPwr(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxDCSwitchPwr',varargin{:});
