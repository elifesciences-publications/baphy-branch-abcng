function varargout = DAQmxGetDigLvlPauseTrigWhen(varargin)
%DAQMXGETDIGLVLPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigLvlPauseTrigWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigLvlPauseTrigWhen',varargin{:});
