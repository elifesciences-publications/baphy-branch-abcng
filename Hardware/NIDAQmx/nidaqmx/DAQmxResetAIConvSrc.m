function varargout = DAQmxResetAIConvSrc(varargin)
%DAQMXRESETAICONVSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAIConvSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvSrc',varargin{:});
