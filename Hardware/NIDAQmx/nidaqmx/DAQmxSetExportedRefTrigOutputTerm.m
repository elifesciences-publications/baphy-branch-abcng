function varargout = DAQmxSetExportedRefTrigOutputTerm(varargin)
%DAQMXSETEXPORTEDREFTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedRefTrigOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedRefTrigOutputTerm',varargin{:});
