function varargout = DAQmxSetCICountEdgesDir(varargin)
%DAQMXSETCICOUNTEDGESDIR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesDir(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesDir',varargin{:});
