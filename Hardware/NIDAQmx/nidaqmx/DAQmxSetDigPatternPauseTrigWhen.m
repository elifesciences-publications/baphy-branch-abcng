function varargout = DAQmxSetDigPatternPauseTrigWhen(varargin)
%DAQMXSETDIGPATTERNPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigPatternPauseTrigWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternPauseTrigWhen',varargin{:});
