function varargout = DAQmxResetCISemiPeriodDigFltrTimebaseSrc(varargin)
%DAQMXRESETCISEMIPERIODDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCISemiPeriodDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCISemiPeriodDigFltrTimebaseSrc',varargin{:});
