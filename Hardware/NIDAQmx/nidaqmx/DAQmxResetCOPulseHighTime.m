function varargout = DAQmxResetCOPulseHighTime(varargin)
%DAQMXRESETCOPULSEHIGHTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseHighTime(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseHighTime',varargin{:});
