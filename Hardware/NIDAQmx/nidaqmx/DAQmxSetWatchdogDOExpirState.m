function varargout = DAQmxSetWatchdogDOExpirState(varargin)
%DAQMXSETWATCHDOGDOEXPIRSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetWatchdogDOExpirState(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWatchdogDOExpirState',varargin{:});
