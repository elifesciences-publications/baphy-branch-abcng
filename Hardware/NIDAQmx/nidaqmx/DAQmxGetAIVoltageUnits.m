function varargout = DAQmxGetAIVoltageUnits(varargin)
%DAQMXGETAIVOLTAGEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIVoltageUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIVoltageUnits',varargin{:});
