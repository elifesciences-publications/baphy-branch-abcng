function varargout = DAQmxGetCIFreqDigSyncEnable(varargin)
%DAQMXGETCIFREQDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIFreqDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqDigSyncEnable',varargin{:});
