function varargout = DAQmxResetAITempUnits(varargin)
%DAQMXRESETAITEMPUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAITempUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAITempUnits',varargin{:});
