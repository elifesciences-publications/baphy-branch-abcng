function varargout = DAQmxSetAIChanCalDesc(varargin)
%DAQMXSETAICHANCALDESC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetAIChanCalDesc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIChanCalDesc',varargin{:});
