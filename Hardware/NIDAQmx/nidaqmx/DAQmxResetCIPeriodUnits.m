function varargout = DAQmxResetCIPeriodUnits(varargin)
%DAQMXRESETCIPERIODUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodUnits',varargin{:});
