function varargout = DAQmxResetAIExcitUseMultiplexed(varargin)
%DAQMXRESETAIEXCITUSEMULTIPLEXED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIExcitUseMultiplexed(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIExcitUseMultiplexed',varargin{:});
