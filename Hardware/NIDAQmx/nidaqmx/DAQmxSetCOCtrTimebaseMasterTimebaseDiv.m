function varargout = DAQmxSetCOCtrTimebaseMasterTimebaseDiv(varargin)
%DAQMXSETCOCTRTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOCtrTimebaseMasterTimebaseDiv(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseMasterTimebaseDiv',varargin{:});
