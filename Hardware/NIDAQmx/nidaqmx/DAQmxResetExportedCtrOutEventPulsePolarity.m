function varargout = DAQmxResetExportedCtrOutEventPulsePolarity(varargin)
%DAQMXRESETEXPORTEDCTROUTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedCtrOutEventPulsePolarity(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedCtrOutEventPulsePolarity',varargin{:});
