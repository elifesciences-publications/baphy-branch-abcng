function varargout = DAQmxSetCOPulseFreqInitialDelay(varargin)
%DAQMXSETCOPULSEFREQINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseFreqInitialDelay(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseFreqInitialDelay',varargin{:});
