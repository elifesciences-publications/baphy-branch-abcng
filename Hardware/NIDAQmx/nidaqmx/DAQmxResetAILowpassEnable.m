function varargout = DAQmxResetAILowpassEnable(varargin)
%DAQMXRESETAILOWPASSENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILowpassEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILowpassEnable',varargin{:});
