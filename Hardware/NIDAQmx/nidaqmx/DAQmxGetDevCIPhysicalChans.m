function varargout = DAQmxGetDevCIPhysicalChans(varargin)
%DAQMXGETDEVCIPHYSICALCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevCIPhysicalChans(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCIPhysicalChans',varargin{:});
