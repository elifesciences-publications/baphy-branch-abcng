function varargout = DAQmxGetSampClkDigFltrTimebaseRate(varargin)
%DAQMXGETSAMPCLKDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetSampClkDigFltrTimebaseRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkDigFltrTimebaseRate',varargin{:});
