function varargout = DAQmxAdjust4204Cal(varargin)
%DAQMXADJUST4204CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxAdjust4204Cal(uint32, cstring, double, uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust4204Cal',varargin{:});
