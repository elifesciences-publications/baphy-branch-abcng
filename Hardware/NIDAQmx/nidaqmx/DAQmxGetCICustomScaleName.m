function varargout = DAQmxGetCICustomScaleName(varargin)
%DAQMXGETCICUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCICustomScaleName(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICustomScaleName',varargin{:});
