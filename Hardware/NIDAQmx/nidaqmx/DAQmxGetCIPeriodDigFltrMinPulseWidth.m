function varargout = DAQmxGetCIPeriodDigFltrMinPulseWidth(varargin)
%DAQMXGETCIPERIODDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIPeriodDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodDigFltrMinPulseWidth',varargin{:});
