function varargout = DAQmxResetCIFreqDigSyncEnable(varargin)
%DAQMXRESETCIFREQDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqDigSyncEnable',varargin{:});
