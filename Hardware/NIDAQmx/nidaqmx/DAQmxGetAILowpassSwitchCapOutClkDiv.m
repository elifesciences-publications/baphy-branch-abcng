function varargout = DAQmxGetAILowpassSwitchCapOutClkDiv(varargin)
%DAQMXGETAILOWPASSSWITCHCAPOUTCLKDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAILowpassSwitchCapOutClkDiv(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILowpassSwitchCapOutClkDiv',varargin{:});
