function varargout = DAQmxGetCIPulseWidthTerm(varargin)
%DAQMXGETCIPULSEWIDTHTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIPulseWidthTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPulseWidthTerm',varargin{:});
