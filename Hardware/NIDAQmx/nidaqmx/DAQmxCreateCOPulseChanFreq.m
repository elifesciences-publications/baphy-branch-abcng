function varargout = DAQmxCreateCOPulseChanFreq(varargin)
%DAQMXCREATECOPULSECHANFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateCOPulseChanFreq(uint32, cstring, cstring, int32, int32, double, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCOPulseChanFreq',varargin{:});
