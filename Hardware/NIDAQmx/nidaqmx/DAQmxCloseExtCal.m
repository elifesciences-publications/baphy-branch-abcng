function varargout = DAQmxCloseExtCal(varargin)
%DAQMXCLOSEEXTCAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxCloseExtCal(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCloseExtCal',varargin{:});
