function varargout = DAQmxGetAIRawDataCompressionType(varargin)
%DAQMXGETAIRAWDATACOMPRESSIONTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIRawDataCompressionType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRawDataCompressionType',varargin{:});
