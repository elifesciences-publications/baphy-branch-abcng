function varargout = DAQmxResetAILowpassCutoffFreq(varargin)
%DAQMXRESETAILOWPASSCUTOFFFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILowpassCutoffFreq(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILowpassCutoffFreq',varargin{:});
