function varargout = DAQmxResetCIEncoderBInputDigSyncEnable(varargin)
%DAQMXRESETCIENCODERBINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderBInputDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderBInputDigSyncEnable',varargin{:});
