function varargout = DAQmxSetAIRVDTSensitivity(varargin)
%DAQMXSETAIRVDTSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRVDTSensitivity(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRVDTSensitivity',varargin{:});
