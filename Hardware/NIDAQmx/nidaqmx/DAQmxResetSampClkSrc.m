function varargout = DAQmxResetSampClkSrc(varargin)
%DAQMXRESETSAMPCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkSrc',varargin{:});
