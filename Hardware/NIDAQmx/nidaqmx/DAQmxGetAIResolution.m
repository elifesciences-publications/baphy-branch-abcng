function varargout = DAQmxGetAIResolution(varargin)
%DAQMXGETAIRESOLUTION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIResolution(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIResolution',varargin{:});
