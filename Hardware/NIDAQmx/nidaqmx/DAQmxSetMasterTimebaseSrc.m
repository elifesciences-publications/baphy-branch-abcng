function varargout = DAQmxSetMasterTimebaseSrc(varargin)
%DAQMXSETMASTERTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetMasterTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetMasterTimebaseSrc',varargin{:});
