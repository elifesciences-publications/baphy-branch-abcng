function varargout = DAQmxGetDigEdgeArmStartTrigEdge(varargin)
%DAQMXGETDIGEDGEARMSTARTTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigEdgeArmStartTrigEdge(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeArmStartTrigEdge',varargin{:});
