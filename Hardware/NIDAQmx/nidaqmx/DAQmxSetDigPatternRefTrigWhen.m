function varargout = DAQmxSetDigPatternRefTrigWhen(varargin)
%DAQMXSETDIGPATTERNREFTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigPatternRefTrigWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternRefTrigWhen',varargin{:});
