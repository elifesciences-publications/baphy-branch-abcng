function varargout = DAQmxResetAIExcitSrc(varargin)
%DAQMXRESETAIEXCITSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIExcitSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIExcitSrc',varargin{:});
