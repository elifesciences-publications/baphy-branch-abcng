function varargout = DAQmxSetSampClkActiveEdge(varargin)
%DAQMXSETSAMPCLKACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkActiveEdge(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkActiveEdge',varargin{:});
