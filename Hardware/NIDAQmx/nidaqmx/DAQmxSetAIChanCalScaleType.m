function varargout = DAQmxSetAIChanCalScaleType(varargin)
%DAQMXSETAICHANCALSCALETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIChanCalScaleType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIChanCalScaleType',varargin{:});
