function varargout = DAQmxGetRealTimeWriteRecoveryMode(varargin)
%DAQMXGETREALTIMEWRITERECOVERYMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetRealTimeWriteRecoveryMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRealTimeWriteRecoveryMode',varargin{:});
