function varargout = DAQmxRegisterEveryNSamplesEvent(varargin)
%DAQMXREGISTEREVERYNSAMPLESEVENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxRegisterEveryNSamplesEvent(uint32, int32, uint32, uint32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxRegisterEveryNSamplesEvent',varargin{:});
