function varargout = DAQmxGetExportedAdvCmpltEventPulsePolarity(varargin)
%DAQMXGETEXPORTEDADVCMPLTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedAdvCmpltEventPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAdvCmpltEventPulsePolarity',varargin{:});
