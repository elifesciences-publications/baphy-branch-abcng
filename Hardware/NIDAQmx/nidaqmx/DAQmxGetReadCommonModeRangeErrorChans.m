function varargout = DAQmxGetReadCommonModeRangeErrorChans(varargin)
%DAQMXGETREADCOMMONMODERANGEERRORCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetReadCommonModeRangeErrorChans(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadCommonModeRangeErrorChans',varargin{:});
