function varargout = DAQmxResetAOFuncGenOffset(varargin)
%DAQMXRESETAOFUNCGENOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOFuncGenOffset(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOFuncGenOffset',varargin{:});
