function varargout = DAQmxResetAODACRngHigh(varargin)
%DAQMXRESETAODACRNGHIGH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACRngHigh(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACRngHigh',varargin{:});
