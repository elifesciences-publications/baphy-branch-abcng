function varargout = DAQmxSetCICountEdgesCountDirDigFltrEnable(varargin)
%DAQMXSETCICOUNTEDGESCOUNTDIRDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesCountDirDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesCountDirDigFltrEnable',varargin{:});
