function varargout = DAQmxGetCIGPSSyncMethod(varargin)
%DAQMXGETCIGPSSYNCMETHOD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIGPSSyncMethod(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIGPSSyncMethod',varargin{:});
