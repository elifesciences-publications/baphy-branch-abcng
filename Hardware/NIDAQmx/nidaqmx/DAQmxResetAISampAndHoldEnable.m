function varargout = DAQmxResetAISampAndHoldEnable(varargin)
%DAQMXRESETAISAMPANDHOLDENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAISampAndHoldEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAISampAndHoldEnable',varargin{:});
