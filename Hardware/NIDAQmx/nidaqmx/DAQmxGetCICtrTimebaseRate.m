function varargout = DAQmxGetCICtrTimebaseRate(varargin)
%DAQMXGETCICTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCICtrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseRate',varargin{:});
