function varargout = DAQmxSetSwitchDevSettlingTime(varargin)
%DAQMXSETSWITCHDEVSETTLINGTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetSwitchDevSettlingTime(cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSwitchDevSettlingTime',varargin{:});
