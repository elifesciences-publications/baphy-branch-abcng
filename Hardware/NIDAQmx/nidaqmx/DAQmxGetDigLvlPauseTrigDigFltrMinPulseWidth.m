function varargout = DAQmxGetDigLvlPauseTrigDigFltrMinPulseWidth(varargin)
%DAQMXGETDIGLVLPAUSETRIGDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetDigLvlPauseTrigDigFltrMinPulseWidth(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigLvlPauseTrigDigFltrMinPulseWidth',varargin{:});
