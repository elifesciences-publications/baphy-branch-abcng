function varargout = DAQmxResetCOCtrTimebaseSrc(varargin)
%DAQMXRESETCOCTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOCtrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOCtrTimebaseSrc',varargin{:});
