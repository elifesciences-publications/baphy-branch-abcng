function varargout = DAQmxSetAOReglitchEnable(varargin)
%DAQMXSETAOREGLITCHENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOReglitchEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOReglitchEnable',varargin{:});
