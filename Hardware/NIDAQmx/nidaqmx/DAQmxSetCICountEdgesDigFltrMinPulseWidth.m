function varargout = DAQmxSetCICountEdgesDigFltrMinPulseWidth(varargin)
%DAQMXSETCICOUNTEDGESDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesDigFltrMinPulseWidth',varargin{:});
