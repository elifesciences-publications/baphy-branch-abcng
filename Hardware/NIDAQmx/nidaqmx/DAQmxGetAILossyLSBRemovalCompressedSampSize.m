function varargout = DAQmxGetAILossyLSBRemovalCompressedSampSize(varargin)
%DAQMXGETAILOSSYLSBREMOVALCOMPRESSEDSAMPSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAILossyLSBRemovalCompressedSampSize(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILossyLSBRemovalCompressedSampSize',varargin{:});
