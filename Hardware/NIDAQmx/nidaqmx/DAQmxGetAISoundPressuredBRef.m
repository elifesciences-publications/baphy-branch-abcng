function varargout = DAQmxGetAISoundPressuredBRef(varargin)
%DAQMXGETAISOUNDPRESSUREDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAISoundPressuredBRef(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAISoundPressuredBRef',varargin{:});
