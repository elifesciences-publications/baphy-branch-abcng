function varargout = DAQmxResetAIMicrophoneSensitivity(varargin)
%DAQMXRESETAIMICROPHONESENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIMicrophoneSensitivity(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIMicrophoneSensitivity',varargin{:});
