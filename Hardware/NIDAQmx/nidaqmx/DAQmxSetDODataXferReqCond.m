function varargout = DAQmxSetDODataXferReqCond(varargin)
%DAQMXSETDODATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDODataXferReqCond(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDODataXferReqCond',varargin{:});
