function varargout = DAQmxSetRefTrigType(varargin)
%DAQMXSETREFTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetRefTrigType(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRefTrigType',varargin{:});
