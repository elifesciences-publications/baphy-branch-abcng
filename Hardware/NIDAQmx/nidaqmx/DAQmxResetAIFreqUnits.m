function varargout = DAQmxResetAIFreqUnits(varargin)
%DAQMXRESETAIFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIFreqUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIFreqUnits',varargin{:});
