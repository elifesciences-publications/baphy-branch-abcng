function varargout = DAQmxCreateTEDSAIPosLVDTChan(varargin)
%DAQMXCREATETEDSAIPOSLVDTCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateTEDSAIPosLVDTChan(uint32, cstring, cstring, double, double, int32, int32, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateTEDSAIPosLVDTChan',varargin{:});
