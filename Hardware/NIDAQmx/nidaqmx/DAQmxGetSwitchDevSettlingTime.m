function varargout = DAQmxGetSwitchDevSettlingTime(varargin)
%DAQMXGETSWITCHDEVSETTLINGTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchDevSettlingTime(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevSettlingTime',varargin{:});
