function varargout = DAQmxGetAIRngLow(varargin)
%DAQMXGETAIRNGLOW calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIRngLow(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRngLow',varargin{:});
