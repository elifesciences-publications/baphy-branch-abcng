function varargout = DAQmxSetCOPulseFreqUnits(varargin)
%DAQMXSETCOPULSEFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseFreqUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseFreqUnits',varargin{:});
