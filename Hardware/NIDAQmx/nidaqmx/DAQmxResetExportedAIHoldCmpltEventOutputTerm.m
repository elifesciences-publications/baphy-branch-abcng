function varargout = DAQmxResetExportedAIHoldCmpltEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDAIHOLDCMPLTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAIHoldCmpltEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAIHoldCmpltEventOutputTerm',varargin{:});
