function varargout = DAQmxGetAIRTDR0(varargin)
%DAQMXGETAIRTDR0 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIRTDR0(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRTDR0',varargin{:});
