function varargout = DAQmxResetStartTrigDelay(varargin)
%DAQMXRESETSTARTTRIGDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetStartTrigDelay(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetStartTrigDelay',varargin{:});
