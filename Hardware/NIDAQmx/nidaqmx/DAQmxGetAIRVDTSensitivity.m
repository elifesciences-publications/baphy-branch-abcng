function varargout = DAQmxGetAIRVDTSensitivity(varargin)
%DAQMXGETAIRVDTSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIRVDTSensitivity(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRVDTSensitivity',varargin{:});
