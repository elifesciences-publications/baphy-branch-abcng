function varargout = DAQmxGetAIAutoZeroMode(varargin)
%DAQMXGETAIAUTOZEROMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIAutoZeroMode(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIAutoZeroMode',varargin{:});
