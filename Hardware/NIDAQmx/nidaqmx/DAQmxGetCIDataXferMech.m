function varargout = DAQmxGetCIDataXferMech(varargin)
%DAQMXGETCIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIDataXferMech(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIDataXferMech',varargin{:});
