function varargout = DAQmxGetDevCOMaxSize(varargin)
%DAQMXGETDEVCOMAXSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevCOMaxSize(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCOMaxSize',varargin{:});
