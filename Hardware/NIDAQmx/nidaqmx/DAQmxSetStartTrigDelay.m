function varargout = DAQmxSetStartTrigDelay(varargin)
%DAQMXSETSTARTTRIGDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetStartTrigDelay(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetStartTrigDelay',varargin{:});
