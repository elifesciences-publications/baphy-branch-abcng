function varargout = DAQmxGetCIPeriodMeasTime(varargin)
%DAQMXGETCIPERIODMEASTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIPeriodMeasTime(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodMeasTime',varargin{:});
