function varargout = DAQmxGetSyncPulseSrc(varargin)
%DAQMXGETSYNCPULSESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetSyncPulseSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSyncPulseSrc',varargin{:});
