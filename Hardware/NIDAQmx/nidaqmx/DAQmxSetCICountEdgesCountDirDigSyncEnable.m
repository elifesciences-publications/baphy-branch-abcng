function varargout = DAQmxSetCICountEdgesCountDirDigSyncEnable(varargin)
%DAQMXSETCICOUNTEDGESCOUNTDIRDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesCountDirDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesCountDirDigSyncEnable',varargin{:});
