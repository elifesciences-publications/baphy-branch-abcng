function varargout = DAQmxResetWriteNextWriteIsLast(varargin)
%DAQMXRESETWRITENEXTWRITEISLAST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWriteNextWriteIsLast(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWriteNextWriteIsLast',varargin{:});
