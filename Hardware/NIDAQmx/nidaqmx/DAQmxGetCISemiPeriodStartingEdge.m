function varargout = DAQmxGetCISemiPeriodStartingEdge(varargin)
%DAQMXGETCISEMIPERIODSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCISemiPeriodStartingEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCISemiPeriodStartingEdge',varargin{:});
