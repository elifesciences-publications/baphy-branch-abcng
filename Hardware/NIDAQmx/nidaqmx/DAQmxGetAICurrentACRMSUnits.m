function varargout = DAQmxGetAICurrentACRMSUnits(varargin)
%DAQMXGETAICURRENTACRMSUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAICurrentACRMSUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAICurrentACRMSUnits',varargin{:});
