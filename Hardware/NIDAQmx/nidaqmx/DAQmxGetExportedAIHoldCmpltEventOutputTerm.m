function varargout = DAQmxGetExportedAIHoldCmpltEventOutputTerm(varargin)
%DAQMXGETEXPORTEDAIHOLDCMPLTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedAIHoldCmpltEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAIHoldCmpltEventOutputTerm',varargin{:});
