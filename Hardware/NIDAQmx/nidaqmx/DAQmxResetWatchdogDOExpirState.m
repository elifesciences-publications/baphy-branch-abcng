function varargout = DAQmxResetWatchdogDOExpirState(varargin)
%DAQMXRESETWATCHDOGDOEXPIRSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetWatchdogDOExpirState(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWatchdogDOExpirState',varargin{:});
