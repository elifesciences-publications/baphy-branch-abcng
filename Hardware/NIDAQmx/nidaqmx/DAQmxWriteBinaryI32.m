function varargout = DAQmxWriteBinaryI32(varargin)
%DAQMXWRITEBINARYI32 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr, int32Ptr, uint32Ptr] DAQmxWriteBinaryI32(uint32, int32, uint32, double, uint32, int32Ptr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteBinaryI32',varargin{:});
