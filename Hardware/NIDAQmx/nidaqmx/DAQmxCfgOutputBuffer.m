function varargout = DAQmxCfgOutputBuffer(varargin)
%DAQMXCFGOUTPUTBUFFER calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxCfgOutputBuffer(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgOutputBuffer',varargin{:});
