function varargout = DAQmxResetCOPulseIdleState(varargin)
%DAQMXRESETCOPULSEIDLESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseIdleState(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseIdleState',varargin{:});
