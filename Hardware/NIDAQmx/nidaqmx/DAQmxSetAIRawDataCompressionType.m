function varargout = DAQmxSetAIRawDataCompressionType(varargin)
%DAQMXSETAIRAWDATACOMPRESSIONTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIRawDataCompressionType(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIRawDataCompressionType',varargin{:});
