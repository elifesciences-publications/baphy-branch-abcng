function varargout = DAQmxResetAIConvRate(varargin)
%DAQMXRESETAICONVRATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAIConvRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvRate',varargin{:});
