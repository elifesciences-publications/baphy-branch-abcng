function varargout = DAQmxResetAIExcitUseForScaling(varargin)
%DAQMXRESETAIEXCITUSEFORSCALING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIExcitUseForScaling(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIExcitUseForScaling',varargin{:});
