function varargout = DAQmxResetExportedHshkEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDHSHKEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedHshkEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedHshkEventOutputTerm',varargin{:});
