function varargout = DAQmxGetCIPulseWidthDigFltrEnable(varargin)
%DAQMXGETCIPULSEWIDTHDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIPulseWidthDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPulseWidthDigFltrEnable',varargin{:});
