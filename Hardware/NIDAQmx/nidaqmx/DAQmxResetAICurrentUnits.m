function varargout = DAQmxResetAICurrentUnits(varargin)
%DAQMXRESETAICURRENTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAICurrentUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAICurrentUnits',varargin{:});
