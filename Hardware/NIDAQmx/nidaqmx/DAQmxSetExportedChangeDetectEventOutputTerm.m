function varargout = DAQmxSetExportedChangeDetectEventOutputTerm(varargin)
%DAQMXSETEXPORTEDCHANGEDETECTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedChangeDetectEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedChangeDetectEventOutputTerm',varargin{:});
