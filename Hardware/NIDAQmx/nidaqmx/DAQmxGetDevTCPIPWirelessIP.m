function varargout = DAQmxGetDevTCPIPWirelessIP(varargin)
%DAQMXGETDEVTCPIPWIRELESSIP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevTCPIPWirelessIP(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevTCPIPWirelessIP',varargin{:});
