function varargout = DAQmxGetCIEncoderAInputDigSyncEnable(varargin)
%DAQMXGETCIENCODERAINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIEncoderAInputDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderAInputDigSyncEnable',varargin{:});
