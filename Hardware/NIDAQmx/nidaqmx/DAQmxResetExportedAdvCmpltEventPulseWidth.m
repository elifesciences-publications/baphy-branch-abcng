function varargout = DAQmxResetExportedAdvCmpltEventPulseWidth(varargin)
%DAQMXRESETEXPORTEDADVCMPLTEVENTPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAdvCmpltEventPulseWidth(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAdvCmpltEventPulseWidth',varargin{:});
