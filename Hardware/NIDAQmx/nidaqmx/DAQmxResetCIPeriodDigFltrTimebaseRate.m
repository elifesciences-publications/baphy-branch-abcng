function varargout = DAQmxResetCIPeriodDigFltrTimebaseRate(varargin)
%DAQMXRESETCIPERIODDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodDigFltrTimebaseRate',varargin{:});
