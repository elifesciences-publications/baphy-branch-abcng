function varargout = DAQmxGetDevDigTrigSupported(varargin)
%DAQMXGETDEVDIGTRIGSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevDigTrigSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDigTrigSupported',varargin{:});
