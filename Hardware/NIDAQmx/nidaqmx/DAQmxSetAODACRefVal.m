function varargout = DAQmxSetAODACRefVal(varargin)
%DAQMXSETAODACREFVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODACRefVal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACRefVal',varargin{:});
