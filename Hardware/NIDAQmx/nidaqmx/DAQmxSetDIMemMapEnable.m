function varargout = DAQmxSetDIMemMapEnable(varargin)
%DAQMXSETDIMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDIMemMapEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDIMemMapEnable',varargin{:});
