function varargout = DAQmxResetAOFuncGenSquareDutyCycle(varargin)
%DAQMXRESETAOFUNCGENSQUAREDUTYCYCLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOFuncGenSquareDutyCycle(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOFuncGenSquareDutyCycle',varargin{:});
