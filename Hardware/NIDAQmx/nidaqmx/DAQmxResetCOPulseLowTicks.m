function varargout = DAQmxResetCOPulseLowTicks(varargin)
%DAQMXRESETCOPULSELOWTICKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseLowTicks(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseLowTicks',varargin{:});
