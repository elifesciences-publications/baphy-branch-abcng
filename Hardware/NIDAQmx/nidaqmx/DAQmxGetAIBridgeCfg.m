function varargout = DAQmxGetAIBridgeCfg(varargin)
%DAQMXGETAIBRIDGECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIBridgeCfg(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIBridgeCfg',varargin{:});
