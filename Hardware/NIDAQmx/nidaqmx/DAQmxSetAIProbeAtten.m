function varargout = DAQmxSetAIProbeAtten(varargin)
%DAQMXSETAIPROBEATTEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIProbeAtten(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIProbeAtten',varargin{:});
