function varargout = DAQmxGetAICurrentShuntResistance(varargin)
%DAQMXGETAICURRENTSHUNTRESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAICurrentShuntResistance(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAICurrentShuntResistance',varargin{:});
