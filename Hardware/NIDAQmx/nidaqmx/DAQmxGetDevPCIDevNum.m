function varargout = DAQmxGetDevPCIDevNum(varargin)
%DAQMXGETDEVPCIDEVNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevPCIDevNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevPCIDevNum',varargin{:});
