function varargout = DAQmxAdjust1520Cal(varargin)
%DAQMXADJUST1520CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1520Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1520Cal',varargin{:});
