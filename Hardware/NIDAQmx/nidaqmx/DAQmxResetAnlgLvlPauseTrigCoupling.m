function varargout = DAQmxResetAnlgLvlPauseTrigCoupling(varargin)
%DAQMXRESETANLGLVLPAUSETRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgLvlPauseTrigCoupling(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgLvlPauseTrigCoupling',varargin{:});
