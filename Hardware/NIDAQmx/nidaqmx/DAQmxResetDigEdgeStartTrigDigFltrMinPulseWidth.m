function varargout = DAQmxResetDigEdgeStartTrigDigFltrMinPulseWidth(varargin)
%DAQMXRESETDIGEDGESTARTTRIGDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeStartTrigDigFltrMinPulseWidth(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeStartTrigDigFltrMinPulseWidth',varargin{:});
