function varargout = DAQmxDeleteSavedGlobalChan(varargin)
%DAQMXDELETESAVEDGLOBALCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxDeleteSavedGlobalChan(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxDeleteSavedGlobalChan',varargin{:});
