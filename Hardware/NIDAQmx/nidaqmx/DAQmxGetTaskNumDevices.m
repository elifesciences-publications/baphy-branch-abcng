function varargout = DAQmxGetTaskNumDevices(varargin)
%DAQMXGETTASKNUMDEVICES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetTaskNumDevices(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTaskNumDevices',varargin{:});
