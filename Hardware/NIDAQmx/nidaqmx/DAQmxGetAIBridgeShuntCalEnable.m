function varargout = DAQmxGetAIBridgeShuntCalEnable(varargin)
%DAQMXGETAIBRIDGESHUNTCALENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIBridgeShuntCalEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIBridgeShuntCalEnable',varargin{:});
