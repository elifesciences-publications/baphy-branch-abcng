function varargout = DAQmxResetAILossyLSBRemovalCompressedSampSize(varargin)
%DAQMXRESETAILOSSYLSBREMOVALCOMPRESSEDSAMPSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILossyLSBRemovalCompressedSampSize(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILossyLSBRemovalCompressedSampSize',varargin{:});
