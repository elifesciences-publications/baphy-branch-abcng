function varargout = DAQmxSetSampClkDigFltrEnable(varargin)
%DAQMXSETSAMPCLKDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkDigFltrEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkDigFltrEnable',varargin{:});
