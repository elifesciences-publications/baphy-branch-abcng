function varargout = DAQmxGetAODACOffsetSrc(varargin)
%DAQMXGETAODACOFFSETSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAODACOffsetSrc(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACOffsetSrc',varargin{:});
