function varargout = DAQmxSetCILinEncoderInitialPos(varargin)
%DAQMXSETCILINENCODERINITIALPOS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCILinEncoderInitialPos(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCILinEncoderInitialPos',varargin{:});
