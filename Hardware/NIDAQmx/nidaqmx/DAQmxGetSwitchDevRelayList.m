function varargout = DAQmxGetSwitchDevRelayList(varargin)
%DAQMXGETSWITCHDEVRELAYLIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetSwitchDevRelayList(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevRelayList',varargin{:});
