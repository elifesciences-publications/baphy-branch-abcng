function varargout = DAQmxSetSampQuantSampMode(varargin)
%DAQMXSETSAMPQUANTSAMPMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampQuantSampMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampQuantSampMode',varargin{:});
