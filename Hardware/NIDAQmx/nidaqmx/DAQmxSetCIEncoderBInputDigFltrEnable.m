function varargout = DAQmxSetCIEncoderBInputDigFltrEnable(varargin)
%DAQMXSETCIENCODERBINPUTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderBInputDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderBInputDigFltrEnable',varargin{:});
