function varargout = DAQmxSetCITwoEdgeSepSecondDigSyncEnable(varargin)
%DAQMXSETCITWOEDGESEPSECONDDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepSecondDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepSecondDigSyncEnable',varargin{:});
