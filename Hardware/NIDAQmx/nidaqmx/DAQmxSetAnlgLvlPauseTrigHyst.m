function varargout = DAQmxSetAnlgLvlPauseTrigHyst(varargin)
%DAQMXSETANLGLVLPAUSETRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgLvlPauseTrigHyst(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgLvlPauseTrigHyst',varargin{:});
