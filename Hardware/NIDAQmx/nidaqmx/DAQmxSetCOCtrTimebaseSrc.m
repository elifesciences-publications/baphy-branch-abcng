function varargout = DAQmxSetCOCtrTimebaseSrc(varargin)
%DAQMXSETCOCTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCOCtrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseSrc',varargin{:});
