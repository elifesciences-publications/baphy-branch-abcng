function varargout = DAQmxSetDIDigFltrEnable(varargin)
%DAQMXSETDIDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDIDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDIDigFltrEnable',varargin{:});
