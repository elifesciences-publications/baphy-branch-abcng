function varargout = DAQmxGetDOOvercurrentLimit(varargin)
%DAQMXGETDOOVERCURRENTLIMIT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDOOvercurrentLimit(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOOvercurrentLimit',varargin{:});
