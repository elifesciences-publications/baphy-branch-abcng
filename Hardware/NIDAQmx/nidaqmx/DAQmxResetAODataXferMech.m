function varargout = DAQmxResetAODataXferMech(varargin)
%DAQMXRESETAODATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODataXferMech(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODataXferMech',varargin{:});
