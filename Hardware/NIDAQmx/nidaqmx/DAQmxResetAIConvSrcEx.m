function varargout = DAQmxResetAIConvSrcEx(varargin)
%DAQMXRESETAICONVSRCEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIConvSrcEx(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvSrcEx',varargin{:});
