function varargout = DAQmxSetWatchdogExpirTrigType(varargin)
%DAQMXSETWATCHDOGEXPIRTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetWatchdogExpirTrigType(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWatchdogExpirTrigType',varargin{:});
