function varargout = DAQmxSetCICtrTimebaseSrc(varargin)
%DAQMXSETCICTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCICtrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICtrTimebaseSrc',varargin{:});
