function varargout = DAQmxGetTrigAttribute(varargin)
%DAQMXGETTRIGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxGetTrigAttribute(uint32, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTrigAttribute',varargin{:});
