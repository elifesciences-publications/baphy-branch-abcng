function varargout = DAQmxResetCIDataXferMech(varargin)
%DAQMXRESETCIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIDataXferMech(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIDataXferMech',varargin{:});
