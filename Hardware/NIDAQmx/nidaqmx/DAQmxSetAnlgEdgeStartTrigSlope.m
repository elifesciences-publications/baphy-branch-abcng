function varargout = DAQmxSetAnlgEdgeStartTrigSlope(varargin)
%DAQMXSETANLGEDGESTARTTRIGSLOPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgEdgeStartTrigSlope(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeStartTrigSlope',varargin{:});
