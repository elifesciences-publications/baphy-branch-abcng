function varargout = DAQmxGetCIPeriodTerm(varargin)
%DAQMXGETCIPERIODTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIPeriodTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodTerm',varargin{:});
