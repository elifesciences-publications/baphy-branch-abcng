function varargout = DAQmxResetAnlgWinRefTrigWhen(varargin)
%DAQMXRESETANLGWINREFTRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinRefTrigWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinRefTrigWhen',varargin{:});
