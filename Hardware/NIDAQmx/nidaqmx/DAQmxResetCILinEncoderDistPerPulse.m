function varargout = DAQmxResetCILinEncoderDistPerPulse(varargin)
%DAQMXRESETCILINENCODERDISTPERPULSE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCILinEncoderDistPerPulse(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCILinEncoderDistPerPulse',varargin{:});
