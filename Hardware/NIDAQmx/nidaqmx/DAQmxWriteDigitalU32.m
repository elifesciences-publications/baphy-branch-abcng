function varargout = DAQmxWriteDigitalU32(varargin)
%DAQMXWRITEDIGITALU32 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr, int32Ptr, uint32Ptr] DAQmxWriteDigitalU32(uint32, int32, uint32, double, uint32, uint32Ptr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteDigitalU32',varargin{:});
