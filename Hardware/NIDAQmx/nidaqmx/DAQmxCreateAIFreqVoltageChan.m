function varargout = DAQmxCreateAIFreqVoltageChan(varargin)
%DAQMXCREATEAIFREQVOLTAGECHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAIFreqVoltageChan(uint32, cstring, cstring, double, double, int32, double, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIFreqVoltageChan',varargin{:});
