function varargout = DAQmxSetAIBridgeInitialVoltage(varargin)
%DAQMXSETAIBRIDGEINITIALVOLTAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIBridgeInitialVoltage(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIBridgeInitialVoltage',varargin{:});
