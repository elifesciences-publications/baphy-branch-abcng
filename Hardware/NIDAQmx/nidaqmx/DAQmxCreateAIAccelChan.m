function varargout = DAQmxCreateAIAccelChan(varargin)
%DAQMXCREATEAIACCELCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAIAccelChan(uint32, cstring, cstring, int32, double, double, int32, double, int32, int32, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIAccelChan',varargin{:});
