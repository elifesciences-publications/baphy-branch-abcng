function varargout = DAQmxResetDOMemMapEnable(varargin)
%DAQMXRESETDOMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOMemMapEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOMemMapEnable',varargin{:});
