function varargout = DAQmxSetAODACRefAllowConnToGnd(varargin)
%DAQMXSETAODACREFALLOWCONNTOGND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODACRefAllowConnToGnd(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACRefAllowConnToGnd',varargin{:});
