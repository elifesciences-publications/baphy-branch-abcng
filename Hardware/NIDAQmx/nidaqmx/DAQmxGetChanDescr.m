function varargout = DAQmxGetChanDescr(varargin)
%DAQMXGETCHANDESCR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetChanDescr(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetChanDescr',varargin{:});
