function varargout = DAQmxGetDevCISampClkSupported(varargin)
%DAQMXGETDEVCISAMPCLKSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevCISampClkSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevCISampClkSupported',varargin{:});
