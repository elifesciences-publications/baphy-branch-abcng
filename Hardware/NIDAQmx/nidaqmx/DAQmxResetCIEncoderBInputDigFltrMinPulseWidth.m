function varargout = DAQmxResetCIEncoderBInputDigFltrMinPulseWidth(varargin)
%DAQMXRESETCIENCODERBINPUTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderBInputDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderBInputDigFltrMinPulseWidth',varargin{:});
