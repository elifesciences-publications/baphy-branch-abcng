function varargout = DAQmxSetExportedAdvCmpltEventOutputTerm(varargin)
%DAQMXSETEXPORTEDADVCMPLTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedAdvCmpltEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAdvCmpltEventOutputTerm',varargin{:});
