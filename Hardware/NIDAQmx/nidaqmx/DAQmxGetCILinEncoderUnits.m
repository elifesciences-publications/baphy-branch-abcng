function varargout = DAQmxGetCILinEncoderUnits(varargin)
%DAQMXGETCILINENCODERUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCILinEncoderUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCILinEncoderUnits',varargin{:});
