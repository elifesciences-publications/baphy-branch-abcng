function varargout = DAQmxGetSwitchChanUsage(varargin)
%DAQMXGETSWITCHCHANUSAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetSwitchChanUsage(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanUsage',varargin{:});
