function varargout = DAQmxAdjust153xCal(varargin)
%DAQMXADJUST153XCAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust153xCal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust153xCal',varargin{:});
