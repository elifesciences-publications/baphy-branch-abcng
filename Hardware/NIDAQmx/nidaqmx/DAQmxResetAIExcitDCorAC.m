function varargout = DAQmxResetAIExcitDCorAC(varargin)
%DAQMXRESETAIEXCITDCORAC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIExcitDCorAC(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIExcitDCorAC',varargin{:});
