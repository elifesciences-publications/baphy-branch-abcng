function varargout = DAQmxResetAIThrmstrA(varargin)
%DAQMXRESETAITHRMSTRA calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIThrmstrA(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIThrmstrA',varargin{:});
