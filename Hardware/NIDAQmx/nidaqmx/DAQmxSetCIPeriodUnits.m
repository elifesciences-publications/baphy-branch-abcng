function varargout = DAQmxSetCIPeriodUnits(varargin)
%DAQMXSETCIPERIODUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodUnits',varargin{:});
