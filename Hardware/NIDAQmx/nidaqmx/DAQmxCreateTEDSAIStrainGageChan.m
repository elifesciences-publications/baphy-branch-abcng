function varargout = DAQmxCreateTEDSAIStrainGageChan(varargin)
%DAQMXCREATETEDSAISTRAINGAGECHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateTEDSAIStrainGageChan(uint32, cstring, cstring, double, double, int32, int32, double, double, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateTEDSAIStrainGageChan',varargin{:});
