function varargout = DAQmxResetAIConvActiveEdgeEx(varargin)
%DAQMXRESETAICONVACTIVEEDGEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIConvActiveEdgeEx(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvActiveEdgeEx',varargin{:});
