function varargout = DAQmxGetDOOvercurrentAutoReenable(varargin)
%DAQMXGETDOOVERCURRENTAUTOREENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDOOvercurrentAutoReenable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOOvercurrentAutoReenable',varargin{:});
