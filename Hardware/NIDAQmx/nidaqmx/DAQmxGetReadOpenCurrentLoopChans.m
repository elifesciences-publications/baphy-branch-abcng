function varargout = DAQmxGetReadOpenCurrentLoopChans(varargin)
%DAQMXGETREADOPENCURRENTLOOPCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetReadOpenCurrentLoopChans(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOpenCurrentLoopChans',varargin{:});
