function varargout = DAQmxGetWriteNumChans(varargin)
%DAQMXGETWRITENUMCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWriteNumChans(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteNumChans',varargin{:});
