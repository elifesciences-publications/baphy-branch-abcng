function varargout = DAQmxSetOnDemandSimultaneousAOEnable(varargin)
%DAQMXSETONDEMANDSIMULTANEOUSAOENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetOnDemandSimultaneousAOEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetOnDemandSimultaneousAOEnable',varargin{:});
