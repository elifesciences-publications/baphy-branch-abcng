function varargout = DAQmxResetDigEdgeAdvTrigSrc(varargin)
%DAQMXRESETDIGEDGEADVTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeAdvTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeAdvTrigSrc',varargin{:});
