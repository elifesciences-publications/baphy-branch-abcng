function varargout = DAQmxGetAIRVDTSensitivityUnits(varargin)
%DAQMXGETAIRVDTSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIRVDTSensitivityUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRVDTSensitivityUnits',varargin{:});
