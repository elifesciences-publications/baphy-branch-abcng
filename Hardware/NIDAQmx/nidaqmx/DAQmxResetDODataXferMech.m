function varargout = DAQmxResetDODataXferMech(varargin)
%DAQMXRESETDODATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDODataXferMech(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDODataXferMech',varargin{:});
