function varargout = DAQmxSetAILowpassSwitchCapExtClkFreq(varargin)
%DAQMXSETAILOWPASSSWITCHCAPEXTCLKFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILowpassSwitchCapExtClkFreq(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILowpassSwitchCapExtClkFreq',varargin{:});
