function varargout = DAQmxSetWriteWaitMode(varargin)
%DAQMXSETWRITEWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetWriteWaitMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetWriteWaitMode',varargin{:});
