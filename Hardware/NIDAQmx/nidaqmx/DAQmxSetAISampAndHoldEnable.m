function varargout = DAQmxSetAISampAndHoldEnable(varargin)
%DAQMXSETAISAMPANDHOLDENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAISampAndHoldEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAISampAndHoldEnable',varargin{:});
