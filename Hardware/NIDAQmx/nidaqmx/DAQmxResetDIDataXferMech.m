function varargout = DAQmxResetDIDataXferMech(varargin)
%DAQMXRESETDIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDIDataXferMech(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDIDataXferMech',varargin{:});
