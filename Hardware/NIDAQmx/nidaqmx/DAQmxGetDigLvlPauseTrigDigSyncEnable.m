function varargout = DAQmxGetDigLvlPauseTrigDigSyncEnable(varargin)
%DAQMXGETDIGLVLPAUSETRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetDigLvlPauseTrigDigSyncEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigLvlPauseTrigDigSyncEnable',varargin{:});
