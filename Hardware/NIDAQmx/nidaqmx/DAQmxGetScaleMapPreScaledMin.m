function varargout = DAQmxGetScaleMapPreScaledMin(varargin)
%DAQMXGETSCALEMAPPRESCALEDMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetScaleMapPreScaledMin(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScaleMapPreScaledMin',varargin{:});
