function varargout = DAQmxResetRealTimeAttribute(varargin)
%DAQMXRESETREALTIMEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRealTimeAttribute(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRealTimeAttribute',varargin{:});
