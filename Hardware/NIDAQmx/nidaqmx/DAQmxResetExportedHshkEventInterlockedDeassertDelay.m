function varargout = DAQmxResetExportedHshkEventInterlockedDeassertDelay(varargin)
%DAQMXRESETEXPORTEDHSHKEVENTINTERLOCKEDDEASSERTDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedHshkEventInterlockedDeassertDelay(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedHshkEventInterlockedDeassertDelay',varargin{:});
