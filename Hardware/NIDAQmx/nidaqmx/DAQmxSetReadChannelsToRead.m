function varargout = DAQmxSetReadChannelsToRead(varargin)
%DAQMXSETREADCHANNELSTOREAD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetReadChannelsToRead(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadChannelsToRead',varargin{:});
