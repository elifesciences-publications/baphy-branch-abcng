function varargout = DAQmxAdjust1503CurrentCal(varargin)
%DAQMXADJUST1503CURRENTCAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxAdjust1503CurrentCal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1503CurrentCal',varargin{:});
