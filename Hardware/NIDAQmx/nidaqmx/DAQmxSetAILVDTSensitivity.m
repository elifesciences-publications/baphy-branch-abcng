function varargout = DAQmxSetAILVDTSensitivity(varargin)
%DAQMXSETAILVDTSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILVDTSensitivity(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILVDTSensitivity',varargin{:});
