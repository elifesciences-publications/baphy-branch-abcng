function varargout = DAQmxSetCIFreqUnits(varargin)
%DAQMXSETCIFREQUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqUnits',varargin{:});
