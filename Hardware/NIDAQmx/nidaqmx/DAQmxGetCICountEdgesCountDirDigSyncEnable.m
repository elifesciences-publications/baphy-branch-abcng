function varargout = DAQmxGetCICountEdgesCountDirDigSyncEnable(varargin)
%DAQMXGETCICOUNTEDGESCOUNTDIRDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCICountEdgesCountDirDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesCountDirDigSyncEnable',varargin{:});
