function varargout = DAQmxSendSoftwareTrigger(varargin)
%DAQMXSENDSOFTWARETRIGGER calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSendSoftwareTrigger(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSendSoftwareTrigger',varargin{:});
