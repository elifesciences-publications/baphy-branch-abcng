function varargout = DAQmxGetCITwoEdgeSepSecondDigFltrMinPulseWidth(varargin)
%DAQMXGETCITWOEDGESEPSECONDDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCITwoEdgeSepSecondDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepSecondDigFltrMinPulseWidth',varargin{:});
