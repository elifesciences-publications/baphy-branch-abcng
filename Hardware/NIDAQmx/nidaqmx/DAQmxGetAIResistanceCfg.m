function varargout = DAQmxGetAIResistanceCfg(varargin)
%DAQMXGETAIRESISTANCECFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIResistanceCfg(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIResistanceCfg',varargin{:});
