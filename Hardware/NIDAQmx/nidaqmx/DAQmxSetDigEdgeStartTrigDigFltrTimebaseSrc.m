function varargout = DAQmxSetDigEdgeStartTrigDigFltrTimebaseSrc(varargin)
%DAQMXSETDIGEDGESTARTTRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigEdgeStartTrigDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeStartTrigDigFltrTimebaseSrc',varargin{:});
