function varargout = DAQmxConnectTerms(varargin)
%DAQMXCONNECTTERMS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxConnectTerms(cstring, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxConnectTerms',varargin{:});
