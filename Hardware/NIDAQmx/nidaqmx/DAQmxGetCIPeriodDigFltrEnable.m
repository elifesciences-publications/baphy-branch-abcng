function varargout = DAQmxGetCIPeriodDigFltrEnable(varargin)
%DAQMXGETCIPERIODDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIPeriodDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodDigFltrEnable',varargin{:});
