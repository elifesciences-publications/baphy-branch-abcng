function varargout = DAQmxGetCICountEdgesTerm(varargin)
%DAQMXGETCICOUNTEDGESTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCICountEdgesTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesTerm',varargin{:});
