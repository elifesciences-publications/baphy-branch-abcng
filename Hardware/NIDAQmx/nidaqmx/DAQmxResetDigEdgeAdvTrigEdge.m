function varargout = DAQmxResetDigEdgeAdvTrigEdge(varargin)
%DAQMXRESETDIGEDGEADVTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeAdvTrigEdge(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeAdvTrigEdge',varargin{:});
