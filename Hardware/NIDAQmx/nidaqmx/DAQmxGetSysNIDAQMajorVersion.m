function varargout = DAQmxGetSysNIDAQMajorVersion(varargin)
%DAQMXGETSYSNIDAQMAJORVERSION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetSysNIDAQMajorVersion(uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSysNIDAQMajorVersion',varargin{:});
