function varargout = DAQmxGetTaskComplete(varargin)
%DAQMXGETTASKCOMPLETE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetTaskComplete(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetTaskComplete',varargin{:});
