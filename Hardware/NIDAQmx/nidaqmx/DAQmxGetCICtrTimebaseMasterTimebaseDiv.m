function varargout = DAQmxGetCICtrTimebaseMasterTimebaseDiv(varargin)
%DAQMXGETCICTRTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCICtrTimebaseMasterTimebaseDiv(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseMasterTimebaseDiv',varargin{:});
