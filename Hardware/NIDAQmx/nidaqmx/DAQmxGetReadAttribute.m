function varargout = DAQmxGetReadAttribute(varargin)
%DAQMXGETREADATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxGetReadAttribute(uint32, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadAttribute',varargin{:});
