function varargout = DAQmxSetExportedRdyForXferEventOutputTerm(varargin)
%DAQMXSETEXPORTEDRDYFORXFEREVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedRdyForXferEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedRdyForXferEventOutputTerm',varargin{:});
