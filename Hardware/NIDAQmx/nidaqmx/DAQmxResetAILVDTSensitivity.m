function varargout = DAQmxResetAILVDTSensitivity(varargin)
%DAQMXRESETAILVDTSENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAILVDTSensitivity(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAILVDTSensitivity',varargin{:});
