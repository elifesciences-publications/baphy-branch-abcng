function varargout = DAQmxSetAIThrmstrA(varargin)
%DAQMXSETAITHRMSTRA calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIThrmstrA(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIThrmstrA',varargin{:});
