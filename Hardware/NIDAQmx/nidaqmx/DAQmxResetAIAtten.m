function varargout = DAQmxResetAIAtten(varargin)
%DAQMXRESETAIATTEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIAtten(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIAtten',varargin{:});
