function varargout = DAQmxResetAIBridgeBalanceCoarsePot(varargin)
%DAQMXRESETAIBRIDGEBALANCECOARSEPOT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIBridgeBalanceCoarsePot(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIBridgeBalanceCoarsePot',varargin{:});
