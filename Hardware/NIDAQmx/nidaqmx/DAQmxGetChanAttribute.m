function varargout = DAQmxGetChanAttribute(varargin)
%DAQMXGETCHANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetChanAttribute(uint32, cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetChanAttribute',varargin{:});
