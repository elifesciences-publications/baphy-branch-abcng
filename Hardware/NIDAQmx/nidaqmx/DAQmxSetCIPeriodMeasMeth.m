function varargout = DAQmxSetCIPeriodMeasMeth(varargin)
%DAQMXSETCIPERIODMEASMETH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodMeasMeth(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodMeasMeth',varargin{:});
