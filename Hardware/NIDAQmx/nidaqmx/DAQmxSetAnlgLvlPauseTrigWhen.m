function varargout = DAQmxSetAnlgLvlPauseTrigWhen(varargin)
%DAQMXSETANLGLVLPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgLvlPauseTrigWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgLvlPauseTrigWhen',varargin{:});
