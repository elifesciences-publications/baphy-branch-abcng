function varargout = DAQmxResetDOLineStatesPausedState(varargin)
%DAQMXRESETDOLINESTATESPAUSEDSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOLineStatesPausedState(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOLineStatesPausedState',varargin{:});
