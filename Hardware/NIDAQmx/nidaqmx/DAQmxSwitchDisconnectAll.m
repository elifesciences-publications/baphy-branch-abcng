function varargout = DAQmxSwitchDisconnectAll(varargin)
%DAQMXSWITCHDISCONNECTALL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSwitchDisconnectAll(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSwitchDisconnectAll',varargin{:});
