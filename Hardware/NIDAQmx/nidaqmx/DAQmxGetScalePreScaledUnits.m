function varargout = DAQmxGetScalePreScaledUnits(varargin)
%DAQMXGETSCALEPRESCALEDUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetScalePreScaledUnits(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetScalePreScaledUnits',varargin{:});
