function varargout = DAQmxGetReadOvercurrentChans(varargin)
%DAQMXGETREADOVERCURRENTCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetReadOvercurrentChans(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOvercurrentChans',varargin{:});
