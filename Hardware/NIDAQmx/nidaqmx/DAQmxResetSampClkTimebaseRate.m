function varargout = DAQmxResetSampClkTimebaseRate(varargin)
%DAQMXRESETSAMPCLKTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkTimebaseRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkTimebaseRate',varargin{:});
