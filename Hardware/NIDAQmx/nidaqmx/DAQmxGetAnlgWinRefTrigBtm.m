function varargout = DAQmxGetAnlgWinRefTrigBtm(varargin)
%DAQMXGETANLGWINREFTRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgWinRefTrigBtm(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinRefTrigBtm',varargin{:});
