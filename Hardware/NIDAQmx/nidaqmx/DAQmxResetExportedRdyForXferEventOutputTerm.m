function varargout = DAQmxResetExportedRdyForXferEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDRDYFORXFEREVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedRdyForXferEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedRdyForXferEventOutputTerm',varargin{:});
