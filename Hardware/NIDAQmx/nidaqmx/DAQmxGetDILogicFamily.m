function varargout = DAQmxGetDILogicFamily(varargin)
%DAQMXGETDILOGICFAMILY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDILogicFamily(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDILogicFamily',varargin{:});
