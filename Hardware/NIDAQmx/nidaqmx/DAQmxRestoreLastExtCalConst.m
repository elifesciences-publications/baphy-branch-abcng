function varargout = DAQmxRestoreLastExtCalConst(varargin)
%DAQMXRESTORELASTEXTCALCONST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxRestoreLastExtCalConst(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxRestoreLastExtCalConst',varargin{:});
