function varargout = DAQmxResetWriteSleepTime(varargin)
%DAQMXRESETWRITESLEEPTIME calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWriteSleepTime(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWriteSleepTime',varargin{:});
