function varargout = DAQmxResetAIVoltageUnits(varargin)
%DAQMXRESETAIVOLTAGEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIVoltageUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIVoltageUnits',varargin{:});
