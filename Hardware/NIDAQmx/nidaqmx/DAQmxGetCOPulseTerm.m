function varargout = DAQmxGetCOPulseTerm(varargin)
%DAQMXGETCOPULSETERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCOPulseTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseTerm',varargin{:});
