function varargout = DAQmxSetExportedAIHoldCmpltEventOutputTerm(varargin)
%DAQMXSETEXPORTEDAIHOLDCMPLTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedAIHoldCmpltEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAIHoldCmpltEventOutputTerm',varargin{:});
