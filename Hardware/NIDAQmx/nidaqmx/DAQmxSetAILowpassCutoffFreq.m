function varargout = DAQmxSetAILowpassCutoffFreq(varargin)
%DAQMXSETAILOWPASSCUTOFFFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILowpassCutoffFreq(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILowpassCutoffFreq',varargin{:});
