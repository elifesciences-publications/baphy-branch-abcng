function varargout = DAQmxGetReadOpenThrmcplChansExist(varargin)
%DAQMXGETREADOPENTHRMCPLCHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadOpenThrmcplChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOpenThrmcplChansExist',varargin{:});
