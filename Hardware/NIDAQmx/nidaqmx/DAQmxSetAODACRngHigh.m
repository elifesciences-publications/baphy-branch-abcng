function varargout = DAQmxSetAODACRngHigh(varargin)
%DAQMXSETAODACRNGHIGH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODACRngHigh(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACRngHigh',varargin{:});
