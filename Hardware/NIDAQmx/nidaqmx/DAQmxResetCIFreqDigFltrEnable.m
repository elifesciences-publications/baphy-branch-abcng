function varargout = DAQmxResetCIFreqDigFltrEnable(varargin)
%DAQMXRESETCIFREQDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqDigFltrEnable',varargin{:});
