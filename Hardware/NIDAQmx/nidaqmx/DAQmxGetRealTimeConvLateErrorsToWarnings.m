function varargout = DAQmxGetRealTimeConvLateErrorsToWarnings(varargin)
%DAQMXGETREALTIMECONVLATEERRORSTOWARNINGS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetRealTimeConvLateErrorsToWarnings(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRealTimeConvLateErrorsToWarnings',varargin{:});
