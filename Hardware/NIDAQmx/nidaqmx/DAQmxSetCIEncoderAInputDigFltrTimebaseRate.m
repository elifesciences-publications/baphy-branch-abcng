function varargout = DAQmxSetCIEncoderAInputDigFltrTimebaseRate(varargin)
%DAQMXSETCIENCODERAINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderAInputDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderAInputDigFltrTimebaseRate',varargin{:});
