function varargout = DAQmxGetPhysicalChanAITermCfgs(varargin)
%DAQMXGETPHYSICALCHANAITERMCFGS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetPhysicalChanAITermCfgs(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanAITermCfgs',varargin{:});
