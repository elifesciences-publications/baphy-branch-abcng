function varargout = DAQmxSetAnlgWinPauseTrigWhen(varargin)
%DAQMXSETANLGWINPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinPauseTrigWhen(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinPauseTrigWhen',varargin{:});
