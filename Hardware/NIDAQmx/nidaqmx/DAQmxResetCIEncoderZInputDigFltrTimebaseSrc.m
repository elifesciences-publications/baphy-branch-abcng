function varargout = DAQmxResetCIEncoderZInputDigFltrTimebaseSrc(varargin)
%DAQMXRESETCIENCODERZINPUTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZInputDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZInputDigFltrTimebaseSrc',varargin{:});
