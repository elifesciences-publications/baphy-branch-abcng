function varargout = DAQmxGetWriteOvercurrentChansExist(varargin)
%DAQMXGETWRITEOVERCURRENTCHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWriteOvercurrentChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteOvercurrentChansExist',varargin{:});
