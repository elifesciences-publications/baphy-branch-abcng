function varargout = DAQmxGetWriteSleepTime(varargin)
%DAQMXGETWRITESLEEPTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetWriteSleepTime(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteSleepTime',varargin{:});
