function varargout = DAQmxResetDigEdgeRefTrigEdge(varargin)
%DAQMXRESETDIGEDGEREFTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeRefTrigEdge(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeRefTrigEdge',varargin{:});
