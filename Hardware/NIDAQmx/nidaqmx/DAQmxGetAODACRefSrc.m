function varargout = DAQmxGetAODACRefSrc(varargin)
%DAQMXGETAODACREFSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAODACRefSrc(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACRefSrc',varargin{:});
