function varargout = DAQmxGetDevTCPIPHostname(varargin)
%DAQMXGETDEVTCPIPHOSTNAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevTCPIPHostname(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevTCPIPHostname',varargin{:});
