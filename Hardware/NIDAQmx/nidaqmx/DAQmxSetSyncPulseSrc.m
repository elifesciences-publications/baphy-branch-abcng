function varargout = DAQmxSetSyncPulseSrc(varargin)
%DAQMXSETSYNCPULSESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetSyncPulseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSyncPulseSrc',varargin{:});
