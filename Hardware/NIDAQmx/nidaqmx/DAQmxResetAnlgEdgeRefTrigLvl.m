function varargout = DAQmxResetAnlgEdgeRefTrigLvl(varargin)
%DAQMXRESETANLGEDGEREFTRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeRefTrigLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeRefTrigLvl',varargin{:});
