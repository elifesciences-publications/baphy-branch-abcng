function varargout = DAQmxResetAnlgEdgeRefTrigHyst(varargin)
%DAQMXRESETANLGEDGEREFTRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeRefTrigHyst(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeRefTrigHyst',varargin{:});
