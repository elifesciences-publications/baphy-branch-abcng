function varargout = DAQmxResetAdvTrigType(varargin)
%DAQMXRESETADVTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAdvTrigType(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAdvTrigType',varargin{:});
