function varargout = DAQmxGetDigEdgeStartTrigDigFltrTimebaseSrc(varargin)
%DAQMXGETDIGEDGESTARTTRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigEdgeStartTrigDigFltrTimebaseSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeStartTrigDigFltrTimebaseSrc',varargin{:});
