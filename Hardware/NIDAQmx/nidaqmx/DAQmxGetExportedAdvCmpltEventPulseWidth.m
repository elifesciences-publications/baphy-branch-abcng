function varargout = DAQmxGetExportedAdvCmpltEventPulseWidth(varargin)
%DAQMXGETEXPORTEDADVCMPLTEVENTPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetExportedAdvCmpltEventPulseWidth(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAdvCmpltEventPulseWidth',varargin{:});
