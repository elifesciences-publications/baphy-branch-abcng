function varargout = DAQmxResetDOGenerateOn(varargin)
%DAQMXRESETDOGENERATEON calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOGenerateOn(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOGenerateOn',varargin{:});
