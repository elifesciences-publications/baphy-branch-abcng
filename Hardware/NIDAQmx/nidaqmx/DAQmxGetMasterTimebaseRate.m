function varargout = DAQmxGetMasterTimebaseRate(varargin)
%DAQMXGETMASTERTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetMasterTimebaseRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetMasterTimebaseRate',varargin{:});
