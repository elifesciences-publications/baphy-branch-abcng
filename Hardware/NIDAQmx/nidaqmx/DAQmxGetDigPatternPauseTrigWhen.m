function varargout = DAQmxGetDigPatternPauseTrigWhen(varargin)
%DAQMXGETDIGPATTERNPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigPatternPauseTrigWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternPauseTrigWhen',varargin{:});
