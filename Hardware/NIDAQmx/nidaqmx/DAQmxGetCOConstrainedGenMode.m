function varargout = DAQmxGetCOConstrainedGenMode(varargin)
%DAQMXGETCOCONSTRAINEDGENMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCOConstrainedGenMode(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOConstrainedGenMode',varargin{:});
