function varargout = DAQmxSetAICurrentUnits(varargin)
%DAQMXSETAICURRENTUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAICurrentUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAICurrentUnits',varargin{:});
