function varargout = DAQmxGetSampClkSrc(varargin)
%DAQMXGETSAMPCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetSampClkSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkSrc',varargin{:});
