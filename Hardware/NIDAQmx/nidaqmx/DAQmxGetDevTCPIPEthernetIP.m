function varargout = DAQmxGetDevTCPIPEthernetIP(varargin)
%DAQMXGETDEVTCPIPETHERNETIP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevTCPIPEthernetIP(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevTCPIPEthernetIP',varargin{:});
