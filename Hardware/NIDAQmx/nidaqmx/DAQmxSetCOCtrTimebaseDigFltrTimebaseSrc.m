function varargout = DAQmxSetCOCtrTimebaseDigFltrTimebaseSrc(varargin)
%DAQMXSETCOCTRTIMEBASEDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCOCtrTimebaseDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseDigFltrTimebaseSrc',varargin{:});
