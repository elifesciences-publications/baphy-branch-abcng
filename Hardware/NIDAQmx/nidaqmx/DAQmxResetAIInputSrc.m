function varargout = DAQmxResetAIInputSrc(varargin)
%DAQMXRESETAIINPUTSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIInputSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIInputSrc',varargin{:});
