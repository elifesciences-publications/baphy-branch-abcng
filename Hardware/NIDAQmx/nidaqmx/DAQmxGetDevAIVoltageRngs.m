function varargout = DAQmxGetDevAIVoltageRngs(varargin)
%DAQMXGETDEVAIVOLTAGERNGS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevAIVoltageRngs(cstring, doublePtr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAIVoltageRngs',varargin{:});
