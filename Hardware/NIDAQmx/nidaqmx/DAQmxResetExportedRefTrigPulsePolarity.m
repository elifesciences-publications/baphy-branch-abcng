function varargout = DAQmxResetExportedRefTrigPulsePolarity(varargin)
%DAQMXRESETEXPORTEDREFTRIGPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedRefTrigPulsePolarity(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedRefTrigPulsePolarity',varargin{:});
