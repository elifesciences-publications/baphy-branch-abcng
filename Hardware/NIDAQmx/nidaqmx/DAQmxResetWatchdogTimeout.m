function varargout = DAQmxResetWatchdogTimeout(varargin)
%DAQMXRESETWATCHDOGTIMEOUT calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWatchdogTimeout(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWatchdogTimeout',varargin{:});
