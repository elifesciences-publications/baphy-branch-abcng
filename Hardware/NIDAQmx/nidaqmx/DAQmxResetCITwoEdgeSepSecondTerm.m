function varargout = DAQmxResetCITwoEdgeSepSecondTerm(varargin)
%DAQMXRESETCITWOEDGESEPSECONDTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepSecondTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepSecondTerm',varargin{:});
