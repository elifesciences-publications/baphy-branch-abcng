function varargout = DAQmxGetAIConvTimebaseSrc(varargin)
%DAQMXGETAICONVTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAIConvTimebaseSrc(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvTimebaseSrc',varargin{:});
