function varargout = DAQmxResetExportedStartTrigPulsePolarity(varargin)
%DAQMXRESETEXPORTEDSTARTTRIGPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedStartTrigPulsePolarity(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedStartTrigPulsePolarity',varargin{:});
