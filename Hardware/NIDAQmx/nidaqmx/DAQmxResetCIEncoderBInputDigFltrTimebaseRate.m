function varargout = DAQmxResetCIEncoderBInputDigFltrTimebaseRate(varargin)
%DAQMXRESETCIENCODERBINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderBInputDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderBInputDigFltrTimebaseRate',varargin{:});
