function varargout = DAQmxSetAIConvTimebaseDiv(varargin)
%DAQMXSETAICONVTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAIConvTimebaseDiv(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvTimebaseDiv',varargin{:});
