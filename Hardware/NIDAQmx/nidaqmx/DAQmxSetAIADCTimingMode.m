function varargout = DAQmxSetAIADCTimingMode(varargin)
%DAQMXSETAIADCTIMINGMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIADCTimingMode(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIADCTimingMode',varargin{:});
