function varargout = DAQmxGetAIVoltagedBRef(varargin)
%DAQMXGETAIVOLTAGEDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIVoltagedBRef(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIVoltagedBRef',varargin{:});
