function varargout = DAQmxGetAOVoltageUnits(varargin)
%DAQMXGETAOVOLTAGEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAOVoltageUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOVoltageUnits',varargin{:});
