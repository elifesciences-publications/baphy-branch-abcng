function varargout = DAQmxClearTEDS(varargin)
%DAQMXCLEARTEDS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxClearTEDS(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxClearTEDS',varargin{:});
