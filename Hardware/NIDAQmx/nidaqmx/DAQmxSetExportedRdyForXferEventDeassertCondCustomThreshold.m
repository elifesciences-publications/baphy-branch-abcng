function varargout = DAQmxSetExportedRdyForXferEventDeassertCondCustomThreshold(varargin)
%DAQMXSETEXPORTEDRDYFORXFEREVENTDEASSERTCONDCUSTOMTHRESHOLD calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedRdyForXferEventDeassertCondCustomThreshold(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedRdyForXferEventDeassertCondCustomThreshold',varargin{:});
