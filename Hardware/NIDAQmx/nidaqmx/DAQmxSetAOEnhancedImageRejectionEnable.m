function varargout = DAQmxSetAOEnhancedImageRejectionEnable(varargin)
%DAQMXSETAOENHANCEDIMAGEREJECTIONENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOEnhancedImageRejectionEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOEnhancedImageRejectionEnable',varargin{:});
