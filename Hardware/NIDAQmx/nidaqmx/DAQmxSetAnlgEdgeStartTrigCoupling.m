function varargout = DAQmxSetAnlgEdgeStartTrigCoupling(varargin)
%DAQMXSETANLGEDGESTARTTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgEdgeStartTrigCoupling(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeStartTrigCoupling',varargin{:});
