function varargout = DAQmxResetExportedAdvTrigPulseWidth(varargin)
%DAQMXRESETEXPORTEDADVTRIGPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAdvTrigPulseWidth(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAdvTrigPulseWidth',varargin{:});
