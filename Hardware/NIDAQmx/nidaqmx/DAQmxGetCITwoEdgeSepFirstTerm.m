function varargout = DAQmxGetCITwoEdgeSepFirstTerm(varargin)
%DAQMXGETCITWOEDGESEPFIRSTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCITwoEdgeSepFirstTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepFirstTerm',varargin{:});
