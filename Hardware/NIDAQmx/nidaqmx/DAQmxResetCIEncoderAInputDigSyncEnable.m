function varargout = DAQmxResetCIEncoderAInputDigSyncEnable(varargin)
%DAQMXRESETCIENCODERAINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderAInputDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderAInputDigSyncEnable',varargin{:});
