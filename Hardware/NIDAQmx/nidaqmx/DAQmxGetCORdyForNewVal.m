function varargout = DAQmxGetCORdyForNewVal(varargin)
%DAQMXGETCORDYFORNEWVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCORdyForNewVal(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCORdyForNewVal',varargin{:});
