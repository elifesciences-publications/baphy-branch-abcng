function varargout = DAQmxGetSampClkTimebaseRate(varargin)
%DAQMXGETSAMPCLKTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetSampClkTimebaseRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkTimebaseRate',varargin{:});
