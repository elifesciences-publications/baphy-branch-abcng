function varargout = DAQmxResetExportedSignalAttribute(varargin)
%DAQMXRESETEXPORTEDSIGNALATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedSignalAttribute(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedSignalAttribute',varargin{:});
