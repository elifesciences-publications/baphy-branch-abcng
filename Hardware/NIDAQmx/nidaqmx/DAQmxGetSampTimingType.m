function varargout = DAQmxGetSampTimingType(varargin)
%DAQMXGETSAMPTIMINGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetSampTimingType(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampTimingType',varargin{:});
