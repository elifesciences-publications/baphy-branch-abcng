function varargout = DAQmxSetDigPatternRefTrigPattern(varargin)
%DAQMXSETDIGPATTERNREFTRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigPatternRefTrigPattern(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternRefTrigPattern',varargin{:});
