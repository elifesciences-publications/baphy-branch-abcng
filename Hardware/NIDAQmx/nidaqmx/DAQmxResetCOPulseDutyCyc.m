function varargout = DAQmxResetCOPulseDutyCyc(varargin)
%DAQMXRESETCOPULSEDUTYCYC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseDutyCyc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseDutyCyc',varargin{:});
