function varargout = DAQmxGetAIADCTimingMode(varargin)
%DAQMXGETAIADCTIMINGMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIADCTimingMode(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIADCTimingMode',varargin{:});
