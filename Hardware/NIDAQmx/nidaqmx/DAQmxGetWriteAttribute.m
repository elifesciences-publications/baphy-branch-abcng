function varargout = DAQmxGetWriteAttribute(varargin)
%DAQMXGETWRITEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxGetWriteAttribute(uint32, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWriteAttribute',varargin{:});
