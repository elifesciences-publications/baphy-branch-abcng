function varargout = DAQmxGetExportedRefTrigPulsePolarity(varargin)
%DAQMXGETEXPORTEDREFTRIGPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedRefTrigPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedRefTrigPulsePolarity',varargin{:});
