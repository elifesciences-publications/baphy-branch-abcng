function varargout = DAQmxResetAIConvTimebaseDiv(varargin)
%DAQMXRESETAICONVTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAIConvTimebaseDiv(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvTimebaseDiv',varargin{:});
