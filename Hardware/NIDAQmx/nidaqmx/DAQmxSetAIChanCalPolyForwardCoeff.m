function varargout = DAQmxSetAIChanCalPolyForwardCoeff(varargin)
%DAQMXSETAICHANCALPOLYFORWARDCOEFF calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxSetAIChanCalPolyForwardCoeff ( TaskHandle taskHandle , const char channel [], float64 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, doublePtr] DAQmxSetAIChanCalPolyForwardCoeff(uint32, cstring, doublePtr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIChanCalPolyForwardCoeff',varargin{:});
