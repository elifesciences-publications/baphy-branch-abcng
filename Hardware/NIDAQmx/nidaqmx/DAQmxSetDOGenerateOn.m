function varargout = DAQmxSetDOGenerateOn(varargin)
%DAQMXSETDOGENERATEON calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOGenerateOn(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOGenerateOn',varargin{:});
