function varargout = DAQmxSetAIBridgeShuntCalGainAdjust(varargin)
%DAQMXSETAIBRIDGESHUNTCALGAINADJUST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIBridgeShuntCalGainAdjust(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIBridgeShuntCalGainAdjust',varargin{:});
