function varargout = DAQmxSetChanDescr(varargin)
%DAQMXSETCHANDESCR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetChanDescr(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetChanDescr',varargin{:});
