function varargout = DAQmxGetDODataXferReqCond(varargin)
%DAQMXGETDODATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDODataXferReqCond(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDODataXferReqCond',varargin{:});
