function varargout = DAQmxGetAIConvMaxRateEx(varargin)
%DAQMXGETAICONVMAXRATEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIConvMaxRateEx(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvMaxRateEx',varargin{:});
