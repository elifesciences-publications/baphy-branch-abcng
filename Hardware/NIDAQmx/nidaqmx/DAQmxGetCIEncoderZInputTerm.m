function varargout = DAQmxGetCIEncoderZInputTerm(varargin)
%DAQMXGETCIENCODERZINPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIEncoderZInputTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderZInputTerm',varargin{:});
