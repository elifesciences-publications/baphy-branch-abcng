function varargout = DAQmxGetExportedWatchdogExpiredEventOutputTerm(varargin)
%DAQMXGETEXPORTEDWATCHDOGEXPIREDEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedWatchdogExpiredEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedWatchdogExpiredEventOutputTerm',varargin{:});
