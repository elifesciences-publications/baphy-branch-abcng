function varargout = DAQmxSetAnlgWinStartTrigCoupling(varargin)
%DAQMXSETANLGWINSTARTTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinStartTrigCoupling(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinStartTrigCoupling',varargin{:});
