function varargout = DAQmxGetCIEncoderBInputDigFltrTimebaseRate(varargin)
%DAQMXGETCIENCODERBINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIEncoderBInputDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderBInputDigFltrTimebaseRate',varargin{:});
