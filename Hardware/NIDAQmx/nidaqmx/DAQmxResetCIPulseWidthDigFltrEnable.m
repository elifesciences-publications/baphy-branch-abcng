function varargout = DAQmxResetCIPulseWidthDigFltrEnable(varargin)
%DAQMXRESETCIPULSEWIDTHDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPulseWidthDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPulseWidthDigFltrEnable',varargin{:});
