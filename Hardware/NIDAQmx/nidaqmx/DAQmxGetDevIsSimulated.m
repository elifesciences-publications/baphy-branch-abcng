function varargout = DAQmxGetDevIsSimulated(varargin)
%DAQMXGETDEVISSIMULATED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevIsSimulated(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevIsSimulated',varargin{:});
