function varargout = DAQmxResetCICtrTimebaseDigFltrEnable(varargin)
%DAQMXRESETCICTRTIMEBASEDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseDigFltrEnable',varargin{:});
