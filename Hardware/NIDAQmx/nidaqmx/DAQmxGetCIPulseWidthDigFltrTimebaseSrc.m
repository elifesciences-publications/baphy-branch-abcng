function varargout = DAQmxGetCIPulseWidthDigFltrTimebaseSrc(varargin)
%DAQMXGETCIPULSEWIDTHDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIPulseWidthDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPulseWidthDigFltrTimebaseSrc',varargin{:});
