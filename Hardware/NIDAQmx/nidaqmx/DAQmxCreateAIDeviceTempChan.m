function varargout = DAQmxCreateAIDeviceTempChan(varargin)
%DAQMXCREATEAIDEVICETEMPCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCreateAIDeviceTempChan(uint32, cstring, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAIDeviceTempChan',varargin{:});
