function varargout = DAQmxGetExportedPauseTrigOutputTerm(varargin)
%DAQMXGETEXPORTEDPAUSETRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedPauseTrigOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedPauseTrigOutputTerm',varargin{:});
