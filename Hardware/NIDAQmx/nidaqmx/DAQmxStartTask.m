function varargout = DAQmxStartTask(varargin)
%DAQMXSTARTTASK calls nidaqmx library with the appropriate arguments.
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxStartTask',varargin{:});
