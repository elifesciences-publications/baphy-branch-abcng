function varargout = DAQmxGetDOInvertLines(varargin)
%DAQMXGETDOINVERTLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDOInvertLines(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOInvertLines',varargin{:});
