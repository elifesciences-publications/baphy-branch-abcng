function varargout = DAQmxReadBinaryU32(varargin)
%DAQMXREADBINARYU32 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr, int32Ptr, uint32Ptr] DAQmxReadBinaryU32(uint32, int32, double, uint32, uint32Ptr, uint32, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxReadBinaryU32',varargin{:});
