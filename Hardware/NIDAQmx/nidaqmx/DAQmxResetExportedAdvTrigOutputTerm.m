function varargout = DAQmxResetExportedAdvTrigOutputTerm(varargin)
%DAQMXRESETEXPORTEDADVTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAdvTrigOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAdvTrigOutputTerm',varargin{:});
