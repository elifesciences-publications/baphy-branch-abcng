function varargout = DAQmxGetAIBridgeBalanceFinePot(varargin)
%DAQMXGETAIBRIDGEBALANCEFINEPOT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIBridgeBalanceFinePot(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIBridgeBalanceFinePot',varargin{:});
