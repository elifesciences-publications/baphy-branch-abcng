function varargout = DAQmxGetDOTristate(varargin)
%DAQMXGETDOTRISTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDOTristate(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOTristate',varargin{:});
