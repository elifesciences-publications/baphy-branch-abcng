function varargout = DAQmxResetExportedSampClkTimebaseOutputTerm(varargin)
%DAQMXRESETEXPORTEDSAMPCLKTIMEBASEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedSampClkTimebaseOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedSampClkTimebaseOutputTerm',varargin{:});
