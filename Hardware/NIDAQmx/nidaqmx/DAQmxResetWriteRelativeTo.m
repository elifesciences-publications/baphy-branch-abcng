function varargout = DAQmxResetWriteRelativeTo(varargin)
%DAQMXRESETWRITERELATIVETO calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWriteRelativeTo(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWriteRelativeTo',varargin{:});
