function varargout = DAQmxGetCOCtrTimebaseSrc(varargin)
%DAQMXGETCOCTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCOCtrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseSrc',varargin{:});
