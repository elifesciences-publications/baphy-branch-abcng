function varargout = DAQmxCreateCOPulseChanTicks(varargin)
%DAQMXCREATECOPULSECHANTICKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateCOPulseChanTicks(uint32, cstring, cstring, cstring, int32, int32, int32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCOPulseChanTicks',varargin{:});
