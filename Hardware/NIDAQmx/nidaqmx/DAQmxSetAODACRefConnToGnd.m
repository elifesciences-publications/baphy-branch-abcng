function varargout = DAQmxSetAODACRefConnToGnd(varargin)
%DAQMXSETAODACREFCONNTOGND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAODACRefConnToGnd(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACRefConnToGnd',varargin{:});
