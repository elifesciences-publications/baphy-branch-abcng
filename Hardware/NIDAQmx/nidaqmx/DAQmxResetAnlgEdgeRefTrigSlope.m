function varargout = DAQmxResetAnlgEdgeRefTrigSlope(varargin)
%DAQMXRESETANLGEDGEREFTRIGSLOPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeRefTrigSlope(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeRefTrigSlope',varargin{:});
