function varargout = DAQmxAdjust1104Cal(varargin)
%DAQMXADJUST1104CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1104Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1104Cal',varargin{:});
