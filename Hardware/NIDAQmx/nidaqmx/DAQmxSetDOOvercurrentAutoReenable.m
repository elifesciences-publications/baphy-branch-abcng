function varargout = DAQmxSetDOOvercurrentAutoReenable(varargin)
%DAQMXSETDOOVERCURRENTAUTOREENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOOvercurrentAutoReenable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOOvercurrentAutoReenable',varargin{:});
