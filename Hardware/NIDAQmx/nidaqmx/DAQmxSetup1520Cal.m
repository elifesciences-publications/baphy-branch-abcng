function varargout = DAQmxSetup1520Cal(varargin)
%DAQMXSETUP1520CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1520Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1520Cal',varargin{:});
