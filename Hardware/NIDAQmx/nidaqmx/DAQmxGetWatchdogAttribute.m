function varargout = DAQmxGetWatchdogAttribute(varargin)
%DAQMXGETWATCHDOGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetWatchdogAttribute(uint32, cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWatchdogAttribute',varargin{:});
