function varargout = DAQmxGetAOOutputImpedance(varargin)
%DAQMXGETAOOUTPUTIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOOutputImpedance(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOOutputImpedance',varargin{:});
