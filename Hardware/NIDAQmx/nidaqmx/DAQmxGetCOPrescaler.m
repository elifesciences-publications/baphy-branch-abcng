function varargout = DAQmxGetCOPrescaler(varargin)
%DAQMXGETCOPRESCALER calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOPrescaler(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPrescaler',varargin{:});
