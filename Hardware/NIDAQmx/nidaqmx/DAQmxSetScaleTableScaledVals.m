function varargout = DAQmxSetScaleTableScaledVals(varargin)
%DAQMXSETSCALETABLESCALEDVALS calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxSetScaleTableScaledVals ( const char scaleName [], float64 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, doublePtr] DAQmxSetScaleTableScaledVals(cstring, doublePtr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleTableScaledVals',varargin{:});
