function varargout = DAQmxGetCICtrTimebaseDigSyncEnable(varargin)
%DAQMXGETCICTRTIMEBASEDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCICtrTimebaseDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICtrTimebaseDigSyncEnable',varargin{:});
