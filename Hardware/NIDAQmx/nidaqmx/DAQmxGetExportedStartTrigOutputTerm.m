function varargout = DAQmxGetExportedStartTrigOutputTerm(varargin)
%DAQMXGETEXPORTEDSTARTTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedStartTrigOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedStartTrigOutputTerm',varargin{:});
