function varargout = DAQmxResetAnlgWinPauseTrigWhen(varargin)
%DAQMXRESETANLGWINPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgWinPauseTrigWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgWinPauseTrigWhen',varargin{:});
