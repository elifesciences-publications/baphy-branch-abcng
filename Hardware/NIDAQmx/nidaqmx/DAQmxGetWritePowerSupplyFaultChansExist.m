function varargout = DAQmxGetWritePowerSupplyFaultChansExist(varargin)
%DAQMXGETWRITEPOWERSUPPLYFAULTCHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetWritePowerSupplyFaultChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWritePowerSupplyFaultChansExist',varargin{:});
