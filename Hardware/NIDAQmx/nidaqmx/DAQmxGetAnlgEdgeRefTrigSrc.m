function varargout = DAQmxGetAnlgEdgeRefTrigSrc(varargin)
%DAQMXGETANLGEDGEREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetAnlgEdgeRefTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeRefTrigSrc',varargin{:});
