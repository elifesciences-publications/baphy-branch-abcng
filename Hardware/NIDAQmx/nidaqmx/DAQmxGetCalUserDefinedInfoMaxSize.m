function varargout = DAQmxGetCalUserDefinedInfoMaxSize(varargin)
%DAQMXGETCALUSERDEFINEDINFOMAXSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCalUserDefinedInfoMaxSize(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCalUserDefinedInfoMaxSize',varargin{:});
