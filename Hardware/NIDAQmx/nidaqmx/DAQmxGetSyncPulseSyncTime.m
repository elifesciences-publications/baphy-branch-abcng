function varargout = DAQmxGetSyncPulseSyncTime(varargin)
%DAQMXGETSYNCPULSESYNCTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetSyncPulseSyncTime(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSyncPulseSyncTime',varargin{:});
