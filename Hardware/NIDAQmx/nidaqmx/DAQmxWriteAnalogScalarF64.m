function varargout = DAQmxWriteAnalogScalarF64(varargin)
%DAQMXWRITEANALOGSCALARF64 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxWriteAnalogScalarF64(uint32, uint32, double, double, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteAnalogScalarF64',varargin{:});
