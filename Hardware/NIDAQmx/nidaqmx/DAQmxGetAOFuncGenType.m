function varargout = DAQmxGetAOFuncGenType(varargin)
%DAQMXGETAOFUNCGENTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAOFuncGenType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOFuncGenType',varargin{:});
