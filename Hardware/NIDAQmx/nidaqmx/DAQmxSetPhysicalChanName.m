function varargout = DAQmxSetPhysicalChanName(varargin)
%DAQMXSETPHYSICALCHANNAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetPhysicalChanName(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetPhysicalChanName',varargin{:});
