function varargout = DAQmxResetRealTimeNumOfWarmupIters(varargin)
%DAQMXRESETREALTIMENUMOFWARMUPITERS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRealTimeNumOfWarmupIters(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRealTimeNumOfWarmupIters',varargin{:});
