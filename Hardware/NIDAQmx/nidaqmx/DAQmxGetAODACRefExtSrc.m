function varargout = DAQmxGetAODACRefExtSrc(varargin)
%DAQMXGETAODACREFEXTSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAODACRefExtSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACRefExtSrc',varargin{:});
