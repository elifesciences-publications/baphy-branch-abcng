function varargout = DAQmxGetSwitchChanImpedance(varargin)
%DAQMXGETSWITCHCHANIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanImpedance(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanImpedance',varargin{:});
