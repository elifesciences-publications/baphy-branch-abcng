function varargout = DAQmxSetAIVoltageUnits(varargin)
%DAQMXSETAIVOLTAGEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIVoltageUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIVoltageUnits',varargin{:});
