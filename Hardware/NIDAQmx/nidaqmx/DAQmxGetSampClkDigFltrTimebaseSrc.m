function varargout = DAQmxGetSampClkDigFltrTimebaseSrc(varargin)
%DAQMXGETSAMPCLKDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetSampClkDigFltrTimebaseSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkDigFltrTimebaseSrc',varargin{:});
