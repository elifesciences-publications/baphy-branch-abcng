function varargout = DAQmxGetAODACRefVal(varargin)
%DAQMXGETAODACREFVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAODACRefVal(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACRefVal',varargin{:});
