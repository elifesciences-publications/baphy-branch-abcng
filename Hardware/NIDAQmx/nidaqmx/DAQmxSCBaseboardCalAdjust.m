function varargout = DAQmxSCBaseboardCalAdjust(varargin)
%DAQMXSCBASEBOARDCALADJUST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSCBaseboardCalAdjust(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSCBaseboardCalAdjust',varargin{:});
