function varargout = DAQmxResetAODACRefSrc(varargin)
%DAQMXRESETAODACREFSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACRefSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACRefSrc',varargin{:});
