function varargout = DAQmxSetAIResistanceUnits(varargin)
%DAQMXSETAIRESISTANCEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIResistanceUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIResistanceUnits',varargin{:});
