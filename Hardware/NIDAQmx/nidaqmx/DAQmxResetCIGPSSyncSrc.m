function varargout = DAQmxResetCIGPSSyncSrc(varargin)
%DAQMXRESETCIGPSSYNCSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIGPSSyncSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIGPSSyncSrc',varargin{:});
