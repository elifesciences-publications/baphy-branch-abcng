function varargout = DAQmxRegisterSignalEvent(varargin)
%DAQMXREGISTERSIGNALEVENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxRegisterSignalEvent(uint32, int32, uint32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxRegisterSignalEvent',varargin{:});
