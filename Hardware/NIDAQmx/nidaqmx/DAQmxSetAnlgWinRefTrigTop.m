function varargout = DAQmxSetAnlgWinRefTrigTop(varargin)
%DAQMXSETANLGWINREFTRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinRefTrigTop(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinRefTrigTop',varargin{:});
