function varargout = DAQmxResetCOCtrTimebaseMasterTimebaseDiv(varargin)
%DAQMXRESETCOCTRTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOCtrTimebaseMasterTimebaseDiv(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOCtrTimebaseMasterTimebaseDiv',varargin{:});
