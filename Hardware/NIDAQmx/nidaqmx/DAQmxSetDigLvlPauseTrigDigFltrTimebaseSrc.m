function varargout = DAQmxSetDigLvlPauseTrigDigFltrTimebaseSrc(varargin)
%DAQMXSETDIGLVLPAUSETRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigLvlPauseTrigDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigLvlPauseTrigDigFltrTimebaseSrc',varargin{:});
