function varargout = DAQmxGetSwitchDevNumSwitchChans(varargin)
%DAQMXGETSWITCHDEVNUMSWITCHCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetSwitchDevNumSwitchChans(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchDevNumSwitchChans',varargin{:});
