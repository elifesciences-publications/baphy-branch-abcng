function varargout = DAQmxResetDigLvlPauseTrigDigFltrTimebaseRate(varargin)
%DAQMXRESETDIGLVLPAUSETRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigLvlPauseTrigDigFltrTimebaseRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigLvlPauseTrigDigFltrTimebaseRate',varargin{:});
