function varargout = DAQmxGetSwitchScanBreakMode(varargin)
%DAQMXGETSWITCHSCANBREAKMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetSwitchScanBreakMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchScanBreakMode',varargin{:});
