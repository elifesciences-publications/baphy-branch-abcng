function varargout = DAQmxResetDigEdgeArmStartTrigEdge(varargin)
%DAQMXRESETDIGEDGEARMSTARTTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeArmStartTrigEdge(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeArmStartTrigEdge',varargin{:});
