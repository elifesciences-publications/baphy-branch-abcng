function varargout = DAQmxSetRefClkRate(varargin)
%DAQMXSETREFCLKRATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetRefClkRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRefClkRate',varargin{:});
