function varargout = DAQmxResetDigEdgeStartTrigDigFltrTimebaseSrc(varargin)
%DAQMXRESETDIGEDGESTARTTRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeStartTrigDigFltrTimebaseSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeStartTrigDigFltrTimebaseSrc',varargin{:});
