function varargout = DAQmxGetCICountEdgesDigFltrEnable(varargin)
%DAQMXGETCICOUNTEDGESDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCICountEdgesDigFltrEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesDigFltrEnable',varargin{:});
