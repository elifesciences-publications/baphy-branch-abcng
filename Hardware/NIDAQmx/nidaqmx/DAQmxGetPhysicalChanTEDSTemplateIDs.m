function varargout = DAQmxGetPhysicalChanTEDSTemplateIDs(varargin)
%DAQMXGETPHYSICALCHANTEDSTEMPLATEIDS calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxGetPhysicalChanTEDSTemplateIDs ( const char physicalChannel [], uInt32 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanTEDSTemplateIDs(cstring, uint32Ptr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanTEDSTemplateIDs',varargin{:});
