function varargout = DAQmxDeleteSavedScale(varargin)
%DAQMXDELETESAVEDSCALE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxDeleteSavedScale(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxDeleteSavedScale',varargin{:});
