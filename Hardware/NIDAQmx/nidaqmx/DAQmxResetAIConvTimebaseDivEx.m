function varargout = DAQmxResetAIConvTimebaseDivEx(varargin)
%DAQMXRESETAICONVTIMEBASEDIVEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIConvTimebaseDivEx(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvTimebaseDivEx',varargin{:});
