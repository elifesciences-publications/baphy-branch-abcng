function varargout = DAQmxSetDOUseOnlyOnBrdMem(varargin)
%DAQMXSETDOUSEONLYONBRDMEM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOUseOnlyOnBrdMem(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOUseOnlyOnBrdMem',varargin{:});
