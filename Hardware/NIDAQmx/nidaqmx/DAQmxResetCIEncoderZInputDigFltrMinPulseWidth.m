function varargout = DAQmxResetCIEncoderZInputDigFltrMinPulseWidth(varargin)
%DAQMXRESETCIENCODERZINPUTDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZInputDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZInputDigFltrMinPulseWidth',varargin{:});
