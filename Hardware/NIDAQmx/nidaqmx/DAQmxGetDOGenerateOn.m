function varargout = DAQmxGetDOGenerateOn(varargin)
%DAQMXGETDOGENERATEON calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDOGenerateOn(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOGenerateOn',varargin{:});
