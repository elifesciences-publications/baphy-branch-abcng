function varargout = DAQmxGetCIMin(varargin)
%DAQMXGETCIMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIMin(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIMin',varargin{:});
