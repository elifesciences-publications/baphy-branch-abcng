function varargout = DAQmxResetAIRTDB(varargin)
%DAQMXRESETAIRTDB calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRTDB(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRTDB',varargin{:});
