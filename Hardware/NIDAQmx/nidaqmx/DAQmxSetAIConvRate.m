function varargout = DAQmxSetAIConvRate(varargin)
%DAQMXSETAICONVRATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAIConvRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIConvRate',varargin{:});
