function varargout = DAQmxResetExportedRdyForXferEventLvlActiveLvl(varargin)
%DAQMXRESETEXPORTEDRDYFORXFEREVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedRdyForXferEventLvlActiveLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedRdyForXferEventLvlActiveLvl',varargin{:});
