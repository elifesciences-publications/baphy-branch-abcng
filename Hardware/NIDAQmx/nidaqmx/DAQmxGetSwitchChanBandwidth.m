function varargout = DAQmxGetSwitchChanBandwidth(varargin)
%DAQMXGETSWITCHCHANBANDWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanBandwidth(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanBandwidth',varargin{:});
