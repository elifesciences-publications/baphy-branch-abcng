function varargout = DAQmxSetDelayFromSampClkDelayUnitsEx(varargin)
%DAQMXSETDELAYFROMSAMPCLKDELAYUNITSEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDelayFromSampClkDelayUnitsEx(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDelayFromSampClkDelayUnitsEx',varargin{:});
