function varargout = DAQmxSetBufOutputOnbrdBufSize(varargin)
%DAQMXSETBUFOUTPUTONBRDBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetBufOutputOnbrdBufSize(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetBufOutputOnbrdBufSize',varargin{:});
