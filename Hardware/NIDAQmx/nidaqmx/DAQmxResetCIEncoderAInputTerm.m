function varargout = DAQmxResetCIEncoderAInputTerm(varargin)
%DAQMXRESETCIENCODERAINPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderAInputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderAInputTerm',varargin{:});
