function varargout = DAQmxSetCITwoEdgeSepFirstDigFltrTimebaseRate(varargin)
%DAQMXSETCITWOEDGESEPFIRSTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepFirstDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepFirstDigFltrTimebaseRate',varargin{:});
