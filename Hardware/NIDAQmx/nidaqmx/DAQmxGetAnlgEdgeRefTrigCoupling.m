function varargout = DAQmxGetAnlgEdgeRefTrigCoupling(varargin)
%DAQMXGETANLGEDGEREFTRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgEdgeRefTrigCoupling(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeRefTrigCoupling',varargin{:});
