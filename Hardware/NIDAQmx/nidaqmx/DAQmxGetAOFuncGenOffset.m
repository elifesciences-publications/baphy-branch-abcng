function varargout = DAQmxGetAOFuncGenOffset(varargin)
%DAQMXGETAOFUNCGENOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOFuncGenOffset(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOFuncGenOffset',varargin{:});
