function varargout = DAQmxGetCICountEdgesDigFltrTimebaseRate(varargin)
%DAQMXGETCICOUNTEDGESDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCICountEdgesDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesDigFltrTimebaseRate',varargin{:});
