function varargout = DAQmxGetMasterTimebaseSrc(varargin)
%DAQMXGETMASTERTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetMasterTimebaseSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetMasterTimebaseSrc',varargin{:});
