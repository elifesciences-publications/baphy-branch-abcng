function varargout = DAQmxGetDOMemMapEnable(varargin)
%DAQMXGETDOMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDOMemMapEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDOMemMapEnable',varargin{:});
