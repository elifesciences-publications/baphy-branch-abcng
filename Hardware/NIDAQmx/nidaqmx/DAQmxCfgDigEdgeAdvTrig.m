function varargout = DAQmxCfgDigEdgeAdvTrig(varargin)
%DAQMXCFGDIGEDGEADVTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgDigEdgeAdvTrig(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgDigEdgeAdvTrig',varargin{:});
