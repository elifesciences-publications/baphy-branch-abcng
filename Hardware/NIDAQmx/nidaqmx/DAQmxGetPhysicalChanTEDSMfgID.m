function varargout = DAQmxGetPhysicalChanTEDSMfgID(varargin)
%DAQMXGETPHYSICALCHANTEDSMFGID calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanTEDSMfgID(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanTEDSMfgID',varargin{:});
