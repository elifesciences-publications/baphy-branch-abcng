function varargout = DAQmxGetAnlgLvlPauseTrigLvl(varargin)
%DAQMXGETANLGLVLPAUSETRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgLvlPauseTrigLvl(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgLvlPauseTrigLvl',varargin{:});
