function varargout = DAQmxSetAILVDTSensitivityUnits(varargin)
%DAQMXSETAILVDTSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILVDTSensitivityUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILVDTSensitivityUnits',varargin{:});
