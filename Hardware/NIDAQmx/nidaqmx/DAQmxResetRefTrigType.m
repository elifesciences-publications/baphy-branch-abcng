function varargout = DAQmxResetRefTrigType(varargin)
%DAQMXRESETREFTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRefTrigType(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRefTrigType',varargin{:});
