function varargout = DAQmxSetDOLineStatesDoneState(varargin)
%DAQMXSETDOLINESTATESDONESTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOLineStatesDoneState(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOLineStatesDoneState',varargin{:});
