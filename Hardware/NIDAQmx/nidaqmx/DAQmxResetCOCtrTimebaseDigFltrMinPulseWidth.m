function varargout = DAQmxResetCOCtrTimebaseDigFltrMinPulseWidth(varargin)
%DAQMXRESETCOCTRTIMEBASEDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOCtrTimebaseDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOCtrTimebaseDigFltrMinPulseWidth',varargin{:});
