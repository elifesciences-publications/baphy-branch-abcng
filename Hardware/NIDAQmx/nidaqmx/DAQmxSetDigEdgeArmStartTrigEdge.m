function varargout = DAQmxSetDigEdgeArmStartTrigEdge(varargin)
%DAQMXSETDIGEDGEARMSTARTTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeArmStartTrigEdge(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeArmStartTrigEdge',varargin{:});
