function varargout = DAQmxGetAOFuncGenSquareDutyCycle(varargin)
%DAQMXGETAOFUNCGENSQUAREDUTYCYCLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOFuncGenSquareDutyCycle(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOFuncGenSquareDutyCycle',varargin{:});
