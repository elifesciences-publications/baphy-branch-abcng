function varargout = DAQmxResetCITwoEdgeSepSecondEdge(varargin)
%DAQMXRESETCITWOEDGESEPSECONDEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepSecondEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepSecondEdge',varargin{:});
