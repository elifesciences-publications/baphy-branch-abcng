function varargout = DAQmxGetSwitchChanMaxACCarryPwr(varargin)
%DAQMXGETSWITCHCHANMAXACCARRYPWR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxACCarryPwr(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxACCarryPwr',varargin{:});
