function varargout = DAQmxGetAIConvMaxRate(varargin)
%DAQMXGETAICONVMAXRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAIConvMaxRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvMaxRate',varargin{:});
