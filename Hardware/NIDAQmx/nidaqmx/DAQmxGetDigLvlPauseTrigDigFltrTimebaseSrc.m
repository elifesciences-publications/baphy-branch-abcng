function varargout = DAQmxGetDigLvlPauseTrigDigFltrTimebaseSrc(varargin)
%DAQMXGETDIGLVLPAUSETRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigLvlPauseTrigDigFltrTimebaseSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigLvlPauseTrigDigFltrTimebaseSrc',varargin{:});
