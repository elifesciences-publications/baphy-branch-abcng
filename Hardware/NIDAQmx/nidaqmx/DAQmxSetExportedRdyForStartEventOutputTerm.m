function varargout = DAQmxSetExportedRdyForStartEventOutputTerm(varargin)
%DAQMXSETEXPORTEDRDYFORSTARTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedRdyForStartEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedRdyForStartEventOutputTerm',varargin{:});
