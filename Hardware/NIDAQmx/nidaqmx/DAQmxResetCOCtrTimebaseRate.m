function varargout = DAQmxResetCOCtrTimebaseRate(varargin)
%DAQMXRESETCOCTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOCtrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOCtrTimebaseRate',varargin{:});
