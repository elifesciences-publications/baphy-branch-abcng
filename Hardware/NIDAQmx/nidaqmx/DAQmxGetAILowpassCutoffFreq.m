function varargout = DAQmxGetAILowpassCutoffFreq(varargin)
%DAQMXGETAILOWPASSCUTOFFFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAILowpassCutoffFreq(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILowpassCutoffFreq',varargin{:});
