function varargout = DAQmxResetAOResolutionUnits(varargin)
%DAQMXRESETAORESOLUTIONUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOResolutionUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOResolutionUnits',varargin{:});
