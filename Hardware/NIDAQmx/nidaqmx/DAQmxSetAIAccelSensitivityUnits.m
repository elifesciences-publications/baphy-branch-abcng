function varargout = DAQmxSetAIAccelSensitivityUnits(varargin)
%DAQMXSETAIACCELSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIAccelSensitivityUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIAccelSensitivityUnits',varargin{:});
