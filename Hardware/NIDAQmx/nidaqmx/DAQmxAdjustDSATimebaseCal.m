function varargout = DAQmxAdjustDSATimebaseCal(varargin)
%DAQMXADJUSTDSATIMEBASECAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjustDSATimebaseCal(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjustDSATimebaseCal',varargin{:});
