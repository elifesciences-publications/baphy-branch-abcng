function varargout = DAQmxSetCIFreqDigFltrEnable(varargin)
%DAQMXSETCIFREQDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqDigFltrEnable',varargin{:});
