function varargout = DAQmxResetAIDitherEnable(varargin)
%DAQMXRESETAIDITHERENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIDitherEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIDitherEnable',varargin{:});
