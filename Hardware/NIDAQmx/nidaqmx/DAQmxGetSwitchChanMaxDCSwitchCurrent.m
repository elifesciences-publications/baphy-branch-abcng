function varargout = DAQmxGetSwitchChanMaxDCSwitchCurrent(varargin)
%DAQMXGETSWITCHCHANMAXDCSWITCHCURRENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxDCSwitchCurrent(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxDCSwitchCurrent',varargin{:});
