function varargout = DAQmxSetDOLogicFamily(varargin)
%DAQMXSETDOLOGICFAMILY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDOLogicFamily(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDOLogicFamily',varargin{:});
