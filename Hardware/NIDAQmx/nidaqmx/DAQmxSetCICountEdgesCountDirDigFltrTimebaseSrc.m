function varargout = DAQmxSetCICountEdgesCountDirDigFltrTimebaseSrc(varargin)
%DAQMXSETCICOUNTEDGESCOUNTDIRDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCICountEdgesCountDirDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesCountDirDigFltrTimebaseSrc',varargin{:});
