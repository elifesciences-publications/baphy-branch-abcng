function varargout = DAQmxSetAnlgWinPauseTrigSrc(varargin)
%DAQMXSETANLGWINPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAnlgWinPauseTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinPauseTrigSrc',varargin{:});
