function varargout = DAQmxResetDITristate(varargin)
%DAQMXRESETDITRISTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDITristate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDITristate',varargin{:});
