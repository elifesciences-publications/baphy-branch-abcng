function varargout = DAQmxCreateCISemiPeriodChan(varargin)
%DAQMXCREATECISEMIPERIODCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateCISemiPeriodChan(uint32, cstring, cstring, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCISemiPeriodChan',varargin{:});
