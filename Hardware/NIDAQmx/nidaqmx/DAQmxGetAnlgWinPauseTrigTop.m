function varargout = DAQmxGetAnlgWinPauseTrigTop(varargin)
%DAQMXGETANLGWINPAUSETRIGTOP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgWinPauseTrigTop(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinPauseTrigTop',varargin{:});
