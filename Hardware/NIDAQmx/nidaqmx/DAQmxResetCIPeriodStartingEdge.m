function varargout = DAQmxResetCIPeriodStartingEdge(varargin)
%DAQMXRESETCIPERIODSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodStartingEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodStartingEdge',varargin{:});
