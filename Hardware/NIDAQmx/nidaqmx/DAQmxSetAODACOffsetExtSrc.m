function varargout = DAQmxSetAODACOffsetExtSrc(varargin)
%DAQMXSETAODACOFFSETEXTSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetAODACOffsetExtSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAODACOffsetExtSrc',varargin{:});
