function varargout = DAQmxResetAOReglitchEnable(varargin)
%DAQMXRESETAOREGLITCHENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOReglitchEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOReglitchEnable',varargin{:});
