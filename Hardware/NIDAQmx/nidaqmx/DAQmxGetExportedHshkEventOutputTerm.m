function varargout = DAQmxGetExportedHshkEventOutputTerm(varargin)
%DAQMXGETEXPORTEDHSHKEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExportedHshkEventOutputTerm(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedHshkEventOutputTerm',varargin{:});
