function varargout = DAQmxGetPauseTrigType(varargin)
%DAQMXGETPAUSETRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetPauseTrigType(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPauseTrigType',varargin{:});
