function varargout = DAQmxSetAOUsbXferReqSize(varargin)
%DAQMXSETAOUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOUsbXferReqSize(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOUsbXferReqSize',varargin{:});
