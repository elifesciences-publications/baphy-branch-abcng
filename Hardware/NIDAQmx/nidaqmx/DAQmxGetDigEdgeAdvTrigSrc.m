function varargout = DAQmxGetDigEdgeAdvTrigSrc(varargin)
%DAQMXGETDIGEDGEADVTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigEdgeAdvTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeAdvTrigSrc',varargin{:});
