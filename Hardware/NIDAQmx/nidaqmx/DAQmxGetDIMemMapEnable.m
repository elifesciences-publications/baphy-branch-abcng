function varargout = DAQmxGetDIMemMapEnable(varargin)
%DAQMXGETDIMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDIMemMapEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDIMemMapEnable',varargin{:});
