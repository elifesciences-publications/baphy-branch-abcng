function varargout = DAQmxResetAIACExcitFreq(varargin)
%DAQMXRESETAIACEXCITFREQ calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIACExcitFreq(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIACExcitFreq',varargin{:});
