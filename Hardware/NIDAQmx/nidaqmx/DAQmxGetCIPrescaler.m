function varargout = DAQmxGetCIPrescaler(varargin)
%DAQMXGETCIPRESCALER calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIPrescaler(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPrescaler',varargin{:});
