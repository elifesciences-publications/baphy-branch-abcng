function varargout = DAQmxSetCIEncoderZInputDigFltrTimebaseSrc(varargin)
%DAQMXSETCIENCODERZINPUTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIEncoderZInputDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZInputDigFltrTimebaseSrc',varargin{:});
