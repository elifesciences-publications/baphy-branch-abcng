function varargout = DAQmxGetAIChanCalHasValidCalInfo(varargin)
%DAQMXGETAICHANCALHASVALIDCALINFO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIChanCalHasValidCalInfo(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIChanCalHasValidCalInfo',varargin{:});
