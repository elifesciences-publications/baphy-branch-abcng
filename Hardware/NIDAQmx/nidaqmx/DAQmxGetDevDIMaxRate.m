function varargout = DAQmxGetDevDIMaxRate(varargin)
%DAQMXGETDEVDIMAXRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDevDIMaxRate(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDIMaxRate',varargin{:});
