function varargout = DAQmxSetExportedSampClkOutputBehavior(varargin)
%DAQMXSETEXPORTEDSAMPCLKOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedSampClkOutputBehavior(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedSampClkOutputBehavior',varargin{:});
