function varargout = DAQmxSetAIDCOffset(varargin)
%DAQMXSETAIDCOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIDCOffset(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIDCOffset',varargin{:});
