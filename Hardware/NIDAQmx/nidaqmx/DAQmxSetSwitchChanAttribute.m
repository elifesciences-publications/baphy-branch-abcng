function varargout = DAQmxSetSwitchChanAttribute(varargin)
%DAQMXSETSWITCHCHANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr] DAQmxSetSwitchChanAttribute(cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSwitchChanAttribute',varargin{:});
