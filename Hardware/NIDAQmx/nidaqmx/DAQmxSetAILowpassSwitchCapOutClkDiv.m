function varargout = DAQmxSetAILowpassSwitchCapOutClkDiv(varargin)
%DAQMXSETAILOWPASSSWITCHCAPOUTCLKDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAILowpassSwitchCapOutClkDiv(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAILowpassSwitchCapOutClkDiv',varargin{:});
