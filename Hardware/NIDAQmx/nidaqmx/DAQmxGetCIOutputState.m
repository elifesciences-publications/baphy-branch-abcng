function varargout = DAQmxGetCIOutputState(varargin)
%DAQMXGETCIOUTPUTSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIOutputState(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIOutputState',varargin{:});
