function varargout = DAQmxSetCISemiPeriodUnits(varargin)
%DAQMXSETCISEMIPERIODUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCISemiPeriodUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCISemiPeriodUnits',varargin{:});
