function varargout = DAQmxGetNthTaskChannel(varargin)
%DAQMXGETNTHTASKCHANNEL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetNthTaskChannel(uint32, uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetNthTaskChannel',varargin{:});
