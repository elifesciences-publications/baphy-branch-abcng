function varargout = DAQmxGetSysNIDAQMinorVersion(varargin)
%DAQMXGETSYSNIDAQMINORVERSION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetSysNIDAQMinorVersion(uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSysNIDAQMinorVersion',varargin{:});
