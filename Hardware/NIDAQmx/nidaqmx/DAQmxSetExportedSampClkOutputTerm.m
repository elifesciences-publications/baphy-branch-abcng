function varargout = DAQmxSetExportedSampClkOutputTerm(varargin)
%DAQMXSETEXPORTEDSAMPCLKOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedSampClkOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedSampClkOutputTerm',varargin{:});
