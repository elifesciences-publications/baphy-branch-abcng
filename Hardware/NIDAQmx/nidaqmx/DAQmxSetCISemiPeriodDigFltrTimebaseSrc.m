function varargout = DAQmxSetCISemiPeriodDigFltrTimebaseSrc(varargin)
%DAQMXSETCISEMIPERIODDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCISemiPeriodDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCISemiPeriodDigFltrTimebaseSrc',varargin{:});
