function varargout = DAQmxResetAIAcceldBRef(varargin)
%DAQMXRESETAIACCELDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIAcceldBRef(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIAcceldBRef',varargin{:});
