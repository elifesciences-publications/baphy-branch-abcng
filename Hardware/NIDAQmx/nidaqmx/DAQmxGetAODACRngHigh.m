function varargout = DAQmxGetAODACRngHigh(varargin)
%DAQMXGETAODACRNGHIGH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAODACRngHigh(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACRngHigh',varargin{:});
