function varargout = DAQmxSetAIMemMapEnable(varargin)
%DAQMXSETAIMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIMemMapEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIMemMapEnable',varargin{:});
