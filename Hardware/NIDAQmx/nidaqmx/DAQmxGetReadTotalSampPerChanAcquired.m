function varargout = DAQmxGetReadTotalSampPerChanAcquired(varargin)
%DAQMXGETREADTOTALSAMPPERCHANACQUIRED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint64Ptr] DAQmxGetReadTotalSampPerChanAcquired(uint32, uint64Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadTotalSampPerChanAcquired',varargin{:});
