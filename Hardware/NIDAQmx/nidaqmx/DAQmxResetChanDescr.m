function varargout = DAQmxResetChanDescr(varargin)
%DAQMXRESETCHANDESCR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetChanDescr(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetChanDescr',varargin{:});
