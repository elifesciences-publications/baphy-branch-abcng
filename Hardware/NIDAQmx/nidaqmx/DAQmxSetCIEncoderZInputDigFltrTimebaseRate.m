function varargout = DAQmxSetCIEncoderZInputDigFltrTimebaseRate(varargin)
%DAQMXSETCIENCODERZINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderZInputDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZInputDigFltrTimebaseRate',varargin{:});
