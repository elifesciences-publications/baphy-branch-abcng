function varargout = DAQmxSetCIPeriodDigFltrTimebaseRate(varargin)
%DAQMXSETCIPERIODDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPeriodDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPeriodDigFltrTimebaseRate',varargin{:});
