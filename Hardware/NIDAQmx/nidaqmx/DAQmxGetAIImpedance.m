function varargout = DAQmxGetAIImpedance(varargin)
%DAQMXGETAIIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIImpedance(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIImpedance',varargin{:});
