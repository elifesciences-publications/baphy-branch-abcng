function varargout = DAQmxResetCIPulseWidthDigSyncEnable(varargin)
%DAQMXRESETCIPULSEWIDTHDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPulseWidthDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPulseWidthDigSyncEnable',varargin{:});
