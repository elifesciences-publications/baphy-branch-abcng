function varargout = DAQmxSetPhysicalChanAOManualControlEnable(varargin)
%DAQMXSETPHYSICALCHANAOMANUALCONTROLENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetPhysicalChanAOManualControlEnable(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetPhysicalChanAOManualControlEnable',varargin{:});
