function varargout = DAQmxResetExportedWatchdogExpiredEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDWATCHDOGEXPIREDEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedWatchdogExpiredEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedWatchdogExpiredEventOutputTerm',varargin{:});
