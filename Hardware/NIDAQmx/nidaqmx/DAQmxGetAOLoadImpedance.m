function varargout = DAQmxGetAOLoadImpedance(varargin)
%DAQMXGETAOLOADIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOLoadImpedance(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOLoadImpedance',varargin{:});
