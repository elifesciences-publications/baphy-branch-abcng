function varargout = DAQmxGetDelayFromSampClkDelayUnits(varargin)
%DAQMXGETDELAYFROMSAMPCLKDELAYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDelayFromSampClkDelayUnits(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDelayFromSampClkDelayUnits',varargin{:});
