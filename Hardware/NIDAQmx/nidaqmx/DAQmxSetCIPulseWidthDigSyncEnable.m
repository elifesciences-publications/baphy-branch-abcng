function varargout = DAQmxSetCIPulseWidthDigSyncEnable(varargin)
%DAQMXSETCIPULSEWIDTHDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPulseWidthDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPulseWidthDigSyncEnable',varargin{:});
