function varargout = DAQmxGetPersistedTaskAttribute(varargin)
%DAQMXGETPERSISTEDTASKATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr, voidPtr] DAQmxGetPersistedTaskAttribute(cstring, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedTaskAttribute',varargin{:});
