function varargout = DAQmxResetRealTimeWaitForNextSampClkWaitMode(varargin)
%DAQMXRESETREALTIMEWAITFORNEXTSAMPCLKWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetRealTimeWaitForNextSampClkWaitMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetRealTimeWaitForNextSampClkWaitMode',varargin{:});
