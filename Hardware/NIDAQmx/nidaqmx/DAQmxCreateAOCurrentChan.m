function varargout = DAQmxCreateAOCurrentChan(varargin)
%DAQMXCREATEAOCURRENTCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateAOCurrentChan(uint32, cstring, cstring, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateAOCurrentChan',varargin{:});
