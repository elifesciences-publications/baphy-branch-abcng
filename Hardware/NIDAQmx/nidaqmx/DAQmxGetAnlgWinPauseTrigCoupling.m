function varargout = DAQmxGetAnlgWinPauseTrigCoupling(varargin)
%DAQMXGETANLGWINPAUSETRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgWinPauseTrigCoupling(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinPauseTrigCoupling',varargin{:});
