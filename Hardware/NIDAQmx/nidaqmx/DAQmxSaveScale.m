function varargout = DAQmxSaveScale(varargin)
%DAQMXSAVESCALE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxSaveScale(cstring, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSaveScale',varargin{:});
