function varargout = DAQmxSetRealTimeReportMissedSamp(varargin)
%DAQMXSETREALTIMEREPORTMISSEDSAMP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetRealTimeReportMissedSamp(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRealTimeReportMissedSamp',varargin{:});
