function varargout = DAQmxGetDevAnlgTrigSupported(varargin)
%DAQMXGETDEVANLGTRIGSUPPORTED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevAnlgTrigSupported(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAnlgTrigSupported',varargin{:});
