function varargout = DAQmxGetDigEdgeStartTrigDigSyncEnable(varargin)
%DAQMXGETDIGEDGESTARTTRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetDigEdgeStartTrigDigSyncEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeStartTrigDigSyncEnable',varargin{:});
