function varargout = DAQmxGetDigEdgeRefTrigEdge(varargin)
%DAQMXGETDIGEDGEREFTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetDigEdgeRefTrigEdge(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeRefTrigEdge',varargin{:});
