function varargout = DAQmxGetSampClkDigFltrMinPulseWidth(varargin)
%DAQMXGETSAMPCLKDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetSampClkDigFltrMinPulseWidth(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkDigFltrMinPulseWidth',varargin{:});
