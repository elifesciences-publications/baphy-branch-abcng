function varargout = DAQmxGetCITwoEdgeSepFirstDigFltrTimebaseSrc(varargin)
%DAQMXGETCITWOEDGESEPFIRSTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCITwoEdgeSepFirstDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepFirstDigFltrTimebaseSrc',varargin{:});
