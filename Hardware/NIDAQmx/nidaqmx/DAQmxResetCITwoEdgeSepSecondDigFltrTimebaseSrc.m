function varargout = DAQmxResetCITwoEdgeSepSecondDigFltrTimebaseSrc(varargin)
%DAQMXRESETCITWOEDGESEPSECONDDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepSecondDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepSecondDigFltrTimebaseSrc',varargin{:});
