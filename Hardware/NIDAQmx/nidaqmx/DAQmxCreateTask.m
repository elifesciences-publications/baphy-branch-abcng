function varargout = DAQmxCreateTask(varargin)
%DAQMXCREATETASK calls nidaqmx library with the appropriate arguments.
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateTask',varargin{:});
