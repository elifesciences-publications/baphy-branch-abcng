function varargout = DAQmxSetDIDataXferReqCond(varargin)
%DAQMXSETDIDATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDIDataXferReqCond(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDIDataXferReqCond',varargin{:});
