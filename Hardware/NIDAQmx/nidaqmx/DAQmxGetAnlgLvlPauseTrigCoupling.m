function varargout = DAQmxGetAnlgLvlPauseTrigCoupling(varargin)
%DAQMXGETANLGLVLPAUSETRIGCOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgLvlPauseTrigCoupling(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgLvlPauseTrigCoupling',varargin{:});
