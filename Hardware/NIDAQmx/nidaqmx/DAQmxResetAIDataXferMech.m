function varargout = DAQmxResetAIDataXferMech(varargin)
%DAQMXRESETAIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIDataXferMech(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIDataXferMech',varargin{:});
