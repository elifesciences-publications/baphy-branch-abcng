function varargout = DAQmxGetAODataXferMech(varargin)
%DAQMXGETAODATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAODataXferMech(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODataXferMech',varargin{:});
