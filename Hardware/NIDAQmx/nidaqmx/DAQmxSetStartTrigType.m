function varargout = DAQmxSetStartTrigType(varargin)
%DAQMXSETSTARTTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetStartTrigType(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetStartTrigType',varargin{:});
