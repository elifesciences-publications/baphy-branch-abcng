function varargout = DAQmxGetCITwoEdgeSepSecondDigFltrTimebaseSrc(varargin)
%DAQMXGETCITWOEDGESEPSECONDDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCITwoEdgeSepSecondDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepSecondDigFltrTimebaseSrc',varargin{:});
