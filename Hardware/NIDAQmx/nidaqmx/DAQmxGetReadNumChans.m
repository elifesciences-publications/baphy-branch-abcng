function varargout = DAQmxGetReadNumChans(varargin)
%DAQMXGETREADNUMCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadNumChans(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadNumChans',varargin{:});
