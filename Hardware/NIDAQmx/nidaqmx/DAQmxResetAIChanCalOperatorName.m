function varargout = DAQmxResetAIChanCalOperatorName(varargin)
%DAQMXRESETAICHANCALOPERATORNAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalOperatorName(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalOperatorName',varargin{:});
