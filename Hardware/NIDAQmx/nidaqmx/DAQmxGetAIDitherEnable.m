function varargout = DAQmxGetAIDitherEnable(varargin)
%DAQMXGETAIDITHERENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIDitherEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIDitherEnable',varargin{:});
