function varargout = DAQmxSetTimingAttributeEx(varargin)
%DAQMXSETTIMINGATTRIBUTEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr] DAQmxSetTimingAttributeEx(uint32, cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetTimingAttributeEx',varargin{:});
