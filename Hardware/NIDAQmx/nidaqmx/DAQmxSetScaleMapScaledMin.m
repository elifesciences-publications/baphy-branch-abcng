function varargout = DAQmxSetScaleMapScaledMin(varargin)
%DAQMXSETSCALEMAPSCALEDMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetScaleMapScaledMin(cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleMapScaledMin',varargin{:});
