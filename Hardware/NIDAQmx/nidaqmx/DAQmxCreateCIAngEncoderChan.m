function varargout = DAQmxCreateCIAngEncoderChan(varargin)
%DAQMXCREATECIANGENCODERCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateCIAngEncoderChan(uint32, cstring, cstring, int32, uint32, double, int32, int32, uint32, double, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCIAngEncoderChan',varargin{:});
