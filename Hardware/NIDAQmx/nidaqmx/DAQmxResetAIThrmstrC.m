function varargout = DAQmxResetAIThrmstrC(varargin)
%DAQMXRESETAITHRMSTRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIThrmstrC(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIThrmstrC',varargin{:});
