function varargout = DAQmxGetDIUsbXferReqSize(varargin)
%DAQMXGETDIUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDIUsbXferReqSize(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDIUsbXferReqSize',varargin{:});
