function varargout = DAQmxSetAIExcitUseMultiplexed(varargin)
%DAQMXSETAIEXCITUSEMULTIPLEXED calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIExcitUseMultiplexed(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIExcitUseMultiplexed',varargin{:});
