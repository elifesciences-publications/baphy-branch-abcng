function varargout = DAQmxGetDigLvlPauseTrigSrc(varargin)
%DAQMXGETDIGLVLPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigLvlPauseTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigLvlPauseTrigSrc',varargin{:});
