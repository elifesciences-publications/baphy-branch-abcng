function varargout = DAQmxGetAILowpassEnable(varargin)
%DAQMXGETAILOWPASSENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAILowpassEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILowpassEnable',varargin{:});
