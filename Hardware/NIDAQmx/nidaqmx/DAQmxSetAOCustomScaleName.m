function varargout = DAQmxSetAOCustomScaleName(varargin)
%DAQMXSETAOCUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetAOCustomScaleName(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOCustomScaleName',varargin{:});
