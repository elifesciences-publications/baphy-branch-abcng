function varargout = DAQmxGetAOUsbXferReqSize(varargin)
%DAQMXGETAOUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAOUsbXferReqSize(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOUsbXferReqSize',varargin{:});
