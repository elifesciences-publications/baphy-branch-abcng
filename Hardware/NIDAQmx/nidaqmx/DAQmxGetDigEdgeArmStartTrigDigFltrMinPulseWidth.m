function varargout = DAQmxGetDigEdgeArmStartTrigDigFltrMinPulseWidth(varargin)
%DAQMXGETDIGEDGEARMSTARTTRIGDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetDigEdgeArmStartTrigDigFltrMinPulseWidth(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeArmStartTrigDigFltrMinPulseWidth',varargin{:});
