function varargout = DAQmxResetCIEncoderZInputTerm(varargin)
%DAQMXRESETCIENCODERZINPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZInputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZInputTerm',varargin{:});
