function varargout = DAQmxGetAnlgWinPauseTrigWhen(varargin)
%DAQMXGETANLGWINPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetAnlgWinPauseTrigWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgWinPauseTrigWhen',varargin{:});
