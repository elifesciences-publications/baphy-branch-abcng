function varargout = DAQmxGetDevAOPhysicalChans(varargin)
%DAQMXGETDEVAOPHYSICALCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevAOPhysicalChans(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAOPhysicalChans',varargin{:});
