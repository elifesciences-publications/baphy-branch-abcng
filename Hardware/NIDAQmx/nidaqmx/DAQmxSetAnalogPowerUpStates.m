function varargout = DAQmxSetAnalogPowerUpStates(varargin)
%DAQMXSETANALOGPOWERUPSTATES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, voidPtr] DAQmxSetAnalogPowerUpStates(cstring, cstring, double, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnalogPowerUpStates',varargin{:});
