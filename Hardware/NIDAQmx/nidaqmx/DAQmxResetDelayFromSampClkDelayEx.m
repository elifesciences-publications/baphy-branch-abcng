function varargout = DAQmxResetDelayFromSampClkDelayEx(varargin)
%DAQMXRESETDELAYFROMSAMPCLKDELAYEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDelayFromSampClkDelayEx(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDelayFromSampClkDelayEx',varargin{:});
