function varargout = DAQmxSetCIEncoderZIndexPhase(varargin)
%DAQMXSETCIENCODERZINDEXPHASE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIEncoderZIndexPhase(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZIndexPhase',varargin{:});
