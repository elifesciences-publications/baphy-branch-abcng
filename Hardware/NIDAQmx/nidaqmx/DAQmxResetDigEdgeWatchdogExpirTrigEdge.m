function varargout = DAQmxResetDigEdgeWatchdogExpirTrigEdge(varargin)
%DAQMXRESETDIGEDGEWATCHDOGEXPIRTRIGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeWatchdogExpirTrigEdge(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeWatchdogExpirTrigEdge',varargin{:});
