function varargout = DAQmxCreateTEDSAIPosRVDTChan(varargin)
%DAQMXCREATETEDSAIPOSRVDTCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateTEDSAIPosRVDTChan(uint32, cstring, cstring, double, double, int32, int32, double, double, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateTEDSAIPosRVDTChan',varargin{:});
