function varargout = DAQmxGetAIRawSampJustification(varargin)
%DAQMXGETAIRAWSAMPJUSTIFICATION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIRawSampJustification(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRawSampJustification',varargin{:});
