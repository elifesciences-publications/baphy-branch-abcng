function varargout = DAQmxGetDigEdgeArmStartTrigDigFltrTimebaseRate(varargin)
%DAQMXGETDIGEDGEARMSTARTTRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetDigEdgeArmStartTrigDigFltrTimebaseRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeArmStartTrigDigFltrTimebaseRate',varargin{:});
