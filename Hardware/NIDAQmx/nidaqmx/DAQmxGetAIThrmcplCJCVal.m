function varargout = DAQmxGetAIThrmcplCJCVal(varargin)
%DAQMXGETAITHRMCPLCJCVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIThrmcplCJCVal(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmcplCJCVal',varargin{:});
