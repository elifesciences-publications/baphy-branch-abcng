function varargout = DAQmxResetAOFuncGenFMDeviation(varargin)
%DAQMXRESETAOFUNCGENFMDEVIATION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOFuncGenFMDeviation(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOFuncGenFMDeviation',varargin{:});
