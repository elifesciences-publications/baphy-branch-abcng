function varargout = DAQmxSetCICtrTimebaseMasterTimebaseDiv(varargin)
%DAQMXSETCICTRTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICtrTimebaseMasterTimebaseDiv(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICtrTimebaseMasterTimebaseDiv',varargin{:});
