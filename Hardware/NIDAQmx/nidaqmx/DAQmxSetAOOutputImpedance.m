function varargout = DAQmxSetAOOutputImpedance(varargin)
%DAQMXSETAOOUTPUTIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOOutputImpedance(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOOutputImpedance',varargin{:});
