function varargout = DAQmxResetAICoupling(varargin)
%DAQMXRESETAICOUPLING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAICoupling(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAICoupling',varargin{:});
