function varargout = DAQmxGetCITwoEdgeSepSecondEdge(varargin)
%DAQMXGETCITWOEDGESEPSECONDEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCITwoEdgeSepSecondEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepSecondEdge',varargin{:});
