function varargout = DAQmxGetAIConvActiveEdgeEx(varargin)
%DAQMXGETAICONVACTIVEEDGEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIConvActiveEdgeEx(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvActiveEdgeEx',varargin{:});
