function varargout = DAQmxResetAOVoltageCurrentLimit(varargin)
%DAQMXRESETAOVOLTAGECURRENTLIMIT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOVoltageCurrentLimit(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOVoltageCurrentLimit',varargin{:});
