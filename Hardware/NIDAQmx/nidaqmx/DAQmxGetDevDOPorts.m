function varargout = DAQmxGetDevDOPorts(varargin)
%DAQMXGETDEVDOPORTS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevDOPorts(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDOPorts',varargin{:});
