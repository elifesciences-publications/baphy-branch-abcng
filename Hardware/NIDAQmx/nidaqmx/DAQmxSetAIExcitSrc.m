function varargout = DAQmxSetAIExcitSrc(varargin)
%DAQMXSETAIEXCITSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIExcitSrc(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIExcitSrc',varargin{:});
