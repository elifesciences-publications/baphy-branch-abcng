function varargout = DAQmxResetExportedSyncPulseEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDSYNCPULSEEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedSyncPulseEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedSyncPulseEventOutputTerm',varargin{:});
