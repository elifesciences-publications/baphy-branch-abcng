function varargout = DAQmxGetInterlockedHshkTrigAssertedLvl(varargin)
%DAQMXGETINTERLOCKEDHSHKTRIGASSERTEDLVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetInterlockedHshkTrigAssertedLvl(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetInterlockedHshkTrigAssertedLvl',varargin{:});
