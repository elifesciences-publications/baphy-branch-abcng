function varargout = DAQmxSetExportedAdvCmpltEventPulseWidth(varargin)
%DAQMXSETEXPORTEDADVCMPLTEVENTPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedAdvCmpltEventPulseWidth(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAdvCmpltEventPulseWidth',varargin{:});
