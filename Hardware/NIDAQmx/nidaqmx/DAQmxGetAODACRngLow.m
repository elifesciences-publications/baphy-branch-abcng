function varargout = DAQmxGetAODACRngLow(varargin)
%DAQMXGETAODACRNGLOW calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAODACRngLow(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODACRngLow',varargin{:});
