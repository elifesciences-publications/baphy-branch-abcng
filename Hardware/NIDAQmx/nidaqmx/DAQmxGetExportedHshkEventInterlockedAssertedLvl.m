function varargout = DAQmxGetExportedHshkEventInterlockedAssertedLvl(varargin)
%DAQMXGETEXPORTEDHSHKEVENTINTERLOCKEDASSERTEDLVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedHshkEventInterlockedAssertedLvl(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedHshkEventInterlockedAssertedLvl',varargin{:});
