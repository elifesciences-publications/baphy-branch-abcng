function varargout = DAQmxGetExportedRdyForStartEventLvlActiveLvl(varargin)
%DAQMXGETEXPORTEDRDYFORSTARTEVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedRdyForStartEventLvlActiveLvl(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedRdyForStartEventLvlActiveLvl',varargin{:});
