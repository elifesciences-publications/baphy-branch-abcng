function varargout = DAQmxResetOnDemandSimultaneousAOEnable(varargin)
%DAQMXRESETONDEMANDSIMULTANEOUSAOENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetOnDemandSimultaneousAOEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetOnDemandSimultaneousAOEnable',varargin{:});
