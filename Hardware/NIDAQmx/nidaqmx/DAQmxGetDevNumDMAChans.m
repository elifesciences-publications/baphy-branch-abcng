function varargout = DAQmxGetDevNumDMAChans(varargin)
%DAQMXGETDEVNUMDMACHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevNumDMAChans(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevNumDMAChans',varargin{:});
