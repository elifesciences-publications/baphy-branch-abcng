function varargout = DAQmxGetReadReadAllAvailSamp(varargin)
%DAQMXGETREADREADALLAVAILSAMP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadReadAllAvailSamp(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadReadAllAvailSamp',varargin{:});
