function varargout = DAQmxSetCITwoEdgeSepSecondDigFltrTimebaseSrc(varargin)
%DAQMXSETCITWOEDGESEPSECONDDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCITwoEdgeSepSecondDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepSecondDigFltrTimebaseSrc',varargin{:});
