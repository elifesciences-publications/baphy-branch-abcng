function varargout = DAQmxAdjustDSAAICal(varargin)
%DAQMXADJUSTDSAAICAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjustDSAAICal(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjustDSAAICal',varargin{:});
