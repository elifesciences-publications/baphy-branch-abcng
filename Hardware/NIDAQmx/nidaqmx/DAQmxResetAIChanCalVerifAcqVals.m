function varargout = DAQmxResetAIChanCalVerifAcqVals(varargin)
%DAQMXRESETAICHANCALVERIFACQVALS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalVerifAcqVals(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalVerifAcqVals',varargin{:});
