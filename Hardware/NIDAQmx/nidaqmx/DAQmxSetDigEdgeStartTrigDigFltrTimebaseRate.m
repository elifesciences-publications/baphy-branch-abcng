function varargout = DAQmxSetDigEdgeStartTrigDigFltrTimebaseRate(varargin)
%DAQMXSETDIGEDGESTARTTRIGDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeStartTrigDigFltrTimebaseRate(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeStartTrigDigFltrTimebaseRate',varargin{:});
