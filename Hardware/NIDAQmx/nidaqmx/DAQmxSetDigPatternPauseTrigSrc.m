function varargout = DAQmxSetDigPatternPauseTrigSrc(varargin)
%DAQMXSETDIGPATTERNPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigPatternPauseTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternPauseTrigSrc',varargin{:});
