function varargout = DAQmxSetAnlgEdgeRefTrigLvl(varargin)
%DAQMXSETANLGEDGEREFTRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgEdgeRefTrigLvl(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeRefTrigLvl',varargin{:});
