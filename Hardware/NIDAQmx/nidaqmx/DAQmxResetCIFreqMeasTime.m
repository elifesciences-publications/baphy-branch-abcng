function varargout = DAQmxResetCIFreqMeasTime(varargin)
%DAQMXRESETCIFREQMEASTIME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIFreqMeasTime(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIFreqMeasTime',varargin{:});
