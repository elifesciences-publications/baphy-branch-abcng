function varargout = DAQmxResetExportedHshkEventOutputBehavior(varargin)
%DAQMXRESETEXPORTEDHSHKEVENTOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedHshkEventOutputBehavior(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedHshkEventOutputBehavior',varargin{:});
