function varargout = DAQmxGetExportedAIConvClkPulsePolarity(varargin)
%DAQMXGETEXPORTEDAICONVCLKPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedAIConvClkPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedAIConvClkPulsePolarity',varargin{:});
