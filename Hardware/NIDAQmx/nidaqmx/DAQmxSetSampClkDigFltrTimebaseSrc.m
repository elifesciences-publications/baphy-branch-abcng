function varargout = DAQmxSetSampClkDigFltrTimebaseSrc(varargin)
%DAQMXSETSAMPCLKDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetSampClkDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkDigFltrTimebaseSrc',varargin{:});
