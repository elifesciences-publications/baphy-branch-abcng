function varargout = DAQmxResetAIRVDTSensitivityUnits(varargin)
%DAQMXRESETAIRVDTSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRVDTSensitivityUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRVDTSensitivityUnits',varargin{:});
