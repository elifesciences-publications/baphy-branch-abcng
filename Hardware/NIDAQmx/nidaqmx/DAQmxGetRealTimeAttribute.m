function varargout = DAQmxGetRealTimeAttribute(varargin)
%DAQMXGETREALTIMEATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr, voidPtr] DAQmxGetRealTimeAttribute(uint32, int32, voidPtr, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRealTimeAttribute',varargin{:});
