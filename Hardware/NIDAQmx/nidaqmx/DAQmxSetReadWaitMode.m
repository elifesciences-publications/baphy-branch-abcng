function varargout = DAQmxSetReadWaitMode(varargin)
%DAQMXSETREADWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetReadWaitMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadWaitMode',varargin{:});
