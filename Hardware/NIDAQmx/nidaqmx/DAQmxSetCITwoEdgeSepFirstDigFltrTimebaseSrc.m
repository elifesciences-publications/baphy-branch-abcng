function varargout = DAQmxSetCITwoEdgeSepFirstDigFltrTimebaseSrc(varargin)
%DAQMXSETCITWOEDGESEPFIRSTDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCITwoEdgeSepFirstDigFltrTimebaseSrc(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepFirstDigFltrTimebaseSrc',varargin{:});
