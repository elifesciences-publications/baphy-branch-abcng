function varargout = DAQmxSetBufOutputBufSize(varargin)
%DAQMXSETBUFOUTPUTBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetBufOutputBufSize(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetBufOutputBufSize',varargin{:});
