function varargout = DAQmxGetCOPulseTimeInitialDelay(varargin)
%DAQMXGETCOPULSETIMEINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOPulseTimeInitialDelay(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseTimeInitialDelay',varargin{:});
