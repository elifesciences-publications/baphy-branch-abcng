function varargout = DAQmxResetCICountEdgesCountDirDigFltrTimebaseRate(varargin)
%DAQMXRESETCICOUNTEDGESCOUNTDIRDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICountEdgesCountDirDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICountEdgesCountDirDigFltrTimebaseRate',varargin{:});
