function varargout = DAQmxGetAILowpassSwitchCapExtClkDiv(varargin)
%DAQMXGETAILOWPASSSWITCHCAPEXTCLKDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAILowpassSwitchCapExtClkDiv(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILowpassSwitchCapExtClkDiv',varargin{:});
