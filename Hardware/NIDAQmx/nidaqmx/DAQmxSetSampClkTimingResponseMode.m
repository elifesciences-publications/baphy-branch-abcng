function varargout = DAQmxSetSampClkTimingResponseMode(varargin)
%DAQMXSETSAMPCLKTIMINGRESPONSEMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkTimingResponseMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkTimingResponseMode',varargin{:});
