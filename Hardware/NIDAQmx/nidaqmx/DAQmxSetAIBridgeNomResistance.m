function varargout = DAQmxSetAIBridgeNomResistance(varargin)
%DAQMXSETAIBRIDGENOMRESISTANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIBridgeNomResistance(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIBridgeNomResistance',varargin{:});
