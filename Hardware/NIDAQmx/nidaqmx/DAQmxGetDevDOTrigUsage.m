function varargout = DAQmxGetDevDOTrigUsage(varargin)
%DAQMXGETDEVDOTRIGUSAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDevDOTrigUsage(cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDOTrigUsage',varargin{:});
