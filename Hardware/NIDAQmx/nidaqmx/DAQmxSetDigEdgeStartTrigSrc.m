function varargout = DAQmxSetDigEdgeStartTrigSrc(varargin)
%DAQMXSETDIGEDGESTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigEdgeStartTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeStartTrigSrc',varargin{:});
