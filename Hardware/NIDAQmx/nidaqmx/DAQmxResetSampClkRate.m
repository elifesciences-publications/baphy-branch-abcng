function varargout = DAQmxResetSampClkRate(varargin)
%DAQMXRESETSAMPCLKRATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkRate',varargin{:});
