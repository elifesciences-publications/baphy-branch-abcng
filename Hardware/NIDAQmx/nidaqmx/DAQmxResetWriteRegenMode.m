function varargout = DAQmxResetWriteRegenMode(varargin)
%DAQMXRESETWRITEREGENMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetWriteRegenMode(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetWriteRegenMode',varargin{:});
