function varargout = DAQmxAdjust1126Cal(varargin)
%DAQMXADJUST1126CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1126Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1126Cal',varargin{:});
