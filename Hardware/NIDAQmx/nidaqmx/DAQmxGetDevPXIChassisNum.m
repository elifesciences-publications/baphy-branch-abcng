function varargout = DAQmxGetDevPXIChassisNum(varargin)
%DAQMXGETDEVPXICHASSISNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevPXIChassisNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevPXIChassisNum',varargin{:});
