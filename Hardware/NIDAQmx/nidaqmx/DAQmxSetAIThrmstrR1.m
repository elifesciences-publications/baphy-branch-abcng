function varargout = DAQmxSetAIThrmstrR1(varargin)
%DAQMXSETAITHRMSTRR1 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIThrmstrR1(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIThrmstrR1',varargin{:});
