function varargout = DAQmxGetDIDigFltrMinPulseWidth(varargin)
%DAQMXGETDIDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetDIDigFltrMinPulseWidth(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDIDigFltrMinPulseWidth',varargin{:});
