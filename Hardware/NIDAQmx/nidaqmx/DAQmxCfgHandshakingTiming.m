function varargout = DAQmxCfgHandshakingTiming(varargin)
%DAQMXCFGHANDSHAKINGTIMING calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxCfgHandshakingTiming(uint32, int32, uint64)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgHandshakingTiming',varargin{:});
