function varargout = DAQmxResetAnlgLvlPauseTrigLvl(varargin)
%DAQMXRESETANLGLVLPAUSETRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgLvlPauseTrigLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgLvlPauseTrigLvl',varargin{:});
