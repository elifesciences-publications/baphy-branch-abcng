function varargout = DAQmxSetReadReadAllAvailSamp(varargin)
%DAQMXSETREADREADALLAVAILSAMP calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetReadReadAllAvailSamp(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadReadAllAvailSamp',varargin{:});
