function varargout = DAQmxGetBufOutputOnbrdBufSize(varargin)
%DAQMXGETBUFOUTPUTONBRDBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetBufOutputOnbrdBufSize(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetBufOutputOnbrdBufSize',varargin{:});
