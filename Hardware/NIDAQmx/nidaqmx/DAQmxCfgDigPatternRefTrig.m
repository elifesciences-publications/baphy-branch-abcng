function varargout = DAQmxCfgDigPatternRefTrig(varargin)
%DAQMXCFGDIGPATTERNREFTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxCfgDigPatternRefTrig(uint32, cstring, cstring, int32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgDigPatternRefTrig',varargin{:});
