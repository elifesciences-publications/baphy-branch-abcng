function varargout = DAQmxWriteCtrTicksScalar(varargin)
%DAQMXWRITECTRTICKSSCALAR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxWriteCtrTicksScalar(uint32, uint32, double, uint32, uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteCtrTicksScalar',varargin{:});
