function varargout = DAQmxSetExportedHshkEventPulsePolarity(varargin)
%DAQMXSETEXPORTEDHSHKEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedHshkEventPulsePolarity(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedHshkEventPulsePolarity',varargin{:});
