function varargout = DAQmxGetDigEdgeArmStartTrigDigFltrEnable(varargin)
%DAQMXGETDIGEDGEARMSTARTTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetDigEdgeArmStartTrigDigFltrEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigEdgeArmStartTrigDigFltrEnable',varargin{:});
