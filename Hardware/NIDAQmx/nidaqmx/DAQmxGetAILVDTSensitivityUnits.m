function varargout = DAQmxGetAILVDTSensitivityUnits(varargin)
%DAQMXGETAILVDTSENSITIVITYUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAILVDTSensitivityUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAILVDTSensitivityUnits',varargin{:});
