function varargout = DAQmxSetDIAcquireOn(varargin)
%DAQMXSETDIACQUIREON calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDIAcquireOn(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDIAcquireOn',varargin{:});
