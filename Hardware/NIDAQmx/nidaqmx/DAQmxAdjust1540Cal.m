function varargout = DAQmxAdjust1540Cal(varargin)
%DAQMXADJUST1540CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1540Cal(uint32, double, double, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1540Cal',varargin{:});
