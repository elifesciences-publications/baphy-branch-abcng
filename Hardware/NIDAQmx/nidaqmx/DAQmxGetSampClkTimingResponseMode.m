function varargout = DAQmxGetSampClkTimingResponseMode(varargin)
%DAQMXGETSAMPCLKTIMINGRESPONSEMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetSampClkTimingResponseMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkTimingResponseMode',varargin{:});
