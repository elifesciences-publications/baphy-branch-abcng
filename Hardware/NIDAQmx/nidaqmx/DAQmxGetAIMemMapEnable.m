function varargout = DAQmxGetAIMemMapEnable(varargin)
%DAQMXGETAIMEMMAPENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIMemMapEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIMemMapEnable',varargin{:});
