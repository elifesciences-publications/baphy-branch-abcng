function varargout = DAQmxGetSampClkMaxRate(varargin)
%DAQMXGETSAMPCLKMAXRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetSampClkMaxRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkMaxRate',varargin{:});
