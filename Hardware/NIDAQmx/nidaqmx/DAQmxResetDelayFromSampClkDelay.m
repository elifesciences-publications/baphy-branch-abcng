function varargout = DAQmxResetDelayFromSampClkDelay(varargin)
%DAQMXRESETDELAYFROMSAMPCLKDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDelayFromSampClkDelay(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDelayFromSampClkDelay',varargin{:});
