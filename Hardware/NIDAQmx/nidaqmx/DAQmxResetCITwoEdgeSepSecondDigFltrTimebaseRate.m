function varargout = DAQmxResetCITwoEdgeSepSecondDigFltrTimebaseRate(varargin)
%DAQMXRESETCITWOEDGESEPSECONDDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepSecondDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepSecondDigFltrTimebaseRate',varargin{:});
