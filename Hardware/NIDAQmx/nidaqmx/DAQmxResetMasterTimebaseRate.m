function varargout = DAQmxResetMasterTimebaseRate(varargin)
%DAQMXRESETMASTERTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetMasterTimebaseRate(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetMasterTimebaseRate',varargin{:});
