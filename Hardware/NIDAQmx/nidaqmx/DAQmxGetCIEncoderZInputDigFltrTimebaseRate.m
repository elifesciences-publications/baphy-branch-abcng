function varargout = DAQmxGetCIEncoderZInputDigFltrTimebaseRate(varargin)
%DAQMXGETCIENCODERZINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIEncoderZInputDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderZInputDigFltrTimebaseRate',varargin{:});
