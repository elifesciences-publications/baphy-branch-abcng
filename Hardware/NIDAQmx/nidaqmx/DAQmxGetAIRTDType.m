function varargout = DAQmxGetAIRTDType(varargin)
%DAQMXGETAIRTDTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIRTDType(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRTDType',varargin{:});
