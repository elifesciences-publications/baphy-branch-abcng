function varargout = DAQmxGetReadWaitMode(varargin)
%DAQMXGETREADWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetReadWaitMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadWaitMode',varargin{:});
