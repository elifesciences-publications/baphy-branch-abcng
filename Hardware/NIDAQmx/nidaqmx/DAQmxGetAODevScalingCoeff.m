function varargout = DAQmxGetAODevScalingCoeff(varargin)
%DAQMXGETAODEVSCALINGCOEFF calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxGetAODevScalingCoeff ( TaskHandle taskHandle , const char channel [], float64 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, doublePtr] DAQmxGetAODevScalingCoeff(uint32, cstring, doublePtr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAODevScalingCoeff',varargin{:});
