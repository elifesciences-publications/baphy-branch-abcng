function varargout = DAQmxSetCalInfoAttribute(varargin)
%DAQMXSETCALINFOATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, voidPtr] DAQmxSetCalInfoAttribute(cstring, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCalInfoAttribute',varargin{:});
