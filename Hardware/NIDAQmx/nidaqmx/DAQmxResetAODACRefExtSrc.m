function varargout = DAQmxResetAODACRefExtSrc(varargin)
%DAQMXRESETAODACREFEXTSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACRefExtSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACRefExtSrc',varargin{:});
