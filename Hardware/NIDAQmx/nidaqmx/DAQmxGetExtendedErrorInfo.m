function varargout = DAQmxGetExtendedErrorInfo(varargin)
%DAQMXGETEXTENDEDERRORINFO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetExtendedErrorInfo(cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExtendedErrorInfo',varargin{:});
