function varargout = DAQmxGetHshkSampleInputDataWhen(varargin)
%DAQMXGETHSHKSAMPLEINPUTDATAWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetHshkSampleInputDataWhen(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetHshkSampleInputDataWhen',varargin{:});
