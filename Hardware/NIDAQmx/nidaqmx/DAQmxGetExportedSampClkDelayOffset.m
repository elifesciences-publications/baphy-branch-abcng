function varargout = DAQmxGetExportedSampClkDelayOffset(varargin)
%DAQMXGETEXPORTEDSAMPCLKDELAYOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetExportedSampClkDelayOffset(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedSampClkDelayOffset',varargin{:});
