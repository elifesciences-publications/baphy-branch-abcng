function varargout = DAQmxGetPhysicalChanDIPortWidth(varargin)
%DAQMXGETPHYSICALCHANDIPORTWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanDIPortWidth(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanDIPortWidth',varargin{:});
