function varargout = DAQmxResetAICustomScaleName(varargin)
%DAQMXRESETAICUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAICustomScaleName(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAICustomScaleName',varargin{:});
