function varargout = DAQmxResetExportedRdyForXferEventDeassertCond(varargin)
%DAQMXRESETEXPORTEDRDYFORXFEREVENTDEASSERTCOND calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedRdyForXferEventDeassertCond(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedRdyForXferEventDeassertCond',varargin{:});
