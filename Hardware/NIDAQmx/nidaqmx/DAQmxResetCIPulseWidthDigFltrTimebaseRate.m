function varargout = DAQmxResetCIPulseWidthDigFltrTimebaseRate(varargin)
%DAQMXRESETCIPULSEWIDTHDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPulseWidthDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPulseWidthDigFltrTimebaseRate',varargin{:});
