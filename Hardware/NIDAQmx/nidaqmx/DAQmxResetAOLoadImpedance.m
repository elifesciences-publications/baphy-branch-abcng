function varargout = DAQmxResetAOLoadImpedance(varargin)
%DAQMXRESETAOLOADIMPEDANCE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOLoadImpedance(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOLoadImpedance',varargin{:});
