function varargout = DAQmxSetSampClkDigFltrMinPulseWidth(varargin)
%DAQMXSETSAMPCLKDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetSampClkDigFltrMinPulseWidth(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkDigFltrMinPulseWidth',varargin{:});
