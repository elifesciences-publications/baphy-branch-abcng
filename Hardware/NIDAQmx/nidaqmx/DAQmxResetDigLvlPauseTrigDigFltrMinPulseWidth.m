function varargout = DAQmxResetDigLvlPauseTrigDigFltrMinPulseWidth(varargin)
%DAQMXRESETDIGLVLPAUSETRIGDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigLvlPauseTrigDigFltrMinPulseWidth(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigLvlPauseTrigDigFltrMinPulseWidth',varargin{:});
