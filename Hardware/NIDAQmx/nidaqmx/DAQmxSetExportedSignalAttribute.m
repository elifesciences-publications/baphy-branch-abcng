function varargout = DAQmxSetExportedSignalAttribute(varargin)
%DAQMXSETEXPORTEDSIGNALATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxSetExportedSignalAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedSignalAttribute',varargin{:});
