function varargout = DAQmxGetAIRTDA(varargin)
%DAQMXGETAIRTDA calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIRTDA(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRTDA',varargin{:});
