function varargout = DAQmxGetExportedSampClkOutputBehavior(varargin)
%DAQMXGETEXPORTEDSAMPCLKOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedSampClkOutputBehavior(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedSampClkOutputBehavior',varargin{:});
