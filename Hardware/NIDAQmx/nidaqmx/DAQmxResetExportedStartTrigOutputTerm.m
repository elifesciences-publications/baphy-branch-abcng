function varargout = DAQmxResetExportedStartTrigOutputTerm(varargin)
%DAQMXRESETEXPORTEDSTARTTRIGOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedStartTrigOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedStartTrigOutputTerm',varargin{:});
