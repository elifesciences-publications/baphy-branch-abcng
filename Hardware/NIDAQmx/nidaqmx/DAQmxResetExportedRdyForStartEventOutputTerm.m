function varargout = DAQmxResetExportedRdyForStartEventOutputTerm(varargin)
%DAQMXRESETEXPORTEDRDYFORSTARTEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedRdyForStartEventOutputTerm(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedRdyForStartEventOutputTerm',varargin{:});
