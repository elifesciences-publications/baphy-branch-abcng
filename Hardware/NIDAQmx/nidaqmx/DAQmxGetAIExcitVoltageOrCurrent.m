function varargout = DAQmxGetAIExcitVoltageOrCurrent(varargin)
%DAQMXGETAIEXCITVOLTAGEORCURRENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIExcitVoltageOrCurrent(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIExcitVoltageOrCurrent',varargin{:});
