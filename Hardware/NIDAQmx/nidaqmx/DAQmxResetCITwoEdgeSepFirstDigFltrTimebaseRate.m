function varargout = DAQmxResetCITwoEdgeSepFirstDigFltrTimebaseRate(varargin)
%DAQMXRESETCITWOEDGESEPFIRSTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepFirstDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepFirstDigFltrTimebaseRate',varargin{:});
