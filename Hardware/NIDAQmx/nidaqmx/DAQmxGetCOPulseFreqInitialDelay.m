function varargout = DAQmxGetCOPulseFreqInitialDelay(varargin)
%DAQMXGETCOPULSEFREQINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOPulseFreqInitialDelay(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseFreqInitialDelay',varargin{:});
