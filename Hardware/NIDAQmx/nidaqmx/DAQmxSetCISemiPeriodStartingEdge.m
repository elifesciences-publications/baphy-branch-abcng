function varargout = DAQmxSetCISemiPeriodStartingEdge(varargin)
%DAQMXSETCISEMIPERIODSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCISemiPeriodStartingEdge(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCISemiPeriodStartingEdge',varargin{:});
