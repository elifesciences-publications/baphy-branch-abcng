function varargout = DAQmxGetAIDataXferCustomThreshold(varargin)
%DAQMXGETAIDATAXFERCUSTOMTHRESHOLD calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAIDataXferCustomThreshold(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIDataXferCustomThreshold',varargin{:});
