function varargout = DAQmxGetDevPCIBusNum(varargin)
%DAQMXGETDEVPCIBUSNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevPCIBusNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevPCIBusNum',varargin{:});
