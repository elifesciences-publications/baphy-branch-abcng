function varargout = DAQmxSetExportedCtrOutEventOutputBehavior(varargin)
%DAQMXSETEXPORTEDCTROUTEVENTOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedCtrOutEventOutputBehavior(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedCtrOutEventOutputBehavior',varargin{:});
