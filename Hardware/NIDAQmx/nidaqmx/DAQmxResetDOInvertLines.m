function varargout = DAQmxResetDOInvertLines(varargin)
%DAQMXRESETDOINVERTLINES calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOInvertLines(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOInvertLines',varargin{:});
