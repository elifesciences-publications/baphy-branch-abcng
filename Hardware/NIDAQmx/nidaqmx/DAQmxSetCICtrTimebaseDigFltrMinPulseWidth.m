function varargout = DAQmxSetCICtrTimebaseDigFltrMinPulseWidth(varargin)
%DAQMXSETCICTRTIMEBASEDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICtrTimebaseDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICtrTimebaseDigFltrMinPulseWidth',varargin{:});
