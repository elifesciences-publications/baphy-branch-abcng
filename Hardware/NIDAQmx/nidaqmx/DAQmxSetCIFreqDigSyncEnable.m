function varargout = DAQmxSetCIFreqDigSyncEnable(varargin)
%DAQMXSETCIFREQDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqDigSyncEnable',varargin{:});
