function varargout = DAQmxGetCOPulseTimeUnits(varargin)
%DAQMXGETCOPULSETIMEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCOPulseTimeUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseTimeUnits',varargin{:});
