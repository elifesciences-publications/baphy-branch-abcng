function varargout = DAQmxResetCIEncoderAInputDigFltrTimebaseRate(varargin)
%DAQMXRESETCIENCODERAINPUTDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderAInputDigFltrTimebaseRate(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderAInputDigFltrTimebaseRate',varargin{:});
