function varargout = DAQmxDeleteSavedTask(varargin)
%DAQMXDELETESAVEDTASK calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxDeleteSavedTask(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxDeleteSavedTask',varargin{:});
