function varargout = DAQmxResetCIEncoderZIndexPhase(varargin)
%DAQMXRESETCIENCODERZINDEXPHASE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderZIndexPhase(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderZIndexPhase',varargin{:});
