function varargout = DAQmxGetCIFreqStartingEdge(varargin)
%DAQMXGETCIFREQSTARTINGEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIFreqStartingEdge(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqStartingEdge',varargin{:});
