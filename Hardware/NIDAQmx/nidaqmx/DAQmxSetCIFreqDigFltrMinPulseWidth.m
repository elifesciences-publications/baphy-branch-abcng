function varargout = DAQmxSetCIFreqDigFltrMinPulseWidth(varargin)
%DAQMXSETCIFREQDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqDigFltrMinPulseWidth',varargin{:});
