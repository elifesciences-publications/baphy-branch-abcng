function varargout = DAQmxSetSampClkSrc(varargin)
%DAQMXSETSAMPCLKSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetSampClkSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetSampClkSrc',varargin{:});
