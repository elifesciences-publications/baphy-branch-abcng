function varargout = DAQmxGetPersistedChanAuthor(varargin)
%DAQMXGETPERSISTEDCHANAUTHOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetPersistedChanAuthor(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedChanAuthor',varargin{:});
