function varargout = DAQmxGetAIExcitActualVal(varargin)
%DAQMXGETAIEXCITACTUALVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIExcitActualVal(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIExcitActualVal',varargin{:});
