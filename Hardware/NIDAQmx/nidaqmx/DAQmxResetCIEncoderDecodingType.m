function varargout = DAQmxResetCIEncoderDecodingType(varargin)
%DAQMXRESETCIENCODERDECODINGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIEncoderDecodingType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIEncoderDecodingType',varargin{:});
