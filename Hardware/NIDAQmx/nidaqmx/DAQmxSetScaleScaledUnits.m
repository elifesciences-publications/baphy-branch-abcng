function varargout = DAQmxSetScaleScaledUnits(varargin)
%DAQMXSETSCALESCALEDUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetScaleScaledUnits(cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleScaledUnits',varargin{:});
