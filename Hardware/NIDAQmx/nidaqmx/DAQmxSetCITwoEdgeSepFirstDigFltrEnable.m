function varargout = DAQmxSetCITwoEdgeSepFirstDigFltrEnable(varargin)
%DAQMXSETCITWOEDGESEPFIRSTDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepFirstDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepFirstDigFltrEnable',varargin{:});
