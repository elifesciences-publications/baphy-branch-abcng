function varargout = DAQmxSetCOCtrTimebaseDigSyncEnable(varargin)
%DAQMXSETCOCTRTIMEBASEDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOCtrTimebaseDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOCtrTimebaseDigSyncEnable',varargin{:});
