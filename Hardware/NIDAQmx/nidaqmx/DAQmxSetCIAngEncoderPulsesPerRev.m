function varargout = DAQmxSetCIAngEncoderPulsesPerRev(varargin)
%DAQMXSETCIANGENCODERPULSESPERREV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIAngEncoderPulsesPerRev(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIAngEncoderPulsesPerRev',varargin{:});
