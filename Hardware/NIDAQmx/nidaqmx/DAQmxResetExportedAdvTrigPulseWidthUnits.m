function varargout = DAQmxResetExportedAdvTrigPulseWidthUnits(varargin)
%DAQMXRESETEXPORTEDADVTRIGPULSEWIDTHUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAdvTrigPulseWidthUnits(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAdvTrigPulseWidthUnits',varargin{:});
