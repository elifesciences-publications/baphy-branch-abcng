function varargout = DAQmxResetCIAngEncoderInitialAngle(varargin)
%DAQMXRESETCIANGENCODERINITIALANGLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIAngEncoderInitialAngle(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIAngEncoderInitialAngle',varargin{:});
