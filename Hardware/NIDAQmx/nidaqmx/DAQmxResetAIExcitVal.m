function varargout = DAQmxResetAIExcitVal(varargin)
%DAQMXRESETAIEXCITVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIExcitVal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIExcitVal',varargin{:});
