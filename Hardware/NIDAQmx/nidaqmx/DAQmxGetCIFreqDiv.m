function varargout = DAQmxGetCIFreqDiv(varargin)
%DAQMXGETCIFREQDIV calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIFreqDiv(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIFreqDiv',varargin{:});
