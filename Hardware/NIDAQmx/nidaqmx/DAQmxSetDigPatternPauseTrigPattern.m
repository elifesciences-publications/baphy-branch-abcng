function varargout = DAQmxSetDigPatternPauseTrigPattern(varargin)
%DAQMXSETDIGPATTERNPAUSETRIGPATTERN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigPatternPauseTrigPattern(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigPatternPauseTrigPattern',varargin{:});
