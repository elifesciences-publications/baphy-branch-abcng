function varargout = DAQmxSetAnlgWinRefTrigBtm(varargin)
%DAQMXSETANLGWINREFTRIGBTM calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetAnlgWinRefTrigBtm(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgWinRefTrigBtm',varargin{:});
