function varargout = DAQmxGetDODataXferMech(varargin)
%DAQMXGETDODATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDODataXferMech(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDODataXferMech',varargin{:});
