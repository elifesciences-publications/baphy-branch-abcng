function varargout = DAQmxSetScaleLinYIntercept(varargin)
%DAQMXSETSCALELINYINTERCEPT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetScaleLinYIntercept(cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleLinYIntercept',varargin{:});
