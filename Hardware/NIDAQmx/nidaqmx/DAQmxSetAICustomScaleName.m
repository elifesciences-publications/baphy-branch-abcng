function varargout = DAQmxSetAICustomScaleName(varargin)
%DAQMXSETAICUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetAICustomScaleName(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAICustomScaleName',varargin{:});
