function varargout = DAQmxSetDIDigFltrMinPulseWidth(varargin)
%DAQMXSETDIDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDIDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDIDigFltrMinPulseWidth',varargin{:});
