function varargout = DAQmxGetAIExcitDCorAC(varargin)
%DAQMXGETAIEXCITDCORAC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIExcitDCorAC(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIExcitDCorAC',varargin{:});
