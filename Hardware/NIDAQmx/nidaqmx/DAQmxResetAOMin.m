function varargout = DAQmxResetAOMin(varargin)
%DAQMXRESETAOMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOMin(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOMin',varargin{:});
