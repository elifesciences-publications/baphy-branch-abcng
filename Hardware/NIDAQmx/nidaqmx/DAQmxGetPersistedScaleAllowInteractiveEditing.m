function varargout = DAQmxGetPersistedScaleAllowInteractiveEditing(varargin)
%DAQMXGETPERSISTEDSCALEALLOWINTERACTIVEEDITING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPersistedScaleAllowInteractiveEditing(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedScaleAllowInteractiveEditing',varargin{:});
