function varargout = DAQmxGetAnlgEdgeStartTrigHyst(varargin)
%DAQMXGETANLGEDGESTARTTRIGHYST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAnlgEdgeStartTrigHyst(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAnlgEdgeStartTrigHyst',varargin{:});
