function varargout = DAQmxResetAIFreqThreshVoltage(varargin)
%DAQMXRESETAIFREQTHRESHVOLTAGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIFreqThreshVoltage(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIFreqThreshVoltage',varargin{:});
