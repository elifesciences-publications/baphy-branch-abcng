function varargout = DAQmxGetCITwoEdgeSepSecondDigSyncEnable(varargin)
%DAQMXGETCITWOEDGESEPSECONDDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCITwoEdgeSepSecondDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCITwoEdgeSepSecondDigSyncEnable',varargin{:});
