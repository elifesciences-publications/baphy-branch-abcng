function varargout = DAQmxResetDigEdgeArmStartTrigSrc(varargin)
%DAQMXRESETDIGEDGEARMSTARTTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeArmStartTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeArmStartTrigSrc',varargin{:});
