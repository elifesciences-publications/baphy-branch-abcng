function varargout = DAQmxGetAIResistanceUnits(varargin)
%DAQMXGETAIRESISTANCEUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAIResistanceUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIResistanceUnits',varargin{:});
