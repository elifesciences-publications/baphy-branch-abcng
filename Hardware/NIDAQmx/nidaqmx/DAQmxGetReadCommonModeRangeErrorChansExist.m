function varargout = DAQmxGetReadCommonModeRangeErrorChansExist(varargin)
%DAQMXGETREADCOMMONMODERANGEERRORCHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadCommonModeRangeErrorChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadCommonModeRangeErrorChansExist',varargin{:});
