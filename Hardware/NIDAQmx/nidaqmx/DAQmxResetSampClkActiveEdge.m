function varargout = DAQmxResetSampClkActiveEdge(varargin)
%DAQMXRESETSAMPCLKACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkActiveEdge(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkActiveEdge',varargin{:});
