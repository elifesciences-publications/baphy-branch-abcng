function varargout = DAQmxGetExportedHshkEventInterlockedAssertOnStart(varargin)
%DAQMXGETEXPORTEDHSHKEVENTINTERLOCKEDASSERTONSTART calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetExportedHshkEventInterlockedAssertOnStart(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedHshkEventInterlockedAssertOnStart',varargin{:});
