function varargout = DAQmxGetDIAcquireOn(varargin)
%DAQMXGETDIACQUIREON calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetDIAcquireOn(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDIAcquireOn',varargin{:});
