function varargout = DAQmxResetAIChanCalScaleType(varargin)
%DAQMXRESETAICHANCALSCALETYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIChanCalScaleType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIChanCalScaleType',varargin{:});
