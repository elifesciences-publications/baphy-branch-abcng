function varargout = DAQmxResetAIAccelUnits(varargin)
%DAQMXRESETAIACCELUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIAccelUnits(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIAccelUnits',varargin{:});
