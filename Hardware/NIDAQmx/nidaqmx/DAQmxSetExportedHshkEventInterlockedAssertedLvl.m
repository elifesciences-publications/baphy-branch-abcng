function varargout = DAQmxSetExportedHshkEventInterlockedAssertedLvl(varargin)
%DAQMXSETEXPORTEDHSHKEVENTINTERLOCKEDASSERTEDLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedHshkEventInterlockedAssertedLvl(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedHshkEventInterlockedAssertedLvl',varargin{:});
