function varargout = DAQmxSetCICountEdgesCountDirDigFltrMinPulseWidth(varargin)
%DAQMXSETCICOUNTEDGESCOUNTDIRDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesCountDirDigFltrMinPulseWidth(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesCountDirDigFltrMinPulseWidth',varargin{:});
