function varargout = DAQmxGetAIChanCalOperatorName(varargin)
%DAQMXGETAICHANCALOPERATORNAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAIChanCalOperatorName(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIChanCalOperatorName',varargin{:});
