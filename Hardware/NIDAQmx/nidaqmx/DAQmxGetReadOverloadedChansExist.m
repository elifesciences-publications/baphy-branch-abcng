function varargout = DAQmxGetReadOverloadedChansExist(varargin)
%DAQMXGETREADOVERLOADEDCHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadOverloadedChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOverloadedChansExist',varargin{:});
