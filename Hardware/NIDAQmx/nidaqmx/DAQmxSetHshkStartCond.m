function varargout = DAQmxSetHshkStartCond(varargin)
%DAQMXSETHSHKSTARTCOND calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetHshkStartCond(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetHshkStartCond',varargin{:});
