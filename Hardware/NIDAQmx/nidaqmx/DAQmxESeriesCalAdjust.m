function varargout = DAQmxESeriesCalAdjust(varargin)
%DAQMXESERIESCALADJUST calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxESeriesCalAdjust(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxESeriesCalAdjust',varargin{:});
