function varargout = DAQmxSetCITwoEdgeSepFirstDigSyncEnable(varargin)
%DAQMXSETCITWOEDGESEPFIRSTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepFirstDigSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepFirstDigSyncEnable',varargin{:});
