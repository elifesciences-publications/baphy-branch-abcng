function varargout = DAQmxResetAIThrmcplCJCVal(varargin)
%DAQMXRESETAITHRMCPLCJCVAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIThrmcplCJCVal(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIThrmcplCJCVal',varargin{:});
