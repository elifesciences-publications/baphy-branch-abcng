function varargout = DAQmxGetCOCtrTimebaseDigSyncEnable(varargin)
%DAQMXGETCOCTRTIMEBASEDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOCtrTimebaseDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOCtrTimebaseDigSyncEnable',varargin{:});
