function varargout = DAQmxSetAIChanCalApplyCalIfExp(varargin)
%DAQMXSETAICHANCALAPPLYCALIFEXP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIChanCalApplyCalIfExp(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIChanCalApplyCalIfExp',varargin{:});
