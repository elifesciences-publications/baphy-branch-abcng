function varargout = DAQmxSetReadRelativeTo(varargin)
%DAQMXSETREADRELATIVETO calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetReadRelativeTo(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetReadRelativeTo',varargin{:});
