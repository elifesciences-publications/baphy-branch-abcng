function varargout = DAQmxGetSampClkDigFltrEnable(varargin)
%DAQMXGETSAMPCLKDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetSampClkDigFltrEnable(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampClkDigFltrEnable',varargin{:});
