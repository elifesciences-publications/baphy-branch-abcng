function varargout = DAQmxSetAOIdleOutputBehavior(varargin)
%DAQMXSETAOIDLEOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOIdleOutputBehavior(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOIdleOutputBehavior',varargin{:});
