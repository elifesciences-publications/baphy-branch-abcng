function varargout = DAQmxSetCIAngEncoderInitialAngle(varargin)
%DAQMXSETCIANGENCODERINITIALANGLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIAngEncoderInitialAngle(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIAngEncoderInitialAngle',varargin{:});
