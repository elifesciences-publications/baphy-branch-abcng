function varargout = DAQmxGetCISemiPeriodDigSyncEnable(varargin)
%DAQMXGETCISEMIPERIODDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCISemiPeriodDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCISemiPeriodDigSyncEnable',varargin{:});
