function varargout = DAQmxResetDOLineStatesStartState(varargin)
%DAQMXRESETDOLINESTATESSTARTSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDOLineStatesStartState(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDOLineStatesStartState',varargin{:});
