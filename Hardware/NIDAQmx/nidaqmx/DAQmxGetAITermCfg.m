function varargout = DAQmxGetAITermCfg(varargin)
%DAQMXGETAITERMCFG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAITermCfg(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAITermCfg',varargin{:});
