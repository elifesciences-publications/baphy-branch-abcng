function varargout = DAQmxGetRealTimeNumOfWarmupIters(varargin)
%DAQMXGETREALTIMENUMOFWARMUPITERS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetRealTimeNumOfWarmupIters(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetRealTimeNumOfWarmupIters',varargin{:});
