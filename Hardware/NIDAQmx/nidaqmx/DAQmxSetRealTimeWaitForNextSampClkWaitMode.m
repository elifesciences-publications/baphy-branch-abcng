function varargout = DAQmxSetRealTimeWaitForNextSampClkWaitMode(varargin)
%DAQMXSETREALTIMEWAITFORNEXTSAMPCLKWAITMODE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetRealTimeWaitForNextSampClkWaitMode(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetRealTimeWaitForNextSampClkWaitMode',varargin{:});
