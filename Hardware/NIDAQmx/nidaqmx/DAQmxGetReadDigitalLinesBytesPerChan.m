function varargout = DAQmxGetReadDigitalLinesBytesPerChan(varargin)
%DAQMXGETREADDIGITALLINESBYTESPERCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadDigitalLinesBytesPerChan(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadDigitalLinesBytesPerChan',varargin{:});
