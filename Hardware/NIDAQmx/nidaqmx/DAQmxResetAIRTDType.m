function varargout = DAQmxResetAIRTDType(varargin)
%DAQMXRESETAIRTDTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRTDType(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRTDType',varargin{:});
