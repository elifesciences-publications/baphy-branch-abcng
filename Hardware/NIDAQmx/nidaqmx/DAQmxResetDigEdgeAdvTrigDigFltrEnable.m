function varargout = DAQmxResetDigEdgeAdvTrigDigFltrEnable(varargin)
%DAQMXRESETDIGEDGEADVTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeAdvTrigDigFltrEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeAdvTrigDigFltrEnable',varargin{:});
