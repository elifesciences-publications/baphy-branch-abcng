function varargout = DAQmxGetCILinEncoderDistPerPulse(varargin)
%DAQMXGETCILINENCODERDISTPERPULSE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCILinEncoderDistPerPulse(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCILinEncoderDistPerPulse',varargin{:});
