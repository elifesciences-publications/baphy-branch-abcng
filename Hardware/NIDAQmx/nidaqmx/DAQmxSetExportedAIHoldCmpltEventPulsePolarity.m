function varargout = DAQmxSetExportedAIHoldCmpltEventPulsePolarity(varargin)
%DAQMXSETEXPORTEDAIHOLDCMPLTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedAIHoldCmpltEventPulsePolarity(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAIHoldCmpltEventPulsePolarity',varargin{:});
