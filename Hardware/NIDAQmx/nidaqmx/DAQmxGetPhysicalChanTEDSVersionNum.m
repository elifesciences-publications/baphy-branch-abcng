function varargout = DAQmxGetPhysicalChanTEDSVersionNum(varargin)
%DAQMXGETPHYSICALCHANTEDSVERSIONNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanTEDSVersionNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanTEDSVersionNum',varargin{:});
