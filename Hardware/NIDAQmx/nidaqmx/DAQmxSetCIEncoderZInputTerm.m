function varargout = DAQmxSetCIEncoderZInputTerm(varargin)
%DAQMXSETCIENCODERZINPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCIEncoderZInputTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIEncoderZInputTerm',varargin{:});
