function varargout = DAQmxResetTrigAttribute(varargin)
%DAQMXRESETTRIGATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetTrigAttribute(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetTrigAttribute',varargin{:});
