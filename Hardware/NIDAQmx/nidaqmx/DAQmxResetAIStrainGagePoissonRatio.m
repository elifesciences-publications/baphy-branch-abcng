function varargout = DAQmxResetAIStrainGagePoissonRatio(varargin)
%DAQMXRESETAISTRAINGAGEPOISSONRATIO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIStrainGagePoissonRatio(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIStrainGagePoissonRatio',varargin{:});
