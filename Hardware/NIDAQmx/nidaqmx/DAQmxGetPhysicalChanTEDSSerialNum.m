function varargout = DAQmxGetPhysicalChanTEDSSerialNum(varargin)
%DAQMXGETPHYSICALCHANTEDSSERIALNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanTEDSSerialNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanTEDSSerialNum',varargin{:});
