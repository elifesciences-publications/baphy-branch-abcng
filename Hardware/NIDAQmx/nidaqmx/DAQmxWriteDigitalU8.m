function varargout = DAQmxWriteDigitalU8(varargin)
%DAQMXWRITEDIGITALU8 calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint8Ptr, int32Ptr, uint32Ptr] DAQmxWriteDigitalU8(uint32, int32, uint32, double, uint32, uint8Ptr, int32Ptr, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxWriteDigitalU8',varargin{:});
