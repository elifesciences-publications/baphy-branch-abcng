function varargout = DAQmxSetDigitalLogicFamilyPowerUpState(varargin)
%DAQMXSETDIGITALLOGICFAMILYPOWERUPSTATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetDigitalLogicFamilyPowerUpState(cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigitalLogicFamilyPowerUpState',varargin{:});
