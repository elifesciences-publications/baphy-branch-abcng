function varargout = DAQmxResetAIDCOffset(varargin)
%DAQMXRESETAIDCOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIDCOffset(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIDCOffset',varargin{:});
