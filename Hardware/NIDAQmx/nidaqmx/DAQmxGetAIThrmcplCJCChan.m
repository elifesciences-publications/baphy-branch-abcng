function varargout = DAQmxGetAIThrmcplCJCChan(varargin)
%DAQMXGETAITHRMCPLCJCCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetAIThrmcplCJCChan(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIThrmcplCJCChan',varargin{:});
