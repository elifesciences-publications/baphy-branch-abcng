function varargout = DAQmxResetArmStartTrigType(varargin)
%DAQMXRESETARMSTARTTRIGTYPE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetArmStartTrigType(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetArmStartTrigType',varargin{:});
