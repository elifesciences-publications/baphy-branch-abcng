function varargout = DAQmxGetCIEncoderBInputDigSyncEnable(varargin)
%DAQMXGETCIENCODERBINPUTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIEncoderBInputDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderBInputDigSyncEnable',varargin{:});
