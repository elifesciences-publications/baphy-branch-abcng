function varargout = DAQmxResetDigPatternPauseTrigSrc(varargin)
%DAQMXRESETDIGPATTERNPAUSETRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternPauseTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternPauseTrigSrc',varargin{:});
