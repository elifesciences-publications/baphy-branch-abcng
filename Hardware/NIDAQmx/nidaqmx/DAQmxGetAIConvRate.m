function varargout = DAQmxGetAIConvRate(varargin)
%DAQMXGETAICONVRATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetAIConvRate(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIConvRate',varargin{:});
