function varargout = DAQmxSetAIMicrophoneSensitivity(varargin)
%DAQMXSETAIMICROPHONESENSITIVITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIMicrophoneSensitivity(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIMicrophoneSensitivity',varargin{:});
