function varargout = DAQmxGetDevPXISlotNum(varargin)
%DAQMXGETDEVPXISLOTNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetDevPXISlotNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevPXISlotNum',varargin{:});
