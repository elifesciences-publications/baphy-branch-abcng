function varargout = DAQmxGetCICountEdgesCountDirDigFltrTimebaseSrc(varargin)
%DAQMXGETCICOUNTEDGESCOUNTDIRDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCICountEdgesCountDirDigFltrTimebaseSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesCountDirDigFltrTimebaseSrc',varargin{:});
