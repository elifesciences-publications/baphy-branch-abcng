function varargout = DAQmxResetAIForceReadFromChan(varargin)
%DAQMXRESETAIFORCEREADFROMCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIForceReadFromChan(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIForceReadFromChan',varargin{:});
