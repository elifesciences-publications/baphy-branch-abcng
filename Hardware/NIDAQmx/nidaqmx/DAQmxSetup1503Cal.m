function varargout = DAQmxSetup1503Cal(varargin)
%DAQMXSETUP1503CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1503Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1503Cal',varargin{:});
