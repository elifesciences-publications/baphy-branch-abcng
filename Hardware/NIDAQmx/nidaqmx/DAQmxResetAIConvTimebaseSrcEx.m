function varargout = DAQmxResetAIConvTimebaseSrcEx(varargin)
%DAQMXRESETAICONVTIMEBASESRCEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIConvTimebaseSrcEx(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvTimebaseSrcEx',varargin{:});
