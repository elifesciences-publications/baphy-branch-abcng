function varargout = DAQmxGetAISoundPressureUnits(varargin)
%DAQMXGETAISOUNDPRESSUREUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAISoundPressureUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAISoundPressureUnits',varargin{:});
