function varargout = DAQmxResetCIPeriodDigFltrTimebaseSrc(varargin)
%DAQMXRESETCIPERIODDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCIPeriodDigFltrTimebaseSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCIPeriodDigFltrTimebaseSrc',varargin{:});
