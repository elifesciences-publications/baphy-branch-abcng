function varargout = DAQmxSetup1126Cal(varargin)
%DAQMXSETUP1126CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetup1126Cal(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetup1126Cal',varargin{:});
