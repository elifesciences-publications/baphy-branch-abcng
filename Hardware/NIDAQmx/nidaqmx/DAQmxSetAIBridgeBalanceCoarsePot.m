function varargout = DAQmxSetAIBridgeBalanceCoarsePot(varargin)
%DAQMXSETAIBRIDGEBALANCECOARSEPOT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIBridgeBalanceCoarsePot(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIBridgeBalanceCoarsePot',varargin{:});
