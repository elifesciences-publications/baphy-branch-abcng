function varargout = DAQmxGetReadOpenCurrentLoopChansExist(varargin)
%DAQMXGETREADOPENCURRENTLOOPCHANSEXIST calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetReadOpenCurrentLoopChansExist(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetReadOpenCurrentLoopChansExist',varargin{:});
