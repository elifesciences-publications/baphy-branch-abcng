function varargout = DAQmxGetDevDIPorts(varargin)
%DAQMXGETDEVDIPORTS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetDevDIPorts(cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevDIPorts',varargin{:});
