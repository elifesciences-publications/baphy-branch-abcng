function varargout = DAQmxGetCIEncoderAInputTerm(varargin)
%DAQMXGETCIENCODERAINPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIEncoderAInputTerm(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderAInputTerm',varargin{:});
