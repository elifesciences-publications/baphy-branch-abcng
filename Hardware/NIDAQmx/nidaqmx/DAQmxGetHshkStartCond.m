function varargout = DAQmxGetHshkStartCond(varargin)
%DAQMXGETHSHKSTARTCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetHshkStartCond(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetHshkStartCond',varargin{:});
