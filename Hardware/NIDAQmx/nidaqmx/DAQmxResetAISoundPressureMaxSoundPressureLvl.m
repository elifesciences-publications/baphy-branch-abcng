function varargout = DAQmxResetAISoundPressureMaxSoundPressureLvl(varargin)
%DAQMXRESETAISOUNDPRESSUREMAXSOUNDPRESSURELVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAISoundPressureMaxSoundPressureLvl(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAISoundPressureMaxSoundPressureLvl',varargin{:});
