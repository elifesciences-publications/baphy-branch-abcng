function varargout = DAQmxSetAISoundPressureUnits(varargin)
%DAQMXSETAISOUNDPRESSUREUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAISoundPressureUnits(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAISoundPressureUnits',varargin{:});
