function varargout = DAQmxResetDigPatternRefTrigSrc(varargin)
%DAQMXRESETDIGPATTERNREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigPatternRefTrigSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigPatternRefTrigSrc',varargin{:});
