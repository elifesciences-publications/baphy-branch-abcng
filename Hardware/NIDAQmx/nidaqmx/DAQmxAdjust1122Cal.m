function varargout = DAQmxAdjust1122Cal(varargin)
%DAQMXADJUST1122CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1122Cal(uint32, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1122Cal',varargin{:});
