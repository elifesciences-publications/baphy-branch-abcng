function varargout = DAQmxResetAODACOffsetSrc(varargin)
%DAQMXRESETAODACOFFSETSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAODACOffsetSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAODACOffsetSrc',varargin{:});
