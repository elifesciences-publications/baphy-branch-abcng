function varargout = DAQmxGetAOGain(varargin)
%DAQMXGETAOGAIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOGain(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOGain',varargin{:});
