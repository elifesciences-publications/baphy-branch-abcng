function varargout = DAQmxResetChanAttribute(varargin)
%DAQMXRESETCHANATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetChanAttribute(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetChanAttribute',varargin{:});
