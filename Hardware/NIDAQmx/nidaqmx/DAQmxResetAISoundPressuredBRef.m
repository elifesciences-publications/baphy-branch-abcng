function varargout = DAQmxResetAISoundPressuredBRef(varargin)
%DAQMXRESETAISOUNDPRESSUREDBREF calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAISoundPressuredBRef(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAISoundPressuredBRef',varargin{:});
