function varargout = DAQmxSetDigEdgeArmStartTrigDigSyncEnable(varargin)
%DAQMXSETDIGEDGEARMSTARTTRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetDigEdgeArmStartTrigDigSyncEnable(uint32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetDigEdgeArmStartTrigDigSyncEnable',varargin{:});
