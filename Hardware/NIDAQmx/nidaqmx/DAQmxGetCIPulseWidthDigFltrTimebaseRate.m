function varargout = DAQmxGetCIPulseWidthDigFltrTimebaseRate(varargin)
%DAQMXGETCIPULSEWIDTHDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCIPulseWidthDigFltrTimebaseRate(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPulseWidthDigFltrTimebaseRate',varargin{:});
