function varargout = DAQmxSetAIThrmstrB(varargin)
%DAQMXSETAITHRMSTRB calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIThrmstrB(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIThrmstrB',varargin{:});
