function varargout = DAQmxGetExportedDataActiveEventLvlActiveLvl(varargin)
%DAQMXGETEXPORTEDDATAACTIVEEVENTLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedDataActiveEventLvlActiveLvl(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedDataActiveEventLvlActiveLvl',varargin{:});
