function varargout = DAQmxSetCalUserDefinedInfo(varargin)
%DAQMXSETCALUSERDEFINEDINFO calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCalUserDefinedInfo(cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCalUserDefinedInfo',varargin{:});
