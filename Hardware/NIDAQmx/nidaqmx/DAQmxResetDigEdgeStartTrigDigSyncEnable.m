function varargout = DAQmxResetDigEdgeStartTrigDigSyncEnable(varargin)
%DAQMXRESETDIGEDGESTARTTRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeStartTrigDigSyncEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeStartTrigDigSyncEnable',varargin{:});
