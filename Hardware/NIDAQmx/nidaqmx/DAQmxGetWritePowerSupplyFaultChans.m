function varargout = DAQmxGetWritePowerSupplyFaultChans(varargin)
%DAQMXGETWRITEPOWERSUPPLYFAULTCHANS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetWritePowerSupplyFaultChans(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetWritePowerSupplyFaultChans',varargin{:});
