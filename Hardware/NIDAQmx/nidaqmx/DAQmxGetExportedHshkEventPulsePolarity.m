function varargout = DAQmxGetExportedHshkEventPulsePolarity(varargin)
%DAQMXGETEXPORTEDHSHKEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedHshkEventPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedHshkEventPulsePolarity',varargin{:});
