function varargout = DAQmxSetAIACExcitSyncEnable(varargin)
%DAQMXSETAIACEXCITSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIACExcitSyncEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIACExcitSyncEnable',varargin{:});
