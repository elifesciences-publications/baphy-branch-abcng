function varargout = DAQmxGetExportedPauseTrigLvlActiveLvl(varargin)
%DAQMXGETEXPORTEDPAUSETRIGLVLACTIVELVL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedPauseTrigLvlActiveLvl(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedPauseTrigLvlActiveLvl',varargin{:});
