function varargout = DAQmxSetCOPulseTicksInitialDelay(varargin)
%DAQMXSETCOPULSETICKSINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCOPulseTicksInitialDelay(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseTicksInitialDelay',varargin{:});
