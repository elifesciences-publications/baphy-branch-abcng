function varargout = DAQmxGetSampQuantSampMode(varargin)
%DAQMXGETSAMPQUANTSAMPMODE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetSampQuantSampMode(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSampQuantSampMode',varargin{:});
