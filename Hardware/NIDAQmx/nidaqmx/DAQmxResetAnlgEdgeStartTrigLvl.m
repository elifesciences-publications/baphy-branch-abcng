function varargout = DAQmxResetAnlgEdgeStartTrigLvl(varargin)
%DAQMXRESETANLGEDGESTARTTRIGLVL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgEdgeStartTrigLvl(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgEdgeStartTrigLvl',varargin{:});
