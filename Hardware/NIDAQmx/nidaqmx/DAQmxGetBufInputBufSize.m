function varargout = DAQmxGetBufInputBufSize(varargin)
%DAQMXGETBUFINPUTBUFSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, uint32Ptr] DAQmxGetBufInputBufSize(uint32, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetBufInputBufSize',varargin{:});
