function varargout = DAQmxResetAnlgLvlPauseTrigWhen(varargin)
%DAQMXRESETANLGLVLPAUSETRIGWHEN calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetAnlgLvlPauseTrigWhen(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAnlgLvlPauseTrigWhen',varargin{:});
