function varargout = DAQmxGetSyncPulseMinDelayToStart(varargin)
%DAQMXGETSYNCPULSEMINDELAYTOSTART calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, doublePtr] DAQmxGetSyncPulseMinDelayToStart(uint32, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSyncPulseMinDelayToStart',varargin{:});
