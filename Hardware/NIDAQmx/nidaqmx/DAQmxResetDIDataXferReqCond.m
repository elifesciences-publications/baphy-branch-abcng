function varargout = DAQmxResetDIDataXferReqCond(varargin)
%DAQMXRESETDIDATAXFERREQCOND calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetDIDataXferReqCond(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDIDataXferReqCond',varargin{:});
