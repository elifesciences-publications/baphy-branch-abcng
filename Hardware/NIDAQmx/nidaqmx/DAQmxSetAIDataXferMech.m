function varargout = DAQmxSetAIDataXferMech(varargin)
%DAQMXSETAIDATAXFERMECH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAIDataXferMech(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAIDataXferMech',varargin{:});
