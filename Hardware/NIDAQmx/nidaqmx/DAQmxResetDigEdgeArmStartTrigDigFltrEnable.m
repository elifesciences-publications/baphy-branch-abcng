function varargout = DAQmxResetDigEdgeArmStartTrigDigFltrEnable(varargin)
%DAQMXRESETDIGEDGEARMSTARTTRIGDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeArmStartTrigDigFltrEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeArmStartTrigDigFltrEnable',varargin{:});
