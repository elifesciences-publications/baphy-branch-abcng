function varargout = DAQmxGetDevAOCurrentRngs(varargin)
%DAQMXGETDEVAOCURRENTRNGS calls nidaqmx library with the appropriate arguments.
%
% The C declaration for this function is the following:
%	 int32 _stdcall DAQmxGetDevAOCurrentRngs ( const char device [], float64 * data , uInt32 arraySizeInSamples ); 
%
% The MATLAB Declaration looks like the following:
%	[int32, cstring, doublePtr] DAQmxGetDevAOCurrentRngs(cstring, doublePtr, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDevAOCurrentRngs',varargin{:});
