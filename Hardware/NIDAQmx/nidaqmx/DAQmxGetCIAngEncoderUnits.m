function varargout = DAQmxGetCIAngEncoderUnits(varargin)
%DAQMXGETCIANGENCODERUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIAngEncoderUnits(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIAngEncoderUnits',varargin{:});
