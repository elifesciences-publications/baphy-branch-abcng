function varargout = DAQmxGetCIEncoderZIndexPhase(varargin)
%DAQMXGETCIENCODERZINDEXPHASE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetCIEncoderZIndexPhase(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIEncoderZIndexPhase',varargin{:});
