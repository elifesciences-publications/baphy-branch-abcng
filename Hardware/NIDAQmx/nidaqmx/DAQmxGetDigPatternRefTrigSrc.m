function varargout = DAQmxGetDigPatternRefTrigSrc(varargin)
%DAQMXGETDIGPATTERNREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxGetDigPatternRefTrigSrc(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetDigPatternRefTrigSrc',varargin{:});
