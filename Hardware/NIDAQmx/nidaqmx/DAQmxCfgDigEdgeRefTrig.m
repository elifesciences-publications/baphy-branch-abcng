function varargout = DAQmxCfgDigEdgeRefTrig(varargin)
%DAQMXCFGDIGEDGEREFTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxCfgDigEdgeRefTrig(uint32, cstring, int32, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCfgDigEdgeRefTrig',varargin{:});
