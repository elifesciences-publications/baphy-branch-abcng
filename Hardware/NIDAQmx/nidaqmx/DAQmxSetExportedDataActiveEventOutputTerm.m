function varargout = DAQmxSetExportedDataActiveEventOutputTerm(varargin)
%DAQMXSETEXPORTEDDATAACTIVEEVENTOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedDataActiveEventOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedDataActiveEventOutputTerm',varargin{:});
