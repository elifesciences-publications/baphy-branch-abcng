function varargout = DAQmxSetCIPrescaler(varargin)
%DAQMXSETCIPRESCALER calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIPrescaler(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIPrescaler',varargin{:});
