function varargout = DAQmxResetCICtrTimebaseDigFltrMinPulseWidth(varargin)
%DAQMXRESETCICTRTIMEBASEDIGFLTRMINPULSEWIDTH calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseDigFltrMinPulseWidth(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseDigFltrMinPulseWidth',varargin{:});
