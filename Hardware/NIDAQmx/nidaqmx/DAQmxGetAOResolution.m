function varargout = DAQmxGetAOResolution(varargin)
%DAQMXGETAORESOLUTION calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAOResolution(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOResolution',varargin{:});
