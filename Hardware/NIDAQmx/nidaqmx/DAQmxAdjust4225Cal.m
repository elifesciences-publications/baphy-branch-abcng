function varargout = DAQmxAdjust4225Cal(varargin)
%DAQMXADJUST4225CAL calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxAdjust4225Cal(uint32, cstring, double, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust4225Cal',varargin{:});
