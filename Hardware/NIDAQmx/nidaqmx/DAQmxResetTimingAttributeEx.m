function varargout = DAQmxResetTimingAttributeEx(varargin)
%DAQMXRESETTIMINGATTRIBUTEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetTimingAttributeEx(uint32, cstring, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetTimingAttributeEx',varargin{:});
