function varargout = DAQmxSetCOPulseTerm(varargin)
%DAQMXSETCOPULSETERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxSetCOPulseTerm(uint32, cstring, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCOPulseTerm',varargin{:});
