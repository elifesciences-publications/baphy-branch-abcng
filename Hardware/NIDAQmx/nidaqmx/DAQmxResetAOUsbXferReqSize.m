function varargout = DAQmxResetAOUsbXferReqSize(varargin)
%DAQMXRESETAOUSBXFERREQSIZE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOUsbXferReqSize(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOUsbXferReqSize',varargin{:});
