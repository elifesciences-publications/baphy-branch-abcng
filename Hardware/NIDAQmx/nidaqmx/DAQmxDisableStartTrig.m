function varargout = DAQmxDisableStartTrig(varargin)
%DAQMXDISABLESTARTTRIG calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxDisableStartTrig(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxDisableStartTrig',varargin{:});
