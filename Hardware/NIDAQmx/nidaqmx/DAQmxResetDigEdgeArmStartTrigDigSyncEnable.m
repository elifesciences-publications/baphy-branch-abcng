function varargout = DAQmxResetDigEdgeArmStartTrigDigSyncEnable(varargin)
%DAQMXRESETDIGEDGEARMSTARTTRIGDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeArmStartTrigDigSyncEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeArmStartTrigDigSyncEnable',varargin{:});
