function varargout = DAQmxGetCICountEdgesDigSyncEnable(varargin)
%DAQMXGETCICOUNTEDGESDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCICountEdgesDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCICountEdgesDigSyncEnable',varargin{:});
