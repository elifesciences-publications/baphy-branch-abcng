function varargout = DAQmxCreateCIGPSTimestampChan(varargin)
%DAQMXCREATECIGPSTIMESTAMPCHAN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring, cstring] DAQmxCreateCIGPSTimestampChan(uint32, cstring, cstring, int32, int32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxCreateCIGPSTimestampChan',varargin{:});
