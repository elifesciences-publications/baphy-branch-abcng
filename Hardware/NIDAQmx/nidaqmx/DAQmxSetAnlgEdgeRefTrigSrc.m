function varargout = DAQmxSetAnlgEdgeRefTrigSrc(varargin)
%DAQMXSETANLGEDGEREFTRIGSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAnlgEdgeRefTrigSrc(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAnlgEdgeRefTrigSrc',varargin{:});
