function varargout = DAQmxResetSampClkTimebaseActiveEdge(varargin)
%DAQMXRESETSAMPCLKTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkTimebaseActiveEdge(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkTimebaseActiveEdge',varargin{:});
