function varargout = DAQmxGetAOIdleOutputBehavior(varargin)
%DAQMXGETAOIDLEOUTPUTBEHAVIOR calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, int32Ptr] DAQmxGetAOIdleOutputBehavior(uint32, cstring, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOIdleOutputBehavior',varargin{:});
