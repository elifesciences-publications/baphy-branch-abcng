function varargout = DAQmxGetPhysicalChanAOManualControlEnable(varargin)
%DAQMXGETPHYSICALCHANAOMANUALCONTROLENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanAOManualControlEnable(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanAOManualControlEnable',varargin{:});
