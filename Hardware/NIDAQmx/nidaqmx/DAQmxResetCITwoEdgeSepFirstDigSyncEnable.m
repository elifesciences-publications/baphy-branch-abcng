function varargout = DAQmxResetCITwoEdgeSepFirstDigSyncEnable(varargin)
%DAQMXRESETCITWOEDGESEPFIRSTDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCITwoEdgeSepFirstDigSyncEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCITwoEdgeSepFirstDigSyncEnable',varargin{:});
