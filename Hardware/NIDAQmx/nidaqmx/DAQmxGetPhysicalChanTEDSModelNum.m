function varargout = DAQmxGetPhysicalChanTEDSModelNum(varargin)
%DAQMXGETPHYSICALCHANTEDSMODELNUM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPhysicalChanTEDSModelNum(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPhysicalChanTEDSModelNum',varargin{:});
