function varargout = DAQmxSetCICountEdgesInitialCnt(varargin)
%DAQMXSETCICOUNTEDGESINITIALCNT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCICountEdgesInitialCnt(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCICountEdgesInitialCnt',varargin{:});
