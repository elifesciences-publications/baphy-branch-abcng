function varargout = DAQmxResetSampClkDigSyncEnable(varargin)
%DAQMXRESETSAMPCLKDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkDigSyncEnable(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkDigSyncEnable',varargin{:});
