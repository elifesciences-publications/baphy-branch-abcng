function varargout = DAQmxGetCOPulseLowTicks(varargin)
%DAQMXGETCOPULSELOWTICKS calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCOPulseLowTicks(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseLowTicks',varargin{:});
