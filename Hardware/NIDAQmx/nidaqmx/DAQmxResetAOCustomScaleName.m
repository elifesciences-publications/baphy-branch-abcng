function varargout = DAQmxResetAOCustomScaleName(varargin)
%DAQMXRESETAOCUSTOMSCALENAME calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAOCustomScaleName(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAOCustomScaleName',varargin{:});
