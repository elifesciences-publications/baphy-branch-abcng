function varargout = DAQmxGetPersistedChanAllowInteractiveEditing(varargin)
%DAQMXGETPERSISTEDCHANALLOWINTERACTIVEEDITING calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetPersistedChanAllowInteractiveEditing(cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetPersistedChanAllowInteractiveEditing',varargin{:});
