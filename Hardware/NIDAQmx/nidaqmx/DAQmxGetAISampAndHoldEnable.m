function varargout = DAQmxGetAISampAndHoldEnable(varargin)
%DAQMXGETAISAMPANDHOLDENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAISampAndHoldEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAISampAndHoldEnable',varargin{:});
