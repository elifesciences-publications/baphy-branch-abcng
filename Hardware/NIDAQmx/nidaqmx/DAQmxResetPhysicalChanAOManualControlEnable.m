function varargout = DAQmxResetPhysicalChanAOManualControlEnable(varargin)
%DAQMXRESETPHYSICALCHANAOMANUALCONTROLENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetPhysicalChanAOManualControlEnable(cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetPhysicalChanAOManualControlEnable',varargin{:});
