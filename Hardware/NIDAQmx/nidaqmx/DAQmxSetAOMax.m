function varargout = DAQmxSetAOMax(varargin)
%DAQMXSETAOMAX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetAOMax(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetAOMax',varargin{:});
