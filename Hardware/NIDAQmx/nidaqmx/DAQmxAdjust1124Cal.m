function varargout = DAQmxAdjust1124Cal(varargin)
%DAQMXADJUST1124CAL calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxAdjust1124Cal(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxAdjust1124Cal',varargin{:});
