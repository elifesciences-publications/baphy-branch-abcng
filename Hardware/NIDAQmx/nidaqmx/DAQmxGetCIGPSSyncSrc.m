function varargout = DAQmxGetCIGPSSyncSrc(varargin)
%DAQMXGETCIGPSSYNCSRC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, cstring] DAQmxGetCIGPSSyncSrc(uint32, cstring, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIGPSSyncSrc',varargin{:});
