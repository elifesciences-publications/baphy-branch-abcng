function varargout = DAQmxResetAIRTDC(varargin)
%DAQMXRESETAIRTDC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIRTDC(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIRTDC',varargin{:});
