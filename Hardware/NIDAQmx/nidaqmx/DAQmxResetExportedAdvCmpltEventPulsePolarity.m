function varargout = DAQmxResetExportedAdvCmpltEventPulsePolarity(varargin)
%DAQMXRESETEXPORTEDADVCMPLTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetExportedAdvCmpltEventPulsePolarity(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetExportedAdvCmpltEventPulsePolarity',varargin{:});
