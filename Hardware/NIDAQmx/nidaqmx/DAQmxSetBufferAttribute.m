function varargout = DAQmxSetBufferAttribute(varargin)
%DAQMXSETBUFFERATTRIBUTE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, voidPtr] DAQmxSetBufferAttribute(uint32, int32, voidPtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetBufferAttribute',varargin{:});
