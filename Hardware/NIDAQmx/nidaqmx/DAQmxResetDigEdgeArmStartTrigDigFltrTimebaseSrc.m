function varargout = DAQmxResetDigEdgeArmStartTrigDigFltrTimebaseSrc(varargin)
%DAQMXRESETDIGEDGEARMSTARTTRIGDIGFLTRTIMEBASESRC calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetDigEdgeArmStartTrigDigFltrTimebaseSrc(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetDigEdgeArmStartTrigDigFltrTimebaseSrc',varargin{:});
