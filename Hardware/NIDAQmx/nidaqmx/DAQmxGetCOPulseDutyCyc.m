function varargout = DAQmxGetCOPulseDutyCyc(varargin)
%DAQMXGETCOPULSEDUTYCYC calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetCOPulseDutyCyc(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCOPulseDutyCyc',varargin{:});
