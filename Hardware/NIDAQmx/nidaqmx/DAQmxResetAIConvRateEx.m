function varargout = DAQmxResetAIConvRateEx(varargin)
%DAQMXRESETAICONVRATEEX calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetAIConvRateEx(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetAIConvRateEx',varargin{:});
