function varargout = DAQmxResetCICtrTimebaseActiveEdge(varargin)
%DAQMXRESETCICTRTIMEBASEACTIVEEDGE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCICtrTimebaseActiveEdge(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCICtrTimebaseActiveEdge',varargin{:});
