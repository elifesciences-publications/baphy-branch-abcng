function varargout = DAQmxGetCIPeriodDigSyncEnable(varargin)
%DAQMXGETCIPERIODDIGSYNCENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetCIPeriodDigSyncEnable(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetCIPeriodDigSyncEnable',varargin{:});
