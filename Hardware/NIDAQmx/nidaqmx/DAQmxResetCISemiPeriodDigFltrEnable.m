function varargout = DAQmxResetCISemiPeriodDigFltrEnable(varargin)
%DAQMXRESETCISEMIPERIODDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCISemiPeriodDigFltrEnable(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCISemiPeriodDigFltrEnable',varargin{:});
