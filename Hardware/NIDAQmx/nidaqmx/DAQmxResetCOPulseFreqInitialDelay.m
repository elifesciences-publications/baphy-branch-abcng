function varargout = DAQmxResetCOPulseFreqInitialDelay(varargin)
%DAQMXRESETCOPULSEFREQINITIALDELAY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxResetCOPulseFreqInitialDelay(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetCOPulseFreqInitialDelay',varargin{:});
