function varargout = DAQmxSetExportedSampClkDelayOffset(varargin)
%DAQMXSETEXPORTEDSAMPCLKDELAYOFFSET calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedSampClkDelayOffset(uint32, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedSampClkDelayOffset',varargin{:});
