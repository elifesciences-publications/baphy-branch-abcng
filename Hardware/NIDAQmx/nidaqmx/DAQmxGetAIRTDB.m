function varargout = DAQmxGetAIRTDB(varargin)
%DAQMXGETAIRTDB calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetAIRTDB(uint32, cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAIRTDB',varargin{:});
