function varargout = DAQmxSetExportedSampClkTimebaseOutputTerm(varargin)
%DAQMXSETEXPORTEDSAMPCLKTIMEBASEOUTPUTTERM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetExportedSampClkTimebaseOutputTerm(uint32, cstring)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedSampClkTimebaseOutputTerm',varargin{:});
