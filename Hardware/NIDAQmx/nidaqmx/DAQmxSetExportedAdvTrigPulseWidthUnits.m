function varargout = DAQmxSetExportedAdvTrigPulseWidthUnits(varargin)
%DAQMXSETEXPORTEDADVTRIGPULSEWIDTHUNITS calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxSetExportedAdvTrigPulseWidthUnits(uint32, int32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetExportedAdvTrigPulseWidthUnits',varargin{:});
