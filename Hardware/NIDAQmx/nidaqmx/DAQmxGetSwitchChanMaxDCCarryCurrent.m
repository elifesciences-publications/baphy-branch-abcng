function varargout = DAQmxGetSwitchChanMaxDCCarryCurrent(varargin)
%DAQMXGETSWITCHCHANMAXDCCARRYCURRENT calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSwitchChanMaxDCCarryCurrent(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSwitchChanMaxDCCarryCurrent',varargin{:});
