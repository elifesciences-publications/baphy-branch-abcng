function varargout = DAQmxSetCITwoEdgeSepSecondDigFltrEnable(varargin)
%DAQMXSETCITWOEDGESEPSECONDDIGFLTRENABLE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCITwoEdgeSepSecondDigFltrEnable(uint32, cstring, uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCITwoEdgeSepSecondDigFltrEnable',varargin{:});
