function varargout = DAQmxSetScaleMapPreScaledMin(varargin)
%DAQMXSETSCALEMAPPRESCALEDMIN calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetScaleMapPreScaledMin(cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetScaleMapPreScaledMin',varargin{:});
