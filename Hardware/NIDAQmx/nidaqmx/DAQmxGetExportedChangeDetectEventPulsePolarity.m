function varargout = DAQmxGetExportedChangeDetectEventPulsePolarity(varargin)
%DAQMXGETEXPORTEDCHANGEDETECTEVENTPULSEPOLARITY calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, int32Ptr] DAQmxGetExportedChangeDetectEventPulsePolarity(uint32, int32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetExportedChangeDetectEventPulsePolarity',varargin{:});
