function varargout = DAQmxSetCIFreqDigFltrTimebaseRate(varargin)
%DAQMXSETCIFREQDIGFLTRTIMEBASERATE calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring] DAQmxSetCIFreqDigFltrTimebaseRate(uint32, cstring, double)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxSetCIFreqDigFltrTimebaseRate',varargin{:});
