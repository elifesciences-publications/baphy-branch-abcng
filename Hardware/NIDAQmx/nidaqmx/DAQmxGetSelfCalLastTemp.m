function varargout = DAQmxGetSelfCalLastTemp(varargin)
%DAQMXGETSELFCALLASTTEMP calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, doublePtr] DAQmxGetSelfCalLastTemp(cstring, doublePtr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetSelfCalLastTemp',varargin{:});
