function varargout = DAQmxResetSampClkTimebaseMasterTimebaseDiv(varargin)
%DAQMXRESETSAMPCLKTIMEBASEMASTERTIMEBASEDIV calls nidaqmx library with the appropriate arguments.
%
...
%	int32 DAQmxResetSampClkTimebaseMasterTimebaseDiv(uint32)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxResetSampClkTimebaseMasterTimebaseDiv',varargin{:});
