function varargout = DAQmxGetAOUseOnlyOnBrdMem(varargin)
%DAQMXGETAOUSEONLYONBRDMEM calls nidaqmx library with the appropriate arguments.
%
...
%	[int32, cstring, uint32Ptr] DAQmxGetAOUseOnlyOnBrdMem(uint32, cstring, uint32Ptr)
%
...
[varargout{1}]=calllib('nidaqmx','DAQmxGetAOUseOnlyOnBrdMem',varargin{:});
