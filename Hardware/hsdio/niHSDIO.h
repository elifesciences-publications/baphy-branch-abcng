...
#define NIHSDIO_MINOR_VERSION                800   /* Instrument driver minor version  */

#define NIHSDIO_SUPPORTED_INSTRUMENT_MODELS  "NI-PXI-6541, NI-PXI-6542, NI-PCI-6541, NI-PCI-6542, NI-PXIe-6544, NI-PXIe-6545, NI-PXIe-6547, NI-PXIe-6548, NI-PXI-6551, NI-PXI-6552, NI-PCI-6551, NI-PCI-6552, NI-PXIe-6555, NI-PXIe-6556, NI-PXI-6561, NI-PXI-6562, NI-PCI-6561, NI-PCI-6562"
...
#define NIHSDIO_ATTR_DATA_TERMINATION_VOLTAGE_LEVEL          (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 161L)  /* ViReal64, channel-based */
#define NIHSDIO_ATTR_DATA_VOLTAGE_RANGE                      (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 163L)  /* ViInt32 */
...
#define NIHSDIO_ATTR_TRIGGER_VOLTAGE_RANGE                   (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 172L)  /* ViInt32 */
...
#define NIHSDIO_ATTR_EVENT_VOLTAGE_RANGE                     (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 173L)  /* ViInt32 */
#define NIHSDIO_ATTR_CLOCK_VOLTAGE_LOW_LEVEL                 (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 168L)  /* ViReal64 */
#define NIHSDIO_ATTR_CLOCK_VOLTAGE_HIGH_LEVEL                (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 169L)  /* ViReal64 */
#define NIHSDIO_ATTR_CLOCK_VOLTAGE_RANGE                      (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 174L)  /* ViInt32 */
...
#define NIHSDIO_ATTR_DATA_TRISTATE_MODE                      (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 160L)  /* ViInt32, channel-based */
#define NIHSDIO_ATTR_DATA_TERMINATION_MODE                   (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 175L)  /* ViInt32, channel-based */
...
#define NIHSDIO_ATTR_DATA_DESKEW                             (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 162L)  /* ViReal64 */
#define NIHSDIO_ATTR_TRIGGER_POSITION_DELAY                  (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 164L)  /* ViReal64 */
#define NIHSDIO_ATTR_TRIGGER_DESKEW                          (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 165L)  /* ViReal64 */
#define NIHSDIO_ATTR_EVENT_POSITION_DELAY                    (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 166L)  /* ViReal64 */
#define NIHSDIO_ATTR_EVENT_DESKEW                            (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 167L)  /* ViReal64 */
...
#define NIHSDIO_ATTR_DEVICE_POWER_CONSUMPTION                (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 170L)  /* ViInt32 */
#define NIHSDIO_ATTR_DEVICE_PEAK_POWER_CONSUMED              (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 171L)  /* ViInt32 */
...
/* Data Voltage Range */
#define NIHSDIO_VAL_MINUS_2_TO_6_VOLTAGE_RANGE           86
#define NIHSDIO_VAL_MINUS_1_TO_7_VOLTAGE_RANGE           87

/* Tristate Mode */
#define NIHSDIO_VAL_HIGH_IMPEDANCE                       84
#define NIHSDIO_VAL_DRIVE_TERMINATION_VOLTAGE            85
...
/* Software Timed PMU Constants */
/* Sense Terminal */
#define NIHSDIO_VAL_STPMU_LOCAL_SENSE                    88
#define NIHSDIO_VAL_STPMU_REMOTE_SENSE                   89

/* STPMU Disable return state */
#define NIHSDIO_VAL_STPMU_RETURN_TO_TRISTATE             90
#define NIHSDIO_VAL_STPMU_RETURN_TO_PREVIOUS             91

/* STPMU External force/sense control action */
#define NIHSDIO_VAL_STPMU_CONNECT_EXTERNAL               92
#define NIHSDIO_VAL_STPMU_DISCONNECT_EXTERNAL            93

/* STPMU External force/sense connector */
#define NIHSDIO_VAL_STPMU_AUX_IO_CONNECTOR               94
#define NIHSDIO_VAL_STPMU_REMOTE_SENSE_CONNECTOR         95
...
#define NIHSDIO_VAL_PXIE_DSTARA_STR                      "PXIe-DStarA"
...
/* Software Timed PMU Functions */
ViStatus _VI_FUNC niHSDIO_STPMU_SourceVoltage (
   ViSession vi,
   ViConstString channelList,
   ViReal64 voltageLevel,
   ViInt32 sense,
   ViReal64 currentRange);
ViStatus _VI_FUNC niHSDIO_STPMU_SourceCurrent (
   ViSession vi,
   ViConstString channelList,
...
ViStatus _VI_FUNC niHSDIO_STPMU_DisablePMU (
   ViSession vi,
   ViConstString channelList,
   ViInt32 returnState);
ViStatus _VI_FUNC niHSDIO_STPMU_MeasureVoltage (
   ViSession vi,
   ViConstString channelList,
...
ViStatus _VI_FUNC niHSDIO_STPMU_MeasureCurrent (
   ViSession vi,
   ViConstString channelList,
   ViReal64 apertureTime,
   ViReal64 measurements[],
   ViInt32 *numberOfMeasurements);
ViStatus _VI_FUNC niHSDIO_STPMU_ExternalForceControl (
   ViSession vi,
   ViConstString channelList,
   ViInt32 action,
   ViInt32 connector);
ViStatus _VI_FUNC niHSDIO_STPMU_ExternalSenseControl (
   ViSession vi,
...
#define NIHSDIO_ERROR_EMPTY_CHANNEL_LIST_NOT_SUPPORTED             (IVI_SPECIFIC_ERROR_BASE + 104L)
#define NIHSDIO_ERROR_STPMU_FUNCTION_NOT_SUPPORTED                 (IVI_SPECIFIC_ERROR_BASE + 105L)
#define NIHSDIO_ERROR_DEVICE_POWER_LIMIT_EXCEEDED                  (IVI_SPECIFIC_ERROR_BASE + 106L)
#define NIHSDIO_ERROR_INVALID_SENSE_TERMINAL                       (IVI_SPECIFIC_ERROR_BASE + 107L)
#define NIHSDIO_ERROR_INVALID_PMU_RETURN_STATE                     (IVI_SPECIFIC_ERROR_BASE + 108L)
#define NIHSDIO_ERROR_INVALID_PMU_EXTERNAL_ACTION                  (IVI_SPECIFIC_ERROR_BASE + 109L)
#define NIHSDIO_ERROR_INVALID_PMU_CURRENT_RANGE                    (IVI_SPECIFIC_ERROR_BASE + 110L)
#define NIHSDIO_ERROR_INVALID_PMU_CONNECTOR                        (IVI_SPECIFIC_ERROR_BASE + 111L)
#define NIHSDIO_ERROR_DDS_CLOCK_FAILED_TO_LOCK                     (IVI_SPECIFIC_ERROR_BASE + 112L)
#define NIHSDIO_ERROR_STPMU_MULTIPLE_CHANNELS_FOR_EXT_SENSE        (IVI_SPECIFIC_ERROR_BASE + 113L)
#define NIHSDIO_ERROR_STPMU_SENSE_TERMINAL_MISMATCH                (IVI_SPECIFIC_ERROR_BASE + 114L)
#define NIHSDIO_ERROR_VOLTAGE_RANGE_RESERVATION                    (IVI_SPECIFIC_ERROR_BASE + 115L)
#define NIHSDIO_ERROR_VOLTAGE_VALUE_NOT_WITHIN_VOLTAGE_RANGE       (IVI_SPECIFIC_ERROR_BASE + 116L)
#define NIHSDIO_ERROR_STPMU_INVALID_APERTURE_TIME                  (IVI_SPECIFIC_ERROR_BASE + 117L)
#define NIHSDIO_ERROR_STPMU_UNINITIALIZED_CHANNEL                  (IVI_SPECIFIC_ERROR_BASE + 118L)
#define NIHSDIO_ERROR_INVALID_CHANNEL_DELAY_POSITION               (IVI_SPECIFIC_ERROR_BASE + 119L)
#define NIHSDIO_ERROR_INVALID_DESKEW_BELOW_DCM_THRESHOLD           (IVI_SPECIFIC_ERROR_BASE + 120L)
#define NIHSDIO_ERROR_STPMU_INVALID_VOLTAGE                        (IVI_SPECIFIC_ERROR_BASE + 121L)
#define NIHSDIO_ERROR_STPMU_INVALID_CURRENT                        (IVI_SPECIFIC_ERROR_BASE + 122L)
#define NIHSDIO_ERROR_STPMU_INVALID_CURRENT_FOR_SELECTED_RANGE     (IVI_SPECIFIC_ERROR_BASE + 123L)
#define NIHSDIO_ERROR_SELF_CALIBRATION_FAILED                      (IVI_SPECIFIC_ERROR_BASE + 124L)
#define NIHSDIO_ERROR_PIN_RESERVED_FOR_EXTERNAL_CONNECTION         (IVI_SPECIFIC_ERROR_BASE + 125L)
#define NIHSDIO_ERROR_IMPEDANCE_NOT_SUPPORTED_ON_STROBE            (IVI_SPECIFIC_ERROR_BASE + 126L)
#define NIHSDIO_ERROR_STPMU_INVALID_VOLTAGE_CLAMP_DIFFERENCE       (IVI_SPECIFIC_ERROR_BASE + 127L)
#define NIHSDIO_ERROR_TRIG_OR_EVENT_ON_RESERVED_CLOCK_TERMINAL     (IVI_SPECIFIC_ERROR_BASE + 128L)
#define NIHSDIO_ERROR_VTT_TRISTATE_TERMINATION_MODE_RESERVATION    (IVI_SPECIFIC_ERROR_BASE + 129L)
#define NIHSDIO_ERROR_CANNOT_TRISTATE_PFI_LINES                    (IVI_SPECIFIC_ERROR_BASE + 130L)
#define NIHSDIO_ERROR_EXTERNAL_CONNECTOR_MISMATCH                  (IVI_SPECIFIC_ERROR_BASE + 131L)
