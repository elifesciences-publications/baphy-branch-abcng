...
while ContinueExp == 1
  ...
  if isfield(exptparams.TrialObject,'TrialIndexLst') && isempty(get(exptparams.TrialObject,'TrialIndexLst')); exptparams.TrialObject = set(exptparams.TrialObject,'TrialIndexLst',TrialIndexLst); end
