    function o = StairStepPunishTarget (varargin)
%
% General behavior control script for Conditioned Avoidance tasks
% (StairStepPunishTarget model). Note that the timing parameters should be
...
switch nargin
    case 0
        ...
        o.IncludeLickDuring = 1;
        o.InitialStepSize= 8;
        o.UserDefinableFields = {'ResponseTime','edit',0.4, 'PreLickWindow', ...
            'edit',0.4, 'PostLickWindow','edit',0.4, 'ShockDuration','edit',0.2, ...
            'PumpDuration','edit',.5,'LightFlashFreq','edit',5, ...
            'LightOnTarget','popupmenu','Yes|No|RefOnTarFlash','MultipleLights','popupmenu','No|Yes',...,
            'StopWaterIfNoLick','checkbox',0,'IncludeLickDuring','checkbox',1, 'InitialStepSize', 'edit',8 };
        o = class(o,'StairStepPunishTarget');
        o = ObjUpdate(o);
    case 1
        % if single argument of class SoundObject, return it
        if isa(varargin{1},'StairStepPunishTarget')
            o = varargin{1};
        else
