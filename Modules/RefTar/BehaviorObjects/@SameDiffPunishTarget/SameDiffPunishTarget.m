function o = SameDiffPunishTarget (varargin)
%
% General behavior control script for Conditioned Avoidance tasks
% (SameDiffPunishTarget model). Note that the timing parameters should be
...
switch nargin
    case 0
        ...
        o = class(o,'SameDiffPunishTarget');
        o = ObjUpdate(o);
    case 1
        % if single argument of class SoundObject, return it
        if isa(varargin{1},'SameDiffPunishTarget')
            o = varargin{1};
        else
