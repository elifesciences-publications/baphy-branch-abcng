function o = FMvsTonePunishTarget (varargin)
%
% General behavior control script for Conditioned Avoidance tasks
% (FMvsTonePunishTarget model). Note that the timing parameters should be
...
switch nargin
    case 0
        ...
        o = class(o,'FMvsTonePunishTarget');
        o = ObjUpdate(o);
    case 1
        % if single argument of class SoundObject, return it
        if isa(varargin{1},'FMvsTonePunishTarget')
            o = varargin{1};
        else
