function o = RovingPunishTarget (varargin)
%
% General behavior control script for Conditioned Avoidance tasks
% (RovingPunishTarget model). Note that the timing parameters should be
...
switch nargin
    case 0
        ...
        o = class(o,'RovingPunishTarget');
        o = ObjUpdate(o);
    case 1
        % if single argument of class SoundObject, return it
        if isa(varargin{1},'RovingPunishTarget')
            o = varargin{1};
        else
