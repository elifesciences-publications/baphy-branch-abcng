...
% (PunishTarget model). Note that the timing parameters should be
...
switch nargin
    case 0
        ...
        o.UserDefinableFields = {'ResponseTime','edit',0.4, 'PreLickWindow', ...
            ...
            'LightFlashGap','edit',0,'LightOnTarget','popupmenu','Yes|No|RefOnTarFlash|RefOffTarFlash|Beginning',...
            'LightOnTrial','popupmenu','Yes|No',...
        ...
        o = class(o,'PunishTarget');
        o = ObjUpdate(o);
    case 1
        % if single argument of class SoundObject, return it
        if isa(varargin{1},'PunishTarget')
            o = varargin{1};
        else
