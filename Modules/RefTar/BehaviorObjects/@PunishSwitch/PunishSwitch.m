function o = PunishSwitch (varargin)
%
% General behavior control script for Conditioned Avoidance tasks
% (PunishSwitch model). Note that the timing parameters should be
...
switch nargin
    case 0
        ...
        o.UserDefinableFields = {'ResponseTime','edit',0.4, 'PreLickWindow', ...
            ...
            'LightFlashGap','edit',0,'LightOnTarget','popupmenu','Yes|No|RefOnTarFlash|Beginning',...
            ...
            'IncludeLickDuring','checkbox',0,'Passive','checkbox',0};
        o = class(o,'PunishSwitch');
        o = ObjUpdate(o);
    case 1
        % if single argument of class SoundObject, return it
        if isa(varargin{1},'PunishSwitch')
            o = varargin{1};
        else
