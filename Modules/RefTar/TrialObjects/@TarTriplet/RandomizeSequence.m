...
LookupTable=randsample(RandTorcs,length(LookupTable),'true',w);
...
RovingRangedB = get(o.TargetHandle,'ScaleFactor');

TripletRovedB=[];
for i = 1:TotalTrials
    index = randperm(3);
    TripletRovedB{1,i} = RovingRangedB(index);
    
end


o = set(o,'TripletRovedB',TripletRovedB);
