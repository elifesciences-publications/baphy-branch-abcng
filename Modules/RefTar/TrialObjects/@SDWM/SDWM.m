function RefTarO = SDWM(varargin)
% SDWM Creates a reference-target base class. All the experiments in this
% paradigm inherit from this class (including passive experiments). 
% The properties of SDWM objects are:
...
case 0
    ...
    RefTarO.UserDefinableFields = {'RefLevel','edit',65,'TarLevel','edit',75,'RoveDurs', 'edit',1,'PumpProfile', 'edit',0,'Safe', 'edit',0,'Gap', 'edit',0.015,'SDorWM', 'edit','WM'};
    RefTarO = class(RefTarO,'SDWM');
    RefTarO = ObjUpdate(RefTarO);
case 1
    % if single argument of class SoundObject, return it
    if isa(varargin{1},'SDWM')
        RefTarO = varargin{1};
    else
