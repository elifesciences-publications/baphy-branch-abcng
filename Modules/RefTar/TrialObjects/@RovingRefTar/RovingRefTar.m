function RefTarO = RovingRefTar(varargin)
% RovingRefTar Creates a reference-target base class. All the experiments in this
% paradigm inherit from this class (including passive experiments). 
% The properties of RovingRefTar objects are:
...
% Methods of RovingRefTar objects are:
%   generateRandomIndex
...
case 0
    ...
    RefTarO.RovingRangedB = [50 60 70 80];
    RefTarO.RoveLevelsdB = [];
    RefTarO.RoveRefs = 0;
    ...
    RefTarO.RunClass = '[]';
    RefTarO.UserDefinableFields = {'OveralldB','edit',80,'RovingRangedB',...
        'edit',20,'RoveRefs', 'edit',0};
    RefTarO = class(RefTarO,'RovingRefTar');
    RefTarO = ObjUpdate(RefTarO);
case 1
    % if single argument of class SoundObject, return it
    if isa(varargin{1},'RovingRefTar')
        RefTarO = varargin{1};
    else
