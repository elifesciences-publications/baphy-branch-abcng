function RefTarO = CntxTuning(varargin)
% CntxTuning Creates a reference-target base class. All the experiments in this
% paradigm inherit from this class (including passive experiments). 
% The properties of CntxTuning objects are:
...
% Methods of CntxTuning objects are:
%   generateRandomIndex
...
case 0
    ...
    RefTarO.UserDefinableFields = {'OveralldB','edit',65,'RelativeTarRefdB',...
        'edit',0};
    RefTarO = class(RefTarO,'CntxTuning');
    RefTarO = ObjUpdate(RefTarO);
case 1
    % if single argument of class SoundObject, return it
    if isa(varargin{1},'CntxTuning')
        RefTarO = varargin{1};
    else
