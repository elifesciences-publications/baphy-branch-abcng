function RefTarO = RefTarToneVsFm(varargin)
% RefTarToneVsFm Creates a reference-target base class. All the experiments in this
% paradigm inherit from this class (including passive experiments). 
% The properties of RefTarToneVsFm objects are:
...
% Methods of RefTarToneVsFm objects are:
%   generateRandomIndex
...
case 0
    ...
    RefTarO.RunClass = '[]';
    RefTarO.UserDefinableFields = {'RefLevel','edit',65,'TarLevel','edit',75,'Punish', 'edit',0,'PunishPercent', 'edit','L','MaxRefs','edit',7};
    RefTarO = class(RefTarO,'RefTarToneVsFm');
    RefTarO = ObjUpdate(RefTarO);
case 1
    % if single argument of class SoundObject, return it
    if isa(varargin{1},'RefTarToneVsFm')
        RefTarO = varargin{1};
    else
