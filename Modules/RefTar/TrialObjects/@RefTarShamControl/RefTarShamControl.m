function RefTarO = RefTarShamControl(varargin)
% RefTarShamControl Creates a reference-target base class. All the experiments in this
% paradigm inherit from this class (including passive experiments). 
% The properties of RefTarShamControl objects are:
...
% Methods of RefTarShamControl objects are:
%   generateRandomIndex

% Serin Atiani June 2010
...
case 0
    ...
    RefTarO.RunClass = '[]';
    RefTarO.ShamBandwidth = 0.25;
    RefTarO.ShamToneCount=20;
    RefTarO.LowFreq = 250;
    RefTarO.HighFreq = 8000;
    RefTarO.UserDefinableFields = {'OveralldB','edit',65,'RelativeTarRefdB',...
        'edit',0, 'ShamBandwidth', 'edit', 0.25, 'ShamToneCount', 'edit', 20, ...
        'LowFreq','edit',250,...       
        'HighFreq','edit',8000};
    RefTarO = class(RefTarO,'RefTarShamControl');
    RefTarO = ObjUpdate(RefTarO);
case 1
    % if single argument of class SoundObject, return it
    if isa(varargin{1},'RefTarShamControl')
        RefTarO = varargin{1};
    else
