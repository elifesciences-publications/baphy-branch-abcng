function RefTarO = RefTarPunishSwitch(varargin)
% RefTarPunishSwitch Creates a reference-target base class. All the experiments in this
% paradigm inherit from this class (including passive experiments). 
% The properties of RefTarPunishSwitch objects are:
...
% Methods of RefTarPunishSwitch objects are:
%   generateRandomIndex
...
case 0
    ...
    RefTarO.RunClass = '[]';
    RefTarO.UserDefinableFields = {'RefLevel','edit',65,'TarLevel','edit',75,'RoveDurs', 'edit',0,'ShockTar', 'edit',1,'PunishPercent', 'edit','L','MaxRefs','edit',7};
    RefTarO = class(RefTarO,'RefTarPunishSwitch');
    RefTarO = ObjUpdate(RefTarO);
case 1
    % if single argument of class SoundObject, return it
    if isa(varargin{1},'RefTarPunishSwitch')
        RefTarO = varargin{1};
    else
