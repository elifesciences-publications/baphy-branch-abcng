...
<head>
 ...
 var codesite_token = "ABZ6GAfsM47buoPCv12VS3v9bnTWMdGUnQ:1410858492433";
 
 
 var CS_env = {"loggedInUserEmail": "boubenec@gmail.com", "relativeBaseUrl": "", "projectHomeUrl": "/p/baphy", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/17097911804237236952", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectName": "baphy", "token": "ABZ6GAfsM47buoPCv12VS3v9bnTWMdGUnQ:1410858492433", "profileUrl": "/u/105489876805901808296/"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fbaphy%2Fsource%2Fbrowse%2FConfig%2Flbhb%2FTrialObjects%2F%40RefTarOpt%2Fset.m" 
...
<table id="nav_and_rev" class="list"
 ...
 <a href="/p/baphy/source/browse/Config/lbhb/TrialObjects/%40RefTarOpt/set.m?edit=1"
 ...
 <li><a href="/p/baphy/source/browse/Config/lbhb/TrialObjects/%40RefTarOpt/set.m?r=5f8ae5ec007ebfa3f58c90785aa90c85ed941cd3" title="Next">5f8ae5ec007e&rsaquo;</a></li>
...
><td class="source">function o = set (o,varargin)<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_2

 onmouseover="gutterOver(2)"

><td class="source">% This is a generic set function for all userdefined classes. Copy this <br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_3

 onmouseover="gutterOver(3)"

><td class="source">% function in your objects directory.<br></td></tr
><tr
...
><td class="source">    % if one argument, display all the fields<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_10

 onmouseover="gutterOver(10)"

><td class="source">        get(o);<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_11

 onmouseover="gutterOver(11)"

><td class="source">    % or two inputs, just return the field<br></td></tr
><tr
...
><td class="source">        get(o,varargin{1});<br></td></tr
><tr
...
><td class="source">        % if single property, change its value<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_16

 onmouseover="gutterOver(16)"

><td class="source">        fields = fieldnames(o);<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_17

 onmouseover="gutterOver(17)"

><td class="source">        index = find(strcmpi (fields,varargin{1})==1);<br></td></tr
><tr
...
><td class="source">            object_field = o.(fields{end});<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_20

 onmouseover="gutterOver(20)"

><td class="source">            if isobject(object_field)<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_21

 onmouseover="gutterOver(21)"

><td class="source">                o.(fields{end}) = set(object_field,varargin{1},varargin{2});<br></td></tr
><tr
...
><td class="source">                error(&#39;%s \n%s&#39;, [&#39;There is no &#39;&#39;&#39; varargin{1} &#39;&#39;&#39; property in specified class&#39;]);<br></td></tr
><tr
...
><td class="source">            o.(fields{index})=varargin{2};<br></td></tr
><tr
...
><td class="source">        error(&#39;%s \n%s&#39;,&#39;Error using ==&gt; set&#39;,&#39;Too many input arguments.&#39;);<br></td></tr
><tr
...
><td class="source">caller = dbstack;<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_33

 onmouseover="gutterOver(33)"

><td class="source">if length(caller)&gt;1<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_34

 onmouseover="gutterOver(34)"

><td class="source">    if ~strcmpi(caller(2).name, &#39;ObjUpdate&#39;)<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_35

 onmouseover="gutterOver(35)"

><td class="source">        % if its not called from ObjUpdate function, run it. <br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_36

 onmouseover="gutterOver(36)"

><td class="source">        % without this check, it will become a close loop.<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_37

 onmouseover="gutterOver(37)"

><td class="source">%         disp(sprintf(&#39;called by %s&#39;,caller(2).name));<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_38

 onmouseover="gutterOver(38)"

><td class="source">        o = ObjUpdate (o);<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 on May 21, 2014
 &nbsp; <a href="/p/baphy/source/diff?spec=svne8a83f1978e8252fc8f4030b6d6a882f0e87739c&r=5f8ae5ec007ebfa3f58c90785aa90c85ed941cd3&amp;format=side&amp;path=/Config/lbhb/TrialObjects/%40RefTarOpt/set.m&amp;old_path=/Config/lbhb/TrialObjects/%40RefTarOpt/set.m&amp;old=">Diff</a>
 </div>
...
\
 ...
 var selected_path = '/Config/lbhb/TrialObjects/@RefTarOpt/set.m';
 ...
 <a href="/p/baphy/source/list?path=/Config/lbhb/TrialObjects/%40RefTarOpt/set.m&r=5f8ae5ec007ebfa3f58c90785aa90c85ed941cd3">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//baphy.googlecode.com/git/Config/lbhb/TrialObjects/@RefTarOpt/set.m">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svne8a83f1978e8252fc8f4030b6d6a882f0e87739c': '/Config/lbhb/TrialObjects/@RefTarOpt/set.m'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail": "boubenec@gmail.com", "relativeBaseUrl": "", "projectHomeUrl": "/p/baphy", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/17097911804237236952", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "domainName": null, "projectName": "baphy", "token": "ABZ6GAfsM47buoPCv12VS3v9bnTWMdGUnQ:1410858492433", "profileUrl": "/u/105489876805901808296/"}, '', 'svne8a83f1978e8252fc8f4030b6d6a882f0e87739c', paths,
