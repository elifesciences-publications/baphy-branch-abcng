...
<head>
 ...
 var codesite_token = "ABZ6GAcjmJ4xk0ZCCliu57geXiaQC5gQCA:1410858482804";
 
 
 var CS_env = {"relativeBaseUrl": "", "projectName": "baphy", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/17097911804237236952", "domainName": null, "profileUrl": "/u/105489876805901808296/", "projectHomeUrl": "/p/baphy", "loggedInUserEmail": "boubenec@gmail.com", "token": "ABZ6GAcjmJ4xk0ZCCliu57geXiaQC5gQCA:1410858482804"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fbaphy%2Fsource%2Fbrowse%2FConfig%2Flbhb%2FTrialObjects%2F%40RefTarOpt%2Fget.m" 
...
<table id="nav_and_rev" class="list"
 ...
 <a href="/p/baphy/source/browse/Config/lbhb/TrialObjects/%40RefTarOpt/get.m?edit=1"
 ...
 <li><a href="/p/baphy/source/browse/Config/lbhb/TrialObjects/%40RefTarOpt/get.m?r=5f8ae5ec007ebfa3f58c90785aa90c85ed941cd3" title="Next">5f8ae5ec007e&rsaquo;</a></li>
...
><td class="source">function varargout = get (varargin)<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_2

 onmouseover="gutterOver(2)"

><td class="source">% This is a generic get function for all child classes. It means, its a get<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_3

 onmouseover="gutterOver(3)"

><td class="source">% function for a class that has a parent object, e.g. any user defined<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_4

 onmouseover="gutterOver(4)"

><td class="source">% sound class, any trial class, etc.<br></td></tr
><tr
...
><td class="source">% Nima Mesgarani, October 2005, mnima@umd.edu<br></td></tr
><tr
...
><td class="source">% check the number of inputs<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_9

 onmouseover="gutterOver(9)"

><td class="source">switch nargin<br></td></tr
><tr
...
><td class="source">        % if property is specified, display all the fields if no output<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_12

 onmouseover="gutterOver(12)"

><td class="source">        % otherwise return them in varargout<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_13

 onmouseover="gutterOver(13)"

><td class="source">        fields = fieldnames(varargin{1});<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_14

 onmouseover="gutterOver(14)"

><td class="source">        if nargout==0 , disp(sprintf(&#39;\t&#39;));end<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_15

 onmouseover="gutterOver(15)"

><td class="source">        if isobject(varargin{1}.(fields{end})) % if there is an object field first return that.<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_16

 onmouseover="gutterOver(16)"

><td class="source">            order = [length(fields) 1:length(fields)-1];<br></td></tr
><tr
...
><td class="source">            order = 1:length(fields);<br></td></tr
><tr
...
><td class="source">        for cnt1 = order<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_21

 onmouseover="gutterOver(21)"

><td class="source">            % if no output required, just display the fields. otherwise<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_22

 onmouseover="gutterOver(22)"

><td class="source">            % put them as fields of output variable<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_23

 onmouseover="gutterOver(23)"

><td class="source">            if isobject(varargin{1}.(fields{cnt1})) % if its an object, call its method<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_24

 onmouseover="gutterOver(24)"

><td class="source">                % if this is parent, get the properties<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_25

 onmouseover="gutterOver(25)"

><td class="source">                if cnt1==max(order)<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_26

 onmouseover="gutterOver(26)"

><td class="source">                    ObjProp = get(varargin{1}.(fields{cnt1}));<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_27

 onmouseover="gutterOver(27)"

><td class="source">                    Objfields = fieldnames(ObjProp);<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_28

 onmouseover="gutterOver(28)"

><td class="source">                    for cnt2 =1:length(Objfields)<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_29

 onmouseover="gutterOver(29)"

><td class="source">                        varargout{1}.(Objfields{cnt2}) = ObjProp.(Objfields{cnt2});<br></td></tr
><tr
...
><td class="source">                    varargout{1}.(fields{cnt1}) = varargin{1}.(fields{cnt1});<br></td></tr
><tr
...
><td class="source">        % if single property is specified, display it or return its value<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_40

 onmouseover="gutterOver(40)"

><td class="source">        % based on argout<br></td></tr
><tr
...
><td class="source">        index = find(strcmpi (fields,varargin{2})==1);<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_43

 onmouseover="gutterOver(43)"

><td class="source">        if isempty(index)<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_44

 onmouseover="gutterOver(44)"

><td class="source">            if isobject(varargin{1}.(fields{end}))<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_45

 onmouseover="gutterOver(45)"

><td class="source">                % go to the parent<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_46

 onmouseover="gutterOver(46)"

><td class="source">                object_field = varargin{1}.(fields{end});<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_47

 onmouseover="gutterOver(47)"

><td class="source">                temp = get(object_field,varargin{2});<br></td></tr
><tr
...
><td class="source">                error(&#39;%s \n%s&#39;, [&#39;There is no &#39;&#39;&#39; varargin{2} &#39;&#39;&#39; property in specified class&#39;]);<br></td></tr
><tr
...
><td class="source">            temp = varargin{1}.(fields{index});<br></td></tr
><tr
...
><td class="source">        varargout{1} = temp;<br></td></tr
><tr
id=sl_svne8a83f1978e8252fc8f4030b6d6a882f0e87739c_55

 onmouseover="gutterOver(55)"

><td class="source">        % Only one property is allowed<br></td></tr
><tr
...
><td class="source">        error(&#39;%s \n%s&#39;,&#39;Error using ==&gt; get&#39;,&#39;Too many input arguments.&#39;);<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 on May 21, 2014
 &nbsp; <a href="/p/baphy/source/diff?spec=svne8a83f1978e8252fc8f4030b6d6a882f0e87739c&r=5f8ae5ec007ebfa3f58c90785aa90c85ed941cd3&amp;format=side&amp;path=/Config/lbhb/TrialObjects/%40RefTarOpt/get.m&amp;old_path=/Config/lbhb/TrialObjects/%40RefTarOpt/get.m&amp;old=">Diff</a>
 </div>
...
\
 ...
 var selected_path = '/Config/lbhb/TrialObjects/@RefTarOpt/get.m';
 ...
 <a href="/p/baphy/source/list?path=/Config/lbhb/TrialObjects/%40RefTarOpt/get.m&r=5f8ae5ec007ebfa3f58c90785aa90c85ed941cd3">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//baphy.googlecode.com/git/Config/lbhb/TrialObjects/@RefTarOpt/get.m">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svne8a83f1978e8252fc8f4030b6d6a882f0e87739c': '/Config/lbhb/TrialObjects/@RefTarOpt/get.m'}
 codereviews = CR_controller.setup(
 {"relativeBaseUrl": "", "projectName": "baphy", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/17097911804237236952", "domainName": null, "profileUrl": "/u/105489876805901808296/", "projectHomeUrl": "/p/baphy", "loggedInUserEmail": "boubenec@gmail.com", "token": "ABZ6GAcjmJ4xk0ZCCliu57geXiaQC5gQCA:1410858482804"}, '', 'svne8a83f1978e8252fc8f4030b6d6a882f0e87739c', paths,
