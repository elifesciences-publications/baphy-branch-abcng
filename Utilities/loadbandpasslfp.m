% function [r,tags,trialset,exptevents]=loadbandpasslfp(mfile,channel,...
%      rasterfs,includeprestim,tag_masks,psthonly,lof,hif,envelope,trialrange)
% 
% load lfp data bandpassed lof-hif.  if envelope=1, return
% envelope, otherwise returns bandpassed voltage trace
%
