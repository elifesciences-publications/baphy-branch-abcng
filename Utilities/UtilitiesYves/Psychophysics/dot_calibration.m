...
Screen('Preference', 'SkipSyncTests', 0);   %  sync tests to skip syn test 1

%% *************** constants *******************
screenNumber = 3;				% use main screen
...
fileDir = 'C:\Data\';                     % directory for data
...
tim0 = GetSecs;
nspl = 5;
x(1) = winCtr(1); % screen center
y(1) =  winCtr(2); % screen center
x(2) = winCtr(1);
...
% ad fixation cross to the screen
