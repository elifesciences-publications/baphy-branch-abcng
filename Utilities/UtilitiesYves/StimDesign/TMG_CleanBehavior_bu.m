...
%         disp('MISS: !CARAMBA! should be NaN');
    ...
    Behavior.ChangeTimes(CatchBit|CatchEarlyBits) = nan;
    Behavior.ShortChangeTimes = IntegrationTimes;
    Behavior.ShortChangeTimes(CatchBit|CatchEarlyBits) = nan;
    Behavior.TrialStopTimes = TrialStopTimes;
