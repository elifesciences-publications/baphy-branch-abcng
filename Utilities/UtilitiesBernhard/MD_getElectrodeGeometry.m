...
for i=1:length(ElectrodesByChannel)
  ...
  if ~isfield(ElectrodesByChannel(i),'ElecPos') || ...
          isempty(ElectrodesByChannel(i).ElecPos),
      if ~strcmp(cArray,lastArray) 
          ArrayInfo = M_ArrayInfo(cArray, length(ElectrodesByChannel));
      end
